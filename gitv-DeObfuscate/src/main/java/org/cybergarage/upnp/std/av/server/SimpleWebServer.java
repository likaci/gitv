...
public class SimpleWebServer extends NanoHTTPD {
    ...
    private static final Map<String, String> MIME_TYPES = new C21981();
    private static final String TAG = "SimpleWebServer";
    private File rootDir;

    class C21981 extends HashMap<String, String> {
        C21981() {
            put("css", "text/css");
            put("htm", "text/html");
            put("html", "text/html");
                ...
                if (res != null) {
                    ...
                    try {
                        ...
                        if (range != null || startFrom < 0) {
                            ...
                            InputStream c21992 = new FileInputStream(f) {
                                public int available() throws IOException {
                                    return (int) dataLen;
                                }
                            };
                            c21992.skip(startFrom);
                            response2 = new Response(Status.PARTIAL_CONTENT, mime, c21992);
