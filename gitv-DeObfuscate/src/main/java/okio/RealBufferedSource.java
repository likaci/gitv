...
final class RealBufferedSource implements BufferedSource {
    ...
    class C21921 extends InputStream {
        C21921() {
        }
    ...
    public long readDecimalLong() throws IOException {
        ...
        while (request((long) (pos + 1))) {
            ...
            if ((b < (byte) 48 || b > RemoteCode.FLING_LEFT) && !(pos == 0 && b == (byte) 45)) {
                if (pos == 0) {
    ...
    public long readHexadecimalUnsignedLong() throws IOException {
        ...
        for (int pos = 0; request((long) (pos + 1)); pos++) {
            byte b = this.buffer.getByte((long) pos);
            if ((b < (byte) 48 || b > RemoteCode.FLING_LEFT) && ((b < (byte) 97 || b > (byte) 102) && (b < (byte) 65 || b > (byte) 70))) {
                if (pos == 0) {
