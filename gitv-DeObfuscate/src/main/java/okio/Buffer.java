...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
    private static final byte[] DIGITS = new byte[]{(byte) 48, RemoteCode.HOME, RemoteCode.CLICK, RemoteCode.BACK, RemoteCode.MENU, RemoteCode.SEEK_LEFT, RemoteCode.SEEK_RIGHT, RemoteCode.VOLUME_TOP, RemoteCode.VOLUME_BOTTOM, RemoteCode.FLING_LEFT, (byte) 97, (byte) 98, (byte) 99, (byte) 100, (byte) 101, (byte) 102};
    ...
    public Buffer readFrom(InputStream in) throws IOException {
        readFrom(in, IOpenApiCommandHolder.OAA_NO_LIMIT, true);
        return this;
    }
    ...
    public long readHexadecimalUnsignedLong() {
        ...
        do {
            ...
            while (pos < limit) {
                int digit;
                byte b = data[pos];
                if (b >= (byte) 48 && b <= RemoteCode.FLING_LEFT) {
                    digit = b - 48;
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        byte b0 = getByte(0);
        if ((b0 & 128) == 0) {
            codePoint = b0 & Service.LOCUS_CON;
            byteCount = 1;
            min = 0;
            ...
            codePoint = b0 & 7;
            byteCount = 4;
            min = SendFlag.FLAG_KEY_PINGBACK_ST;
        } else {
            skip(1);
            ...
            while (i < endIndex) {
                ...
                if (c < 128) {
                    ...
                    if (c > 56319 || low < 56320 || low > 57343) {
                        ...
                        int codePoint = SendFlag.FLAG_KEY_PINGBACK_ST + (((-55297 & c) << 10) | (-56321 & low));
    ...
    public Buffer writeUtf8CodePoint(int codePoint) {
        if (codePoint < 128) {
            ...
            writeByte((codePoint & 63) | 128);
        } else if (codePoint < SendFlag.FLAG_KEY_PINGBACK_ST) {
