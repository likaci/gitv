...
abstract class Platform {
    ...
    private static class Android extends Platform {
        ...
        class C22212 implements ThreadFactory {
            C22212() {
            }
        ...
        Executor defaultHttpExecutor() {
            return Executors.newCachedThreadPool(new C22212());
        }
    ...
    private static class Base extends Platform {
        ...
        class C22252 implements ThreadFactory {
            C22252() {
            }
        ...
        Executor defaultHttpExecutor() {
            return Executors.newCachedThreadPool(new C22252());
        }
