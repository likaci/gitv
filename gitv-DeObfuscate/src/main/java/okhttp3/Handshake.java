...
public final class Handshake {
    ...
    public int hashCode() {
        return (((((((this.tlsVersion != null ? this.tlsVersion.hashCode() : 0) + WidgetType.ITEM_SETTING_NETWORK) * 31) + this.cipherSuite.hashCode()) * 31) + this.peerCertificates.hashCode()) * 31) + this.localCertificates.hashCode();
    }
}
