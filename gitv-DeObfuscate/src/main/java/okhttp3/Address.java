...
public final class Address {
    ...
    public int hashCode() {
        int hashCode;
        int i = 0;
        int hashCode2 = (((((((((((this.url.hashCode() + WidgetType.ITEM_SETTING_NETWORK) * 31) + this.dns.hashCode()) * 31) + this.proxyAuthenticator.hashCode()) * 31) + this.protocols.hashCode()) * 31) + this.connectionSpecs.hashCode()) * 31) + this.proxySelector.hashCode()) * 31;
        if (this.proxy != null) {
    ...
    public String toString() {
        StringBuilder result = new StringBuilder().append("Address{").append(this.url.host()).append(SOAP.DELIM).append(this.url.port());
        if (this.proxy != null) {
