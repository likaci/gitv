...
public class OkHttpClient implements Cloneable, Factory, WebSocket.Factory {
    ...
    static class C21541 extends Internal {
        C21541() {
        }
    ...
    public static final class Builder {
        ...
        public Builder connectTimeout(long timeout, TimeUnit unit) {
            this.connectTimeout = checkDuration(PingbackConstants.ACT_MIXER_TIMEOUT, timeout, unit);
            return this;
        }

        public Builder readTimeout(long timeout, TimeUnit unit) {
            this.readTimeout = checkDuration(PingbackConstants.ACT_MIXER_TIMEOUT, timeout, unit);
            return this;
        }

        public Builder writeTimeout(long timeout, TimeUnit unit) {
            this.writeTimeout = checkDuration(PingbackConstants.ACT_MIXER_TIMEOUT, timeout, unit);
            return this;
        }
