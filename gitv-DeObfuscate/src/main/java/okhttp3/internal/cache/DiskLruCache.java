...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new C21611();
    boolean closed;
    ...
    class C21633 implements Iterator<Snapshot> {
    ...
    private void readJournal() throws IOException {
        ...
        try {
            ...
            if (MAGIC.equals(magic) && "1".equals(version) && Integer.toString(this.appVersion).equals(appVersionString) && Integer.toString(this.valueCount).equals(valueCountString) && "".equals(blank)) {
                ...
                throw new IOException("unexpected journal header: [" + magic + ", " + version + ", " + valueCountString + ", " + blank + AlbumEnterFactory.SIGN_STR);
            }
