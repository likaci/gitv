...
public final class Http2Codec implements HttpCodec {
    ...
    private static final ByteString HOST = ByteString.encodeUtf8(CrashConst.KEY_HOST);
    ...
    private static final ByteString UPGRADE = ByteString.encodeUtf8(SettingConstants.UPGRADE);
