...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    class C00031 implements FragmentContainer {
        C00031() {
        }
    ...
    public static class SavedState implements Parcelable {
        ...
        class C00041 implements Creator<SavedState> {
            C00041() {
            }
    ...
    final void setIndex(int index, Fragment parent) {
        this.mIndex = index;
        if (parent != null) {
            this.mWho = parent.mWho + SOAP.DELIM + this.mIndex;
        } else {
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        if (this.mChildFragmentManager != null) {
            writer.print(prefix);
            writer.println("Child " + this.mChildFragmentManager + SOAP.DELIM);
            this.mChildFragmentManager.dump(new StringBuilder(String.valueOf(prefix)).append("  ").toString(), fd, writer, args);
        }
    }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachActivity(this.mActivity, new C00031(), this);
    }
