...
final class FragmentManagerImpl extends FragmentManager {
    ...
    int mCurState = 0;
    boolean mDestroyed;
    Runnable mExecCommit = new C00071();
    ...
    public void popBackStack() {
        enqueueAction(new C00082(), false);
    }
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        int i;
        Fragment f;
        String innerPrefix = new StringBuilder(String.valueOf(prefix)).append("    ").toString();
    ...
    static Animation makeOpenCloseAnimation(Context context, float startScale, float endScale, float startAlpha, float endAlpha) {
        ...
        ScaleAnimation scale = new ScaleAnimation(startScale, endScale, startScale, endScale, 1, ThreeDimensionalParams.TEXT_SCALE_FOR_3D, 1, ThreeDimensionalParams.TEXT_SCALE_FOR_3D);
    ...
    L_0x00c2:
        r0 = new android.util.AndroidRuntimeException;
        r1 = new java.lang.StringBuilder;
        r2 = "Fragment ";
        r1.<init>(r2);
        r1 = r1.append(r11);
    ...
    L_0x0026:
        monitor-enter(r8);
        r5 = r8.mPendingActions;	 Catch:{ all -> 0x007d }
        if (r5 == 0) goto L_0x0033;
    L_0x002b:
        r5 = r8.mPendingActions;	 Catch:{ all -> 0x007d }
        r5 = r5.size();	 Catch:{ all -> 0x007d }
    ...
    L_0x004a:
        r5 = r8.mPendingActions;	 Catch:{ all -> 0x007d }
        r4 = r5.size();	 Catch:{ all -> 0x007d }
        r5 = r8.mTmpActions;	 Catch:{ all -> 0x007d }
    ...
    L_0x0059:
        r5 = new java.lang.Runnable[r4];	 Catch:{ all -> 0x007d }
        r8.mTmpActions = r5;	 Catch:{ all -> 0x007d }
    L_0x005d:
        r5 = r8.mPendingActions;	 Catch:{ all -> 0x007d }
        r6 = r8.mTmpActions;	 Catch:{ all -> 0x007d }
        r5.toArray(r6);	 Catch:{ all -> 0x007d }
        r5 = r8.mPendingActions;	 Catch:{ all -> 0x007d }
        r5.clear();	 Catch:{ all -> 0x007d }
        r5 = r8.mActivity;	 Catch:{ all -> 0x007d }
        r5 = r5.mHandler;	 Catch:{ all -> 0x007d }
        r6 = r8.mExecCommit;	 Catch:{ all -> 0x007d }
        r5.removeCallbacks(r6);	 Catch:{ all -> 0x007d }
        monitor-exit(r8);	 Catch:{ all -> 0x007d }
        r5 = 1;
