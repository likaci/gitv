...
public class FragmentActivity extends Activity {
    ...
    final FragmentContainer mContainer = new C00062();
    boolean mCreated;
    ...
    class C00062 implements FragmentContainer {
        C00062() {
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (index != 0) {
            ...
            if (frag == null) {
                ...
                frag.onActivityResult(org.xbill.DNS.Message.MAXLENGTH & requestCode, resultCode, data);
                return;
            }
        }
    ...
    public View onCreateView(String name, Context context, AttributeSet attrs) {
        ...
        int containerId = 0;
        if (!SettingConstants.ACTION_TYPE_FRAGMENT.equals(name)) {
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        if (this.mLoaderManager != null) {
            ...
            this.mLoaderManager.dump(new StringBuilder(String.valueOf(prefix)).append("  ").toString(), fd, writer, args);
        }
        this.mFragments.dump(prefix, fd, writer, args);
        writer.print(prefix);
        writer.println("View Hierarchy:");
        dumpViewHierarchy(new StringBuilder(String.valueOf(prefix)).append("  ").toString(), writer, getWindow().getDecorView());
    }
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int requestCode) {
        if (requestCode == -1) {
            ...
            super.startActivityForResult(intent, ((fragment.mIndex + 1) << 16) + (org.xbill.DNS.Message.MAXLENGTH & requestCode));
        }
    }
