...
public class LocalFingerPrintCacheHelper {
        ...
        try {
            ...
            if (!(dfp == null || store_time == 0 || exp_time == 0)) {
                if (isExpired(store_time, exp_time)) {
                    LogMgr.m1899i("readFingerPrintLocalCache expire");
                    return null;
                }
                LogMgr.m1899i("readFingerPrintLocalCache not expire dfp: " + dfp);
                return dfp;
            }
            ...
            LogMgr.m1900i(Consts.TAG, "SharedPreferences storage type mismatch. Erase all the keys");
        }
        try {
    ...
    public String readFromExternal(String path) throws FingerPrintExpiredException {
        ...
        LogMgr.m1899i("readFromExternal path: " + dfp_file.getAbsolutePath());
        try {
    ...
    private java.lang.String parseDfp(java.lang.String r14) {
        ...
        r9 = r9.append(r14);
        r9 = r9.toString();
        tv.gitv.ptqy.security.fingerprint.LogMgr.m1899i(r9);
        r1 = 0;
        r6 = 0;
        r2 = 0;
        r9 = "&";
                ...
                if (dirs != null) {
                    for (File dir : dirs) {
                        if (dir != null) {
                            ...
                            LogMgr.m1899i("dfp_external: " + dfp_external);
                            if (dfp_external != null) {
                                return dfp_external;
                            }
                        }
