...
public class PingbackController {
    ...
    private void initBasicEvents() {
        ...
        this.kBasicEvents.put(PingbackConstants.ACT_TRACKING_SUCCESS, new BasicInfo(Keys.f2035T, "s", ""));
        this.kBasicEvents.put(PingbackConstants.ACT_TRACKING_HTTP_ERROR, new BasicInfo(Keys.f2035T, "e", "601"));
        this.kBasicEvents.put(PingbackConstants.ACT_TRACKING_TIMEOUT, new BasicInfo(Keys.f2035T, "e", "602"));
        this.kBasicEvents.put(PingbackConstants.ACT_TRACKING_PARAM_ERROR, new BasicInfo(Keys.f2035T, "e", "603"));
