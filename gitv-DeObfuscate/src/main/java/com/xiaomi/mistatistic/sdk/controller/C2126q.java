...
public abstract class C2126q {
    public static String m1842a(Context context, String str, List list) {
        IOException e;
        ...
        try {
            HttpURLConnection a = C2126q.m1845a(context, new URL(str));
            a.setConnectTimeout(10000);
            a.setReadTimeout(15000);
            a.setRequestMethod(HTTP.POST);
            String a2 = C2126q.m1844a(list);
            if (a2 == null) {
            ...
            try {
                ...
                a.getResponseCode();
                BufferedReader bufferedReader3 = new BufferedReader(new InputStreamReader(new C2127r(a.getInputStream())));
                try {
                    String readLine;
    ...
    public static String m1843a(URL url) {
    ...
    public static String m1844a(List list) {
        StringBuffer stringBuffer = new StringBuffer();
    ...
    public static HttpURLConnection m1845a(Context context, URL url) {
        if (!"http".equals(url.getProtocol())) {
            return (HttpURLConnection) url.openConnection();
        }
        if (C2126q.m1849d(context)) {
            return (HttpURLConnection) url.openConnection(new Proxy(Type.HTTP, new InetSocketAddress("10.0.0.200", 80)));
        }
        if (!C2126q.m1848c(context)) {
            return (HttpURLConnection) url.openConnection();
        }
        HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(C2126q.m1843a(url)).openConnection();
    ...
    public static String m1847b(Context context) {
        if (C2126q.m1846a(context)) {
            return "WIFI";
        }
        try {
            ConnectivityManager connectivityManager = (ConnectivityManager) context.getSystemService("connectivity");
    ...
    public static boolean m1848c(Context context) {
    ...
    public static boolean m1849d(Context context) {
        if (!"CN".equalsIgnoreCase(((TelephonyManager) context.getSystemService("phone")).getSimCountryIso())) {
            return false;
        }
        try {
