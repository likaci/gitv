...
public class VGridView extends FrameLayout {
    ...
    private OnFocusChangeListener mOnFocusChangeListener = new C20802();
    private OnItemFocusChangeListener mOnItemFocusChangeListener;
    private OnScrollListener mOnScrollListener = new C20791();
    ...
    class C20791 implements OnScrollListener {
        C20791() {
        }
    ...
    class C20802 implements OnFocusChangeListener {
        C20802() {
        }
