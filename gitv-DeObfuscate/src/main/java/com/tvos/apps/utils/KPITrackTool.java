...
public class KPITrackTool {
    ...
    public static void trackOTADownloadTime(String pkgName, long downloadTime) {
        LogUtil.m1721d(TAG, formatTimeLogMsg(KPIType.TIME_DOWNLOAD_OTA, pkgName, downloadTime, TimeType.COUNT));
    }

    public static void trackGameDownloadTime(String gameName, long downloadTime) {
        LogUtil.m1721d(TAG, formatTimeLogMsg(KPIType.TIME_DOWNLOAD_GAME, gameName, downloadTime, TimeType.COUNT));
    }

    public static void trackGameInstallTime(String gameName, long installTime) {
        LogUtil.m1721d(TAG, formatTimeLogMsg(KPIType.TIME_INSTALL_GAME, gameName, installTime, TimeType.COUNT));
    }

    public static void trackGameUninstallTime(String gameName, long uninstallTime, TimeType timeType) {
        LogUtil.m1721d(TAG, formatTimeLogMsg(KPIType.TIME_UNINSTALL_GAME, gameName, uninstallTime, timeType));
    }

    public static void trackAppDownloadTime(String appName, long downloadTime) {
        LogUtil.m1721d(TAG, formatTimeLogMsg(KPIType.TIME_DOWNLOAD_APP, appName, downloadTime, TimeType.COUNT));
    }

    public static void trackAppInstallTime(String appName, long installTime, TimeType timeType) {
        LogUtil.m1721d(TAG, formatTimeLogMsg(KPIType.TIME_INSTALL_APP, appName, installTime, timeType));
    }

    public static void trackUseCouponTime(String couponName, long time, TimeType timeType) {
        LogUtil.m1721d(TAG, formatTimeLogMsg(KPIType.TIME_USE_COUPON, couponName, time, timeType));
    }
