...
import com.tvos.appdetailpage.utils.INetWorkManager.OnNetStateChangedListener;
import com.tvos.appdetailpage.utils.INetWorkManager.StateCallback;
...
public class NetWorkManager implements INetWorkManager {
    ...
    private static final ThreadFactory sThreadFactory = new C20561();
    ...
    class C20561 implements ThreadFactory {
    ...
    public void initNetWorkManager(Context context, String domain) {
        if (domain.equals(BuildDefaultDocument.APK_DOMAIN_NAME)) {
            this.mRequestUrl = new String[]{"http://www.gitv.cn", "http://www.gitv.cn", "http://www.gitv.cn"};
        }
        this.mContext = context;
        this.mWifiManager = (WifiManager) context.getSystemService("wifi");
        registerLanReceiver();
