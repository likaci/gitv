...
public class AppStoreClient {
    ...
    class C20311 extends ResponseCallback {
        C20311() {
        }
    ...
    class C20322 extends ResponseCallback {
        C20322() {
        }
    ...
    class C20333 extends ResponseCallback {
        C20333() {
        }
    ...
    class C20344 extends ResponseCallback {
        C20344() {
        }
    ...
    public StatusResponse onPushedAppInstalled(String app_id, String app_ver, String keywords, String yunsourceid, String sourcetype, Callback<StatusResponse> cb) {
        ...
        this.pingbackRest.pushedAppStatsPingbackAsync(this.platform_1, this.platform_2, this.product_1, this.product_2, anonymousUserID, this.userID, String.valueOf(rand.nextInt()), Constants.PINGBACK_ACTION_INSTALL_DONE, app_id, app_ver, deviceID, this.macID, this.osVersion, this.appVersion, this.channelID, Constants.TV_CHANNEL_ID_JDTV, null, null, null, keywords, this.entry, null, yunsourceid, sourcetype, new C20311());
    ...
    public StatusResponse onAppInstalled(String app_id, String app_ver, String rpage, String block, String rseat, String keywords, Callback<StatusResponse> cb) {
        ...
        this.pingbackRest.appStatsPingbackAsync(this.platform_1, this.platform_2, this.product_1, this.product_2, anonymousUserID, this.userID, String.valueOf(rand.nextInt()), Constants.PINGBACK_ACTION_INSTALL_DONE, app_id, app_ver, deviceID, this.macID, this.osVersion, this.appVersion, this.channelID, Constants.TV_CHANNEL_ID_JDTV, rpage, block, rseat, keywords, this.entry, null, new C20322());
        this.appRest.updateAppsStatusAsync(this.userID, deviceID, app_id, app_ver, "1", this.platformIDV3, cb);
        return null;
    }
    ...
    public StatusResponse onAppUpdated(String app_id, String app_ver, String rpage, String block, String rseat, String keywords, Callback<StatusResponse> cb) {
        ...
        this.pingbackRest.appStatsPingbackAsync(this.platform_1, this.platform_2, this.product_1, this.product_2, anonymousUserID, this.userID, String.valueOf(rand.nextInt()), Constants.PINGBACK_ACTION_UPDATE_DONE, app_id, app_ver, deviceID, this.macID, this.osVersion, this.appVersion, this.channelID, Constants.TV_CHANNEL_ID_JDTV, rpage, block, rseat, keywords, this.entry, null, new C20333());
    ...
    public StatusResponse onAppUninstalled(String app_id, String app_ver, String rpage, String block, String rseat, String keywords, Callback<StatusResponse> cb) {
        ...
        this.pingbackRest.appStatsPingbackAsync(this.platform_1, this.platform_2, this.product_1, this.product_2, anonymousUserID, this.userID, String.valueOf(rand.nextInt()), Constants.PINGBACK_ACTION_UNINSTALL_DONE, app_id, app_ver, deviceID, this.macID, this.osVersion, this.appVersion, this.channelID, Constants.TV_CHANNEL_ID_JDTV, rpage, block, rseat, keywords, this.entry, null, new C20344());
