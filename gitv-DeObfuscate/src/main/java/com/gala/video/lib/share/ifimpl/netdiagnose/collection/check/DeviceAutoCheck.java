        ...
        TVApi.deviceCheck.callSync(new IApiCallback<ApiResultDeviceCheck>() {
            public void onSuccess(ApiResultDeviceCheck apiResult) {
                if (apiResult == null || apiResult.data == null) {
                    ...
                    LogUtils.m1571e(DeviceAutoCheck.TAG, "onDevCheckSuccess():" + apiResult.data);
            ...
            public void onException(ApiException e) {
                ...
                PingBackParams add = params.add(Keys.f2035T, "0").add("ec", "315008");
                String str2 = "pfec";
                if (e == null) {
                    str = "";
                } else {
                ...
                LogUtils.m1571e(DeviceAutoCheck.TAG, "startDevCheck() -> onException e:" + e);
