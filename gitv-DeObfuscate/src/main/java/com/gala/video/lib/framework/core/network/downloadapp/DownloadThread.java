    ...
    public void run() {
        ...
        try {
            ...
            if (this.mSaveFile.exists()) {
                LogUtils.m1568d(TAG, "run, delete temp file result : " + this.mSaveFile.delete());
            }
                ...
                if (this.mFileSize <= 0) {
                    ...
                    if (this.mDownloadSize == 0 || this.mDownloadSize != this.mFileSize) {
                        ...
                        if (this.mSaveFile.renameTo(new File(this.mSaveFileDir, filename))) {
                            ...
                            LogUtils.m1571e(TAG, "DownloadThread---ThreadRun() - > renameTo fialed---");
            ...
            e = e19;
            try {
                LogUtils.m1571e(TAG, "DownloadThread ---ThreadRun()-> ConnectTimeoutException ---mName:" + this.mName + "mUrlstr:" + this.mDownloadUrl + e.getMessage());
                isFinish = 7;
                this.mSaveFile.delete();
                if (threadfile != null) {
                    try {
            ...
            e2 = e24;
            LogUtils.m1571e(TAG, "DownloadThread ---ThreadRun()-> SocketTimeoutException ---mName:" + this.mName + "mUrlstr:" + this.mDownloadUrl + e2.getMessage());
            isFinish = 7;
            this.mSaveFile.delete();
            if (threadfile != null) {
                try {
            ...
            e3 = e27;
            LogUtils.m1571e(TAG, "DownloadThread ---ThreadRun()-> ProtocolException ---mName:" + this.mName + "mUrlstr:" + this.mDownloadUrl + e3.getMessage());
            isFinish = 6;
            this.mSaveFile.delete();
            if (threadfile != null) {
                try {
            ...
            e4 = e30;
            LogUtils.m1571e(TAG, "DownloadThread ---ThreadRun()-> SocketException ---mName:" + this.mName + "mUrlstr:" + this.mDownloadUrl + e4.getMessage());
            isFinish = 7;
            this.mSaveFile.delete();
            if (threadfile != null) {
                try {
            ...
            e5 = e33;
            LogUtils.m1571e(TAG, "DownloadThread ---ThreadRun()-> catch Exception ---mName:" + this.mName + "mUrlstr:" + this.mDownloadUrl + e5.getMessage());
            isFinish = 5;
            this.mSaveFile.delete();
            if (threadfile != null) {
                try {
    ...
    private int getConnection(HttpURLConnection http) {
        ...
        while (num < this.DOWNLOAD_RETRY_TIMES) {
            try {
                ...
                LogUtils.m1571e(TAG, "DownloadThread ---getConnection() -> stateCode=" + stateCode);
                if (stateCode == this.HTTP_RESPONSECODE_200 || stateCode == this.HTTP_RESPONSECODE_206) {
                    try {
                        Thread.sleep(800);
                    } catch (InterruptedException e) {
                        LogUtils.m1571e(TAG, "DownloadThread ---getConnection() -> InterruptedException:" + e.getMessage());
                    }
                    num++;
                    return stateCode;
                    ...
                    try {
                        ...
                        LogUtils.m1571e(TAG, "DownloadThread ---getConnection() -> InterruptedException:" + e2.getMessage());
                    }
                    num++;
                } else {
                    ...
                    try {
                        ...
                        LogUtils.m1571e(TAG, "DownloadThread ---getConnection() -> InterruptedException:" + e22.getMessage());
                    }
                    num++;
                    return stateCode;
                }
            } catch (Exception e3) {
                LogUtils.m1571e(TAG, "DownloadThread ---getConnection() -> exception" + e3.getMessage());
                try {
                    Thread.sleep(800);
                } catch (InterruptedException e222) {
                    LogUtils.m1571e(TAG, "DownloadThread ---getConnection() -> InterruptedException:" + e222.getMessage());
                }
                num++;
            } catch (Throwable th) {
                try {
                    ...
                    LogUtils.m1571e(TAG, "DownloadThread ---getConnection() -> InterruptedException:" + e2222.getMessage());
                }
                num++;
            }
        }
