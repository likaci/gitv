...
public class ItemStyleFlatBufferParser {
    ...
    private void setJsonDataByForeach(Cute dataModel, ItemData item) {
        if (dataModel instanceof CuteImage) {
            ...
            d.setWidth(ResourceUtil.getPxShort(item.style.f2043w));
            d.setHeight(ResourceUtil.getPxShort(item.style.f2042h));
            ...
            d2.setWidth(ResourceUtil.getPxShort(item.style.f2043w));
            d2.setHeight(ResourceUtil.getPxShort(item.style.f2042h));
