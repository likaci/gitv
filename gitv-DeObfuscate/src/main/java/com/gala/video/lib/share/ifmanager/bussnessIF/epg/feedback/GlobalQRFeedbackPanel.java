...
public class GlobalQRFeedbackPanel extends FrameLayout {
    ...
    private final OnClickListener mClickListener = new C17701();
    private TextView mErrorText;
    private Button mFeedBackBtn;
    private final OnFocusChangeListener mFocusListener = new C17712();
    ...
    class C17701 implements OnClickListener {
        ...
        class C17691 implements UploadResultControllerListener {
            C17691() {
            }
        ...
        public void onClick(View v) {
            if (GlobalQRFeedbackPanel.this.mIsSendingFeedback) {
                QToast.makeTextAndShow(GlobalQRFeedbackPanel.this.getContext(), C1632R.string.feedback_sending, 2000);
            } else if (GlobalQRFeedbackPanel.this.mIsSendedFeedbackSuccess) {
                QToast.makeTextAndShow(GlobalQRFeedbackPanel.this.getContext(), C1632R.string.feedback_retry, 2000);
            } else {
                ...
                if (GetInterfaceTools.getILogRecordProvider().isLogRecordFeatureReady()) {
                    ...
                    feedbackResultCallback.init(GlobalQRFeedbackPanel.this.getContext(), feedbackExtraInfo, feedbackOption, recorder, GlobalQRFeedbackPanel.this.mApiException, new C17691(), SourceType.feedback);
    ...
    class C17712 implements OnFocusChangeListener {
        C17712() {
        }
    ...
    private void init(Context context) {
        try {
            ...
            layoutInflater.inflate(C1632R.layout.share_global_panel_error_view, this);
    ...
    private void initView() {
        this.mErrorText = (TextView) findViewById(C1632R.id.share_global_error_panel_tv);
        this.mFeedBackBtn = (Button) findViewById(C1632R.id.share_global_error_panel_btn);
        this.mBlankLayout = (ViewGroup) findViewById(C1632R.id.share_global_error_panel_layout);
    ...
    public void setQRText(String errorText) {
        ...
        this.mIsButton = true;
        this.mErrorText.setText(ResourceUtil.getStr(C1632R.string.feedback_tip, errorText));
    }
