...
public class MemoryLevelInfo {
    ...
    public static boolean isLowMemoryDevice() {
        if (isLowMemory < (byte) 0) {
            ...
            LogUtils.m1574i(TAG, "is Low Memory Device:" + totalMemory);
    ...
    public static boolean isLowConfigDevice() {
        ...
        if (isLowConfig < (byte) 0) {
            ...
            LogUtils.m1574i(TAG, "is Low Config Device, cpuNum: " + cpuNum + ", isLowConfigDevice:" + isLowConfig);
            if (!isLowConfigDev) {
                i = 0;
            }
            isLowConfig = (byte) i;
    ...
    public static boolean isHighConfigDevice() {
        ...
        if (isHighConfig < (byte) 0) {
            ...
            LogUtils.m1574i(TAG, "is high Config Device, cpuNum: " + cpuNum + ", isHighConfig:" + isHighConfig);
            if (!isHighConfigDev) {
                i = 0;
            }
            isHighConfig = (byte) i;
