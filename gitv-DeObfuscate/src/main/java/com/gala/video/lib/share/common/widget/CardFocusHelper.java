...
public class CardFocusHelper implements OnScrollChangedListener {
    public static final int FOCUS_ANIMATION_TIME = C1632R.id.animation_time;
    private static final int FOCUS_ANIM_DURATION = 200;
    public static final int FOCUS_RES = C1632R.id.focus_res;
    public static final int FOCUS_RES_ENDS_WITH = C1632R.id.focus_res_ends_with;
    static final int FORCE_INVISIBLE = 4;
    public static final int FocusRect = C1632R.id.focus_rect;
    static final int HideFocusHL = 2;
    public static final int ItemDeltaHigh = C1632R.id.item_delta_high;
    public static final int KeyNotScale = C1632R.id.not_scale;
    static final int MaxCheckLoop = 8;
    static final int Move2LastFocus = 1;
    private static int MoveDelay = 10;
    public static final int RESOURCE_PADDING = C1632R.id.resource_padding;
    ...
    class C16441 implements Callback {
        C16441() {
        }
    ...
    class C16452 implements AnimatorUpdateListener {
        C16452() {
        }
    ...
    class C16463 implements AnimatorListener {
        C16463() {
        }
    ...
    public CardFocusHelper(View aFocusHL) {
        ...
        this.mAnim.addUpdateListener(new C16452());
        this.mAnim.addListener(new C16463());
    }
        ...
        if (this.mLastFocus == null) {
            ...
            try {
                ...
                if (noRect || forceInvisible) {
                    ...
                    Object resTag = this.mLastFocus.getTag(C1632R.id.focus_res);
                    if (resTag != null) {
                    ...
                    baseRes = resStr;
                    Object endsTag = this.mLastFocus.getTag(C1632R.id.focus_res_ends_with);
                    if (endsTag != null) {
                ...
                if (this.mLastFocus.getTag(C1632R.id.focus_start_scale) != null) {
                    startScale = ((Float) this.mLastFocus.getTag(C1632R.id.focus_start_scale)).floatValue();
                }
                float scale = 1.1f;
                if (this.mLastFocus.getTag(C1632R.id.focus_end_scale) != null) {
                    scale = ((Float) this.mLastFocus.getTag(C1632R.id.focus_end_scale)).floatValue();
                }
                if (sDebugable || this.mDebugable) {
    ...
    private Rect getDrawablePadding() {
        Rect paddingObject = this.mLastFocus.getTag(C1632R.id.resource_padding);
