...
public class LayoutLoader {
    ...
    class C17961 implements Runnable {
        ...
        class C17951 implements IFileCallback {
            C17951() {
            }
        ...
        public void run() {
            ...
            LayoutLoader.this.mDownloader.loadFile(imageRequest, new C17951());
            LayoutLoader.this.mHandler.postDelayed(this, 86400000);
        }
    }

    class C17982 implements Runnable {

        class C17971 implements IFileCallback {
            C17971() {
            }
        ...
        public void run() {
            ...
            imageRequest.setSavePath(LayoutLoader.this.mContext.getFilesDir() + "/" + "home/home_cache/");
            LayoutLoader.this.mDownloader.loadFile(imageRequest, new C17971());
            LayoutLoader.this.mHandler.postDelayed(this, 86400000);
        }
    }
    ...
    private CardMap loadDefCardLayout() {
        return buildCardLayout(getBuffer(C1632R.raw.cardlayout_v1));
    }

    private ItemMap loadDefItemStyle() {
        return buildItemStyle(getBuffer(C1632R.raw.itemstyle_v1));
    }
    ...
    private void callCardLayout() {
        ThreadUtils.execute(new C17961());
    }

    private void callItemStyle() {
        ThreadUtils.execute(new C17982());
    }
    ...
    private void onSuccessFile(String path, String name) {
        try {
            ...
            if (StringUtils.isEmpty((CharSequence) path)) {
                ...
                LogUtils.m1571e(TAG, "onSuccessFile() ->  path is no bin format，use default bin");
