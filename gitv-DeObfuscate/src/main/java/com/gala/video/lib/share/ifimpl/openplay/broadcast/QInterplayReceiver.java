...
public class QInterplayReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (isProcess()) {
            ...
            LogUtils.m1568d("openplay/broadcast/QInterplayReceiver", "onReceive action : " + action);
            ...
            if (BroadcastManager.instance().findBroadcastActionByKey(actionSuffix) == null) {
                LogUtils.m1571e("openplay/broadcast/QInterplayReceiver", "[NOT-AUTHORIZED] [action : " + actionSuffix + "] [supportList : " + BroadcastManager.instance().getSupportActionList() + AlbumEnterFactory.SIGN_STR);
            ...
            if (bundle == null) {
                LogUtils.m1571e("openplay/broadcast/QInterplayReceiver", "[INVALID-PARAMTER] [reason:missing playInfo bundle] [the bundle of the intent is null.]");
                return;
            }
    ...
    private boolean isProcess() {
        ...
        if (diff < 1000) {
            LogUtils.m1577w("openplay/broadcast/QInterplayReceiver", "Operation is too frequent, please try again later. return. diff= " + diff);
            isprocess = false;
        }
