...
public class MultiSubjectHGridView extends HorizontalGridView implements IHorizontalCarkView {
    ...
    class C16772 implements Runnable {
        C16772() {
        }
    ...
    class C16783 implements OnFocusLostListener {
        C16783() {
        }
    ...
    class C16814 implements OnItemFocusChangedListener {
        C16814() {
        }
    ...
    class C16825 implements OnItemRecycledListener {
        C16825() {
        }
    ...
    class C16836 implements OnItemClickListener {
        C16836() {
        }
    ...
    class C16847 extends OnScrollListener {
        C16847() {
        }
    ...
    private MultiSubjectHGridView(Context context) {
        ...
        this.mOnFocusLostListener = new C16783();
        this.mOnItemFocusListener = new C16814();
        this.mOnItemRecycledListener = new C16825();
        this.mOnItemClickListener = new C16836();
        this.mOnScrollListener = new C16847();
    }
    ...
    public MultiSubjectHGridView(Context context, IMultiSubjectVAdapter adapter) {
        ...
        setLabelColor(ResourceUtil.getColor(C1632R.color.albumview_normal_color));
        setLabelPadding(ResourceUtil.getPx(46), 0, ResourceUtil.getPx(13), ResourceUtil.getPx(16));
        setLabelSize(ResourceUtil.getDimensionPixelSize(C1632R.dimen.dimen_27dp));
        setLabelColor(ResourceUtil.getColor(C1632R.color.detail_title_text_color_new));
        setTypeface(FontManager.getInstance().getTypeface(context));
        setTimeColor(ResourceUtil.getColorStateList(C1632R.color.share_normal_item_text_color));
        setTimePadding(ResourceUtil.getPx(10));
        setTimeLineExtraPadding(ResourceUtil.getPx(21));
        setTimeSize(ResourceUtil.getDimensionPixelSize(C1632R.dimen.dimen_20dp));
    ...
    public long getShowedTime() {
        if (this.mIsTimeKeeping) {
            LogUtils.m1571e(LOG_TAG, "getShowedTime --- mIsTimeKeeping is wrong, mIsTimeKeeping should be false");
        }
