...
class GalaAccountLocal {
    ...
    void setAccountType() {
        ...
        if (!StringUtils.isEmpty(this.mPPreference.getCookie(ctx))) {
            ...
            if (userType == null) {
                LogUtils.m1571e(LOG_TAG, ">>>>>PassportPreference.getUserType() ---- null!!!");
                return;
        ...
        LogUtils.m1570d(LOG_TAG, "GalaPingBack.get().setAccountType(type) -----", type);
    ...
    void saveUserTypeForH5(int userTypeParam, boolean isLitchiVip) {
        ...
        LogUtils.m1570d(LOG_TAG, ">>>>>H5 return - isLitchi:", Boolean.valueOf(isLitchiVip), "---return userType:", Integer.valueOf(userTypeParam));
