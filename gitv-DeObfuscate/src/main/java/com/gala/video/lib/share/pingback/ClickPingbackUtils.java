...
public class ClickPingbackUtils {
    ...
    L_0x0007:
        r8 = "";
        r25 = "";
        r44 = com.gala.video.lib.share.pingback.ClickPingbackUtils.C17781.f2030x11154c7a;	 Catch:{ Exception -> 0x00de }
    ...
    L_0x012a:
        ...
        r45 = com.gala.video.lib.share.C1632R.string.carousel_window_name;	 Catch:{ Exception -> 0x00de }
    ...
    L_0x0141:
        ...
        r44 = r44.getApplicationContext();	 Catch:{ Exception -> 0x00de }
        r44 = r44.getResources();	 Catch:{ Exception -> 0x00de }
        r45 = com.gala.video.lib.share.C1632R.string.home_1;	 Catch:{ Exception -> 0x00de }
        r25 = r44.getString(r45);	 Catch:{ Exception -> 0x00de }
        goto L_0x001c;
    L_0x0155:
    ...
    L_0x028e:
        ...
        r44 = r44.getApplicationContext();	 Catch:{ Exception -> 0x00de }
        r44 = r44.getResources();	 Catch:{ Exception -> 0x00de }
        r45 = com.gala.video.lib.share.C1632R.string.home_subject_review;	 Catch:{ Exception -> 0x00de }
        r25 = r44.getString(r45);	 Catch:{ Exception -> 0x00de }
        goto L_0x001c;
    L_0x02a2:
        r0 = r3;
    ...
    private static String getChannelNameByChannelId(int channelId) {
        if (10006 == channelId) {
            return ResourceUtil.getStr(C1632R.string.q_album_str_vip);
        }
        if (channelId == 1000002) {
            return ResourceUtil.getStr(C1632R.string.q_album_str_new_vip);
        }
