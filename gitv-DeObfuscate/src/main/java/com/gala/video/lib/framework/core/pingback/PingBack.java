...
public class PingBack {
    ...
    private void postPingBack(String baseUrl, Map<String, String> pingBackParams) {
        ...
        LogUtils.m1568d(TAG, " id = " + this.mId + "-post pingback");
        ...
        this.mApi.call(new IPinbackCallback() {
            public void onSuccess(String s) {
                LogUtils.m1568d(PingBack.TAG, "id = " + id + "-success:" + printPingBackUrl);
            }

            public void onException(String s, Exception e) {
                LogUtils.m1571e(PingBack.TAG, "id = " + id + "-failed:" + printPingBackUrl);
            }
        }, pingBackUrl);
        if (this.mIsSendYinHePingBack) {
            ...
            this.mApi.call(new IPinbackCallback() {
                public void onSuccess(String s) {
                    LogUtils.m1568d(PingBack.TAG, "id = " + id + "-success:" + printYinHePingBackUrl);
                }
