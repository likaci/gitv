...
public class WebIntentModel implements Serializable {
    ...
    public WebIntentModel(WebIntentParams params) {
        if (params != null) {
            ...
            LogUtils.m1574i("WebIntentModel", "incomesrc:" + params.incomesrc + ",buyVip:" + params.buyVip + ",buyFrom:" + params.buyFrom + ",mIncomesrc:" + params.tabSrc + ",mCouponActivityCode:" + params.couponActivityCode + ",mCouponSignKey:" + params.couponSignKey);
        }
    }
