...
public class RecordItem extends Item implements Presenter {
    ...
    public void updateUI(RecordItemView recordItemView) {
        ...
        LogUtils.m1576i(LOG_TAG, "updateUI longRecordDataCount = ", Integer.valueOf(longRecordDataCount));
    ...
    public void onClick(int viewType, int clickType) {
        ...
        if (PingbackUtils.getPingbackPage(this.mView.getContext()) == PingbackPage.HomePage) {
            ...
            LogUtils.m1568d(LOG_TAG, "incomesrc = " + PingBackCollectionFieldUtils.getIncomeSrc());
        }
    ...
    public synchronized int fetchLongRecordData() {
        ...
        LogUtils.m1576i(LOG_TAG, "fetchLongRecordData count = ", Integer.valueOf(ListUtils.getCount(this.mHistoryInfosList)));
    ...
    protected LongHistoryItemModel createLongHistoryContentModel(Album album) {
        ...
        LogUtils.m1574i(LOG_TAG, "album name = " + titleString);
        ...
        LogUtils.m1574i(LOG_TAG, "currentTime= " + currentTime + " ;totalTime  = " + totalTime);
        ...
        if (currentTime == -2) {
            ...
            LogUtils.m1571e(LOG_TAG, "illegal argument total time = " + totalTimeInt);
        }
        longHistoryItemModel.mPercent = percent;
        String descString = "";
        boolean isSeries = album.isSeries();
        LogUtils.m1574i(LOG_TAG, "album>isSeries = " + isSeries);
        if (isSeries) {
            boolean isSourceType = album.isSourceType();
            LogUtils.m1574i(LOG_TAG, "album>isSourceType = " + isSourceType);
            if (isSourceType) {
                LogUtils.m1576i(LOG_TAG, "album.time = ", album.time);
            ...
            LogUtils.m1574i(LOG_TAG, "albumisSeries.false..");
        ...
        LogUtils.m1574i(LOG_TAG, "album>descString = " + descString);
