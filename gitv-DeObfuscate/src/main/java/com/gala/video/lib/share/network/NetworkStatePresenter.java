...
public class NetworkStatePresenter extends NetworkStateLogic implements NetworkStateUIListener {
    ...
    class NetworkStateJavaUI implements NetworkStateUIActualOperateListener {
        ...
        private Runnable mCancelDialogRunnable = new C17771();
        ...
        public void setNetImageWired() {
            this.mNetImage.setImageResource(C1632R.drawable.share_wired_connected);
        }

        public void setNetImageNull() {
            this.mNetImage.setImageResource(C1632R.drawable.share_wifi_state_none);
            this.mPhoneImage.setVisibility(8);
        }

        public void setNetImageWifi() {
            this.mNetImage.setImageResource(new int[]{C1632R.drawable.share_wifi_state_zero, C1632R.drawable.share_wifi_state_one, C1632R.drawable.share_wifi_state_two, C1632R.drawable.share_wifi_state_three, C1632R.drawable.share_wifi_state_four}[NetWorkManager.getInstance().getWifiStrength() % 5]);
        }
        ...
        public void showNetErrorAnimation(int delay) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1571e(TAG, "showNetErrorDialog() launcher net state check delay 10s");
            }
            this.mNetImage.setImageResource(C1632R.drawable.share_net_search);
