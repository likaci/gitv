...
public class CoverFlowAdapter {
    ...
    public StandardItemView getView() {
        ...
        standardItemView.setTag(C1632R.id.focus_start_scale, Float.valueOf(1.1f));
        standardItemView.setTag(C1632R.id.focus_end_scale, Float.valueOf(1.15f));
    ...
    public void remove(int pos) {
        if (ListUtils.isLegal(this.items, pos)) {
            ...
            LogUtils.m1585d("", "coverflowAdapter ,remove ,exception , illegal postion :" + pos + ", current items size : " + this.items.size());
        }
    }
