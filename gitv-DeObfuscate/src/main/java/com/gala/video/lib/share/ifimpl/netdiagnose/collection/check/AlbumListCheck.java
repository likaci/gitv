    ...
    public boolean runCheck() {
        ...
        TVApi.albumList.callSync(new IApiCallback<ApiResultAlbumList>() {
            public void onSuccess(ApiResultAlbumList apiResult) {
                ...
                LogUtils.m1568d(AlbumListCheck.TAG, " AlbumListCheck apiResult.getAlbumList().get(0)= " + album.name);
            ...
            public void onException(ApiException apiException) {
                LogUtils.m1571e(AlbumListCheck.TAG, " AlbumListCheck ApiException code= " + apiException.getCode());
                LogUtils.m1571e(AlbumListCheck.TAG, " AlbumListCheck ApException cause= " + apiException.getCause());
