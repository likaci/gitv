    ...
    public void updateErrorCode(final Callback callback) {
        ApiFactory.getCommonApi().callSync(this.mUrl, new ICommonApiCallback() {
                    ...
                    try {
                        ...
                        if (data != null) {
                            ...
                            if (!ListUtils.isEmpty(models)) {
                                ...
                                LogUtils.m1571e(ErrorCodeProvider.TAG, "updateErrorCode models is empty");
                            }
                        } else if (LogUtils.mIsDebug) {
                            LogUtils.m1571e(ErrorCodeProvider.TAG, "updateErrorCode data is empty");
                        }
                    } catch (Exception e) {
                        if (LogUtils.mIsDebug) {
                            LogUtils.m1571e(ErrorCodeProvider.TAG, "updateErrorCode parse json error:" + e);
                        }
                    }
                }
            }
            ...
            public void onException(Exception e, String arg1) {
                if (LogUtils.mIsDebug) {
                    LogUtils.m1571e(ErrorCodeProvider.TAG, "updateErrorCode api exception:" + e);
                }
    ...
    private void saveDataToLocal(List<ErrorCodeModel> models) {
        synchronized (this.mRWLock) {
            ...
            try {
                ...
                if (LogUtils.mIsDebug) {
                    LogUtils.m1571e(TAG, "saveDataToLocal()---e=" + e.getMessage());
                }
            }
        }
    }
            ...
            synchronized (this.mRWLock) {
                if (ListUtils.isEmpty(this.mModels)) {
                    try {
                        ...
                        if (LogUtils.mIsDebug) {
                            LogUtils.m1571e(TAG, "getDataMap()---e=" + e.getMessage());
                        }
                    }
                }
            }
        } else if (LogUtils.mIsDebug) {
            LogUtils.m1571e(TAG, "getDataMap()---out------");
        }
        return this.mModels;
    }
