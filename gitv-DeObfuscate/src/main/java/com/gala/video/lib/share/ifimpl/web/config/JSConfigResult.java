...
class JSConfigResult implements IJSConfigResult, Serializable {
    ...
    private void initMemoryConfig() {
        ...
        LogUtils.m1568d(TAG, "get  memorylevel:" + memorylevel);
        if (memorylevel != null) {
            try {
        ...
        LogUtils.m1568d(TAG, "get  mmemorylevel:" + this.mmemorylevel);
    }
    ...
    private void initLogRecordConfig() {
        ...
        LogUtils.m1568d(TAG, "setLogRecordConfig() -> enableLogRecord :" + enableLogRecord);
        this.isLogRecordEnable = "1".equals(enableLogRecord);
        LogUtils.m1568d(TAG, "setLogRecordConfig() -> logRecordOpen :" + this.isLogRecordEnable);
