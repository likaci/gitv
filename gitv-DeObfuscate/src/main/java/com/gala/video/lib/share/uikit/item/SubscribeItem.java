...
public class SubscribeItem extends Item implements Presenter {
    ...
    private SubscribeObserver mObserver = new C18071();
    private int mSubscribeType = 0;
    private View mView;

    class C18071 implements SubscribeObserver {
        ...
        public void onItemState(String qpid, int state) {
            ...
            LogUtils.m1585d(SubscribeItem.TAG, hashCode() + "@--observer,onItemState== qpid=" + qpid + ",state=" + state + ",isFeatureFilm=" + isFeatureFilm);
            ...
            SubscribeItem.this.mHandler.post(new C18061());
        }
    }
