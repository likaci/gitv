...
public abstract class QBaseActivity extends FragmentActivity {
    ...
    private MyObserver mAppDownloadObserver = new C16363();
    private Context mAttachContext;
    protected boolean mIsAppDownloadComplete = false;
    private LayoutInflater mLayoutInflater;
    protected PingbackPage mPingbackPage;
    private MyObserver mUpgradeObserver = new C16352();

    class C16331 implements UpdateOperation {
        C16331() {
        }
    ...
    class C16352 implements MyObserver {
        ...
        public void update(String event) {
            LogUtils.m1568d(QBaseActivity.TAG, "receive upgrade event");
            QBaseActivity.this.runOnUiThread(new C16341());
        }
    }

    class C16363 implements MyObserver {
        C16363() {
        }
    ...
    protected void onStart() {
        LogUtils.m1568d(TAG, "onStart() " + this);
        super.onStart();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LogUtils.m1568d(TAG, "onCreate() " + this);
    ...
    public void finish() {
        LogUtils.m1568d(TAG, "finish() " + this);
        super.finish();
    }
    ...
    protected void onDestroy() {
        ...
        LogUtils.m1568d(TAG, "onDestroy() " + this);
        super.onDestroy();
    ...
    public void keepScreenOn() {
        LogUtils.m1568d(TAG, "keepScreenOn");
        getWindow().addFlags(128);
    }

    public void clearScreenOn() {
        LogUtils.m1568d(TAG, "clearScreenOn->isHome=" + Project.getInstance().getBuild().isHomeVersion());
    ...
    protected void onPause() {
        ...
        LogUtils.m1568d(TAG, "onPause() " + this);
    ...
    private void cleanMemoryApi17TO19() throws Exception {
        try {
            ...
            LogUtils.m1568d(TAG, "Api17TO19 startTrimMemory");
        } catch (Exception e) {
            e.printStackTrace();
            Log.e(TAG, "getWindowManager exception ");
        }
    ...
    private void cleanMemoryApiUp20() throws Exception {
        try {
            ...
            LogUtils.m1568d(TAG, "ApiUp20 trimMemory");
        } catch (Exception e) {
            e.printStackTrace();
            Log.e(TAG, "getWindowManager exception ");
        }
    ...
    protected void onStop() {
        ...
        LogUtils.m1568d(TAG, "onStop()" + this);
        super.onStop();
        if (!isHomeStarted && needCheckUpdate()) {
    ...
    public void setBackground(View container) {
        ...
        if (drawable != null && background != drawable) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1571e(TAG, "container setBackground 2---");
            }
    ...
    protected void showUpdateDialog(boolean isFetchData) {
        LogUtils.m1568d(TAG, "show upgrade dialog, is fetch data " + isFetchData);
        CreateInterfaceTools.createUpdateManager().showDialogAndStartDownload(this, false, new C16331());
    }
