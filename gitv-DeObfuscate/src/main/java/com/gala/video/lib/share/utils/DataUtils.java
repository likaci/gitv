...
public class DataUtils {
    ...
    public static JSONObject parseToJsonObject(String str) {
        ...
        try {
            ...
            LogUtils.m1571e("DataUtils", "parseToJsonObject failure:" + e + ", json:" + str);
            return null;
        }
    }
    ...
    public static Album parseToAlbum(String json) {
        ...
        try {
            ...
            LogUtils.m1571e("DataUtils", "parseToAlbum failure:" + e + ", json:" + json);
            return null;
        }
    }
    ...
    public static ArrayList<Album> parseToAlbumList(String json) {
        ...
        try {
            ...
            LogUtils.m1571e("DataUtils", "parseToAlbumList failure:" + e + ", json:" + json);
            return null;
        }
    }
    ...
    public static <T> T parseToObject(String json, Class<T> clazz) {
        ...
        try {
            ...
            LogUtils.m1571e("DataUtils", "parseToObject failure:" + e + ", json:" + json);
            return null;
        }
    }
    ...
    public static <T> ArrayList<T> parseToList(String json, Class<T> clazz) {
        ...
        try {
            ...
            LogUtils.m1571e("DataUtils", "parseToList failure:" + e + ", json:" + json);
            return null;
        }
    }
