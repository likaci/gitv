...
public class AppContentProvider extends AppPreferenceProvider {
    ...
    public void save(String key, long value) {
        if (this.mContentResolver != null) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1570d(LOG_TAG, "AppProvider --- save --- 【", key, ",", Long.valueOf(value), "】");
            }
    ...
    public void save(String key, int value) {
        if (this.mContentResolver != null) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1570d(LOG_TAG, "AppProvider --- save --- 【", key, ",", Integer.valueOf(value), "】");
            }
            updateOrInsert(this.tableName, key, String.valueOf(value));
        }
    }
    ...
    public void save(String key, String value) {
        if (this.mContentResolver != null) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1570d(LOG_TAG, "AppProvider --- save --- 【", key, ",", value, "】");
            }
    ...
    public void save(String key, boolean value) {
        if (this.mContentResolver != null) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1570d(LOG_TAG, "AppProvider --- save --- 【", key, ",", Boolean.valueOf(value), "】");
            }
            updateOrInsert(this.tableName, key, String.valueOf(value));
        }
    }
