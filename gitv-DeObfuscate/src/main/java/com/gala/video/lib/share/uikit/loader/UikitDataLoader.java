...
public class UikitDataLoader extends BaseUikitDataLoader {
    ...
    class C18157 implements IUikitDataFetcherCallback {
        C18157() {
        }
        ...
        switch (event.eventType) {
            ...
            case 48:
                if (AppRuntimeEnv.get().isPlayInHome() && ChannelId.CHANNEL_ID_CAROUSEL == this.mChannelId) {
                    LogUtils.m1568d("UikitDataLoader", "carousel is playing,no update home carousel tab");
                    return;
                } else {
            ...
            case 66:
                ...
                return;
            case 64:
                LogUtils.m1568d("UikitDataLoader", "onUikitEvent LOADER_PAGE_INIT:" + event.layoutChange);
                if (event.layoutChange == 1) {
                    initDetailPageAction(event);
                    return;
                } else if (event.layoutChange == 0) {
                    LogUtils.m1574i("UikitDataLoader", "initPageAction NODATA!!! ");
                    return;
                } else {
                    return;
                }
            ...
            case UikitEventType.UIKIT_ADD_DETAIL_CARDS /*70*/:
                ...
                return;
            case 73:
                LogUtils.m1568d("UikitDataLoader", "onUikitEvent LOADER_DETAIL_SAVE_DATA ");
                this.mCache.write(this.mCacheType, this.mSourceId, 1, this.mUikitEngineId, event.cardList);
                return;
            case 80:
                LogUtils.m1568d("UikitDataLoader", "onUikitEvent UPDATE_DETAIL_GROUP_DATA:" + event.layoutChange);
    ...
    private void initPageAction(final UikitEvent event) {
        ...
        UikitDataFetcher.callGroupDetail(this.mSourceId, 1, this.mUikitEngineId, this.mIsVipLoader, true, new IUikitDataFetcherCallback() {
            public void onSuccess(List<CardInfoModel> list, String back) {
                UikitEvent event1;
                if (list == null || list.size() == 0) {
                    LogUtils.m1568d("UikitDataLoader", "initPageAction-disk is null-card size =0-" + UikitDataLoader.this.mSourceId);
            ...
            if (firstCardList == null || firstCardList.size() <= 0) {
                ...
                UikitDataFetcher.callGroupDetail(this.mSourceId, 1, this.mUikitEngineId, this.mIsVipLoader, true, new IUikitDataFetcherCallback() {
                    public void onSuccess(List<CardInfoModel> list, String raw) {
                        UikitEvent event1;
                        if (list == null || list.size() == 0) {
                            LogUtils.m1568d("UikitDataLoader", "initDetailPageAction-disk is null-card size =0-" + UikitDataLoader.this.mSourceId);
                            event1 = new UikitEvent(event);
                            event1.eventType = 64;
                            event1.layoutChange = 0;
                            event1.uikitEngineId = UikitDataLoader.this.mUikitEngineId;
    ...
    public void updateDetailPageAction(final UikitEvent event) {
        ...
        UikitDataFetcher.callGroupDetail(this.mSourceId, 1, this.mUikitEngineId, this.mIsVipLoader, true, new IUikitDataFetcherCallback() {
            public void onSuccess(List<CardInfoModel> list, String raw) {
                if (list == null || list.size() == 0) {
                    LogUtils.m1568d("UikitDataLoader", "updateDetailPageAction-disk is null-card size =0-" + UikitDataLoader.this.mSourceId);
                    UikitEvent event1 = new UikitEvent(event);
                    event1.eventType = 64;
                    event1.layoutChange = 0;
                    event1.uikitEngineId = UikitDataLoader.this.mUikitEngineId;
    ...
    private void updateGroupDetailAction(UikitEvent event) {
        if (this.mCacheType == 0 || this.mCacheType == 2) {
            ...
            UikitDataFetcher.callGroupDetail(this.mSourceId, 1, this.mUikitEngineId, this.mIsVipLoader, isNeedFetch, new C18157());
            ...
            if (AppClientUtils.isDebugMode() && debugInterval > 0) {
                ...
                LogUtils.m1568d("UikitDataLoader", "initPageAction, debug interval : " + interval);
            }
