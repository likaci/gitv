...
public class NetDiagnoseDNSUtils {
    ...
    public static String executeDNS() {
        ...
        try {
            ...
            LogUtils.m1568d(TAG, "sDnsUrl = " + sDnsUrl);
            sScacheUrl = (String) jsonObject.get("scache-url");
            LogUtils.m1568d(TAG, "sScacheUrl =  " + sScacheUrl);
            sResultUrl = (String) jsonObject.get("result-url");
            LogUtils.m1568d(TAG, "sResultUrl =  " + sResultUrl);
    ...
    private static String requestByGet(String url) {
        ...
        try {
            ...
            LogUtils.m1568d(TAG, "response.getStatusLine().getStatusCode() = " + response.getStatusLine().getStatusCode());
