...
public class ChannellistItemView extends UIKitCloudItemView implements IViewLifecycle<Presenter> {
    ...
    private IImageLoadCallback mImageCallback = new C18321();
    ...
    class C18321 implements IImageLoadCallback {
        C18321() {
        }
        ...
        public void onFailed(String url) {
            LogUtils.m1571e(ChannellistItemView.TAG, "ChannellistItemView>mImageCallback > onFailed --- getCoreImageView() = " + ChannellistItemView.this.getCoreImageView() + " ;url = " + url);
