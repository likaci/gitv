...
public class AppPreference extends AppPreferenceProvider {
    ...
    public AppPreference(Context ctx, String name) {
        if (ctx != null) {
            ...
            LogUtils.m1571e(LOG_TAG, "EXCEPTION ---- AppPreference(Context ctx, String name) --- Context IS NULL");
        }
    }
    ...
    public void save(String key, String value) {
        if (this.mSharedPref != null) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1570d(LOG_TAG, "AppPreference --- save --- 【", key, ",", value, "】");
            }
    ...
    public void save(String key, long value) {
        if (this.mSharedPref != null) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1570d(LOG_TAG, "AppPreference --- save --- 【", key, ",", Long.valueOf(value), "】");
            }
    ...
    public void save(String key, int value) {
        if (this.mSharedPref != null) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1570d(LOG_TAG, "AppPreference --- save --- 【", key, ",", Integer.valueOf(value), "】");
            }
    ...
    public void save(String key, boolean value) {
        if (this.mSharedPref != null) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1570d(LOG_TAG, "AppPreference --- save --- 【", key, ",", Boolean.valueOf(value), "】");
            }
