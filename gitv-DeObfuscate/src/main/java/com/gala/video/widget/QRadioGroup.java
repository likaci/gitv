...
public class QRadioGroup extends GridView {
    ...
    class C18791 implements OnItemClickListener {
        C18791() {
        }
    ...
    public void setDataSource(List<String> strList, int index, OnCheckedChangeListener onCheckedChangeListener) {
        ...
        LogUtils.m1598d(TAG, "setDataSource: data size=" + (strList != null ? Integer.valueOf(strList.size()) : "NULL") + ", initial index=" + this.mIndex);
        setNumColumns(this.mStringList.size());
        this.mAdapter = new GridAdapter(getContext(), this.mStringList);
        setAdapter(this.mAdapter);
        setOnItemClickListener(new C18791());
    }
    ...
    public void setSelectedChildIndex(int selectedIndex) {
        ...
        LogUtils.m1598d(TAG, "setSelectedChildIndex: total data size=" + size);
        this.mIndex = Math.max(0, Math.min(size, selectedIndex));
        this.mAdapter.notifyDataSetChanged();
        LogUtils.m1598d(TAG, "setSelectedChildIndex: wanted=" + selectedIndex + ", result=" + this.mIndex);
    }
}
