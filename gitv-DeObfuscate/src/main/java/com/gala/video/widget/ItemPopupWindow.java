...
public class ItemPopupWindow {
    private static /* synthetic */ int[] f2053xed9ada6a;
    ...
    static /* synthetic */ int[] m1597xed9ada6a() {
        int[] iArr = f2053xed9ada6a;
        if (iArr == null) {
    ...
    public void show(View anchorView, String content, VerticalPosition verticalPos) {
        if (TextUtils.isEmpty(content)) {
            LogUtils.m1601e("ItemPopupWindow", "content is empty");
            dismiss();
            return;
        }
        ...
        LogUtils.m1598d("ItemPopupWindow", "  view.width=" + anchorView.getWidth() + "  view.getHeight()=" + anchorView.getHeight() + "  needWidth=" + this.needWidth + "  needHeight=" + this.needHeight);
    }
    ...
    public void show(View anchorView, String content, int offsetX, int offsetY) {
        ...
        LogUtils.m1598d("ItemPopupWindow", "  view.width=" + anchorView.getWidth() + "  view.getHeight()=" + anchorView.getHeight() + "  needWidth=" + this.needWidth + "  needHeight=" + this.needHeight + "  offsetX=" + offsetX + "  offsetY=" + offsetY);
    }
    ...
    private void adjustPopupWindowParams(String content) {
        ...
        LogUtils.m1598d("ItemPopupWindow", "measureText" + content + ";width=" + this.needWidth + ";TextSize" + this.mTipsTextSize + ";mTipsTextSize" + this.mTipsTextSize);
    ...
    private int getPopupWindowOffsetX(View view, HorizontalPosition horizontalPos) {
        switch (m1597xed9ada6a()[horizontalPos.ordinal()]) {
            case 1:
                return 0;
            case 2:
