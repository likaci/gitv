...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(5, 120), new ECB(1, Service.ERPC));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(3, 113), new ECB(4, HistoryInfoHelper.MSG_CACHE_CLEAR_ALL));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(4, 116), new ECB(4, Service.UUCP_PATH));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(2, 111), new ECB(7, HistoryInfoHelper.MSG_MERGE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(4, Service.ERPC), new ECB(5, 122));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(6, Service.UUCP_PATH), new ECB(4, ItemSize.ITEM_118));
        ...
        iArr = new int[]{6, 30, 58, 86, HistoryInfoHelper.MSG_CACHE_CLEAR_ALL};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(10, HistoryInfoHelper.MSG_CACHE_CLEAR_ALL), new ECB(2, 115));
        ...
        iArr = new int[]{6, 34, 62, 90, ItemSize.ITEM_118};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(8, 122), new ECB(4, Service.NTP));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(3, Service.UUCP_PATH), new ECB(10, ItemSize.ITEM_118));
        ...
        iArr = new int[]{6, 30, 54, 78, 102, Opcodes.IAND};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(7, 116), new ECB(7, Service.UUCP_PATH));
        ...
        iArr = new int[]{6, 26, 52, 78, 104, Service.CISCO_FNA};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 30, 56, 82, 108, Service.INGRES_NET};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 34, 60, 86, HistoryInfoHelper.MSG_MERGE, Service.NETBIOS_DGM};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 30, 58, 86, HistoryInfoHelper.MSG_CACHE_CLEAR_ALL, Service.BL_IDM};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 34, 62, 90, ItemSize.ITEM_118, 146};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 30, 54, 78, 102, Opcodes.IAND, 150};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(12, Service.ERPC), new ECB(7, 122));
        ...
        iArr = new int[]{6, 24, 50, 76, 102, 128, Opcodes.IFNE};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(6, Service.ERPC), new ECB(14, 122));
        ...
        iArr = new int[]{6, 28, 54, 80, 106, Service.CISCO_SYS, Opcodes.IFLE};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, 122), new ECB(4, Service.NTP));
        ...
        iArr = new int[]{6, 32, 58, 84, 110, Service.PROFILE, Opcodes.IF_ICMPGE};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(4, 122), new ECB(18, Service.NTP));
        ...
        iArr = new int[]{6, 26, 54, 82, 110, Service.NETBIOS_DGM, Opcodes.IF_ACMPNE};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(20, Service.UUCP_PATH), new ECB(4, ItemSize.ITEM_118));
        ...
        iArr = new int[]{6, 30, 58, 86, HistoryInfoHelper.MSG_CACHE_CLEAR_ALL, Service.BL_IDM, 170};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(19, ItemSize.ITEM_118), new ECB(6, Service.NNTP));
