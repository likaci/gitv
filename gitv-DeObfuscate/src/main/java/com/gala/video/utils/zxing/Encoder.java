...
import com.gala.video.utils.zxing.Version.ECBlocks;
...
public final class Encoder {
    private static /* synthetic */ int[] $SWITCH_TABLE$com$gala$video$utils$zxing$Mode = null;
    private static final int[] ALPHANUMERIC_TABLE;
    static final String DEFAULT_BYTE_MODE_ENCODING = "ISO-8859-1";

    static /* synthetic */ int[] $SWITCH_TABLE$com$gala$video$utils$zxing$Mode() {
        int[] iArr = $SWITCH_TABLE$com$gala$video$utils$zxing$Mode;
        if (iArr == null) {
            ...
            $SWITCH_TABLE$com$gala$video$utils$zxing$Mode = iArr;
        }
        return iArr;
    }
    ...
    private static boolean isOnlyDoubleByteKanji(String content) {
        try {
            ...
            for (int i = 0; i < length; i += 2) {
                ...
                if ((byte1 < Service.PWDGEN || byte1 > Opcodes.IF_ICMPEQ) && (byte1 < 224 || byte1 > 235)) {
                    return false;
                }
            }
            return true;
    ...
    static void terminateBits(int numDataBytes, BitArray bits) throws WriterException {
        ...
        for (i = 0; i < numPaddingBytes; i++) {
            bits.appendBits((i & 1) == 0 ? ApiConstants.IMAGE_CORNER_SIZE_236 : 17, 8);
        }
        if (bits.getSize() != capacity) {
    ...
    static void appendBytes(String content, Mode mode, BitArray bits, String encoding) throws WriterException {
        switch ($SWITCH_TABLE$com$gala$video$utils$zxing$Mode()[mode.ordinal()]) {
            case 2:
