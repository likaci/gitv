    ...
    private class MyListener extends NetworkHolder implements IApiCallback<ApiResultCode> {
        ...
        public void onException(ApiException exception) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1577w(GetActivationStateCommand.TAG, "MyListener.onException(" + exception + ")");
            }
        ...
        public void onSuccess(ApiResultCode apiResult) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1577w(GetActivationStateCommand.TAG, "MyListener.onSuccess(" + apiResult.code + ")");
            }
