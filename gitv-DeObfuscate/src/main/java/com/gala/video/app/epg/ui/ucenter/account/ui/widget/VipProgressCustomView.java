...
public class VipProgressCustomView extends View {
    private static final int CIRCLE_WIDTH_DEFAULT = C0508R.dimen.dimen_6dp;
    private static final int PROGRESS_COLOR_DEFAULT_1 = C0508R.color.vip_progress_color1;
    private static final int PROGRESS_COLOR_DEFAULT_2 = C0508R.color.vip_progress_color2;
    private static final int PROGRESS_COLOR_DEFAULT_3 = C0508R.color.vip_progress_color3;
    ...
    public void draw(Canvas canvas) {
        ...
        this.mPaint.setColor(getColor(C0508R.color.gala_write));
