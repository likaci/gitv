...
public class StarsTopView {
    public static final int TOP_HEIGHT = ResourceUtil.getDimen(C0508R.dimen.dimen_74dp);
    ...
    private void initViews() {
        ViewStub stub = (ViewStub) this.mRootView.findViewById(C0508R.id.epg_stars_top_id);
        ...
        this.mTitleText = (TextView) this.mTopView.findViewById(C0508R.id.epg_stars_top_title_text);
        setTitleText();
        setBackgroud();
    }
