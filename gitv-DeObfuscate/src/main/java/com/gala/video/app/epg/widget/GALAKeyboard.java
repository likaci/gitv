...
public class GALAKeyboard extends RelativeLayout {
    ...
    private static final String[] lowerCaseLine1 = new String[]{"a", TrackingConstants.TRACKING_KEY_TIMESTAMP, "c", "d", "e", "f", Keys.f1948G, CuteConstants.f482H, "i", "1", "2", "3"};
    private static final String[] lowerCaseLine2 = new String[]{"j", "k", "l", "m", "n", "o", "p", "q", "r", "4", "5", "6"};
    private static final String[] lowerCaseLine3 = new String[]{"s", PingBackParams.Keys.f2035T, "u", "v", "w", WebConstants.PARAM_KEY_X, WebConstants.PARAM_KEY_Y, "z", "0", "7", "8", "9"};
    ...
    private int bottomPadding = ((int) getResources().getDimension(C0508R.dimen.dimen_010dp));
    ...
    private int iconW = ((int) getResources().getDimension(C0508R.dimen.dimen_34dp));
    ...
    private int margin = ((int) getResources().getDimension(C0508R.dimen.dimen_015dp));
    private int singleItemHeight = ((int) getResources().getDimension(C0508R.dimen.dimen_90dp));
    private int singleItemWidth = ((int) getResources().getDimension(C0508R.dimen.dimen_120dp));
    private float textSize = getResources().getDimension(C0508R.dimen.dimen_34sp);
    ...
    class C12732 implements OnFocusChangeListener {
        C12732() {
        }
    ...
    public GALAKeyboard(Context context) {
        ...
        str_drawable.put(STR_DEL, Integer.valueOf(C0508R.drawable.epg_ico_keyboard_del));
        str_drawable.put(STR_CLEAR, Integer.valueOf(C0508R.drawable.epg_ico_keyboard_clear));
        str_drawable.put(STR_ALBUM, Integer.valueOf(C0508R.drawable.epg_ico_keyboard_album));
        str_drawable.put(STR_ACTOR, Integer.valueOf(C0508R.drawable.epg_ico_keyboard_actor));
        str_drawable.put(STR_BLANK, Integer.valueOf(C0508R.drawable.epg_ico_keyboard_login_space));
        str_drawable.put(STR_LOWER, Integer.valueOf(C0508R.drawable.epg_ico_keyboard_login_lower));
        str_drawable.put(STR_UPPER, Integer.valueOf(C0508R.drawable.epg_ico_keyboard_login_upper));
        str_drawable.put(STR_CONFIRM, Integer.valueOf(C0508R.drawable.epg_ico_keyboard_login_confirm));
        this.mOnClickListener = new C12721();
        ...
        this.mKeyFocusChangeLisener = new C12732();
    ...
    private Button initItemView(String c, int id) {
        ...
        if (Project.getInstance().getBuild().isLitchi()) {
            btn.setBackgroundResource(C0508R.drawable.epg_keyboard_key_bg2);
        } else {
            btn.setBackgroundResource(C0508R.drawable.epg_keyboard_key_bg2);
        }
