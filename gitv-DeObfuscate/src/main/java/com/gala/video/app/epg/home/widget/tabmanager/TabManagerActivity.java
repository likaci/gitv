...
public class TabManagerActivity extends QMultiScreenActivity {
    ...
    private OnClickListener mExitCancelBtnClicker = new C07284();
    private OnClickListener mExitOkBtnClicker = new C07273();
    private OnKeyListener mExitOnKeyListener = new C07295();
    ...
    private OnKeyListener mNotSupportDialogOnKeyListener = new C07317();
    private OnClickListener mNotSupportOkBtnClicker = new C07306();
    ...
    private TabSortedActivatedListener mTabSortedActivatedListener = new C07328();
    private TabSortedAdapter mTabSortedAdapter;
    private TabSortedLayout mTabSortedLayout;
    private TabSortedMovingListener mTabSortedMovingListener = new C07251();
    private TextView mTabSortedPromoteTextView;
    private TabVisibilityAdapter mTabVisibilityAdapter;
    private TabVisibilityItemOnKeyListener mTabVisibilityItemOnKeyListener = new C07339();
    private TabVisibilityLayout mTabVisibilityLayout;
    private TabVisibilityListener mTabVisibilityListener = new C07262();
    private TextView mTabVisibilityPromoteTxt;

    class C07251 implements TabSortedMovingListener {
        C07251() {
        }
    ...
    class C07262 implements TabVisibilityListener {
        C07262() {
        }
        ...
        public boolean addTab(TabModel tabModel, TabVisibilityItemView itemView) {
            if (TabManagerActivity.this.mTabModelManagerEditor.isFull()) {
                QToast.makeText(TabManagerActivity.this, C0508R.string.album_tip_above, 5000).show();
                LogUtils.m1577w(TabManagerActivity.TAG, "the current tabs are full, must not add some tab");
                return false;
                ...
                LogUtils.m1577w(TabManagerActivity.TAG, "add tab failed, tab data:" + tabModel);
                return false;
            }
        }
        ...
        public boolean removeTab(TabModel tabModel, TabVisibilityItemView itemView) {
            if (TabManagerActivity.this.mTabSortedLayout.getAdapter().getCount() == 1) {
                QToast.makeText(TabManagerActivity.this, C0508R.string.tab_manage_min, 3000).show();
                return false;
    ...
    class C07295 implements OnKeyListener {
        C07295() {
        }
    ...
    class C07306 implements OnClickListener {
        C07306() {
        }
    ...
    class C07317 implements OnKeyListener {
        C07317() {
        }
    ...
    class C07328 implements TabSortedActivatedListener {
    ...
    class C07339 implements TabVisibilityItemOnKeyListener {
        ...
        public void onDpadUpKeyEvent(TabVisibilityItemView itemView, KeyEvent event) {
            if (TabManagerActivity.this.mTabSortedLayout.getAdapter().getMinSortableTabIndex() == -2) {
                ...
                if (itemView.isAtFirstLine() && duration > 500) {
                    itemView.startAnimation(AnimationUtils.loadAnimation(TabManagerActivity.this, C0508R.anim.epg_shake_y));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0508R.layout.epg_activity_tab_manager);
        initView();
        setData();
    ...
    private void initView() {
        this.mTabSortedLayout = (TabSortedLayout) findViewById(C0508R.id.epg_tab_manager_layout_tab_moving);
        this.mTabSortedPromoteTextView = (TextView) findViewById(C0508R.id.epg_tab_manager_txt_promote);
        this.mTabVisibilityLayout = (TabVisibilityLayout) findViewById(C0508R.id.epg_tab_manager_layout_tab_visibility);
        this.mTabVisibilityPromoteTxt = (TextView) findViewById(C0508R.id.epg_tab_manager_txt_visibility_promote);
    ...
    private void setData() {
        ...
        if (ListUtils.isEmpty(tabModelList2)) {
            LogUtils.m1577w(TAG, "The result of reading tab info from local cache: tab info data is empty");
        } else {
        ...
        if (ListUtils.isEmpty(tabVisibilityList2)) {
            LogUtils.m1577w(TAG, "The result of reading tab info from local cache: tab visibility tab info  is empty");
            return;
        }
    ...
    protected View getBackgroundContainer() {
        return findViewById(C0508R.id.epg_tab_manager_container);
    }

    private void setNonActivatedPromoteText() {
        SpannableStringBuilder builder = new SpannableStringBuilder("按OK键调整桌面位置");
        ForegroundColorSpan white_0 = new ForegroundColorSpan(getResources().getColor(C0508R.color.albumview_normal_color));
        ForegroundColorSpan yellowSpan = new ForegroundColorSpan(getResources().getColor(C0508R.color.yellow));
        ForegroundColorSpan yellowSpan2 = new ForegroundColorSpan(getResources().getColor(C0508R.color.yellow));
        ForegroundColorSpan white_2 = new ForegroundColorSpan(getResources().getColor(C0508R.color.albumview_normal_color));
        ForegroundColorSpan white_3 = new ForegroundColorSpan(getResources().getColor(C0508R.color.albumview_normal_color));
    ...
    private void setActivatedPromoteText() {
        ...
        ForegroundColorSpan white_0 = new ForegroundColorSpan(getResources().getColor(C0508R.color.albumview_normal_color));
        ForegroundColorSpan white_1 = new ForegroundColorSpan(getResources().getColor(C0508R.color.albumview_normal_color));
        ForegroundColorSpan white_2 = new ForegroundColorSpan(getResources().getColor(C0508R.color.albumview_normal_color));
        ForegroundColorSpan yellowSpan = new ForegroundColorSpan(getResources().getColor(C0508R.color.yellow));
        ForegroundColorSpan yellowSpan2 = new ForegroundColorSpan(getResources().getColor(C0508R.color.yellow));
        builder.setSpan(white_0, 0, 1, 33);
