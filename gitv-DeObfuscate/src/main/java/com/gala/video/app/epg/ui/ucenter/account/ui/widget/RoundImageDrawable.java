...
public class RoundImageDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        this.oval = new RectF((float) getDimen(C0508R.dimen.dimen_10dp), (float) getDimen(C0508R.dimen.dimen_10dp), (float) getDimen(C0508R.dimen.dimen_196dp), (float) getDimen(C0508R.dimen.dimen_196dp));
        Paint paint = new Paint();
        paint.setAntiAlias(true);
        paint.setStrokeWidth((float) getDimen(C0508R.dimen.dimen_7dp));
        paint.setColor(this.mContext.getResources().getColor(C0508R.color.gala_write));
