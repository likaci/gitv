...
public class ServerTimeRequest extends BaseRequestTask {
    ...
    class C06531 implements IApiCallback<ApiResultSysTime> {
        C06531() {
        }

        public void onException(ApiException e) {
            String str;
            LogUtils.m1572e(ServerTimeRequest.TAG, "request server time exception:", e);
        ...
        public void onSuccess(ApiResultSysTime sysTime) {
            ...
            LogUtils.m1568d(ServerTimeRequest.TAG, "request server time success");
        }
    }

    public void invoke() {
        LogUtils.m1568d(TAG, "perform system time request");
        TVApi.sysTime.callSync(new C06531(), new String[0]);
    }

    public void onOneTaskFinished() {
        LogUtils.m1568d(TAG, "request server time task finished");
    }
}
