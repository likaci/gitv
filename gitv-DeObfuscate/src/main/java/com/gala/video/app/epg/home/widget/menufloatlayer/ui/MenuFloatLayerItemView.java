...
public class MenuFloatLayerItemView extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        LayoutInflater.from(context).inflate(C0508R.layout.epg_home_menu_float_layer_item, this, true);
        this.mIconImv = (ImageView) findViewById(C0508R.id.epg_menu_float_layer_item_icon);
        this.mNameTxt = (TextView) findViewById(C0508R.id.epg_menu_float_layer_item_name);
        this.mNameTxt.setTextSize(0, (float) ResourceUtil.getDimensionPixelSize(C0508R.dimen.dimen_20dp));
        setFocusable(true);
