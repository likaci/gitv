...
public class MultiScreenStartTool {
    private static IMSStandListener sMsStandListener = new C07502();
    private static OnPushVideoEvent sOnPushVideoistener = new C07491();

    static class C07491 implements OnPushVideoEvent {
        C07491() {
        }
    ...
    static class C07502 implements IMSStandListener {
        C07502() {
        }
