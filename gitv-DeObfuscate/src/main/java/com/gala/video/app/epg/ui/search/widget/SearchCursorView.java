...
public class SearchCursorView extends TextView {
    ...
    class C10251 implements AnimationListener {

        class C10241 implements AnimationListener {
            C10241() {
            }
        ...
        public void onAnimationEnd(Animation animation) {
            ...
            translateAnimation1.setAnimationListener(new C10241());
    ...
    private void init() {
        ...
        this.mHintString.setSpan(new ForegroundColorSpan(ResourceUtil.getColor(C0508R.color.search_focus_text)), 1, 10, 33);
        this.mHintString.setSpan(new ForegroundColorSpan(ResourceUtil.getColor(C0508R.color.albumview_yellow_color)), 10, 13, 33);
        this.mHintString.setSpan(new ForegroundColorSpan(ResourceUtil.getColor(C0508R.color.search_focus_text)), 13, 14, 33);
        this.mHintString.setSpan(new ForegroundColorSpan(ResourceUtil.getColor(C0508R.color.albumview_yellow_color)), 14, 16, 33);
        setBackgroundResource(C0508R.drawable.epg_full_keyboard_bg);
        setPadding(ResourceUtil.getDimen(C0508R.dimen.dimen_29dp), 0, 0, 0);
        setHint(this.mHintString);
        this.mCurOffsetX = getPaddingLeft() + 1;
        this.mCursorColor = ResourceUtil.getColor(C0508R.color.keyboard_letter);
    ...
    public boolean textIsValide(String text) {
        getPaint().setTextSize(getTextSize());
        if (((int) getPaint().measureText(text)) < ((getWidth() - getPaddingLeft()) - ((int) getResources().getDimension(C0508R.dimen.dimen_16dp))) - ((int) getPaint().measureText("WW1"))) {
            return true;
        }
        exeScrollOverAnimation(1);
        return false;
    ...
    public boolean isDeletable() {
        ...
        LogUtils.m1571e(LOG_TAG, "cursor index < 0 --- delete invalid");
        return false;
    }
    ...
    private void exeScrollOverAnimation(int direction) {
        ...
        translateAnimation.setAnimationListener(new C10251());
