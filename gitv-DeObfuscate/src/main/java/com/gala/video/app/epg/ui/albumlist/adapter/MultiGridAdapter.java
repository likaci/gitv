...
public class MultiGridAdapter extends BaseGridAdapter<IData> {
    ...
    public void initLayoutParamsParams(ViewHolder holder, LayoutParams params) {
        if (holder.getItemViewType() == 1) {
            params.width = ResourceUtil.getDimen(C0508R.dimen.dimen_496dp);
            params.height = ResourceUtil.getDimen(C0508R.dimen.dimen_260dp);
            return;
        }
        params.width = ResourceUtil.getDimen(C0508R.dimen.dimen_246dp);
