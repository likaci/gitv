...
public class TabNameView extends ShaderTextView {
    ...
    private void init(Context context) {
        this.mNormalColor = context.getResources().getColor(C0508R.color.home_tab_name_text_normal);
        this.mFocusColor = context.getResources().getColor(C0508R.color.home_tab_name_text_focus);
    }
    ...
    public void updateTextColor(boolean isVip) {
        ...
        this.mNormalColor = resources.getColor(C0508R.color.home_tab_name_text_normal);
        setTextColor(this.mNormalColor);
        int startResId = C0508R.color.home_tab_name_text_focus_shader_start;
        int endResId = C0508R.color.home_tab_name_text_focus_shader_end;
        if (isVip) {
            startResId = C0508R.color.home_vip_tab_name_text_focus_shader_start;
            endResId = C0508R.color.home_vip_tab_name_text_focus_shader_end;
        }
