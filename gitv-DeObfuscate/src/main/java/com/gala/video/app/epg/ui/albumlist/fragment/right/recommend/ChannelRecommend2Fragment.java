...
public class ChannelRecommend2Fragment extends ChannelRecommendBaseFragment {
    ...
    private WidgetStatusListener mPhotoViewListener = new C08501();

    class C08501 implements WidgetStatusListener {
        C08501() {
        }
    ...
    private class CartoonCircleAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            image.setBackgroundResource(C0508R.drawable.epg_cartoon_circle_bg);
    ...
    protected int getLayoutResId() {
        return C0508R.layout.epg_channel_recommed_page2;
    }

    protected void initCartoonViews() {
        this.mPhotoView = (PhotoGridView) this.mMainView.findViewById(C0508R.id.epg_recommend_small_item);
    ...
    protected void setCartoonData() {
        ...
        if (!ListUtils.isEmpty(this.mCartoonSrcDataList)) {
            ...
            this.mPhotoView.getChildAt(this.mCurtoonAdapter.getCount() - 1).setNextFocusRightId(C0508R.id.epg_recommend_gridview_item);
        }
    }
    ...
    private PhotoGridParams getPhotoViewParams() {
        ...
        int itemPadding = getDimen(C0508R.dimen.dimen_30dp);
