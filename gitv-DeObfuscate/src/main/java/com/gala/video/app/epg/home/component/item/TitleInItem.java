...
public class TitleInItem extends AndroidItem {
    ...
    private void setChannelId() {
        if (this.mItemData.isCarouselChannel) {
            ...
            if (!TextUtils.isEmpty(this.mChannelId)) {
                this.mTitleView.setMarginLeft(ResourceUtil.getDimen(C0508R.dimen.dimen_40dp));
                this.mTitleView.setPaddingRight(ResourceUtil.getDimen(C0508R.dimen.dimen_40dp));
                this.mTitleBgView.setMarginLeft(ResourceUtil.getDimen(C0508R.dimen.dimen_40dp));
                ...
                this.mChannelIdImageView.setWidth(ResourceUtil.getDimen(C0508R.dimen.dimen_40dp));
                this.mChannelIdImageView.setHeight(ResourceUtil.getDimen(C0508R.dimen.dimen_40dp));
            }
    ...
    private void setTitle() {
        ...
        if (!TextUtils.isEmpty(this.mTitle)) {
            ...
            this.mTitleBgView.setWidth(ResourceUtil.getDimen(C0508R.dimen.dimen_1920dp));
            this.mTitleBgView.setHeight(ResourceUtil.getDimen(C0508R.dimen.dimen_40dp));
