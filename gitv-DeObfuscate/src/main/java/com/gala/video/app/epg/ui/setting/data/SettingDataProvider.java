...
public class SettingDataProvider {
    ...
    public CustomDataInfo getCustomDataInfo(SettingItem item) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("SettingDataProvider", "getCustomDataInfo item=" + item);
        }
        ...
        try {
            ...
            if (cur != null) {
                if (LogUtils.mIsDebug) {
                    LogUtils.m1568d("SettingDataProvider", "cur.getCount =" + cur.getCount());
                }
                if (cur.getCount() <= 0 || !cur.moveToFirst()) {
                    ...
                    do {
                        ...
                        if (LogUtils.mIsDebug) {
                            LogUtils.m1568d("SettingDataProvider", "getCustomDataInfo info key/value/option=" + info.getKey() + "/" + info.getValue() + "/" + info.getItemOption());
                        }
            ...
            LogUtils.m1569d("SettingDataProvider", "getCustomDataInfo exception", exception);
        }
        return info;
    }
    ...
    public void updateCustomItem(SettingItem item) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("SettingDataProvider", "updateCustomItem item=" + item);
        }
        ContentValues values = new ContentValues();
        if (item != null) {
            try {
                if (LogUtils.mIsDebug) {
                    LogUtils.m1568d("SettingDataProvider", "updateCustom key/value = " + item.getItemKey() + "/" + item.getItemLastState());
                }
                ...
                if (LogUtils.mIsDebug) {
                    LogUtils.m1569d("SettingDataProvider", "updateCustomItem exception", exception);
                }
            }
        }
    }
