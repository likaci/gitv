        ...
        if (context != null) {
            ...
            if (sharedPref != null) {
                ...
                if (LogUtils.mIsDebug) {
                    LogUtils.m1568d(TAG, "saveCount content:" + content.toString());
                }
                if (LogUtils.mIsDebug) {
                    LogUtils.m1568d(TAG, "success" + success);
                }
            }
        }
    }
    ...
    public int[] getCount(Context context, String type) {
        ...
        if (sharedPref != null) {
            ...
            if (StringUtils.isEmpty(content)) {
                if (LogUtils.mIsDebug) {
                    LogUtils.m1568d(TAG, "content is null");
                }
                return null;
            }
            ...
            if (array != null && array.length == 4) {
                ...
                if (LogUtils.mIsDebug) {
                    LogUtils.m1568d(TAG, "currentdata：" + currentdata + ", version:" + version);
                }
                int total;
