...
public class MultiSubjectBgView extends CloudView {
    ...
    private void init() {
        ...
        getCoreImageView().setDrawable(ResourceUtil.getDrawable(C0508R.color.setting_night_bg));
    }

    public void setBitmap(Bitmap bitmap) {
        if (bitmap != null) {
            getCoreImageView().setBitmap(bitmap);
            getCover().setDrawable(ResourceUtil.getDrawable(C0508R.drawable.epg_multisubject_night_cover));
