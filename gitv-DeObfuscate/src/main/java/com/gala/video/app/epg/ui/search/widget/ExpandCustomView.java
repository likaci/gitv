...
public class ExpandCustomView extends FrameLayout {
    ...
    private OnClickListener mClickListener = new C10211();
    private OnClickListener mConfirmClickListener = new C10222();
    private RelativeLayout mConfirmView;
    private Context mContext;
    private OnFocusChangeListener mItemFocusChangeListener = new C10233();
    ...
    class C10233 implements OnFocusChangeListener {
        C10233() {
        }

        public void onFocusChange(View v, boolean hasFocus) {
            ImageView confirm = null;
            if (v.getId() == C0508R.id.epg_keyItem_confirm) {
                confirm = (ImageView) v.findViewById(C0508R.id.keyitem_confirm_view);
            }
            if (hasFocus) {
                v.bringToFront();
                AnimationUtil.scaleAnimation(v, 1.0f, 1.2f, 200, true);
                if (confirm != null) {
                    confirm.setImageResource(C0508R.drawable.expand_confirm2);
                    return;
                }
                return;
            }
            ...
            if (confirm != null) {
                confirm.setImageResource(C0508R.drawable.expand_confirm);
            }
        }
    }
    ...
    private void initView() {
        addView(LayoutInflater.from(this.mContext).inflate(C0508R.layout.epg_expand_custom_layout, null));
    }

    private void initKeyItem() {
        for (int findViewById : new int[]{C0508R.id.epg_keyItem01, C0508R.id.epg_keyItem02, C0508R.id.epg_keyItem03, C0508R.id.epg_keyItem11, C0508R.id.epg_keyItem12, C0508R.id.epg_keyItem13, C0508R.id.epg_keyItem21, C0508R.id.epg_keyItem22}) {
        ...
        this.mConfirmView = (RelativeLayout) findViewById(C0508R.id.epg_keyItem_confirm);
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        if (event.getAction() == 0) {
            ...
            if (curFocusView != null) {
                ...
                switch (curKeyCode) {
                    case 19:
                        if (focusViewId == C0508R.id.epg_keyItem01 || focusViewId == C0508R.id.epg_keyItem02 || focusViewId == C0508R.id.epg_keyItem03) {
                            this.mRelationKeyItemListener.dismissRelaKeyBoard(this.mCenterChar, KeyDerect.up);
                            return true;
                        }
                    case 20:
                        if (focusViewId == C0508R.id.epg_keyItem_confirm || focusViewId == C0508R.id.epg_keyItem22 || focusViewId == C0508R.id.epg_keyItem21) {
                            this.mRelationKeyItemListener.dismissRelaKeyBoard(this.mCenterChar, KeyDerect.down);
                            return true;
                        }
                    case 21:
                        if (focusViewId == C0508R.id.epg_keyItem01 || focusViewId == C0508R.id.epg_keyItem11 || focusViewId == C0508R.id.epg_keyItem21) {
                            this.mRelationKeyItemListener.dismissRelaKeyBoard(this.mCenterChar, KeyDerect.left);
                            return true;
                        }
                    case 22:
                        if (focusViewId == C0508R.id.epg_keyItem03 || focusViewId == C0508R.id.epg_keyItem13 || focusViewId == C0508R.id.epg_keyItem_confirm) {
