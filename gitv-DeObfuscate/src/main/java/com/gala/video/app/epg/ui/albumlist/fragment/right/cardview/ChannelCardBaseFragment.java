...
public abstract class ChannelCardBaseFragment extends AlbumBaseRightFragment {
    ...
    private static final int HALF_CARD = ResourceUtil.getDimen(C0508R.dimen.dimen_130dp);
    protected int firstVisble = -1;
    protected int lastVisble = -1;
    protected int listCount;
    protected List<IData> mAlbumConvertList;
    private final Runnable mCacheViewRunnable = new C08359();
    ...
    private ItemDecoration mItemDecoration = new C08304();
    protected MultiGridAdapter mMultiGridAdapter;
    protected int mNeedRequestIndex = -1;
    private OnItemFocusChangedListener mOnItemFocusChangedListener = new C08282();
    private OnItemRecycledListener mOnItemRecycledListener = new C08326();
    private OnItemClickListener mOnItemSelectedListener = new C08315();
    private OnScrollListener mOnScrollListener = new C08337();
    private final Runnable mScrollStopRunnable = new C08348();
    private int mSelectedRow;
    protected long mStartLoadingTime;
    private ArrayList<Integer> oldPositionList = new ArrayList();

    class C08271 implements OnFocusChangeListener {
        C08271() {
        }
    ...
    class C08282 implements OnItemFocusChangedListener {
        C08282() {
        }
    ...
    class C08293 implements OnGlobalLayoutListener {
        C08293() {
        }
    ...
    class C08304 extends ItemDecoration {
        C08304() {
        }
        ...
        public int getItemOffsets(int itemPosition, RecyclerView parent) {
            if (itemPosition < ChannelCardBaseFragment.this.mMultiGridAdapter.getCardDataListSize()) {
                return ResourceUtil.getDimen(C0508R.dimen.dimen_12dp);
            }
            return ResourceUtil.getDimen(C0508R.dimen.dimen_04dp);
        }
    }

    class C08315 implements OnItemClickListener {
        C08315() {
        }
    ...
    class C08326 implements OnItemRecycledListener {
        C08326() {
        }
    ...
    class C08337 extends OnScrollListener {
        C08337() {
        }
    ...
    class C08348 implements Runnable {
        C08348() {
        }
        ...
        public void run() {
            if (ChannelCardBaseFragment.this.mGridView != null && ChannelCardBaseFragment.this.mMultiGridAdapter != null) {
                ...
                LogUtils.m1568d("", ">> onScrollStop mMultiGridAdapter" + ChannelCardBaseFragment.this.mMultiGridAdapter + ",mGridView=" + ChannelCardBaseFragment.this.mGridView);
            }
        }
    }

    class C08359 implements Runnable {
        C08359() {
        }
    ...
    protected int getLayoutResId() {
        return C0508R.layout.epg_q_album_grid_right;
    }
    ...
    private void initListener() {
        this.mMainView.setOnFocusChangeListener(new C08271());
    }
    ...
    private void initGridView() {
        ...
        this.mGridView = (VerticalGridView) this.mMainView.findViewById(C0508R.id.epg_qalbum_multigridview);
        ...
        this.mGridView.getViewTreeObserver().addOnGlobalLayoutListener(new C08293());
    }
    ...
    private void dataNotified(List<IData> list) {
        ...
        if (this.mDataApi != null && this.mGridView != null && this.mMultiGridAdapter != null && this.mCardConvertList != null && this.mAlbumConvertList != null) {
            ...
            int cardHeight = ResourceUtil.getDimen(C0508R.dimen.dimen_279dp);
            int cardMargin = ResourceUtil.getDimen(C0508R.dimen.dimen_20dp);
            this.mGridView.setScrollRange((((((cardRow * cardHeight) + (albumRow * ResourceUtil.getDimen(C0508R.dimen.dimen_214dp))) + ((cardRow - 1) * cardMargin)) + (ResourceUtil.getDimen(C0508R.dimen.dimen_4dp) * albumRow)) + this.mGridView.getPaddingTop()) + this.mGridView.getPaddingBottom());
        }
    }
