...
public class PlayerErrorPanel {
    ...
    public static class PlayerErrorPanelUIConfig {
        ...
        private int mCornerTextSize = ResourceUtil.getDimensionPixelSize(C1291R.dimen.dimen_20dp);
        private int mCornerTextStartColor = -65536;
        private int mMainTextEndColor = -65536;
        private int mMainTextGravity = 17;
        private int mMainTextSize = ResourceUtil.getDimensionPixelSize(C1291R.dimen.dimen_20dp);
    ...
    private void initView() {
        ...
        this.mPanelView = LayoutInflater.from(this.mContext).inflate(C1291R.layout.player_error_panel, null);
        this.mBackgroud = (ImageView) this.mPanelView.findViewById(C1291R.id.player_error_panel_bg);
        this.mMainText = (TextView) this.mPanelView.findViewById(C1291R.id.player_error_panel_main_text);
        this.mCornerText = (TextView) this.mPanelView.findViewById(C1291R.id.player_error_panel_corner_text);
    }
