...
public class GuessYoulikeClickPingback extends Pingback {
    ...
    public void doSend(Map<String, String> map) {
        ...
        params.add("type", Constants.RECOMMEND_PINGBACK_TYPE_CLICK).add("usract", Constants.RECOMMEND_PINGBACK_USERACT_CLICK).add(Keys.PLATFORM, "5201").add("url", "").add("tag", "").add(Keys.f2035T, "");
