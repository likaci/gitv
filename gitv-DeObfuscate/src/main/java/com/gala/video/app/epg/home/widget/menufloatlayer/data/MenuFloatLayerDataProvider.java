...
public class MenuFloatLayerDataProvider {
    ...
    public static String getTitle() {
        ...
        LogUtils.m1568d(TAG, "getTitle, menu float layer title :" + title);
        return title;
    }
    ...
    public static List<MenuFloatLayerItemModel> getOnLineData() {
        ...
        LogUtils.m1568d(TAG, "getOnLineData, menu float layer on-line data: " + onLineModels);
    ...
    public static List<MenuFloatLayerItemModel> getLocalDefaultData() {
        List<MenuFloatLayerItemModel> resultModelList = new ArrayList();
        resultModelList.add(new MenuFloatLayerItemModel(ActionBarDataFactory.TOP_BAR_TIME_NAME_SEARCH, ItemDataType.SEARCH, C0508R.drawable.epg_menu_float_layer_search, false));
        resultModelList.add(new MenuFloatLayerItemModel("记录", ItemDataType.RECORD, C0508R.drawable.epg_menu_float_layer_history, false));
        resultModelList.add(new MenuFloatLayerItemModel("设置", ItemDataType.SETTING, C0508R.drawable.epg_menu_float_layer_setting_icon, false));
        resultModelList.add(new MenuFloatLayerItemModel(GetInterfaceTools.getIGalaAccountManager().isLogin(AppRuntimeEnv.get().getApplicationContext()) ? ActionBarDataFactory.TOP_BAR_TIME_NAME_MY : ActionBarDataFactory.TOP_BAR_TIME_NAME_MY, ItemDataType.LOGIN, C0508R.drawable.epg_tab_setting_icon_account_focused, false));
        if (!Project.getInstance().getBuild().isHomeVersion()) {
            resultModelList.add(new MenuFloatLayerItemModel("客服反馈", ItemDataType.FEEDBACK, C0508R.drawable.epg_tab_setting_icon_feedback_focused, false));
        }
        return resultModelList;
    }
    ...
    public static List<MenuFloatLayerItemModel> getSettingListData() {
        ...
        if (length == resLength && length == focusResLength && length == itemLength) {
            ...
            LogUtils.m1571e(TAG, "data do not match! name length=" + length + ",focus res id length=" + focusResLength + ",itemLength=" + itemLength);
        }
        return resultModelList;
    }
    ...
    private static int getIconResIdByItemType(ItemDataType itemDataType) {
        ...
        switch (itemDataType) {
            case SEARCH:
                return C0508R.drawable.epg_menu_float_layer_search;
            case RECORD:
                return C0508R.drawable.epg_menu_float_layer_history;
            case SETTING:
                return C0508R.drawable.epg_menu_float_layer_setting_icon;
            case FEEDBACK:
                return C0508R.drawable.epg_tab_setting_icon_feedback_focused;
            case LOGIN:
                return C0508R.drawable.epg_tab_setting_icon_account_focused;
            case VIP_ATTRIBUTE:
                return C0508R.drawable.epg_menu_float_layer_vip;
            case BACKGROUND:
                return C0508R.drawable.epg_tab_setting_icon_play_focused;
            case PLAY_PROMPT:
                return C0508R.drawable.epg_tab_setting_icon_play_focused;
            case NETWORK:
                return C0508R.drawable.epg_tab_setting_icon_net_focused;
            case TAB_MANAGE:
                return C0508R.drawable.epg_tab_setting_icon_tab_manage_focused;
            default:
                LogUtils.m1568d(TAG, "getIconResIdByItemType, menu float layer item type is illegal");
                return -1;
        }
    }
}
