...
public class ConfigInterfaceBaseImpl extends Wrapper {
    ...
    class C07701 implements ISetting {
        C07701() {
        }
    ...
    public void initHomeLogo(ImageView logo) {
        if (logo != null) {
            ...
            if (loadingImage != null) {
                ...
                logo.setImageResource(C0508R.drawable.share_gitv);
            } else if (isNoLogoUI()) {
    ...
    public int getPlayerLoadingViewResId() {
        return C0508R.layout.share_customizable_player_loadingscreen;
    }
    ...
    public View getPlayerLoadingView(Context context) {
        ...
        ImageView logo = (ImageView) loadingLayout.findViewById(C0508R.id.share_logo);
        if (isNoLogoUI()) {
            logo.setVisibility(4);
        }
