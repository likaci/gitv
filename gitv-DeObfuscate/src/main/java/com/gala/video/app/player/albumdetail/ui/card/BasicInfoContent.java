...
public class BasicInfoContent extends VerticalScrollLayout implements IViewLifecycle<Presenter>, View {
    ...
    private OnBasicDescVisibilityListener mBasicDescVisibilityListener = new C13274();
    private BasicInfoPanel mBasicinfoPanel;
    private android.view.View mCardView;
    private Context mContext;
    private CtrlButtonPanel mCtrlButtonPanel;
    private OnCtrlFocusChangeListener mCtrlFocusChangeListener = new C13252();
    ...
    private OnCtrlButtonClickedListener mOnCtrlButtonClickedListener = new C13263();
    private IPingbackContext mPingbackContext;
    private OnPlayWindowClickedListener mPlayWindowClickedListener = new C13285();
    ...
    class C13252 implements OnCtrlFocusChangeListener {
        C13252() {
        }
    ...
    class C13263 implements OnCtrlButtonClickedListener {
        C13263() {
        }
    ...
    class C13274 implements OnBasicDescVisibilityListener {
        C13274() {
        }
    ...
    class C13285 implements OnPlayWindowClickedListener {
        C13285() {
        }
    ...
    class FullScreenRunnable implements Runnable {
        ...
        public void run() {
            if (BasicInfoContent.this.mIsContentVisible) {
                ...
                LogUtils.m1568d(BasicInfoContent.this.TAG, "FullScreenRunnable, basic content is invisible.");
            }
        }
    }
    ...
    public void resetBasicInfo(IVideo video, BlocksView blocksView) {
        ...
        if (this.mInnerContentHolder != null) {
            ...
            this.mInnerContentHolder.getWrappedContent().getFocusableView().setNextFocusUpId(C1291R.id.share_detail_btn_album_full);
    ...
    private void initView() {
        ...
        this.mCardView = LayoutInflater.from(this.mContext).inflate(C1291R.layout.player_detail_basicinfo_card, this);
    ...
    private void initPanels(android.view.View root) {
        ...
        this.mPlayWindowPanel = new PlayWindowPanel(this.mContext, this.mCardView, (FrameLayout) root.findViewById(C1291R.id.fl_player_view_parent_news), this.mUIConfig);
        ...
        switch (this.mAlbumInfo.getKind()) {
            ...
            case VIDEO_EPISODE:
                if (DataHelper.showEpisodeAsGallery(this.mAlbumInfo.getAlbum())) {
                    ...
                    this.mLayoutParams.height = ResourceUtil.getDimen(C1291R.dimen.dimen_631dp);
                    return holder;
                }
                holder = createEpisodeContentHolder();
                this.mLayoutParams.height = ResourceUtil.getDimen(C1291R.dimen.dimen_537dp);
                return holder;
            case ALBUM_SOURCE:
            case VIDEO_SOURCE:
                holder = createProgramContentHolder();
                ...
                return holder;
            default:
                this.mLayoutParams.height = ResourceUtil.getDimen(C1291R.dimen.dimen_366dp);
                return null;
        }
    }
    ...
    private ContentHolder createProgramContentHolder() {
        ...
        LP.topMargin = ResourceUtil.getDimen(C1291R.dimen.dimen_16dp);
        LP.leftMargin = ResourceUtil.getDimen(C1291R.dimen.dimen_25dp);
    ...
    public List<AbsVoiceAction> getPlayerSupportedVoices(List<AbsVoiceAction> actions) {
        ...
        actions.add(provider.createAbsVoiceAction(ResourceUtil.getStr(C1291R.string.voice_cmd_collection), new FavorRunnable(false), KeyWordType.DEFAULT));
        actions.add(provider.createAbsVoiceAction(ResourceUtil.getStr(C1291R.string.voice_cmd_cancel_collection), new FavorRunnable(true), KeyWordType.DEFAULT));
        if (this.mUIConfig.isEnableWindowPlay()) {
            actions.add(provider.createAbsVoiceAction(ResourceUtil.getStr(C1291R.string.voice_cmd_full_screen), new FullScreenRunnable(), KeyWordType.DEFAULT));
        }
        return actions;
    }
    ...
    private void handleEpisodeClicked(Object data, int index) {
        ...
        if (isPlayerSurfaceValidate()) {
            ...
            if (curIndex >= 0) {
                ...
                LogUtils.m1568d(this.TAG, "handleEpisodeClicked, invalid current index!!!");
            }
        }
    }
    ...
    private void handleProgramClicked(Object data, int index) {
        ...
        if (this.mAlbumInfo == null) {
            ...
            if (curIndex >= 0) {
                ...
                LogUtils.m1568d(this.TAG, "handleProgramClicked, invalid current index!!!");
            }
        }
    }
