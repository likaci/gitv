...
public class AboutActivity extends QMultiScreenActivity implements OnClickListener {
    ...
    class C10341 implements Runnable {
        ...
        class C10322 implements Runnable {
            C10322() {
            }
            ...
            public void run() {
                ...
                int i = C0508R.string.setting_about_devicename;
                ...
                i = C0508R.string.setting_about_devicemodel;
                objArr = new Object[1];
                ...
                access$500 = AboutActivity.this.mContext;
                i = C0508R.string.setting_about_sysversion;
                objArr = new Object[1];
                ...
                access$500 = AboutActivity.this.mContext;
                i = C0508R.string.setting_about_softversion;
                objArr = new Object[1];
                ...
                access$500 = AboutActivity.this.mContext;
                i = C0508R.string.setting_about_ip_inside;
                objArr = new Object[1];
                ...
                if (StringUtils.isEmpty(AboutActivity.this.mIpPublicTxt.getText())) {
                    AboutActivity.this.mIpPublicTxt.setText(AboutActivity.this.mContext.getString(C0508R.string.setting_about_ip_outside_default));
                }
                access$1400 = AboutActivity.this.mNetcardWiredTxt;
                access$500 = AboutActivity.this.mContext;
                i = C0508R.string.setting_about_netcard_wired;
                objArr = new Object[1];
                ...
                access$500 = AboutActivity.this.mContext;
                i = C0508R.string.setting_about_netcard_wireless;
                objArr = new Object[1];
                ...
                access$500 = AboutActivity.this.mContext;
                i = C0508R.string.setting_about_hardware_info;
                objArr = new Object[1];
        ...
        class C10333 implements Runnable {
            ...
            public void run() {
                if (AboutActivity.this.mDNSTxt != null && AboutActivity.this.mContext != null) {
                    ...
                    Context access$500 = AboutActivity.this.mContext;
                    int i = C0508R.string.setting_about_dns;
                    Object[] objArr = new Object[1];
        ...
        public void run() {
            ...
            if (AboutActivity.this.mSystemInfo != null) {
                ...
                if (StringUtils.isEmpty(AboutActivity.this.mHardInfo)) {
                    AboutActivity.this.runOnUiThread(new C10311());
                }
            }
            if (AboutActivity.this.mContext != null) {
                AboutActivity.this.runOnUiThread(new C10322());
            }
            PingBackParams params1 = new PingBackParams();
            params1.add(Keys.f2035T, "21").add("bstp", "1").add("qtcurl", Values.about).add("block", Values.about);
            PingBack.getInstance().postPingBackToLongYuan(params1.build());
            AboutActivity.this.mDNS = DeviceUtils.getDNS();
            AboutActivity.this.runOnUiThread(new C10333());
        }
    }

    class C10352 implements IVrsCallback<ApiResultF4v> {
        C10352() {
        }
        ...
        public void onException(ApiException e) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1571e("EPG/setting/AboutActivity", "initCDNIPData()  e" + e);
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0508R.layout.epg_fragment_setting_about);
        this.mContext = AppRuntimeEnv.get().getApplicationContext();
        this.mDeviceNameTxt = (TextView) findViewById(C0508R.id.epg_about_device_name);
        this.mDeviceModelTxt = (TextView) findViewById(C0508R.id.epg_about_device_model);
        this.mSysVersionTxt = (TextView) findViewById(C0508R.id.epg_about_system_version);
        this.mSoftVersionTxt = (TextView) findViewById(C0508R.id.epg_about_soft_version);
        this.mIpInsideTxt = (TextView) findViewById(C0508R.id.epg_about_ip_inside);
        this.mIpPublicTxt = (TextView) findViewById(C0508R.id.epg_about_ip_outside);
        this.mDNSTxt = (TextView) findViewById(C0508R.id.epg_about_dns);
        this.mNetcardWiredTxt = (TextView) findViewById(C0508R.id.epg_about_networkcard_wired);
        this.mNetcardWirelessTxt = (TextView) findViewById(C0508R.id.epg_about_networkcard_wireless);
        this.mHardWareInfoTxt = (TextView) findViewById(C0508R.id.epg_about_hardware_info);
        this.mResetBtn = (Button) findViewById(C0508R.id.epg_about_reset_btn);
        if (Project.getInstance().getBuild().isHomeVersion()) {
        ...
        ThreadUtils.execute(new C10341());
    }

    protected void onResume() {
        super.onResume();
        LogUtils.m1574i("EPG/setting/AboutActivity", "onResume() --- setDefaultValue is 0");
        this.mMenuCount = 0;
        this.mMenuPreTime = 0;
    ...
    private String getSoftVersion() {
        ...
        if (!StringUtils.isEmpty(uuid)) {
            ...
            if (length >= 5) {
                LogUtils.m1570d("EPG/setting/AboutActivity", ">>>>>getSoftVersion()---uuid=", uuid);
        ...
        switch (event.getKeyCode()) {
            case 82:
                if (this.mMenuCount == 5 && Project.getInstance().getBuild().isHomeVersion()) {
                    LogUtils.m1574i("EPG/setting/AboutActivity", "onClick Menu ---- Project.get().getConfig().getSystemSetting().goToAutoTest()");
                    this.mMenuCount = 0;
                    this.mMenuPreTime = 0;
                    ...
                    if (this.mMenuPreTime == 0 || curTime - this.mMenuPreTime <= 1000) {
                        this.mMenuCount++;
                        LogUtils.m1574i("EPG/setting/AboutActivity", "onClick Menu ---- count++ 【" + this.mMenuCount + "】");
                    } else {
                        LogUtils.m1571e("EPG/setting/AboutActivity", "onClick Menu ---- time > 1s --- reset count 0");
                        this.mMenuCount = 0;
                        curTime = 0;
                    }
    ...
    protected View getBackgroundContainer() {
        return findViewById(C0508R.id.epg_about_setting_new);
    }
    ...
    private void initCDNIPData() {
        CDNHelper.testStress.call(new C10352(), "");
    }

    private void onSuccessResult(ApiResultF4v result) {
        String publicIP;
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("EPG/setting/AboutActivity", "onSuccessResult() -> ip:" + result);
        }
        if (result == null || StringUtils.isEmpty(result.f1347t)) {
            ...
            if (LogUtils.mIsDebug) {
                LogUtils.m1568d("EPG/setting/AboutActivity", "onSuccessResult() -> ip:" + ip);
            }
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                if (AboutActivity.this.mIpPublicTxt != null && AboutActivity.this.mContext != null) {
                    AboutActivity.this.mIpPublicTxt.setText(AboutActivity.this.mContext.getString(C0508R.string.setting_about_ip_outside, new Object[]{ip}));
                }
            }
        });
    }
