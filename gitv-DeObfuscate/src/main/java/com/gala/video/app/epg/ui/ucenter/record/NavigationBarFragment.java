...
public class NavigationBarFragment extends Fragment implements View, OnItemFocusChangedListener {
    ...
    private OnFocusLostListener mOnFocusLostListener = new C12041();
    ...
    class C12041 implements OnFocusLostListener {
        C12041() {
        }
    ...
    public class GridItemDecoration extends ItemDecoration {
        public int getItemOffsets(int position, RecyclerView parent) {
            return NavigationBarFragment.this.isLevel(position) ? ResourceUtil.getDimen(C0508R.dimen.dimen_1dp) : ResourceUtil.getDimen(C0508R.dimen.dimen_8dp);
        }
    }

    public class GridItemDivider extends ItemDivider {
        public Drawable getItemDivider(int position, RecyclerView parent) {
            return NavigationBarFragment.this.isLevel(position) ? null : ResourceUtil.getDrawable(C0508R.drawable.epg_album_label_line);
        }
    }
    ...
    public android.view.View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        android.view.View rootView = inflater.inflate(C0508R.layout.epg_fragment_navigation_bar, null);
        this.mListView = (ListView) rootView.findViewById(C0508R.id.epg_list_view);
        initListView();
    ...
    private void initListView() {
        ...
        this.mListView.setDividerWidth((int) getResources().getDimension(C0508R.dimen.dimen_169dp));
        this.mListView.setBackgroundWidth((int) getResources().getDimension(C0508R.dimen.dimen_218dp));
