...
public class StarHorizontalGridView extends HorizontalGridView {
    private static final int LEFTPADDING = getDimen(C0508R.dimen.dimen_16dp);
    ...
    class C10921 implements OnItemFocusChangedListener {
        C10921() {
        }
    ...
    class C10943 implements OnFocusLostListener {
        C10943() {
        }
    ...
    class C10954 extends OnScrollListener {
        C10954() {
        }
    ...
    class C10965 implements Runnable {
        C10965() {
        }
    ...
    class C10976 implements OnItemRecycledListener {
        C10976() {
        }
    ...
    public StarHorizontalGridView(Context context) {
        ...
        this.mOnItemFocusChangedListener = new C10921();
        this.mOnItemClickListener = new C10932();
        this.mOnFocusLostListener = new C10943();
        this.mOnScrollListener = new C10954();
        this.mScrollStopRunnable = new C10965();
        this.mOnItemRecycledListener = new C10976();
        this.mContext = context;
        setLabelColor(ResourceUtil.getColor(C0508R.color.album_list_default_text_color));
        setLabelPadding(getDimen(C0508R.dimen.dimen_30dp), 0, getDimen(C0508R.dimen.dimen_12dp), 0);
        setLabelSize(ResourceUtil.getDimensionPixelSize(C0508R.dimen.dimen_18dp));
        setClipToPadding(false);
        setScrollRoteScale(0.8f, 1.0f, 2.5f);
        setPadding(LEFTPADDING, getDimen(C0508R.dimen.dimen_20dp), LEFTPADDING, 0);
        setVerticalMargin(getDimen(C0508R.dimen.dimen_4dp));
        setHorizontalMargin(getDimen(C0508R.dimen.dimen_011dp));
        setFocusMode(1);
