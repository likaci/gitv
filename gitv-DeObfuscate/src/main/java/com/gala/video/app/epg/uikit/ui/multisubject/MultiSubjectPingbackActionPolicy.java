...
public class MultiSubjectPingbackActionPolicy extends ActionPolicy {
    ...
    private MyObserver mStartPreviewObserver = new C12281();

    class C12281 implements MyObserver {
        C12281() {
        }

        public void update(String event) {
            LogUtils.m1568d(MultiSubjectPingbackActionPolicy.this.TAG, "checkAndSendBannerAdShowPingback, mStartPreviewObserver, show preview completed");
            for (int i = 0; i < MultiSubjectPingbackActionPolicy.this.mBannerAdShowList.size(); i++) {
                ...
                LogUtils.m1568d(MultiSubjectPingbackActionPolicy.this.TAG, "checkAndSendBannerAdShowPingback, mStartPreviewObserver, send banner ad show pingback, onAdStarted:" + bannerAdId);
            }
        }
    }
