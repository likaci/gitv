...
public class MultiSubjectPresenter implements IMultiSubjectPresenter {
    ...
    private IImageLoadCallback mImageLoadCallback = new C09242();
    private IMultiSubjectView mSubjectView;
    private IMultiSubjectData mTasksRepository;

    class C09231 implements ICardModelCallback {
        C09231() {
        }
    ...
    class C09242 implements IImageLoadCallback {
        C09242() {
        }
    ...
    public void fetchData(String resourceGroupID) {
        this.mTasksRepository.getData(resourceGroupID, new C09231());
    }
    ...
    private void onCardDataCompleteEvent(ArrayList<CardModel> cardArray, String url) {
        if (this.mDestory) {
            LogUtils.m1571e(this.TAG, "onCardDataCompleteEvent --- return, mDestory = true");
            return;
        }
    ...
    private void onImageLoadCompleted(Bitmap bitmap) {
        if (this.mDestory) {
            LogUtils.m1571e(this.TAG, "onImageLoadCompleted --- return, mDestory = true");
        } else {
