...
public class SoloTabActivity extends QMultiScreenActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0508R.layout.epg_activity_solotab);
        ...
        this.mActionBarPresenter = new SoloTabTopPresenter(this, findViewById(C0508R.id.epg_solo_tab_top_panel), infoModel, this.mSoloTabManage);
