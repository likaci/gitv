...
public abstract class ChannelGridBaseFragment extends AlbumBaseRightFragment {
    ...
    private static final int GRIDVIEW_VERTICALMARGIN = ResourceUtil.getDimen(C0508R.dimen.dimen_0dp);
    protected BaseGridAdapter<IData> mAdapter;
    private final Runnable mCacheViewRunnable = new C08411();
    ...
    private final Runnable mLoadAsyncRunnable = new C08466();
    protected int mNeedRequestIndex = -1;
    private boolean mNetState = true;
    private OnItemClickListener mOnItemClickListener = new C08444();
    private OnItemFocusChangedListener mOnItemFocusChangedListener = new C08455();
    private OnItemRecycledListener mOnItemRecycledListener = new C08422();
    private OnScrollListener mOnScrollListener = new C08433();
    private final Runnable mScrollStopRunnable = new C08477();
    ...
    class C08422 implements OnItemRecycledListener {
        C08422() {
        }
    ...
    class C08433 extends OnScrollListener {
        C08433() {
        }
    ...
    class C08444 implements OnItemClickListener {
        C08444() {
        }
    ...
    class C08455 implements OnItemFocusChangedListener {
        C08455() {
        }
    ...
    protected int getLayoutResId() {
        return C0508R.layout.epg_q_album_right5;
    }
    ...
    private void initGridView() {
        this.mGridView = (VerticalGridView) this.mMainView.findViewById(C0508R.id.epg_qalbum_gridview);
        prepareAdapter();
    }
        ...
        if (this.mDataApi == null || this.mDataApi.getCurPage() > 1 || !ListUtils.isEmpty(this.mConvertList)) {
            if (!this.mNetState) {
                if (LogUtils.mIsDebug) {
                    LogUtils.m1573e("onNetChanged:" + this.mNetState);
                }
                onReloadTasks();
            }
            loadDataAsync();
