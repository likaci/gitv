...
public class MsgCenterView extends CloudView {
    ...
    private void init() {
        ...
        this.mUnreadedColor = ResourceUtil.getColor(C0508R.color.message_center_unreaded_color);
        this.mReadColor = ResourceUtil.getColor(C0508R.color.message_center_readed_color);
        this.mReadedFocusIcon = ResourceUtil.getDrawable(C0508R.drawable.epg_message_center_readed_focus);
        this.mReadedUnfocusIcon = ResourceUtil.getDrawable(C0508R.drawable.epg_message_center_readed_unfocus);
        this.mUnreadedFocusIcon = ResourceUtil.getDrawable(C0508R.drawable.epg_message_center_unreaded_focus);
        this.mUnreadedUnfocusIcon = ResourceUtil.getDrawable(C0508R.drawable.epg_message_center_unreaded_unfocus);
    }
