...
public class EnhancedImageView extends ImageView implements IThreeDimensional, ThreeDimensionalParams {
    ...
    public void setThreeDimensional(boolean enable) {
        ...
        int width = this.mContext.getResources().getDimensionPixelSize(C1291R.dimen.gala_logo_width);
        int height = this.mContext.getResources().getDimensionPixelSize(C1291R.dimen.gala_logo_height);
        ...
        setLayoutParams(lp);
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "setThreeDimensional lp.width = " + getLayoutParams().width);
        }
    }
}
