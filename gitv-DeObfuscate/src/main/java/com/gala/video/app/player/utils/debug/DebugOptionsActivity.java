...
public class DebugOptionsActivity extends QMultiScreenActivity implements OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C1291R.layout.player_activity_debug_options);
        initViews();
        initData();
    }

    private void initViews() {
        this.mCbPerfFloatingWindow = (CheckBox) findViewById(C1291R.id.cb_perf_floatingwindow);
        this.mCbPerfFloatingWindow.setOnCheckedChangeListener(this);
        this.mCbLeftPerfFloatingWindow = (CheckBox) findViewById(C1291R.id.cb_perf_leftfloatingwindow);
    ...
    private void initData() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "initData: perfFloatingWindow=" + perfFloatingWindow);
        }
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "initData: perfFloatingLeftWindow=" + perfFloatingLeftWindow);
        }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (i == C1291R.id.cb_perf_floatingwindow) {
            DebugOptionsCache.setPerfFloatingWindowEnabled(this, isChecked);
        } else if (i == C1291R.id.cb_perf_leftfloatingwindow) {
