...
public class SubjectReviewAdapter extends BaseGridAdapter<ChannelLabel> {
    ...
    private static final int HEIGHT = ResourceUtil.getDimen(C0508R.dimen.dimen_232dp);
    private static final int WIDTH = ResourceUtil.getDimen(C0508R.dimen.dimen_391dp);
