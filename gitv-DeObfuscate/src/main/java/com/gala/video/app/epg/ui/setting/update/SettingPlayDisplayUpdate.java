...
public class SettingPlayDisplayUpdate extends BaseSettingUpdate {
    ...
    private List<String> filterScreamType(SettingItem item) {
        ...
        LogUtils.m1571e("TEST", "TEST --- options.size=" + options.size());
    ...
    private String getStreamType(Context context) {
        ...
        LogUtils.m1574i(LOG_TAG, "getStreamType() ---end--- definition = " + definition + " --- result = " + result);
        return result;
    }
    ...
    public String getLastStateByPos(SettingItem item) {
        ...
        return AppRuntimeEnv.get().getApplicationContext().getResources().getString(C0508R.string.setting_resolution, new Object[]{Project.getInstance().getConfig().getSystemSetting().getCurrOutput()});
    }
    ...
    public void saveNewCacheByPos(SettingItem item) {
        ...
        switch (itemId) {
            case 257:
                LogUtils.m1576i(LOG_TAG, "saveNewCache()--- itemId - ", Integer.valueOf(itemId));
