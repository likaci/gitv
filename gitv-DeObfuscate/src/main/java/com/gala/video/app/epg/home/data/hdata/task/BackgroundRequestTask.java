...
public class BackgroundRequestTask extends BaseRequestTask {
    ...
    private String download(String name) {
        ...
        params.add(Keys.f2035T, "11").add("ct", "160602_load").add(Keys.LDTYPE, "daynight").add("st", "0");
        ...
        try {
            ...
            if (responseCode == 200) {
                ...
                try {
                    ...
                    params1.add(Keys.f2035T, "11").add("ct", "160602_load").add(Keys.LDTYPE, "daynight").add("st", "1");
                    ...
                    try {
                        ...
                        addItem.addItem(str, str2).addItem("activity", "HomeActivity").addItem(Keys.f2035T, "0").setOthersNull().post();
            ...
            filePath = "";
            HomePingbackFactory.instance().createPingback(CommonPingback.DATA_ERROR_PINGBACK).addItem("ec", "315008").addItem("pfec", String.valueOf(responseCode)).addItem(Keys.ERRURL, name).addItem(Keys.APINAME, "downloadtheme").addItem("activity", "HomeActivity").addItem(Keys.f2035T, "0").setOthersNull().post();
            httpConn.disconnect();
            if (outputStream != null) {
                try {
                    outputStream.close();
