...
public class SettingAboutFragment extends SettingBaseFragment implements OnClickListener {
    ...
    class C10571 implements Runnable {
        ...
        public void run() {
            ...
            if (SettingAboutFragment.this.getActivity() != null && !SettingAboutFragment.this.getActivity().isFinishing()) {
                SettingAboutFragment.this.getActivity().runOnUiThread(new C10561());
            }
        }
    }

    class C10582 implements IVrsCallback<ApiResultF4v> {
        C10582() {
        }
        ...
        public void onException(ApiException e) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1571e("EPG/setting/SettingAboutFragment", "initCDNIPData()  e" + e);
            }
    ...
    public void onAttach(Activity activity) {
        ...
        if (this.mSettingEvent != null) {
            LogUtils.m1574i("EPG/setting/SettingAboutFragment", "onAttach --- mSettingEvent.onAttachActivity(this)");
            this.mSettingEvent.onAttachActivity(this);
        }
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.mMainView = inflater.inflate(C0508R.layout.epg_fragment_setting_about, null);
        this.mDeviceNameTxt = (TextView) this.mMainView.findViewById(C0508R.id.epg_about_device_name);
        this.mDeviceModelTxt = (TextView) this.mMainView.findViewById(C0508R.id.epg_about_device_model);
        this.mSysVersionTxt = (TextView) this.mMainView.findViewById(C0508R.id.epg_about_system_version);
        this.mSoftVersionTxt = (TextView) this.mMainView.findViewById(C0508R.id.epg_about_soft_version);
        this.mIpInsideTxt = (TextView) this.mMainView.findViewById(C0508R.id.epg_about_ip_inside);
        this.mIpPublicTxt = (TextView) this.mMainView.findViewById(C0508R.id.epg_about_ip_outside);
        this.mDNSTxt = (TextView) this.mMainView.findViewById(C0508R.id.epg_about_dns);
        this.mNetcardWiredTxt = (TextView) this.mMainView.findViewById(C0508R.id.epg_about_networkcard_wired);
        this.mNetcardWirelessTxt = (TextView) this.mMainView.findViewById(C0508R.id.epg_about_networkcard_wireless);
        this.mResetBtn = (Button) this.mMainView.findViewById(C0508R.id.epg_about_reset_btn);
        ...
        if (this.mContext != null) {
            ...
            textView.setText(context.getString(i, objArr));
            this.mIpPublicTxt.setText(this.mContext.getString(C0508R.string.setting_about_ip_outside_default));
        ...
        ThreadUtils.execute(new C10571());
        return this.mMainView;
    }

    public void onResume() {
        super.onResume();
        LogUtils.m1574i("EPG/setting/SettingAboutFragment", "onResume() --- setDefaultValue is 0");
        this.mMenuCount = 0;
        this.mMenuPreTime = 0;
    ...
    private String getSoftVersion() {
        ...
        if (!StringUtils.isEmpty(uuid)) {
            ...
            if (length >= 5) {
                LogUtils.m1570d("EPG/setting/SettingAboutFragment", ">>>>>getSoftVersion()---uuid=", uuid);
        ...
        switch (event.getKeyCode()) {
            case 82:
                if (this.mMenuCount == 5 && Project.getInstance().getBuild().isHomeVersion()) {
                    LogUtils.m1574i("EPG/setting/SettingAboutFragment", "onClick Menu ---- Project.get().getConfig().getSystemSetting().goToAutoTest()");
                    this.mMenuCount = 0;
                    this.mMenuPreTime = 0;
                    ...
                    if (this.mMenuPreTime == 0 || curTime - this.mMenuPreTime <= 1000) {
                        this.mMenuCount++;
                        LogUtils.m1574i("EPG/setting/SettingAboutFragment", "onClick Menu ---- count++ 【" + this.mMenuCount + "】");
                    } else {
                        LogUtils.m1571e("EPG/setting/SettingAboutFragment", "onClick Menu ---- time > 1s --- reset count 0");
                        this.mMenuCount = 0;
                        curTime = 0;
                    }
    ...
    private void initCDNIPData() {
        CDNHelper.testStress.call(new C10582(), "");
    }

    private void onSuccessResult(ApiResultF4v result) {
        String publicIP;
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("EPG/setting/SettingAboutFragment", "onSuccessResult() -> ip:" + result);
        }
        if (result == null || StringUtils.isEmpty(result.f1347t)) {
            ...
            if (LogUtils.mIsDebug) {
                LogUtils.m1568d("EPG/setting/SettingAboutFragment", "onSuccessResult() -> ip:" + ip);
            }
            ...
            getActivity().runOnUiThread(new Runnable() {
                public void run() {
                    if (SettingAboutFragment.this.mIpPublicTxt != null && SettingAboutFragment.this.mContext != null) {
                        SettingAboutFragment.this.mIpPublicTxt.setText(SettingAboutFragment.this.mContext.getString(C0508R.string.setting_about_ip_outside, new Object[]{ip}));
                    }
                }
            });
        }
