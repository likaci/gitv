...
public class BgSettingGridAdapter extends Adapter<MyViewHolder> {
    ...
    class MyViewHolder extends ViewHolder {
        ...
        public MyViewHolder(View view, ImageView albumImage, ImageView selectedIcon) {
            ...
            this.selectedIcon = (ImageView) view.findViewById(C0508R.id.epg_setting_bg_item_selected);
        }
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.itemView.setBackgroundDrawable(this.mContext.getResources().getDrawable(C0508R.drawable.share_item_rect_selector));
        ...
        LogUtils.m1568d(TAG, "onBindViewHolder---position =  " + position + " ;path =  " + path);
        if (path != null) {
            if (path.equals(SystemConfigPreference.SETTING_BACKGROUND_NIGHT_DEFAULT)) {
                albumImage.setBackgroundColor(this.mContext.getResources().getColor(C0508R.color.setting_night_bg));
            } else {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(this.mContext).inflate(C0508R.layout.epg_view_setting_bg_page_item, parent, false);
        return new MyViewHolder(view, (ImageView) view.findViewById(C0508R.id.epg_setting_bg_item_image), (ImageView) view.findViewById(C0508R.id.epg_setting_bg_item_selected));
    }
