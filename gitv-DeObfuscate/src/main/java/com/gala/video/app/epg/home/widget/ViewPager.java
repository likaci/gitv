...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C06921();
    ...
    private static final Interpolator sInterpolator = new C06932();
    ...
    private final Runnable mEndScrollRunnable = new C06943();
    ...
    static class C06921 implements Comparator<ItemInfo> {
        C06921() {
        }
    ...
    static class C06932 implements Interpolator {
        C06932() {
        }
    ...
    class C06943 implements Runnable {
        C06943() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C06951();
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C06951 implements ClassLoaderCreator<SavedState> {
            C06951() {
            }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (i = 0; i < size; i++) {
            ...
            if (child.getVisibility() != 8) {
                lp = (LayoutParams) child.getLayoutParams();
                this.mChildHeightMeasureSpec = MeasureSpec.makeMeasureSpec(childHeightSize - lp.topMargin, 1073741824);
                if (!lp.isDecor) {
