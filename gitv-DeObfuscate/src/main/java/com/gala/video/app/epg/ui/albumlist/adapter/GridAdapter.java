...
public class GridAdapter extends BaseGridAdapter<IData> {
    public static final int HEIGHT = ResourceUtil.getDimen(C0508R.dimen.dimen_313dp);
    public static final int WIDTH = ResourceUtil.getDimen(C0508R.dimen.dimen_196dp);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (holder.getItemViewType() == 17) {
            ...
            params.width = -1;
            params.height = ResourceUtil.getDimen(C0508R.dimen.dimen_275dp);
            return;
        }
        ...
        if (cookie != null) {
            ...
            if (info != null) {
                ...
                if (url == null || url.equals(rightUrl)) {
                    ...
                    LogUtils.m1573e("--return---current.url=" + url + "---right.url=" + rightUrl);
                }
            } else if (LogUtils.mIsDebug) {
                LogUtils.m1573e("info is null");
            }
        } else if (LogUtils.mIsDebug) {
            LogUtils.m1573e("cookie is null");
        }
    }
