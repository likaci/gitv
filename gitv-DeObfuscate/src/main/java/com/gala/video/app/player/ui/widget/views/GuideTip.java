...
public class GuideTip {
    ...
    public void init(ViewGroup rootview) {
        if (this.mGuide == null) {
            ((LayoutInflater) this.mContext.getSystemService("layout_inflater")).inflate(C1291R.layout.player_guide_tip, rootview);
            this.mGuide = (ImageView) rootview.findViewById(C1291R.id.guide_tip);
            this.mGuideflashy = (ImageView) rootview.findViewById(C1291R.id.guide_flashy);
    ...
    public void show() {
        if (this.mGuide != null) {
            this.mGuide.setImageDrawable(this.mContext.getResources().getDrawable(C1291R.drawable.player_guide_tip));
            this.mGuide.setVisibility(0);
            this.mGuideflashy.setImageDrawable(this.mContext.getResources().getDrawable(C1291R.drawable.player_guide_flashy));
