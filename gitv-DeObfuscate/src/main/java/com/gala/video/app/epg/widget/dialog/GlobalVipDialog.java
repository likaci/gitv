...
public class GlobalVipDialog extends GlobalDialog {
    ...
    private void changeFramLayoutWidth() {
        ...
        layoutParams.topMargin = getDimen(C0508R.dimen.dimen_83dp);
    ...
    protected void initLayout() {
        ...
        this.mContentTextView = (TextView) this.mContentLayout.findViewById(C0508R.id.epg_dialog_text);
        this.mCloudView1 = (GlobalVipCloudView) this.mContentLayout.findViewById(C0508R.id.epg_logout_img_left);
        this.mCloudView2 = (GlobalVipCloudView) this.mContentLayout.findViewById(C0508R.id.epg_logout_img_center);
        this.mCloudView3 = (GlobalVipCloudView) this.mContentLayout.findViewById(C0508R.id.epg_logout_img_right);
    ...
    protected void initParams() {
        ...
        this.mContentResId = C0508R.layout.epg_global_dialog_vip_view;
        this.mDialogWidth = getDimen(C0508R.dimen.dimen_724dp);
        this.mOnlyOneBtnHeight = getDimen(C0508R.dimen.dimen_73dp);
        this.mOnlyOneBtnWidth = getDimen(C0508R.dimen.dimen_699dp);
        this.mFirstBtnWidth = getDimen(C0508R.dimen.dimen_350dp);
        this.mFirstBtnHeight = this.mOnlyOneBtnHeight;
        this.mSecondBtnWidth = getDimen(C0508R.dimen.dimen_350dp);
    ...
    public void setVipStyle(boolean isVipStyle) {
        ...
        Resources resources = AppRuntimeEnv.get().getApplicationContext().getResources();
        if (isVipStyle) {
            setBackGround(this.mButtonOK, resources.getDrawable(C0508R.drawable.epg_global_dialog_btn_vip_selector));
            setBackGround(this.mButtonCancel, resources.getDrawable(C0508R.drawable.epg_global_dialog_btn_vip_selector));
            setBackGround(this.mDialogTopView, resources.getDrawable(C0508R.drawable.epg_global_dialog_gradient_vip_line));
            return;
        }
        setBackGround(this.mButtonOK, resources.getDrawable(C0508R.drawable.share_global_dialog_btn_selector));
        setBackGround(this.mButtonCancel, resources.getDrawable(C0508R.drawable.share_global_dialog_btn_selector));
        setBackGround(this.mDialogTopView, resources.getDrawable(C0508R.drawable.share_global_dialog_gradient_line));
    }
    ...
    public void changeDialogDetailParams() {
        ...
        layoutParams.height = getDimen(C0508R.dimen.dimen_2dp);
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        ...
        if ((v.getId() == C0508R.id.share_dialog_btn2 || v.getId() == C0508R.id.share_dialog_btn1) && hasFocus) {
