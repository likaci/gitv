...
public class WebDataUtils {
    ...
    public static String parseWebUrl(String pageUrl) {
        ...
        LogUtils.m1571e(TAG, "parseWebUrl domain pageUrl:" + pageUrl + ",domainName" + domainName);
        ...
        LogUtils.m1571e(TAG, "parseWebUrl domain pageUrl end:" + pageUrl);
        return pageUrl;
    }
    ...
    public static boolean isSSLProceed(SslError error) {
        if (error == null) {
            LogUtils.m1571e(TAG, "onReceivedSslError error is null!");
            return false;
        }
        ...
        LogUtils.m1568d(TAG, "onReceivedSslError current date:" + nowTime);
        long beforeTime = mSslCertificate.getValidNotBeforeDate().getTime();
        LogUtils.m1568d(TAG, "onReceivedSslError before date:" + beforeTime);
        long afterTime = mSslCertificate.getValidNotAfterDate().getTime();
        LogUtils.m1568d(TAG, "onReceivedSslError after date:" + afterTime);
