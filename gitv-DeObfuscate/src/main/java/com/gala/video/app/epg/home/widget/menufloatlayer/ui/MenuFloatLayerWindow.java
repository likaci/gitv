...
public class MenuFloatLayerWindow extends PopupWindow {
    ...
    private MenuFloatLayerOnClickCallBack mClickCallBack = new C07213();
    private MenuFloatLayerLayout mContentView = null;
    private Context mContext = null;
    private Handler mHandler = new Handler(Looper.getMainLooper());
    private MenuFloatLayerOnKeyEventCallBack mKeyEventCallBack = new C07202();

    class C07202 implements MenuFloatLayerOnKeyEventCallBack {
        C07202() {
        }
        ...
        public void onKeyEvent(KeyEvent event) {
            if (event.getKeyCode() == 82 && event.getAction() == 0) {
                ...
                LogUtils.m1577w(MenuFloatLayerWindow.TAG, "not menu key press down, not back key press down");
            }
        }
    }

    class C07213 implements MenuFloatLayerOnClickCallBack {
        C07213() {
        }
