...
public class ShaderTextView extends TextView {
    ...
    public ShaderTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, C0508R.styleable.shadertextview);
        if (mTypedArray != null) {
            this.mSelectedShaderStartColor = mTypedArray.getColor(C0508R.styleable.shadertextview_shader_startColor, context.getResources().getColor(C0508R.color.home_tab_name_text_focus_shader_start));
            this.mSelectedShaderEndColor = mTypedArray.getColor(C0508R.styleable.shadertextview_shader_endColor, context.getResources().getColor(C0508R.color.home_tab_name_text_focus_shader_end));
            mTypedArray.recycle();
        }
    }
