...
public class RecommendQuitApkTask extends BaseRequestTask {
    ...
    class C06511 implements IVrsCallback<ApiResultRecommendListQipu> {
        C06511() {
        }
    ...
    public void invoke() {
        VrsHelper.recommendListQipu.callSync(new C06511(), UserUtil.getLoginUserId(), UserUtil.getLogoutUserId(), "10", "-1", "t_skunk", "0");
    }
