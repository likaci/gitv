...
public class AppUpgradeCheckTask extends BaseRequestTask {
    ...
    class C06271 implements IApiCallback<ApiResultModuleUpdate> {
        C06271() {
        }
                ...
                for (ModuleUpdate module : result.data) {
                    if ("pri".equals(module.key)) {
                        ...
                        if (LogUtils.mIsDebug) {
                            LogUtils.m1568d(AppUpgradeCheckTask.this.TAG, "check upgrade success version : " + version.toString());
                        }
                        ...
                        if (!UpdateManager.getInstance().isShowingDialog() && UpdateManager.getInstance().hasUpdate()) {
                            ...
                            if (LogUtils.mIsDebug) {
                                LogUtils.m1568d(AppUpgradeCheckTask.this.TAG, "has new apk version");
                                return;
                            }
                            return;
                        }
        ...
        public void onException(ApiException exception) {
            LogUtils.m1569d(AppUpgradeCheckTask.this.TAG, "app upgrade request failed!", exception);
        }
    }
    ...
    public void invoke() {
        ...
        LogUtils.m1568d(this.TAG, "invoke app upgrade task");
        TVApi.moduleUpdate.callSync(new C06271(), "{}");
    }
