...
public class TabSortedItemView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(C0508R.layout.epg_tab_manager_tab_moving_item_view, this, true);
        this.mTabNameView = (TextView) findViewById(C0508R.id.epg_tab_moving_item_name_tab);
        this.mTabNameView.setBackgroundResource(C0508R.drawable.share_item_title_uncover_unfocus_bg);
        this.mTabCoverImageView = (ImageView) findViewById(C0508R.id.epg_tab_moving_item_cover_img);
        this.mLockLabelImageView = (ImageView) findViewById(C0508R.id.epg_tab_moving_item_lock);
        setFocusable(true);
    ...
    protected void onFocusChanged(boolean gainFocus, int direction, Rect previouslyFocusedRect) {
        ...
        if (gainFocus) {
            ...
            this.mTabCoverImageView.startAnimation(AnimationUtils.loadAnimation(this.mContext, C0508R.anim.epg_tab_manager_tab_moving_scale_animation));
            bringToFront();
            return;
        }
    ...
    public void setLocked(boolean isLock) {
        ...
        if (isLock) {
            ...
            this.mTabNameView.setTextColor(getResources().getColor(C0508R.color.tab_bar_manager_text_lock));
            return;
        }
    ...
    public void updateStatus(TabSortedState state) {
        switch (state) {
            ...
            case FOCUS:
                ...
                return;
            case FOCUS_GUIDE:
                this.mTabCoverImageView.setImageResource(C0508R.drawable.epg_tab_manager_tab_moving_focus_guide);
                this.mCurTabSortedState = TabSortedState.FOCUS_GUIDE;
                return;
            case FOCUS_ACTIVATED_ARROW_LEFT:
                this.mTabCoverImageView.setImageResource(C0508R.drawable.epg_tab_manager_tab_moving_focus_arrow_left);
                this.mCurTabSortedState = TabSortedState.FOCUS_ACTIVATED_ARROW_LEFT;
                return;
            case FOCUS_ACTIVATED_ARROW_RIGHT:
                this.mTabCoverImageView.setImageResource(C0508R.drawable.epg_tab_manager_tab_moving_focus_arrow_right);
                this.mCurTabSortedState = TabSortedState.FOCUS_ACTIVATED_ARROW_RIGHT;
                return;
            case FOCUS_ACTIVATED_ARROW_LEFT_RIGHT:
                this.mTabCoverImageView.setImageResource(C0508R.drawable.epg_tab_manager_tab_moving_focus_arrow_left_right);
