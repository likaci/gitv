...
public class StarsAdapter extends Adapter<MyViewHolder> {
    private static final int GAP_PADDING = getDimen(C0508R.dimen.dimen_06dp);
    private static final int TOPANDTIPPADDING = getDimen(C0508R.dimen.dimen_30dp);
    ...
    class C10811 implements OnStarItemFocusChangedListener {
        C10811() {
        }
    ...
    private void onBindStarHorizontalView(int type, MyViewHolder holder, LayoutParams params, int position) {
        ...
        if (this.mAlbumMap != null && tag != null) {
            ...
            if (type == 3) {
                params.height = getDimen(C0508R.dimen.dimen_250dp);
            } else if (type == 1) {
                params.height = getDimen(C0508R.dimen.dimen_330dp);
    ...
    private void onBindViewHolderGridView(MyViewHolder holder, int width, int height, int rowIndex, int horizontalPosition, List<IData> data, Tag tag) {
        ...
        starsHorinzontalItem.setOnStarHorizontalFocusChangedListener(new C10811());
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:
                view = LayoutInflater.from(this.mContext).inflate(C0508R.layout.epg_search_staritem_top, parent, false);
                break;
            case 1:
