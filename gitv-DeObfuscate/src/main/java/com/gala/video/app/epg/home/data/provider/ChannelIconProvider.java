...
public class ChannelIconProvider {
    ...
    private int getChannleId(String iconUrl) {
        ...
        LogUtils.m1568d(TAG, "getChannelId iconUrl=" + iconUrl);
            ...
            if (!StringUtils.isEmpty(iconName)) {
                ...
                if (underlines != null && underlines.length > 0) {
                    try {
                        ...
                        LogUtils.m1571e(TAG, "getChannelId error msg=" + e.getMessage());
                    }
                }
            }
        }
        LogUtils.m1568d(TAG, "getChannelId channelId=" + channelId);
        return channelId;
    }
}
