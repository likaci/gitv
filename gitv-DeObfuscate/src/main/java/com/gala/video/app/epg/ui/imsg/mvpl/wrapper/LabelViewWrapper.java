...
public class LabelViewWrapper {
    ...
    OnFocusLostListener mOnLabelFocusLostListener = new C09184();
    OnItemClickListener mOnLabelItemClickListener = new C09195();
    OnItemFocusChangedListener mOnLabelItemFocusChangeListener = new C09173();
    ...
    class C09151 extends ItemDivider {
        C09151() {
        }

        public Drawable getItemDivider(int position, RecyclerView arg1) {
            return position == 0 ? null : ResourceUtil.getDrawable(C0508R.drawable.epg_album_label_line);
        }
    }

    class C09162 extends ItemDecoration {
        C09162() {
        }

        public int getItemOffsets(int position, RecyclerView parent) {
            return ResourceUtil.getDimen(C0508R.dimen.dimen_1dp);
        }
    }

    class C09173 implements OnItemFocusChangedListener {
        C09173() {
        }
    ...
    class C09184 implements OnFocusLostListener {
        C09184() {
        }
    ...
    class C09195 implements OnItemClickListener {
        C09195() {
        }
    ...
    private void initLeftView() {
        ...
        this.mListView.setItemDivider(new C09151());
        this.mListView.setItemDecoration(new C09162());
        this.mListView.setDividerWidth(ResourceUtil.getDimen(C0508R.dimen.dimen_133dp));
        this.mListView.setBackgroundWidth(ResourceUtil.getDimen(C0508R.dimen.dimen_183dp));
        this.mListView.setShakeForbidden(83);
        this.mListView.setPadding(0, ResourceUtil.getDimen(C0508R.dimen.dimen_46dp), 0, 0);
    }
    ...
    public void showLabels(List<Tag> list) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1571e(TAG, "showLabels ,list:" + ListUtils.getCount((List) list));
        }
