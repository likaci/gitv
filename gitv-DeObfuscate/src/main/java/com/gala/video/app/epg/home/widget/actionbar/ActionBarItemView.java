...
public class ActionBarItemView extends FrameLayout {
    ...
    protected void onFocusChanged(boolean gainFocus, int direction, Rect previouslyFocusedRect) {
        ...
        int i = gainFocus ? this.mFocusBackgroundResId >= 0 ? this.mFocusBackgroundResId : C0508R.drawable.epg_action_bar_bg_focused : C0508R.drawable.epg_action_bar_bg_unfocused;
        setBackgroundResource(i);
    }

    protected void init(Context context) {
        this.mContext = context;
        LayoutInflater.from(context).inflate(C0508R.layout.epg_home_topbar_item_view_new, this, true);
        this.mIcon = (ImageView) findViewById(C0508R.id.epg_item_icon);
        this.mName = (TextView) findViewById(C0508R.id.epg_item_name);
        this.mMessage = (TextView) findViewById(C0508R.id.epg_item_message);
        this.mIconNameLayout = (LinearLayout) findViewById(C0508R.id.epg_action_bar_icon_name);
        this.mName.setTextSize(0, (float) ResourceUtil.getDimensionPixelSize(C0508R.dimen.dimen_19dp));
        this.mName.setTextColor(getResources().getColor(C0508R.color.action_bar_text_normal));
        this.mName.setIncludeFontPadding(false);
        setFocusable(true);
        setBackgroundDrawable(getResources().getDrawable(C0508R.drawable.epg_action_bar_bg));
