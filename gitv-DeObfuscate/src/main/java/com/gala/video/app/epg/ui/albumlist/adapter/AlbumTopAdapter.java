...
public class AlbumTopAdapter extends ActionBarAdapter {
    ...
    private void clickTopPingback(String rseat, String copyStr) {
        ...
        params.add("r", rseat).add("block", "top").add("rt", "i").add("rseat", rseat).add(Keys.f2035T, "20").add("rpage", AlbumInfoFactory.isSearchResultPage(this.mAlbumInfoModel.getPageType()) ? "搜索结果" : this.mAlbumInfoModel.getChannelName()).add("copy", copyStr);
