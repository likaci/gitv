...
public class FullKeyBoardAdapter extends BaseSearchAdapter<String> {
    ...
    protected void fillData(ViewHolder holder, View convertView, int position) {
        ...
        if (ListUtils.isEmpty(this.mDataList)) {
            LogUtils.m1571e("EPG/search/FullKeyBoardAdapter", ">>>>>>>>>> search suggest list is null");
        } else {
    ...
    protected void setViewParams(View convertView, int position) {
        ...
        textView.setBackgroundResource(C0508R.drawable.epg_full_keyboard_bg);
        textView.setGravity(17);
        textView.setTextColor(this.mContext.getResources().getColor(C0508R.color.keyboard_letter));
        QSizeUtils.setTextSize(textView, C0508R.dimen.dimen_33dp);
        if (position > 25) {
            textView.setTextColor(this.mContext.getResources().getColor(C0508R.color.keyboard_num));
        }
    }

    public void changeTextColor(View view) {
        ((TextView) view).setTextColor(this.mContext.getResources().getColor(C0508R.color.gala_write));
    }
}
