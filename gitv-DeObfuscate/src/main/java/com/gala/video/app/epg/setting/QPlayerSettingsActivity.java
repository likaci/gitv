...
public class QPlayerSettingsActivity extends QMultiScreenActivity implements OnClickListener {
    private static final int[] SCREEN_SCALE_IDS = new int[]{C0508R.id.epg_default_scale, C0508R.id.epg_full_screen};
    private static final String[] SCREEN_SCALE_TEXTS = new String[]{"原始比例", "强制全屏"};
    private static final int[] SKIP_SETTING_IDS = new int[]{C0508R.id.epg_setting_jump, C0508R.id.epg_setting_no_jump};
    private static final String[] SKIP_SETTING_TEXTS = new String[]{"跳过", "不跳过"};
    private static final int[] STREAM_SETTING_IDS = new int[]{C0508R.id.epg_stream_1080p, C0508R.id.epg_stream_720p, C0508R.id.epg_stream_high};
    private static final String[] STREAM_SETTING_TEXTS = new String[]{"1080P", "720P", "高清"};
    ColorStateList litchi_csl;
    private OnFocusChangeListener mFocusListener = new C07891();
    ...
    class C07891 implements OnFocusChangeListener {
        C07891() {
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0508R.layout.epg_activity_player_settings);
        initLayout();
    }
    ...
    public void onClick(View view) {
        int i = view.getId();
        if (i == C0508R.id.epg_setting_jump) {
            setJump(true);
        } else if (i == C0508R.id.epg_setting_no_jump) {
            setJump(false);
        } else if (i == C0508R.id.epg_stream_1080p) {
            setStream(5);
        } else if (i == C0508R.id.epg_stream_720p) {
            setStream(4);
        } else if (i == C0508R.id.epg_stream_high) {
            setStream(2);
        } else if (i == C0508R.id.epg_default_scale) {
            setScreenScale(false);
        } else if (i == C0508R.id.epg_full_screen) {
            setScreenScale(true);
        }
    }
    ...
    protected View getBackgroundContainer() {
        return findViewById(C0508R.id.epg_player_setting_layout);
    }
}
