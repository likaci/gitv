...
public class StorageDescriptionUtils {
    ...
    public static ArrayList<String> getDefaultDescription(Context context, ArrayList<String> descriptionList, ArrayList<Boolean> removableList) {
        ...
        for (i = 0; i < descriptionList.size(); i++) {
            ...
            if (description == null) {
                if (isRemovable) {
                    description = context.getResources().getString(C1291R.string.external_storage);
                } else {
                    description = context.getResources().getString(C1291R.string.internal_storage);
                }
            }
        ...
        LogUtils.m1571e(TAG, "getDefaultDescription: " + descriptions);
        return descriptions;
    }
}
