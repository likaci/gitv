...
public class T9KeyboardAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (type) {
            case 0:
                convertView = this.mInflater.inflate(C0508R.layout.epg_t9_key_item_num, null);
                convertView.findViewById(C0508R.id.epg_key_line).setBackgroundColor(getColor(getNumKeyLineColor(false)));
                break;
            case 1:
                convertView = this.mInflater.inflate(C0508R.layout.epg_t9_key_item_nomal, null);
                convertView.findViewById(C0508R.id.epg_key_line).setVisibility(0);
                break;
        }
        if (position == 6 || position == 8) {
            View lineView = convertView.findViewById(C0508R.id.epg_key_line);
            LayoutParams lp = lineView.getLayoutParams();
            lp.width = (int) this.mContext.getResources().getDimension(C0508R.dimen.dimen_73dp);
            lineView.setLayoutParams(lp);
        }
        convertView.setBackgroundResource(C0508R.drawable.epg_full_keyboard_bg);
        ViewHolder viewHolder = new ViewHolder();
        viewHolder.numKeyLine = convertView.findViewById(C0508R.id.epg_key_line);
        viewHolder.keyNumFirst = (TextView) convertView.findViewById(C0508R.id.epg_key_num_first);
        viewHolder.keyNumSecond = (TextView) convertView.findViewById(C0508R.id.epg_key_num_second);
        viewHolder.normalKeyNum = (TextView) convertView.findViewById(C0508R.id.epg_nomal_key_num);
        viewHolder.normalKeyLetter = (TextView) convertView.findViewById(C0508R.id.epg_nomal_key_letter);
    ...
    private void fillData(View convertView, int position, int type) {
        ...
        TextView t1 = (TextView) convertView.findViewById(C0508R.id.epg_nomal_key_num);
        TextView t2 = (TextView) convertView.findViewById(C0508R.id.epg_nomal_key_letter);
    ...
    public void changeTextColor(View view, int pos, boolean hasFocus) {
        ...
        if (pos == 0) {
            ...
            numKeyLineColor = hasFocus ? C0508R.color.gala_write : C0508R.color.keyboard_letter;
    ...
    private int getNormalKeyLetterColor(boolean isFocus) {
        return isFocus ? C0508R.color.search_t9_line_focus : C0508R.color.keyboard_letter;
    }

    private int getKeyNumColor(boolean isFocus) {
        return isFocus ? C0508R.color.search_t9_line_focus : C0508R.color.keyboard_num;
    }

    private int getNumKeyLineColor(boolean isFocus) {
        return isFocus ? C0508R.color.search_t9_line_focus : C0508R.color.search_t9_line;
    }
