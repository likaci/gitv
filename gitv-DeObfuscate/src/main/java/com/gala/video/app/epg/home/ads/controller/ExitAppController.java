...
public class ExitAppController {
    ...
    private OnExitAdRequestListener mExitAdRequestListener = new C05601();
    ...
    class C05601 implements OnExitAdRequestListener {
        C05601() {
        }
        ...
        public void onSuccess(ExitAppAdModel exitAppAdModel, Bitmap bitmap) {
            ...
            LogUtils.m1568d(ExitAppController.TAG, "exitAppAdModel = " + exitAppAdModel);
    ...
    private void onNoAdData() {
        ...
        switch (this.mShowType) {
            case 2:
                ...
                break;
            default:
                LogUtils.m1568d(TAG, "both image and recommend do not exist!");
                break;
        }
    ...
    private String getBlockForAd(ExitAppAdModel exitAppAdModel) {
        ...
        switch (exitAppAdModel.getAdClickType()) {
            ...
            case CAROUSEL_ILLEGAL:
                LogUtils.m1568d(TAG, "getBlockForAd, ad click type :" + AdClickType.CAROUSEL_ILLEGAL);
                break;
            case VIDEO_ILLEGAL:
                LogUtils.m1568d(TAG, "getBlockForAd, ad click type :" + AdClickType.VIDEO_ILLEGAL);
                break;
            default:
                LogUtils.m1568d(TAG, "getBlockForAd, ad data :" + exitAppAdModel);
                break;
        }
        return block;
    }
