...
public class BasicInfoPanel {
    ...
    private void initViews() {
        this.mTxtAlbumName = (TextView) this.mRootView.findViewById(C1291R.id.share_detail_txt_album_title);
        this.mTxtAlbumName.setTextSize(0, (float) getDimensionPixelSize(C1291R.dimen.dimen_30dp));
        this.mTxtLine1 = (TextView) this.mRootView.findViewById(C1291R.id.share_detail_txt_line1);
        this.mTxtLine1.setTextSize(0, (float) getDimensionPixelSize(C1291R.dimen.dimen_17dp));
        this.mTxtLine2 = (TextView) this.mRootView.findViewById(C1291R.id.share_detail_txt_line2);
        this.mTxtLine2.setTextSize(0, (float) getDimensionPixelSize(C1291R.dimen.dimen_20dp));
        this.mTxtLine3 = (TextView) this.mRootView.findViewById(C1291R.id.share_detail_txt_line3);
        this.mTxtLine3.setTextSize(0, (float) getDimensionPixelSize(C1291R.dimen.dimen_20dp));
        this.mTxtLine4 = (TextView) this.mRootView.findViewById(C1291R.id.share_detail_txt_line4);
        this.mTxtLine4.setTextSize(0, (float) getDimensionPixelSize(C1291R.dimen.dimen_20dp));
        this.mTxtDetail = (TextView) this.mRootView.findViewById(C1291R.id.share_detail_txt_album_info);
        this.mRlDetailRoot = (RelativeLayout) this.mRootView.findViewById(C1291R.id.share_detail_rl_album_info);
        this.mTxtDetail.setTextSize(0, (float) getDimensionPixelSize(C1291R.dimen.dimen_20dp));
    }
    ...
    private void setTxtDetail(AlbumInfo albumInfo) {
        ...
        StringBuffer sb = new StringBuffer(ResourceUtil.getStr(C1291R.string.detail_album_info_desc));
        sb.append(desc);
