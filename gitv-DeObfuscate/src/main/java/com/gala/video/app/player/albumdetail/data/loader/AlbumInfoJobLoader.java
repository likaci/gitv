...
public class AlbumInfoJobLoader extends DetailAlbumLoader {
            ...
            switch (this.mConditionType) {
                case TvSeries:
                    if (LogUtils.mIsDebug) {
                        LogUtils.m1568d(AlbumInfoJobLoader.TAG, ">> mTVSeriesCondition=" + albumInfo);
                    }
    ...
    public void dataLoad(LoadType type) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, ">> dataLoad=" + type);
        }
    ...
    public void cacheEpisodeLoad() {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, ">> cacheEpisodeLoad, isTvSeries=" + getInfo().isTvSeries());
        }
