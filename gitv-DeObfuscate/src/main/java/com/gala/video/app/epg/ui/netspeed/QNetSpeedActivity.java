...
public class QNetSpeedActivity extends QMultiScreenActivity {
    ...
    class C09552 implements Runnable {
        C09552() {
        }
    ...
    class C09563 implements IRunCheckCallback {
        C09563() {
        }

        public void onDownloadProgress(String arg0, int percent, int speed) {
            LogUtils.m1568d(QNetSpeedActivity.TAG, "net speed check is running, current percent = " + percent + ", current speed = " + speed);
        ...
        public void onFailed(String result) {
            LogUtils.m1571e(QNetSpeedActivity.TAG, "net speed check faild info = " + result);
        ...
        public void onTestResult(String arg0, String arg1) {
            LogUtils.m1568d(QNetSpeedActivity.TAG, "speed check result arg0=" + arg0 + "arg1=" + arg1);
        }
    }

    class C09574 implements IHistoryResultCallBack {
        C09574() {
        }
    ...
    class C09585 implements Runnable {
        C09585() {
        }
    ...
    class C09596 implements OnClickListener {
        C09596() {
        }
        ...
        public void onClick(View v) {
            ...
            if (i == C0508R.id.epg_btn_restart) {
                ...
                if (QNetSpeedActivity.this.mRecommendDefinition == null || QNetSpeedActivity.this.mRecommendDefinition.equals("")) {
                    ...
                    params.add(Keys.f2035T, "20").add("block", "result_lowspeed").add("rt", "i").add("rseat", "retry").add("rpage", Keys.SPEED);
                    PingBack.getInstance().postPingBackToLongYuan(params.build());
                    return;
                }
                params = new PingBackParams();
                params.add(Keys.f2035T, "20").add("block", "result_normal").add("rt", "i").add("rseat", "retry").add("rpage", Keys.SPEED);
                PingBack.getInstance().postPingBackToLongYuan(params.build());
            } else if (i == C0508R.id.epg_btn_set_default_definition) {
                ...
                QToast.makeTextAndShow(QNetSpeedActivity.this.getApplication(), QNetSpeedActivity.this.getResources().getString(C0508R.string.txt_net_speed_recommend_toast) + QNetSpeedActivity.this.mTextRecommendDef.getText(), 2000);
                params = new PingBackParams();
                params.add(Keys.f2035T, "20").add("block", "result_normal").add("rt", "i").add("rseat", "setstream").add("rpage", Keys.SPEED);
                PingBack.getInstance().postPingBackToLongYuan(params.build());
            }
        }
    }

    class C09607 implements OnFocusChangeListener {
        C09607() {
        }
        ...
        public void onFocusChange(View v, boolean hasFocus) {
            ...
            if (hasFocus) {
                ((Button) v).setTextColor(QNetSpeedActivity.this.getResources().getColor(C0508R.color.gala_write));
            } else {
                ((Button) v).setTextColor(QNetSpeedActivity.this.getResources().getColor(C0508R.color.long_history_title_color));
            }
        }
    }
            ...
            switch (msg.what) {
                ...
                case 103:
                    ...
                    if (result_average < 400) {
                        ...
                        params = new PingBackParams();
                        params.add(Keys.f2035T, "11").add("ct", "150518_speed").add(Keys.RA, "0").add(Keys.SPEED, String.valueOf(result_average));
                        PingBack.getInstance().postPingBackToLongYuan(params.build());
                        return;
                    }
                    QNetSpeedActivity.this.mBtnRestart.setVisibility(0);
                    ...
                    params = new PingBackParams();
                    params.add(Keys.f2035T, "11").add("ct", "150518_speed").add(Keys.RA, String.valueOf(QNetSpeedActivity.this.mRecommendDefinitionType)).add(Keys.SPEED, String.valueOf(result_average));
                    PingBack.getInstance().postPingBackToLongYuan(params.build());
                    return;
                case 104:
                    ...
                    QNetSpeedActivity.this.mTextStatus.setText(QNetSpeedActivity.this.getString(C0508R.string.speed_test_server_error));
                    QNetSpeedActivity.this.cancelSpeedRun();
                    return;
                case 105:
                    QNetSpeedActivity.this.mTextStatus.setVisibility(0);
                    ...
                    QNetSpeedActivity.this.mBtnRestart.setVisibility(0);
                    QNetSpeedActivity.this.mBtnRestart.requestFocus();
                    QNetSpeedActivity.this.mTextStatus.setText(QNetSpeedActivity.this.getString(C0508R.string.speed_test_network_wire_error));
                    return;
                case 106:
                    QNetSpeedActivity.this.mSpeedInfoContainer.setVisibility(4);
                    QNetSpeedActivity.this.mTextStatus.setVisibility(0);
                    QNetSpeedActivity.this.mTextStatus.setText(QNetSpeedActivity.this.getString(C0508R.string.speed_test_server_gitv));
                ...
                case 107:
                    ...
                    QNetSpeedActivity.this.mBtnRestart.setVisibility(0);
                    QNetSpeedActivity.this.mBtnRestart.requestFocus();
                    QNetSpeedActivity.this.mTextStatus.setText(QNetSpeedActivity.this.getString(C0508R.string.result_no_net));
                    return;
                default:
                    return;
            }
    ...
    protected int getLayoutResId() {
        return C0508R.layout.epg_activity_net_speed;
    }

    private void init() {
        this.mNetSpeedChatView = (NetSpeedChatView) findViewById(C0508R.id.epg_net_speed_chat_view);
        this.mBtnSetDefaultDefinition = (Button) findViewById(C0508R.id.epg_btn_set_default_definition);
        this.mBtnSetDefaultDefinition.setOnClickListener(this.mOnClickListener);
        this.mBtnRestart = (Button) findViewById(C0508R.id.epg_btn_restart);
        ...
        this.mSpeedInfoContainer = (LinearLayout) findViewById(C0508R.id.epg_net_speed_info);
        this.mTextAve = (TextView) findViewById(C0508R.id.epg_net_speed_avarage_value);
        this.mTextRecommendDef = (TextView) findViewById(C0508R.id.epg_recommend_definition_value);
        this.mTextRecommendDefIndicator = (TextView) findViewById(C0508R.id.epg_recommend_definition_txt);
        this.mTextStatus = (TextView) findViewById(C0508R.id.epg_net_speed_status);
        this.mTextStatus.setText(getString(C0508R.string.speed_test_server_gitv));
        this.mDataSet = new NetSpeedSeriesDataSet();
        this.mLabelsTxt.add(getResources().getString(C0508R.string.definition_standard));
        this.mLabelsTxt.add(getResources().getString(C0508R.string.definition_high));
        this.mLabelsTxt.add(getResources().getString(C0508R.string.definition_720P));
        this.mLabelsTxt.add(getResources().getString(C0508R.string.definition_1080P));
    ...
    private static String creatLowSpeedTipForHtml() {
        return "<html><head></head><body><p><font color='#" + ResourceUtil.getColorLength6(C0508R.color.skin_netspeed_status) + "'>你的网络速度</font>" + "<font color='#" + ResourceUtil.getColorLength6(C0508R.color.skin_net_yellow_tip_txt) + "'>偏低</font>" + "<font color='#" + ResourceUtil.getColorLength6(C0508R.color.skin_netspeed_status) + "'>，可能无法流畅观看在线视频</font><P>" + "</body></html>";
    }

    private void setSharpness(int kb, boolean isfinished) {
        LogUtils.m1568d(TAG, "setSharpness, iFinished = " + isfinished);
        if (kb < 400) {
            ...
            if (isfinished) {
                ...
                params.add(Keys.f2035T, "21").add("bstp", "1").add("qtcurl", Keys.SPEED).add("block", "result_lowspeed");
                PingBack.getInstance().postPingBackToLongYuan(params.build());
                return;
            }
            return;
        ...
        if (isfinished) {
            if (kb >= 400) {
                params = new PingBackParams();
                params.add(Keys.f2035T, "21").add("bstp", "1").add("qtcurl", Keys.SPEED).add("block", "result_normal");
                PingBack.getInstance().postPingBackToLongYuan(params.build());
            }
            this.mTextRecommendDef.setTextColor(getResources().getColor(C0508R.color.net_chat_bottom_description_hight_light));
        } else {
            this.mTextRecommendDef.setTextColor(getResources().getColor(C0508R.color.net_chat_bottom_description_normal));
        }
        if (kb >= 400 && kb < 1024) {
            this.mRecommendDefinitionType = 1;
            this.mRecommendDefinition = getString(C0508R.string.definition_standard);
        } else if (kb >= 1024 && kb < 3072) {
            this.mRecommendDefinitionType = 2;
            this.mRecommendDefinition = getString(C0508R.string.definition_high);
        } else if (kb >= 3072 && kb < 5120) {
            this.mRecommendDefinitionType = 4;
            this.mRecommendDefinition = getString(C0508R.string.definition_720P);
        } else if (kb < 5120 || kb >= NetSpeedSeriesDataSet.P4K_DEFINITION) {
            this.mRecommendDefinitionType = 5;
            this.mRecommendDefinition = getString(C0508R.string.definition_1080P);
        } else {
            this.mRecommendDefinitionType = 5;
            this.mRecommendDefinition = getString(C0508R.string.definition_1080P);
        }
    ...
    private void checkNetwork() {
        NetWorkManager.getInstance().checkNetWork(new C09541());
    }
    ...
    private void setAverageSpeed(int kb, boolean isFinished) {
        if (isFinished) {
            this.mTextAve.setTextColor(getResources().getColor(C0508R.color.net_chat_bottom_description_hight_light));
        } else {
            this.mTextAve.setTextColor(getResources().getColor(C0508R.color.net_chat_bottom_description_normal));
        }
    ...
    protected View getBackgroundContainer() {
        return findViewById(C0508R.id.epg_root);
    }

    protected void onDestroy() {
        super.onDestroy();
        ThreadUtils.execute(new C09552());
    }
    ...
    private void checkPlay() {
        GetInterfaceTools.getIHistoryCacheManager().loadHistoryList(1, 1, 0, new C09574());
    }
    ...
    public void onBackPressed() {
        ThreadUtils.execute(new C09585());
        super.onBackPressed();
    }
}
