...
public abstract class ChannelRecommendBaseFragment extends AlbumBaseRightFragment {
    ...
    private OnClickListener bigViewClickListener = new C08511();
    private OnSelectedListener bigViewSelectedListener = new C08522();
    ...
    private final Runnable mCacheViewRunnable = new C08566();
    private VerticalGridView mGridView;
    protected int mGridViewFocusedPosition;
    private OnItemClickListener mOnItemClickListener = new C08544();
    private OnItemFocusChangedListener mOnItemFocusChangedListener = new C08555();
    private OnItemRecycledListener mOnItemRecycledListener = new C08533();
    ...
    class C08522 implements OnSelectedListener {
        C08522() {
        }
    ...
    class C08533 implements OnItemRecycledListener {
        C08533() {
        }
    ...
    class C08544 implements OnItemClickListener {
        C08544() {
        }
    ...
    class C08555 implements OnItemFocusChangedListener {
        C08555() {
        }
    ...
    class C08566 implements Runnable {
        C08566() {
        }
    ...
    private void initBigView() {
        this.mBigView = (RecommendView) this.mMainView.findViewById(C0508R.id.epg_recommend_big_item);
        ...
        this.mBigView.setNextFocusRightId(C0508R.id.epg_recommend_gridview_item);
    }

    private void initGridView() {
        this.mGridView = (VerticalGridView) this.mMainView.findViewById(C0508R.id.epg_recommend_gridview_item);
        ...
        this.mGridView.setPadding(ResourceUtil.getDimen(C0508R.dimen.dimen_24dp), ResourceUtil.getDimen(C0508R.dimen.dimen_7dp), 0, 0);
