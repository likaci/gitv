...
public class TabLoadingView extends ImageView {
    ...
    private void init(Context context) {
        ...
        setBackgroundResource(C0508R.drawable.epg_loading_skin_switch);
    }

    public void startAnimation() {
        if (this.animation == null) {
            this.animation = AnimationUtils.loadAnimation(this.mContext, C0508R.anim.share_progress_rotate_anim);
