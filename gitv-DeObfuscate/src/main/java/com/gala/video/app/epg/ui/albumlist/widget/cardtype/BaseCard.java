...
public class BaseCard implements ICard {
    ...
    protected void setCountDownDay(long days) {
        if (days > 0) {
            ...
            if (days < 10) {
                offlineCountDown1View.setMarginLeft(getDimenSize(C0508R.dimen.dimen_25dp));
                offlineCountDown2View.setMarginLeft(getDimenSize(C0508R.dimen.dimen_116dp));
                offlineCountDown3View.setMarginLeft(getDimenSize(C0508R.dimen.dimen_127dp));
            } else if (days < 100) {
                offlineCountDown1View.setMarginLeft(getDimenSize(C0508R.dimen.dimen_20dp));
                offlineCountDown2View.setMarginLeft(getDimenSize(C0508R.dimen.dimen_111dp));
                offlineCountDown3View.setMarginLeft(getDimenSize(C0508R.dimen.dimen_133dp));
            } else if (days < 1000) {
                offlineCountDown1View.setMarginLeft(getDimenSize(C0508R.dimen.dimen_15dp));
                offlineCountDown2View.setMarginLeft(getDimenSize(C0508R.dimen.dimen_106dp));
                offlineCountDown3View.setMarginLeft(getDimenSize(C0508R.dimen.dimen_137dp));
            } else if (days < 10000) {
                offlineCountDown1View.setMarginLeft(getDimenSize(C0508R.dimen.dimen_10dp));
                offlineCountDown2View.setMarginLeft(getDimenSize(C0508R.dimen.dimen_101dp));
                offlineCountDown3View.setMarginLeft(getDimenSize(C0508R.dimen.dimen_141dp));
            } else {
                offlineCountDown1View.setMarginLeft(getDimenSize(C0508R.dimen.dimen_5dp));
                offlineCountDown2View.setMarginLeft(getDimenSize(C0508R.dimen.dimen_96dp));
                offlineCountDown3View.setMarginLeft(getDimenSize(C0508R.dimen.dimen_145dp));
            }
    ...
    protected void setCornerDolby3DVisible() {
        ...
        getCornerLBBgView().setWidth(getDimenSize(C0508R.dimen.dimen_95dp));
    }
    ...
    protected void setCornerDolbyVisible() {
        ...
        getCornerLBBgView().setDrawable(ImageCacheUtil.CORNER_BG_LEFT);
        getCornerLBBgView().setWidth(getDimenSize(C0508R.dimen.dimen_66dp));
    }
    ...
    protected void setCorner3DVisible() {
        ...
        getCornerLB2View().setDrawable(null);
        getCornerLBBgView().setDrawable(ImageCacheUtil.CORNER_BG_LEFT);
        getCornerLBBgView().setWidth(getDimenSize(C0508R.dimen.dimen_46dp));
    }
}
