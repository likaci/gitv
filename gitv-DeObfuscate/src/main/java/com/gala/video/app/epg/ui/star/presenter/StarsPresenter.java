...
public class StarsPresenter implements Presenter {
    ...
    private Runnable mShowLoadingRunnable = new C10841();
    ...
    class C10852 implements IStarAlbumCallback {
        C10852() {
        }

        public void onSuccess(Map<String, List<IData>> map, List<Tag> list, StarTaskParams params) {
            LogUtils.m1568d(StarsPresenter.TAG, "getDatas() -> onSuccess() list:" + ListUtils.getCount((List) list) + ",map:" + ListUtils.getCount((Map) map));
    ...
    class C10906 implements IStarDetailCallback {
        C10906() {
        }
        ...
        public void onSuccess(final Star star, String arg1) {
            if (!StarsPresenter.this.mIsDestroy) {
                if (star != null) {
                    LogUtils.m1568d(StarsPresenter.TAG, "getDetails() -> star != null");
                ...
                StarsPresenter.this.onPost(new Runnable() {
                    public void run() {
                        View outer = (View) StarsPresenter.this.mStarsView.get();
                        if (outer != null) {
                            LogUtils.m1568d(StarsPresenter.TAG, "getDetails() -> setDetails:" + star);
        ...
        public void onFail(ApiException e) {
            ...
            LogUtils.m1571e(StarsPresenter.TAG, "getDetails() -> onFail() e:" + e);
        }
    }
    ...
    private class NetworkListener implements INetworkStateListener {
        ...
        public void onConnected(boolean isChanged) {
            LogUtils.m1571e(StarsPresenter.TAG, "onConnected() isChanged：" + isChanged);
            if (isChanged) {
                if (!StarsPresenter.this.isStarData) {
                    LogUtils.m1571e(StarsPresenter.TAG, "onConnected() isStarData：" + StarsPresenter.this.isStarData);
    ...
    private void getDatas() {
        this.mTasksRepository.getTasks(new C10852());
    }
    ...
    private void onTaskSuccess(final Map<String, List<IData>> map, final List<Tag> list, StarTaskParams params) {
        ...
        if (ListUtils.isEmpty((List) list) || ListUtils.isEmpty((Map) map)) {
            ...
            mDataRunnable = new C10863();
        } else {
            LogUtils.m1568d(TAG, "getDatas() -> list is not null");
            this.isMapData = true;
    ...
    private void onTaskFail(final ApiException e) {
        onPost(new Runnable() {
            public void run() {
                LogUtils.m1571e(StarsPresenter.TAG, "getDatas() -> onFail() e:" + e);
                StarsPresenter.this.removeLoadingCallbacks();
    ...
    private void getDetails() {
        this.mTasksRepository.getDetails(new C10906());
    }
