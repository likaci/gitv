...
public class AlbumData<T> implements IData<Album> {
    ...
    public void click(Context context, Object albumInfoModel) {
        if (albumInfoModel == null || !(albumInfoModel instanceof AlbumInfoModel)) {
            LogUtils.m1571e("EPG/album4/AlbumData", "click --- albumInfoModel  = " + albumInfoModel);
            return;
        }
        ...
        LogUtils.m1571e("EPG/album4/AlbumData", "click ---type=" + identification + ", name : " + (this.mAlbum != null ? this.mAlbum.name : ""));
    }
