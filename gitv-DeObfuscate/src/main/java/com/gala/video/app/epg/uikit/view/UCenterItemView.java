...
public class UCenterItemView extends RelativeLayout implements IViewLifecycle<Presenter> {
    ...
    class C12371 implements OnFocusChangeListener {
        C12371() {
        }
    ...
    class C12382 implements OnClickListener {
        ...
        public void onClick(View view) {
            ...
            params.add("rt", "i").add("r", ActionBarDataFactory.TOP_BAR_TIME_NAME_LOGIN).add("block", "account").add("rseat", ActionBarDataFactory.TOP_BAR_TIME_NAME_LOGIN).add("c1", "").add("rpage", "mine_guest").add("s1", s1).add("e", e).add(Keys.f2035T, "20");
            PingBack.getInstance().postPingBackToLongYuan(params.build());
            LogUtils.m1570d(UCenterItemView.LOG_TAG, ">>>>>pingback - click type - [s1,e]= ", s1, ", ", e);
            GetInterfaceTools.getLoginProvider().startLoginActivity(UCenterItemView.this.mContext, s1, 2);
        }
    }

    class C12393 implements Runnable {
        C12393() {
        }
    ...
    class C12404 implements AnimationListener {
        C12404() {
        }
    ...
    private void initView() {
        this.mMainView = (ViewGroup) LayoutInflater.from(getContext()).inflate(C0508R.layout.epg_ucenter_head_view, this, true);
        this.mImgBg = (ImageView) this.mMainView.findViewById(C0508R.id.epg_img_ucenter_head_bg);
        this.mBtnLogin = (Button) this.mMainView.findViewById(C0508R.id.epg_btn_ucenter_login);
        this.mTxtTips = (TextView) this.mMainView.findViewById(C0508R.id.epg_txt_ucenter_no_login_tip);
        this.mImgEyes = (ImageView) this.mMainView.findViewById(C0508R.id.epg_img_ucenter_eye);
        this.mImgHead = (ImageView) this.mMainView.findViewById(C0508R.id.epg_img_ucenter_head);
        this.mTxtName = (TextView) this.mMainView.findViewById(C0508R.id.epg_txt_ucenter_uname);
        this.mTxtUid = (TextView) this.mMainView.findViewById(C0508R.id.epg_txt_ucenter_uid);
        this.mTxtStatus = (TextView) this.mMainView.findViewById(C0508R.id.epg_txt_ucenter_status);
        this.mBtnLogin.setNextFocusLeftId(this.mBtnLogin.getId());
        this.mBtnLogin.setNextFocusUpId(this.mBtnLogin.getId());
        this.mBtnLogin.setOnFocusChangeListener(new C12371());
        this.mBtnLogin.setOnClickListener(new C12382());
    }
    ...
    private void initUserUI(boolean isVip) {
        ...
        if (this.mImgBg != null) {
            this.mImgBg.setImageResource(isVip ? C0508R.drawable.epg_ucenter_vip_login_bg : C0508R.drawable.epg_ucenter_login_bg);
        }
        this.mTxtName.setVisibility(0);
        this.mTxtUid.setVisibility(0);
        this.mTxtStatus.setVisibility(0);
        if (this.mPresenter != null) {
            int color = this.mPresenter.isVip() ? C0508R.color.action_bar_vip_text_normal : C0508R.color.detail_title_text_color_new;
        ...
        int i = C0508R.string.mycenter_uname;
        ...
        i = C0508R.string.mycenter_ustatus;
        objArr = new Object[1];
    ...
    private void initLoginUI() {
        ...
        hideVipUI();
        if (this.mImgBg != null) {
            this.mImgBg.setImageResource(C0508R.drawable.epg_ucenter_no_login_bg);
        }
        ...
        this.mHandler.postDelayed(new C12393(), 100);
    }
    ...
    private void startEyesAnimation() {
        ...
        anim.setAnimationListener(new C12404());
