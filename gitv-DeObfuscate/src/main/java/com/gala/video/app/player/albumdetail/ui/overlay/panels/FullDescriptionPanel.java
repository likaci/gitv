...
public class FullDescriptionPanel {
    ...
    private void initFullDescriptionViews() {
        this.mFullDescriptionRootView = ((ViewStub) this.mRootView.findViewById(C1291R.id.stub_full_description)).inflate();
        this.mFullDescriptionRootView.setVisibility(0);
        this.mllDesc = (LinearLayout) this.mFullDescriptionRootView.findViewById(C1291R.id.ll_album_desc);
        this.mImgDescBg = (ImageView) this.mFullDescriptionRootView.findViewById(C1291R.id.img_album_desc_bg);
        this.mTxtDescTitle = (TextView) this.mFullDescriptionRootView.findViewById(C1291R.id.tv_album_desc_title);
        this.mTxtDescDetail = (AlignmentTextView) this.mFullDescriptionRootView.findViewById(C1291R.id.tv_album_desc_content);
    }

    private void setupFullDescriptionViews() {
        LogRecordUtils.logd(TAG, ">> setupFullDescriptionViews.");
        this.mTxtDescDetail.setLineSpace((float) ResourceUtil.getDimen(C1291R.dimen.dimen_10dp));
        ...
        this.mTxtDescDetail.setNextFocusDownId(C1291R.id.tv_album_desc_content);
        this.mTxtDescDetail.setNextFocusForwardId(C1291R.id.tv_album_desc_content);
        this.mTxtDescDetail.setNextFocusLeftId(C1291R.id.tv_album_desc_content);
        this.mTxtDescDetail.setNextFocusRightId(C1291R.id.tv_album_desc_content);
        this.mTxtDescDetail.setNextFocusUpId(C1291R.id.tv_album_desc_content);
    }
    ...
    private void setupBackground(String imageURL) {
        ...
        if (!this.mIsDescriptionBgSet) {
            this.mImgDescBg.setImageDrawable(ResourceUtil.getDrawable(C1291R.drawable.share_loadingview_bg).getConstantState().newDrawable());
    ...
    private void setDescHeight(String desc) {
        ...
        if (((float) len) >= 476.0f) {
            ...
            lp.height = ResourceUtil.getDimen(C1291R.dimen.dimen_492dp);
        ...
        lp.height = (lineCount + 2) * ResourceUtil.getDimen(C1291R.dimen.dimen_35dp);
        this.mTxtDescDetail.setLayoutParams(lp);
    }
