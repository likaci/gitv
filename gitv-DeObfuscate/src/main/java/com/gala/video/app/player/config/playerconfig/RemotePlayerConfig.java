...
public class RemotePlayerConfig extends AbsPlayerConfig {
    ...
    class C13581 implements OnConfigReadListener {
        C13581() {
        }

        public void onSuccess(String jsonResult) {
            MyLogUtils.m462d(RemotePlayerConfig.this.TAG, "mCachedConfigReadListener.onSuccess(jsonResult: " + jsonResult);
        ...
        public void onFailed(Throwable e) {
            MyLogUtils.m464e(RemotePlayerConfig.this.TAG, "mCachedConfigReadListener.onFailed(" + e + ")");
            RemotePlayerConfig.this.mCachedConfigFailureCount = RemotePlayerConfig.this.mCachedConfigFailureCount + 1;
        }
    }

    class C13592 implements OnConfigReadListener {
        C13592() {
        }

        public void onSuccess(String jsonResult) {
            MyLogUtils.m462d(RemotePlayerConfig.this.TAG, "mRemoteConfigReadListener.onSuccess(jsonResult: " + jsonResult);
            RemotePlayerConfig.this.parseJsResult(jsonResult);
            RemotePlayerConfig.this.mReady = true;
        ...
        public void onFailed(Throwable e) {
            MyLogUtils.m464e(RemotePlayerConfig.this.TAG, "mRemoteConfigReadListener.onFailed(" + e + ")");
    ...
    private RemotePlayerConfig() {
        this.mReady = false;
        this.mCachedConfigReadListener = new C13581();
        this.mRemoteConfigReadListener = new C13592();
    ...
    public void load() {
        MyLogUtils.m462d(this.TAG, "load(), mReady= " + this.mReady + ", mRemoteConfigFailureCount=" + this.mRemoteConfigFailureCount + ", mCachedConfigFailureCount=" + this.mCachedConfigFailureCount);
