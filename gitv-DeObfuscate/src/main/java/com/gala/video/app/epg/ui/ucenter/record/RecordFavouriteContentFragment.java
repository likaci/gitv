...
public class RecordFavouriteContentFragment extends Fragment implements View, OnItemFocusChangedListener {
    ...
    private static final int GRIDVIEW_TOP = ResourceUtil.getDimen(C0508R.dimen.dimen_2dp);
    ...
    private OnItemAnimatorFinishListener mOnItemAnimatorFinishListener = new C12115();
    private OnItemClickListener mOnItemClickListener = new C12071();
    private OnItemRecycledListener mOnItemRecycledListener = new C12104();
    private OnScrollListener mOnScrollListener = new C12082();
    private FootLeftRefreshPage mPage;
    private Presenter mPresenter;
    private final Runnable mScrollStopRunnable = new C12093();

    class C12071 implements OnItemClickListener {
        C12071() {
        }
    ...
    class C12082 extends OnScrollListener {
        C12082() {
        }
    ...
    class C12093 implements Runnable {
        C12093() {
        }
    ...
    class C12104 implements OnItemRecycledListener {
        C12104() {
        }
    ...
    class C12115 implements OnItemAnimatorFinishListener {
        C12115() {
        }
    ...
    class C12148 implements OnKeyListener {
        C12148() {
        }
    ...
    class C12159 implements OnFocusChangeListener {
        C12159() {
        }
    ...
    public android.view.View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        android.view.View rootView = inflater.inflate(C0508R.layout.epg_fragment_record_favourite_content, null);
        this.mMenuDesView = (TextView) rootView.findViewById(C0508R.id.epg_q_album_menu_des);
        this.mGridView = (VerticalGridView) rootView.findViewById(C0508R.id.epg_qalbum_gridview);
        initGridView();
        this.mNoHistoryResultView = (TextView) rootView.findViewById(C0508R.id.epg_no_history_result);
        this.mNoCommonResult = (ImageView) rootView.findViewById(C0508R.id.epg_no_common_result);
    ...
    private void initGridView() {
        ...
        this.mGridView.setPadding(ResourceUtil.getDimen(C0508R.dimen.dimen_24dp), ResourceUtil.getDimen(C0508R.dimen.dimen_2dp), ResourceUtil.getDimen(C0508R.dimen.dimen_10dp), ResourceUtil.getDimen(C0508R.dimen.dimen_15dp));
        this.mGridView.setVerticalMargin(ResourceUtil.getPx(-7));
        this.mGridView.setHorizontalMargin(ResourceUtil.getDimen(C0508R.dimen.dimen_4dp));
    ...
    private Spanned formatMenuDesc() {
        ...
        int menuDescResID = C0508R.string.menu_desc_format_noLogin;
        if (UserUtil.isLogin()) {
            menuDescResID = C0508R.string.menu_desc_format;
        }
        ColorString msp = new ColorString(String.format(ResourceUtil.getStr(menuDescResID), new Object[]{descTxt}));
        msp.setColor(ResourceUtil.getColor(C0508R.color.albumview_menu_color));
        msp.setColor(new ColorStringItem(ResourceUtil.getStr(C0508R.string.alter_menukey_text), ResourceUtil.getColor(C0508R.color.albumview_yellow_color)));
        return msp.build();
    }
    ...
    private void showNoResultView() {
        ...
        switch (this.mPage) {
            ...
            case PLAY_HISTORY_LONG:
                ...
                int resId = this.mPage == FootLeftRefreshPage.PLAY_HISTORY_ALL ? this.mPresenter.isLogin() ? C0508R.string.temporary_no_play_history_login : C0508R.string.temporary_no_play_history : C0508R.string.temporary_no_play_history_long;
            ...
            case SUBSCRIBE:
                ...
                if (this.mNoSubscribleDrawable == null) {
                    setImageResource(this.mNoCommonResult, C0508R.drawable.epg_no_subscrible_record_alter_image);
                    return;
                } else {
            ...
            case FAVOURITE:
                ...
                if (this.mNoFavouriteDrawable == null) {
                    setImageResource(this.mNoCommonResult, C0508R.drawable.epg_no_favorite_record_alter_image);
                    return;
                } else {
    ...
    public void showClearAllDialog() {
        ...
        switch (this.mPage) {
            case PLAY_HISTORY_ALL:
            case PLAY_HISTORY_LONG:
                msg = C0508R.string.playhistory_clear_confirm;
                break;
            case SUBSCRIBE:
                msg = C0508R.string.subscrible_clear_all;
                break;
            case FAVOURITE:
                msg = C0508R.string.favourite_clear_confirm;
                break;
        }
        final GlobalDialog clearAlbumDialog = Project.getInstance().getControl().getGlobalDialog(getActivity());
        clearAlbumDialog.setParams(ResourceUtil.getStr(msg), ResourceUtil.getStr(C0508R.string.delete_sure), new OnClickListener() {
        ...
        }, ResourceUtil.getStr(C0508R.string.exit_cancel_btn), new OnClickListener() {
            public void onClick(android.view.View v) {
                clearAlbumDialog.dismiss();
                QAPingback.recordClearDialogPingback(1);
            }
        });
        clearAlbumDialog.setOnKeyListener(new C12148());
    ...
    private GlobalQRFeedbackPanel getErrorPanel() {
        if (this.mErrorPanel == null) {
            ...
            android.view.View view = ((ViewStub) getView().findViewById(C0508R.id.epg_content_status_layout)).inflate();
            view.setFocusable(true);
            view.setOnFocusChangeListener(new C12159());
            this.mErrorPanel = (GlobalQRFeedbackPanel) getView().findViewById(C0508R.id.epg_q_album_right_data_no_result_panel);
    ...
    private void initLoginView() {
        if (this.mLoginButton == null) {
            if (getView() != null) {
                android.view.View view = ((ViewStub) getView().findViewById(C0508R.id.epg_login_layout)).inflate();
                view.setFocusable(false);
                this.mLoginButton = (Button) view.findViewById(C0508R.id.epg_btn_my_login);
                this.mLoginButton.setOnFocusChangeListener(new OnFocusChangeListener() {
                    public void onFocusChange(android.view.View v, boolean hasFocus) {
                        AnimationUtil.zoomAnimation(v, hasFocus, 1.04f, 200);
                        RecordFavouriteContentFragment.this.mLoginButton.setTextColor(hasFocus ? ResourceUtil.getColor(C0508R.color.albumview_focus_color) : ResourceUtil.getColor(C0508R.color.albumview_normal_color));
                    }
                });
                ...
                this.mLoginButton.setOnClickListener(new OnClickListener() {
                    public void onClick(android.view.View v) {
                        ...
                        QToast.makeTextAndShow(AppRuntimeEnv.get().getApplicationContext(), RecordFavouriteContentFragment.this.mPage == FootLeftRefreshPage.FAVOURITE ? ResourceUtil.getStr(C0508R.string.favourite_login_toast) : ResourceUtil.getStr(C0508R.string.record_login_toast), 5000);
                    }
                });
                this.mLoginTip = (TextView) view.findViewById(C0508R.id.epg_txt_login_tip);
                this.mLoginTip.setTextColor(ResourceUtil.getColorStateList(C0508R.color.albumview_normal_color));
            } else {
                return;
            }
        }
    ...
    private void refreshLoginTip() {
        int loginTipResId = C0508R.string.record_login_tip;
        if (this.mPage == FootLeftRefreshPage.FAVOURITE) {
            loginTipResId = C0508R.string.favourite_login_tip;
        }
