...
public class OpenMediaCommand extends ServerCommand<Intent> {
    ...
    Handler mHandler = new Handler(getContext().getMainLooper()) {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    LogUtils.m1568d(OpenMediaCommand.TAG, " Loading end openPlayList");
                    OpenMediaCommand.this.openPlayList();
                    return;
                case 2:
                    LogUtils.m1568d(OpenMediaCommand.TAG, " Loading end OPEN_ALBUM_PARAMS");
                    OpenMediaCommand.this.openAlbumWithPlayParams();
                    return;
                case 3:
                    LogUtils.m1568d(OpenMediaCommand.TAG, " Loading end OPEN_ALBUM");
