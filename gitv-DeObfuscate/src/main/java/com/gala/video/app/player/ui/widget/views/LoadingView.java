...
public class LoadingView extends FrameLayout implements IScreenUISwitcher {
    ...
    private Handler mHandler = new C15581();
    ...
    class C15581 extends Handler {
        C15581() {
        }

        public void handleMessage(Message msg) {
            LogUtils.m1568d(LoadingView.TAG, "handleMessage()" + msg.what);
            switch (msg.what) {
                case 101:
    ...
    public void initViews() {
        ...
        this.mTxtName = (TextView) this.sLoadingLayout.findViewById(C1291R.id.share_description);
        this.mAnimView = (ImageView) this.sLoadingLayout.findViewById(C1291R.id.share_loading);
        this.mLoadingContainer = (RelativeLayout) this.sLoadingLayout.findViewById(C1291R.id.share_loading_container);
        this.mLogo = (ImageView) this.sLoadingLayout.findViewById(C1291R.id.share_logo);
        this.mVideoDerive = (ImageView) this.sLoadingLayout.findViewById(C1291R.id.share_video_derive);
    ...
    public void show() {
        LogUtils.m1568d(TAG, "show mIsFullScreen=" + this.mIsFullScreen);
    ...
    public void setLoadingText(String text) {
        LogUtils.m1568d(TAG, "addText: " + text);
        ...
        LogUtils.m1568d(TAG, "setLoadingText: mAlbumId" + this.mAlbumId);
    ...
    public void setAlbumId(String id) {
        LogUtils.m1568d(TAG, "setAlbumId: " + id);
        this.mAlbumId = id;
        showVideoDerive();
    }
    ...
    public void startLoadingAnimation() {
        LogUtils.m1568d(TAG, "startLoadingAnimation()");
        if (this.mAnimView != null) {
