...
public class CarouselDetailListViewItem extends RelativeLayout {
    ...
    private void initUI() {
        ...
        this.mPlaying = C1291R.drawable.share_detail_item_playing;
    }

    private void initViews() {
        this.TAG = "CarouselDetaiListViewItem@" + Integer.toHexString(hashCode());
        initUI();
        View view = LayoutInflater.from(this.mContext).inflate(C1291R.layout.player_carousel_listview, this);
        this.mChannelId = (TextView) view.findViewById(C1291R.id.channel_item_id);
        this.mChannelName = (TextView) view.findViewById(C1291R.id.channel_item_name);
        this.mChannelTvName = (MarqueeTextView) view.findViewById(C1291R.id.channel_item_tvname);
        this.mPlayingGifView = new GifImageView(this.mContext);
        LayoutParams params = new LayoutParams(this.mContext.getResources().getDimensionPixelSize(C1291R.dimen.dimen_24dp), this.mContext.getResources().getDimensionPixelSize(C1291R.dimen.dimen_24dp));
        params.topMargin = this.mContext.getResources().getDimensionPixelSize(C1291R.dimen.dimen_13dp);
    ...
    public void setChannelInfo(CarouselChannelDetail info) {
        this.mChannelTvName.setViewBound(this.mContext.getResources().getDimensionPixelSize(C1291R.dimen.dimen_220dp), this.mContext.getResources().getDimensionPixelSize(C1291R.dimen.dimen_22dp));
    ...
    private void adjustGifViewPosition() {
        ...
        params.leftMargin = this.mContext.getResources().getDimensionPixelSize(C1291R.dimen.dimen_5dp);
