...
public class WindowedErrorStrategy extends AbsErrorStrategy {
    ...
    public void handleVipAccountError(final String errorCode) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleVipAccountError" + errorCode);
        }
    ...
    public void handleVideoOfflineError(final String insideMsg, final String log, final String qRMsg) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleVideoOfflineError" + qRMsg);
        }
        this.mOverlay.showError(ErrorType.COMMON, !StringUtils.isEmpty((CharSequence) insideMsg) ? insideMsg : this.mContext.getString(C1291R.string.video_offline_error));
        this.mClickedAction = new Runnable() {
            public void run() {
    ...
    public void handleForeignIpError(final String insideMsg, final String log, final String qRMsg) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleForeignIpError" + qRMsg);
        }
        this.mOverlay.showError(ErrorType.COMMON, !StringUtils.isEmpty((CharSequence) insideMsg) ? insideMsg : this.mContext.getString(C1291R.string.foreign_ip_error));
        this.mClickedAction = new Runnable() {
            public void run() {
    ...
    public void handleCopyrightRestrictionError(boolean needLogcat, String insideMsg, String log, String qRMsg) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleCopyrightRestrictionError" + qRMsg);
        }
        this.mOverlay.showError(ErrorType.COMMON, !StringUtils.isEmpty((CharSequence) insideMsg) ? insideMsg : this.mContext.getString(C1291R.string.copy_restriction_error));
    ...
    public void handleLiveCopyrightRestrictionError(final String insideMsg, final String log, final String qRMsg) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleLiveCopyrightRestrictionError" + qRMsg);
        }
        this.mOverlay.showError(ErrorType.COMMON, this.mContext.getString(C1291R.string.album_detail_window_error_tip));
        this.mClickedAction = new Runnable() {
            public void run() {
    ...
    public void handleNativePlayerBlockError(final String log, final String qRMsg) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleNativePlayerBlockError" + qRMsg);
        }
        this.mOverlay.showError(ErrorType.COMMON, this.mContext.getString(C1291R.string.native_player_block));
        this.mClickedAction = new Runnable() {
            public void run() {
    ...
    public void handleNativePlayer4016Error(final String log, final String qRMsg) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleNativePlayer4016Error" + qRMsg);
        }
        this.mOverlay.showError(ErrorType.COMMON, this.mContext.getString(C1291R.string.nativeerror_4016));
        this.mClickedAction = new Runnable() {
            public void run() {
    ...
    public void handleNativePlayer4011And4012Error(final String log, final String qRMsg) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleNativePlayer4011And4012Error" + qRMsg);
        }
        this.mOverlay.showError(ErrorType.COMMON, this.mContext.getString(C1291R.string.nativeerror_4011_4012));
        this.mClickedAction = new Runnable() {
            public void run() {
    ...
    public void handleSystemPlayerOfflinePlaybackError(final String log, final String qRMsg) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleSystemPlayerOfflinePlaybackError" + qRMsg);
        }
        this.mOverlay.showError(ErrorType.COMMON, this.mContext.getString(C1291R.string.offline_player_error));
        this.mClickedAction = new Runnable() {
            public void run() {
    ...
    public void showErrorWithServerMsg(String content, String errLog, String errCode, String qrMessage) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "showErrorWithServerMsg" + qrMessage);
        }
    ...
    public void handleSystemPlayerCommonError(final String errorCode, final String log, final String qRMsg) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleSystemPlayerCommonError" + qRMsg);
        }
        this.mOverlay.showError(ErrorType.COMMON, this.mContext.getString(C1291R.string.system_player_error, new Object[]{errorCode}));
        this.mClickedAction = new Runnable() {
            public void run() {
    ...
    public void handleNativePlayerCommonError(String errCode, String log, String qRMsg, int playerType) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleNativePlayerCommonError" + qRMsg);
        }
        this.mOverlay.showError(ErrorType.COMMON, this.mContext.getString(C1291R.string.native_player_error, new Object[]{errCode}));
    ...
    public void handleLiveProgramFinished(IVideo iBasicVideo) {
        ...
        this.mOverlay.showError(ErrorType.COMMON, this.mContext.getString(C1291R.string.live_program_finished));
        this.mClickedAction = new Runnable() {
            public void run() {
                WindowedErrorStrategy.this.showToast(WindowedErrorStrategy.this.mContext.getString(C1291R.string.toast_live_program_finished));
            }
        };
    }
    ...
    public void handleUserVipStatusIncorrectError(final IVideo video) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleUserVipStatusIncorrectError");
        }
        this.mOverlay.showError(ErrorType.VIP, this.mContext.getString(C1291R.string.window_cannot_preview));
        this.mClickedAction = new Runnable() {
            public void run() {
    ...
    public void handlePreviewFinished(IVideo video) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handlePreviewFinished");
        }
        this.mOverlay.showError(ErrorType.VIP, this.mContext.getString(C1291R.string.window_preview_finish_tip));
        this.mClickedAction = null;
    }

    public void handleCommonApiError(final IApiError apiErr, final String qRMsg, final String log) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleCommonApiError" + qRMsg);
        }
    ...
    public void handleInvalidTvQidError() {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleInvalidTvQidError");
        }
        this.mOverlay.showError(ErrorType.COMMON, this.mContext.getResources().getString(C1291R.string.invalid_tvQid_error));
        this.mClickedAction = new Runnable() {
            public void run() {
    ...
    public void onErrorClicked() {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "onErrorClicked" + this.mClickedAction);
        }
    ...
    public void handleLiveCommonError(String errCode, String insideMsg, String log, String qRMsg) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleLiveCommonError");
        }
        this.mOverlay.showError(ErrorType.COMMON, this.mContext.getString(C1291R.string.album_detail_window_error_tip));
        final String str = errCode;
    ...
    public void handleCarouselCommonError(final String insideMsg, final String log, final String qRMsg) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleCarouselCommonError");
        }
    ...
    public void handleCarouselNativePlayerBlockError(final String log, final String qRMsg) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleCarouselNativePlayerBlockError" + qRMsg);
        }
        this.mOverlay.showError(ErrorType.COMMON, "");
        this.mClickedAction = new Runnable() {
            public void run() {
    ...
    public void handleCarouselSpecialError(final IVideo video, final ISdkError error, final String qRMsg) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "handleCarouselSpecialError" + qRMsg);
        }
    ...
    public void handleDRMCommonError(final String errorCode, final String log, final String qRMsg) {
        ...
        String msg = this.mContext.getString(C1291R.string.intertrust_drm_error, new Object[]{errorCode});
        if (StringUtils.equals(errorCode, String.valueOf(ISdkError.CODE_INTERTRUST_DRM_DEVICE_NOT_SUPPORT))) {
            msg = this.mContext.getString(C1291R.string.common_player_error, new Object[]{errorCode});
        }
