...
public class ContentViewWrapper {
    ...
    OnItemFocusChangedListener mOnMsgItemFocusChangeListener = new C09132();

    class C09121 extends ItemDecoration {
        C09121() {
        }

        public int getItemOffsets(int itemPosition, RecyclerView parent) {
            return ContentViewWrapper.this.getDimen(C0508R.dimen.dimen_012dp);
        }
    }

    class C09132 implements OnItemFocusChangedListener {
        C09132() {
        }
    ...
    private void initRightView() {
        ...
        this.mGridView.setPadding(0, 0, getDimen(C0508R.dimen.dimen_13dp), getDimen(C0508R.dimen.dimen_5dp));
        this.mGridView.setContentWidth(getDimen(C0508R.dimen.dimen_1061dp));
        this.mGridView.setContentHeight(getDimen(C0508R.dimen.dimen_94dp));
        this.mGridView.setShakeForbidden(115);
        this.mGridView.setQuickFocusLeaveForbidden(true);
        this.mGridView.setItemDecoration(new C09121());
    ...
    public void showMsgs(final List<IMsgContent> list) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1571e(TAG, "showMsgs list:" + ListUtils.getCount((List) list));
        }
    ...
    private void setScollBarScrollRange(List<IMsgContent> list) {
        ...
        this.mGridView.setScrollRange((getDimen(C0508R.dimen.dimen_94dp) * count) - ((count - 1) * getDimen(C0508R.dimen.dimen_12dp)));
    }
