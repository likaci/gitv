...
public class AdbConfigUtils {
        ...
        try {
            ...
            while (true) {
                ...
                if (temp != null) {
                    ...
                    LogUtils.m1568d(TAG, "getValue key = " + key + " value = " + result);
                    return result;
                }
            }
        } catch (Exception e) {
            LogUtils.m1572e(TAG, "getValue cmd = " + cmd + " exception ", e);
            return "";
        }
    }
    ...
    public static long getHomeDataRefreshInterval() {
        ...
        try {
            ...
            LogUtils.m1572e(TAG, "getHomeDataRefreshInterval, exception = ", e);
            return j;
        }
    }
    ...
    public static long getTabInfoRefreshInterval() {
        ...
        try {
            ...
            LogUtils.m1572e(TAG, "getTabInfoRefreshInterval, exception = ", e);
            return j;
        }
    }
    ...
    public static long getScreenSaverInterval() {
        ...
        try {
            ...
            LogUtils.m1572e(TAG, "getScreenSaverInterval, exception = ", e);
            return j;
        }
    }
    ...
    public static boolean isMonkeyTest() {
        ...
        LogUtils.m1568d(TAG, "isOpenMonkeyTest:" + interval);
        if (!StringUtils.isEmpty(interval)) {
            try {
    ...
    public static boolean isOpenOperateImageSequenceShowTest() {
        ...
        LogUtils.m1568d(TAG, "isOpenOperateImageSequenceShowTest:" + result);
        if (!StringUtils.isEmpty(result)) {
            try {
                z = Boolean.valueOf(result).booleanValue();
            } catch (Exception e) {
                LogUtils.m1572e(TAG, "isOpenOperateImageSequenceShowTest, exception = ", e);
            }
        }
        return z;
    }
    ...
    public static boolean isOpenExitRecommendShow() {
        ...
        LogUtils.m1568d(TAG, "isOpenExitRecommendShowTest:" + result);
        if (!StringUtils.isEmpty(result)) {
            try {
                z = Boolean.valueOf(result).booleanValue();
            } catch (Exception e) {
                LogUtils.m1572e(TAG, "isOpenExitRecommendShowTest, exception = ", e);
            }
        }
        return z;
    }
