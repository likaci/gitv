...
public class PlayerFeedbackModel extends FeedBackModel {
    ...
    public String getQRString() {
        LogUtils.m1568d(TAG, "getQRString, mCustomQrMessage = " + this.mCustomQrMessage + "super.toString()=" + super.toString());
    ...
    public String toString() {
        LogUtils.m1568d(TAG, "toString, mCustomQrMessage = " + this.mCustomQrMessage + "super.toString()=" + super.toString());
