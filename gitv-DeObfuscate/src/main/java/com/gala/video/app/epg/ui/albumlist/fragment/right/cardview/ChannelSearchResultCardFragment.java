...
public class ChannelSearchResultCardFragment extends ChannelCardBaseFragment {
    ...
    class C08403 implements OnKeyListener {
        C08403() {
        }
    ...
    protected void sendRquestPingback(boolean fromScrollEnd) {
        ...
        LogUtils.m1571e(this.LOG_TAG, "sendRquestPingback ---- time = " + timeToken + ", count = " + ListUtils.getCount(list));
        try {
    ...
    private List<Album> getVisibleList(boolean fromScrollEnd) {
        ...
        for (int i = this.firstVisble; i <= this.lastVisble; i++) {
            ...
            if (view != null) {
                ...
                int top = ResourceUtil.getDimen(C0508R.dimen.dimen_32dp);
    ...
    private void showAddTabDialog() {
        String nameDialog = getResources().getString(C0508R.string.add_tab_dialog_content);
        String nameToastSuccess = getResources().getString(C0508R.string.add_tab_toast_content_success);
        String nameToastFailure = getResources().getString(C0508R.string.add_tab_toast_content_failure);
        ...
        addTabDialog.setParams(showDialog, ResourceUtil.getStr(C0508R.string.add_tab_dialog_ok), new OnClickListener() {
        ...
        }, ResourceUtil.getStr(C0508R.string.add_tab_dialog_cancel), new OnClickListener() {
            public void onClick(View v) {
        ...
        addTabDialog.show();
        addTabDialog.setOnKeyListener(new C08403());
    ...
    private void sendAddPingback(int add, String albumName) {
        ...
        params.add("rpage", "搜索结果").add("st", st).add("tab", tab).add("a", "addtab").add(Keys.f2035T, "5");
