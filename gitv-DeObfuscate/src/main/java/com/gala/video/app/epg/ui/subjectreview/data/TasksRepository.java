...
public class TasksRepository implements IDataSource {
    ...
    private List<ChannelLabel> fiterSubjectData(List<ChannelLabel> originalData) {
        LogUtils.m1576i(LOG_TAG, "fiterSubjectData --- ListUtils.getCount(originalData)", Integer.valueOf(ListUtils.getCount((List) originalData)));
        ...
        LogUtils.m1576i(LOG_TAG, "fiterSubjectData --- ListUtils.getCount(newChannelLabels)", Integer.valueOf(ListUtils.getCount(newChannelLabels)));
