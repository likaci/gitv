...
public class GlobalUpdateDialog extends GlobalDialog {
    ...
    protected void initLayout() {
        ...
        params.setMargins(this.mContext.getResources().getDimensionPixelSize(C0508R.dimen.dimen_0dp), this.mContext.getResources().getDimensionPixelSize(C0508R.dimen.dimen_0dp), this.mContext.getResources().getDimensionPixelSize(C0508R.dimen.dimen_0dp), this.mContext.getResources().getDimensionPixelSize(C0508R.dimen.dimen_0dp));
        this.mContentLayout.setLayoutParams(params);
        this.mContentTextView = (TextView) this.mContentLayout.findViewById(C0508R.id.epg_gdutv_dialog_text);
        this.mContentTextView.setVisibility(0);
        this.mContentTextTitle = (TextView) this.mContentLayout.findViewById(C0508R.id.epg_gdutv_dialog_text_title);
        this.mContentTextTitle.setVisibility(8);
        this.mContentTextMessage = (TextView) this.mContentLayout.findViewById(C0508R.id.epg_gdutv_dialog_text_message);
        this.mContentTextMessage.setVisibility(8);
        this.mContentTextDownloadingState = (TextView) this.mContentLayout.findViewById(C0508R.id.epg_gdutv_dialog_text_downloading_state);
        this.mContentTextDownloadingState.setVisibility(8);
    }

    protected void initParams() {
        super.initParams();
        this.mContentResId = C0508R.layout.epg_global_dialog_update_text_view;
    }
