...
public class ActionBarLayout extends LinearLayout implements OnFocusChangeListener, OnClickListener {
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        this.mFocusView = v;
        LogUtils.m1568d(TAG, "onFocusChange() --- hasFocus = " + hasFocus + "  v.tag = " + v.getTag());
    ...
    public void setAdapter(ActionBarStateListener actionBarAdapter) {
        ...
        while (i < length) {
            ...
            if (i != length - 1) {
                layoutParams.rightMargin = ResourceUtil.getDimen(C0508R.dimen.dimen_5dp);
            }
            layoutParams.height = this.mContext.getResources().getDimensionPixelSize(C0508R.dimen.dimen_56dp);
    ...
    public void onClick(View v) {
        ...
        LogUtils.m1568d(TAG, "onClick(),  v.tag = " + v.getTag() + ",  position = " + position);
    }
