...
public class DetailConstants {
    ...
    public static final String CONTENT_TAG_2DTO3D = ResourceUtil.getStr(C1291R.string.detail_tab_content_tag_2d_to_3d);
    public static final String CONTENT_TAG_BITSTREAM = ResourceUtil.getStr(C1291R.string.detail_tab_content_tag_bit_stream);
    public static final String CONTENT_TAG_BODAN = ResourceUtil.getStr(C1291R.string.detail_tab_content_tag_bodan);
    public static final String CONTENT_TAG_EPISODE = ResourceUtil.getStr(C1291R.string.detail_tab_content_tag_episode);
    public static final String CONTENT_TAG_PROGRAM = ResourceUtil.getStr(C1291R.string.detail_tab_content_tag_program);
    public static final String CONTENT_TAG_RECOMMEND = ResourceUtil.getStr(C1291R.string.detail_tab_content_tag_recommend);
    public static final String CONTENT_TAG_SCREENRATIO = ResourceUtil.getStr(C1291R.string.detail_tab_content_tag_screen_ratio);
    public static final String CONTENT_TAG_SKIPHEADER = ResourceUtil.getStr(C1291R.string.detail_tab_content_tag_skip_header);
    public static final String CONTENT_TITLE_2DTO3D = ResourceUtil.getStr(C1291R.string.menupanel_2dto3d_title);
    public static final String CONTENT_TITLE_BITSTREAM = ResourceUtil.getStr(C1291R.string.version_id);
    public static final String CONTENT_TITLE_EPISODE = ResourceUtil.getStr(C1291R.string.detail_tab_content_title_episodelist);
    public static final String CONTENT_TITLE_EPISODE_FOR_PLAYER = ResourceUtil.getStr(C1291R.string.selection_panel_title);
    public static final String CONTENT_TITLE_PERIPHERAL = ResourceUtil.getStr(C1291R.string.detail_tab_content_title_peripheral);
    public static final String CONTENT_TITLE_PROGRAMS = ResourceUtil.getStr(C1291R.string.detail_tab_content_title_programlist);
    public static final String CONTENT_TITLE_RECOMMEND = ResourceUtil.getStr(C1291R.string.detail_tab_content_title_recommend);
    public static final String CONTENT_TITLE_RECOMMEND_MENUPANEL = ResourceUtil.getStr(C1291R.string.detail_tab_content_title_recommend_menupanel);
    public static final String CONTENT_TITLE_RELATED = ResourceUtil.getStr(C1291R.string.detail_tab_content_title_related);
    public static final String CONTENT_TITLE_SCREENRATIO = ResourceUtil.getStr(C1291R.string.screen_scale);
    public static final String CONTENT_TITLE_SKIPHEADERTAILER = ResourceUtil.getStr(C1291R.string.jump_head_tail);
    public static final String CONTENT_TITLE_STARLIST = ResourceUtil.getStr(C1291R.string.detail_tab_content_title_starlist);
    public static final String CONTENT_TITLE_SUPERALBUM = ResourceUtil.getStr(C1291R.string.detail_tab_content_title_superalbum);
    public static final String CONTENT_TITLE_TRAILERS = ResourceUtil.getStr(C1291R.string.detail_tab_content_title_trailers);
