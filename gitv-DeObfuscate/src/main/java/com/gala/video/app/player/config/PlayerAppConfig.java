...
public class PlayerAppConfig {
    ...
    public static int getDefaultStreamType() {
        ...
        LogUtils.m1568d(TAG, "getDefaultStreamType=" + defaultStreamType);
        return defaultStreamType;
    }

    public static void setDefaultStreamType(int streamType) {
        LogUtils.m1568d(TAG, "setDefaultStreamType=" + streamType);
    ...
    public static void setIsOpenHDR(boolean isOpen) {
        LogUtils.m1568d(TAG, "setIsOpenHDR=" + isOpen);
    ...
    public static void setAudioTypeSetting(int audioType) {
        LogUtils.m1568d(TAG, "setAudioTypeSetting=" + audioType);
    ...
    public static int getAudioTypeSetting() {
        ...
        LogUtils.m1568d(TAG, "getAudioTypeSetting=" + typeSetting);
        return typeSetting;
    }
    ...
    public static boolean getStretchPlaybackToFullScreen() {
        ...
        LogUtils.m1568d(TAG, "getStretchPlaybackToFullScreen=" + isStretchPlaybackToFullScreen);
    ...
    public static boolean isSelectionPanelShown() {
        ...
        LogUtils.m1568d(TAG, "isSelectionPanelShown=" + shown);
        return shown;
    }
    ...
    public static int getMediaPlayerLayoutId() {
        return C1291R.layout.player_layout_control;
    }

    public static int getLiveMediaPlayerLayoutId() {
        return C1291R.layout.player_layout_control_live;
    }

    public static int getSeekBarLayoutId() {
        if (Project.getInstance().getBuild().isLitchi()) {
            return C1291R.layout.player_layout_playseekbar;
        }
        return C1291R.layout.player_layout_playseekbar;
    }
    ...
    public static int getBufferViewLayoutId() {
        return C1291R.layout.player_progressbar_center;
    }
    ...
    public static int get3dFullScreenHintBgResId() {
        return C1291R.drawable.player_bg_fullscreen_hint_3d;
    }

    public static int getPlayerControlLayerTipTextColor(boolean isLive) {
        if (isLive) {
            return AppRuntimeEnv.get().getApplicationContext().getResources().getColor(C1291R.color.live_tip_color);
        }
        return AppRuntimeEnv.get().getApplicationContext().getResources().getColor(C1291R.color.video_name_color);
    }

    public static int getPlayerControlLayerTipTextSizePx(boolean isLive) {
        if (isLive) {
            return AppRuntimeEnv.get().getApplicationContext().getResources().getDimensionPixelSize(C1291R.dimen.dimen_23dp);
        }
        return AppRuntimeEnv.get().getApplicationContext().getResources().getDimensionPixelSize(C1291R.dimen.dimen_27dp);
    }

    public static int getAlbumDetailLayoutId() {
        return C1291R.layout.player_activity_album_detail_common;
    }
    ...
    public static int getNewsDetailLayoutId() {
        return C1291R.layout.player_activity_album_detail_news;
    }
