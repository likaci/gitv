...
public class SearchT9Fragment extends SearchBaseFragment {
    private IKeyboardListener mKeyboardListener = new C10182();
    private View mMainView;
    private OnT9FocusListener mT9FocusListener = new C10171();
    private T9Keyboard mT9Keyboard;

    class C10171 implements OnT9FocusListener {
        C10171() {
        }
    ...
    class C10182 implements IKeyboardListener {
        C10182() {
        }

        public void onTextChange(String text) {
            LogUtils.m1574i("T9", ">>>>>text ------" + text);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.mMainView = inflater.inflate(C0508R.layout.epg_fragment_t9_keyboard, null);
        init();
        return this.mMainView;
    }

    private void init() {
        this.mT9Keyboard = (T9Keyboard) this.mMainView.findViewById(C0508R.id.epg_keyboard_t9);
        initKeyboard();
    }

    private void initKeyboard() {
        this.mT9Keyboard.setKeyPanelParams(getDimen(C0508R.dimen.dimen_86dp), getDimen(C0508R.dimen.dimen_83dp), getDimen(C0508R.dimen.dimen_28dp), getDimen(C0508R.dimen.dimen_46dp));
        this.mT9Keyboard.setLayerParams(getDimen(C0508R.dimen.dimen_53dp), getDimen(C0508R.dimen.dimen_53dp));
    ...
    private void sendClickPingback() {
        ...
        params.add(Keys.f2035T, "20").add("rseat", "t9keyboard").add("rpage", "srch_keyboard").add("block", "t9keyboard").add("rt", "i");
