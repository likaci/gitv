...
public class CardView extends CloudView implements ICard {
    ...
    private void prepareResValues() {
        ...
        this.TITLE_MARGIN_BOTTOM_LINE_1 = getDimenSize(C0508R.dimen.dimen_175dp);
        this.TITLE_MARGIN_BOTTOM_LINE_2 = getDimenSize(C0508R.dimen.dimen_164dp);
        this.DESC_CHANGE1_MARGIN_BOTTOM_TITLE1_LINES1 = getDimenSize(C0508R.dimen.dimen_102dp);
        this.DESC_CHANGE1_MARGIN_BOTTOM_TITLE1_LINES2 = getDimenSize(C0508R.dimen.dimen_79dp);
        this.RIGHT_DESC_TEXT_VIEW_SIZE_19 = getDimenSize(C0508R.dimen.dimen_20dp);
        this.RIGHT_DESC_TEXT_VIEW_SIZE_18 = getDimenSize(C0508R.dimen.dimen_20dp);
        this.DIVIDE_LINE_DRAWABLE = getDrawable(C0508R.drawable.epg_card_divide_line);
        this.XIN_DRAWABLE = getDrawable(C0508R.drawable.epg_corner_xin);
        this.SIGN_YU_GAO_DRAWABLE = getDrawable(C0508R.drawable.epg_corner_yugao);
        this.SIGN_ZHUAN_TI_DRAWABLE = getDrawable(C0508R.drawable.epg_corner_card_zhuanti);
        this.SIGN_MING_XI_DRAWABLE = getDrawable(C0508R.drawable.epg_corner_mingxing);
        this.LINE_1_BG_DRAWABLE = getDrawable(C0508R.drawable.epg_card_desc_bg);
        this.DU_JIA_DRAWABLE = getDrawable(C0508R.drawable.share_corner_dujia);
        this.GALA_GREEN = new ColorDrawable(ResourceUtil.getColor(C0508R.color.gala_green));
    }
    ...
    public void setTextData(IData info) {
        if (this.mCard == null) {
            LogUtils.m1573e(LOG_TAG, "setTextData mCard == null, mViewType = ", Integer.valueOf(this.mViewType));
            return;
        }
    ...
    public void setImageData(IData info) {
        if (this.mCard == null) {
            LogUtils.m1573e(LOG_TAG, "setImageData mCard == null, mViewType = ", Integer.valueOf(this.mViewType));
            return;
        }
    ...
    public void setViewType(int type) {
        ...
        if (this.mCard == null) {
            LogUtils.m1573e(LOG_TAG, "setViewType mCard == null, mViewType = ", Integer.valueOf(this.mViewType));
        } else {
            this.mCard.releaseData();
        }
    }
