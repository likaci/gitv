...
public class SoloTabManage {
    ...
    class C10772 implements StateCallback {
        C10772() {
        }
        ...
        public void getStateResult(int state) {
            ...
            if (!networkAvaliable) {
                QToast.makeTextAndShow(ResourceUtil.getContext(), C0508R.string.result_no_net, (int) QToast.LENGTH_4000);
            }
        }
    }
    ...
    private void initEngine() {
        this.mBlocksView = (BlocksView) this.mRootView.findViewById(C0508R.id.epg_solo_tab_blockview);
        this.mBlocksView.setPadding(0, ResourceUtil.getPx(43), 0, ResourceUtil.getPx(30));
        this.mCardFocusHelper = new CardFocusHelper(this.mRootView.findViewById(C0508R.id.epg_solo_tab_card_focus));
        ...
        switch (event.eventType) {
            case 32:
                ...
                if (ListUtils.isEmpty(event.cardList)) {
                    ...
                    NetWorkManager.getInstance().checkNetWork(new C10772());
                    return;
                }
