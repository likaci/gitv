...
public class HookAppLoad {
    protected static final int f1960M = 23;
            ...
            if (sPathListField != null) {
                ...
                if (pathList != null) {
                    ...
                    try {
                        ...
                        LogUtils.m1572e(HookAppLoad.TAG, "V14_22 expand native library directories exception =", e);
                    }
                }
            }
        }
        ...
        public static boolean isExistInNativeLibrary(ClassLoader classLoader) {
            ...
            if (pathList != null) {
                try {
                    ...
                    LogUtils.m1575i(HookAppLoad.TAG, "isExistInNativeLibrary", e);
                    return true;
                }
            }
            if (nativeLib == null || nativeLib.length <= 0) {
                ...
                for (Object path : nativeLib) {
                    ...
                    LogUtils.m1574i(HookAppLoad.TAG, "apkNativePath=" + existPath);
            ...
            if (sPathListField != null) {
                ...
                if (pathList != null) {
                    ...
                    try {
                        ...
                        LogUtils.m1572e(HookAppLoad.TAG, "V23_ expand native library directories exception =", e);
                    }
                }
            }
        }
    ...
    public static void expandNativeLibrary(ClassLoader classLoader, ApplicationInfo ai) {
        ...
        try {
            ...
            LogUtils.m1575i(TAG, "expandNativeLibrary", e);
        }
    }
    ...
    private static Field getDeclaredField(Class cls, String fieldName) {
        try {
            ...
            LogUtils.m1572e(TAG, "no such field exception = ", e);
            return null;
        }
    }
    ...
    private static <T> T getValue(Field field, Object target) {
        ...
        if (field != null) {
            try {
                ...
                LogUtils.m1572e(TAG, "get value exception = ", e);
            }
        }
        return t;
    }
