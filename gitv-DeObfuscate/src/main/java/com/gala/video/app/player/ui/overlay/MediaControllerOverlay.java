...
public class MediaControllerOverlay extends AbsMediaController {
    ...
    private Handler mHandler = new C14771();
    ...
    protected void onAttachedToWindow() {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "onAttachedToWindow");
        }
    ...
    protected void onDetachedFromWindow() {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "onDetachedFromWindow");
        }
    ...
    public void setSubtitle(String subtitle) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "setSubtitle:" + subtitle);
        }
        if (this.mInitized) {
    ...
    public void setMaxProgress(int maxProgress, int maxSeekableProgress) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "setMaxProgress maxProgress=" + maxProgress + ",maxSeekableProgress=" + maxSeekableProgress);
        }
    ...
    public void setHeadAndTailProgress(int headProgress, int tailProgress) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "setHeadAndTailProgress=" + headProgress + "/" + tailProgress);
        }
    ...
    public void setBufferPercent(int percent) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "setBufferPercent(" + percent + ")");
        }
    ...
    public void setNetSpeed(long bytePerSecond) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "setNetSpeed:" + bytePerSecond);
        }
    ...
    public void showTip(TipWrapper tip) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "showTip:" + tip);
        }
        this.mTip = tip;
        if (this.mInitized) {
    ...
    public void hideTip() {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "hideTip");
        }
        this.mTip = null;
        if (this.mInitized) {
    ...
    public void showPanel(int duration) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "showPanel:" + duration);
        }
    }
    ...
    public void switchScreen(boolean isFullScreen, float zoomRatio) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "switchScreen() isFullScreen = " + isFullScreen);
        }
    ...
    private void switchStrategy(ScreenMode mode) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "switchStrategy" + mode);
        }
    ...
    public void showBottomAndTop(int duration) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "showBottomAndTop(" + duration + ")");
        }
    ...
    public void hideBottomAndTop(int duration) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "hideBottomAndTop(" + duration + ")");
        }
    ...
    public void showVolumePanel(int currentCount) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "showVolumePanel() currentCount " + currentCount);
        }
    ...
    public void hideVolumePanel() {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "hideVolumePanel()");
        }
    ...
    public void showBrightnessPanel(int lightCount) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "showBrightnessPanel() lightCount = " + lightCount);
        }
    ...
    public void hideBrightnessPanel() {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "hideBrightnessPanel()");
        }
    ...
    public void showPlayOverFlow(boolean forward, long distance) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "showPlayOverFlow() forward (" + forward + ",distance " + distance + ")");
        }
    ...
    public void hidePlayOverFlow(boolean forward, long distance) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "hidePlayOverFlow() forward (" + forward + ",distance " + distance + ")");
        }
    ...
    public boolean showSeekBar() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(this.TAG, "showSeekBar() (" + isShow + ")");
        }
        return isShow;
    }
