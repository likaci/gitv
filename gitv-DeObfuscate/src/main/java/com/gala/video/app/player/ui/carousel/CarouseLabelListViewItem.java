...
public class CarouseLabelListViewItem extends RelativeLayout {
    ...
    private void initViews() {
        ...
        this.mLabel.setTextSize(0, (float) this.mContext.getResources().getDimensionPixelSize(C1291R.dimen.dimen_30dp));
        LayoutParams params = new LayoutParams(-2, -2);
        params.leftMargin = this.mContext.getResources().getDimensionPixelSize(C1291R.dimen.dimen_27dp);
        params.addRule(15);
        addView(this.mLabel, params);
        this.mLabel.setMaxWidth(this.mContext.getResources().getDimensionPixelSize(C1291R.dimen.dimen_120dp));
        this.mLabel.setEllipsize(TruncateAt.END);
        this.mLabel.setSingleLine(true);
        this.mLabel.setIncludeFontPadding(false);
        this.mLabel.setTextColor(this.mContext.getResources().getColor(C1291R.color.player_ui_text_color_default));
    ...
    public void setSelectedColor() {
        if (this.mLabel != null) {
            this.mLabel.setTextColor(this.mContext.getResources().getColor(C1291R.color.player_ui_carousel_item_channel_selected));
            setBackgroundResource(C1291R.drawable.player_carousel_label_spread);
        }
    }
}
