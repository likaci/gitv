            ...
            this.mSetting = new ISetting() {
                public void setScreenSaverTime(String time) {
                    if (LogUtils.mIsDebug) {
                        LogUtils.m1568d(ConfigSkyworthBase.TAG, "setScreenSaverTime:" + time);
                    }
                ...
                public void setOutputDisplay(String output) {
                    if (LogUtils.mIsDebug) {
                        LogUtils.m1568d(ConfigSkyworthBase.TAG, "setOutputDisplay:" + output);
                    }
                ...
                public void setDreamTime(String time) {
                    if (LogUtils.mIsDebug) {
                        LogUtils.m1568d(ConfigSkyworthBase.TAG, "setDreamTime:" + time);
                    }
                ...
                public void setDRCMode(String mode) {
                    if (LogUtils.mIsDebug) {
                        LogUtils.m1568d(ConfigSkyworthBase.TAG, "setDRCMode:" + mode);
                    }
                ...
                public void setAudioOutputMode(String mode) {
                    if (LogUtils.mIsDebug) {
                        LogUtils.m1568d(ConfigSkyworthBase.TAG, "setAudioOutputMode:" + mode);
                    }
