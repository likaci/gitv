...
public class CommonScrollAdapter extends Adapter<DetailViewHolder> {
    ...
    class C15191 implements IImageCallback {
        C15191() {
        }
        ...
        public void onSuccess(ImageRequest imageRequest, Bitmap bitmap) {
            if (bitmap != null) {
                ...
                LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "loadBitmap >> onSuccess-------  netBitmap = null !! ");
            }
        }

        public void onFailure(ImageRequest imageRequest, Exception exception) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "loadBitmap >> onFailure ------- !! ");
            }
            Object cookie = imageRequest.getCookie();
            if (!CommonScrollAdapter.this.mCanceledTask && cookie != null) {
    ...
    public void updateDataSet(List<VideoData> datas) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", ">> updateDataSet, datas.size=" + datas.size());
        }
    ...
    public void changeDataSet(List<VideoData> datas) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", ">> changeDataSet, datas.size=" + datas.size());
        }
        this.mDataList.clear();
        this.mDataList.addAll(datas);
    ...
    private AlbumView createAlbumView() {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", ">> createAlbumView");
        }
    ...
    private boolean needRefreshAlbumView(VideoData newData, VideoData oldData) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "<< needRefreshAlbumView, ret=" + ret);
        }
        return ret;
    }
    ...
    private void setAlbumViewContent(int position, AlbumView albumView) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "setAlbumViewContent(" + position + ")");
        }
        if (ListUtils.isEmpty(this.mDataList) || position >= getCount()) {
            LogUtils.m1572e("Player/ui/detail/CommonScrollAdapter", "setAlbumViewContent(" + position + ") invalid position!", new Throwable());
            return;
        }
    ...
    private void setSpecialViewContent(View view) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", ">> setSpecialViewContent, view=" + view);
        }
    }
    ...
    private void updatePlaying(AlbumView albumView) {
        if (albumView != null) {
            ...
            if (info != null) {
                ...
                albumView.setDescLine1Left(getBottomString(albumView, true));
                if (LogUtils.mIsDebug) {
                    LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "updatePlaying() mIsPort=" + this.mIsPort + ", data=" + info + ", playing=" + playing + ", view=" + albumView);
                }
            } else if (LogUtils.mIsDebug) {
                LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "updatePlaying，info is null.");
            }
        } else if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "updatePlaying，albumView is null.");
        }
    }
    ...
    private void updateImage(AlbumView albumView) {
        ...
        if (data == null) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "updateImage, data is null, reset to default.");
            }
        ...
        if (StringUtils.isEmpty(imageUrl)) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "updateImage, url is null, reset to default.");
            }
            showDefaultBitmap(albumView);
            return;
        }
    ...
    private void setCorner(AlbumView albumView) {
        ...
        if (data != null) {
            ...
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "updateImage, data is null.");
        }
    }
    ...
    private void loadBitmap(View convertView, String imageUrl) {
        ...
        if (convertView == null) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "loadBitmap( return convertView == null !! imageUrl = " + imageUrl);
            }
        } else if (StringUtils.isEmpty((CharSequence) imageUrl)) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "loadBitmap( return imageUrl has null = " + imageUrl);
            }
            ...
            if (LogUtils.mIsDebug) {
                ...
                LogUtils.m1568d(str, append.append(z).append(",end ").append(this.mDirectLoad).toString());
            }
            if (!this.mCanceledTask && (isShowingDefault(convertView) || this.mDirectLoad)) {
                if (LogUtils.mIsDebug) {
                    LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "loadBitmap( imageUrl = " + imageUrl);
                }
                this.mImageProvider.loadImage(getImageRequest(new ImageRequest(imageUrl, convertView)), new C15191());
            } else if (LogUtils.mIsDebug) {
                LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "loadBitmap( return " + imageUrl);
            }
        }
    }
    ...
    private String getBottomString(AlbumView albumView, boolean isLeft) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", ">> updateLeftAndRightDesc video = " + info.getData());
        }
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", video.getAlbumName() + ">> SourceType == " + type + "mIsOtherType" + this.mIsOtherType + "VideoKind" + videoKind + "mIsPort" + this.mIsPort + "isFlower" + video.isFlower());
        }
        ...
        switch (videoKind) {
            ...
            case VIDEO_SOURCE:
                if (type == SourceType.BO_DAN) {
                    ...
                    if (LogUtils.mIsDebug) {
                        LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "albumView video " + video + ", playing " + albumView.isPlaying());
                    }
                    if (!isLeft) {
                        return info.getText(7);
                    }
    ...
    private String getOnlineTime(IVideo video) {
        if (video == null) {
            LogUtils.m1571e("Player/ui/detail/CommonScrollAdapter", "getOnlineTime: video is null!");
            return "";
        }
        ...
        LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "getOnlineTime() time" + time);
        return time;
    }

    private String formateIssueTime(String textdate) {
        SpannableStringBuilder ssb = new SpannableStringBuilder();
        ssb.append(this.mContext.getString(C1291R.string.horizontal_date_di));
        ssb.append(ResourceUtil.getStr(C1291R.string.horizontal_date_qi, textdate));
        return ssb.toString();
    }
        ...
        this.mHandler.post(new Runnable() {
            public void run() {
                if (convertView != null && (convertView instanceof AlbumView)) {
                    ...
                    LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "showDefaultBitmap---convertView is null");
                }
            }
        });
    }
    ...
    private boolean isShowingDefault(View convertView) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "isShowingDefault--wrong-convertView =" + convertView);
        }
        return true;
    }
    ...
    private void setAlbumDisplayData(String url, final Bitmap netBitmap, Object cookie) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "setAlbumDisplayData url " + url + ", netBitmap " + ", cookie " + cookie);
        }
        if (albumView != null) {
            ...
            if (url == null || url.equals(rightUrl)) {
                ...
                LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "--return---current.url=" + url + "---right.url=" + rightUrl);
            }
        }
    }
    ...
    private void updateBottomName(AlbumView albumView) {
        if (albumView != null) {
            ...
            if (info != null) {
                if (LogUtils.mIsDebug) {
                    LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", ">> updateBottomName( video = " + info.getData());
                }
                String name = info.getText(3);
                if (LogUtils.mIsDebug) {
                    LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", ">> updateBottomName( name = " + name + ")");
                }
    ...
    public void onBindViewHolder(DetailViewHolder detailViewHolder, int i) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", ">> onBindViewHolder, positioin=" + i);
        }
    ...
    public void onCancelAllTasks() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "onCancelAllTasks");
        }
    ...
    public void onReloadTasks(List<View> list) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "onReloadTasks");
        }
        reloadBitmap(list);
    }

    private void reloadBitmap(List<View> list) {
        LogUtils.m1571e("Player/ui/detail/CommonScrollAdapter", "reloadBitmap " + list);
        for (View view : list) {
    ...
    public int getItemViewType(int position) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "<< getItemViewType, position=" + position + ", ret=" + ret);
        }
        return ret;
    }
    ...
    private void setItemParams(View view) {
        int itemWidth;
        int itemHeight;
        Rect bgRect = UiHelper.getBgDrawablePaddings(ResourceUtil.getDrawable(C1291R.drawable.player_item_rect_bg));
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", ">> setItemParams, bgRect(top=" + bgRect.top + ", bottom=" + bgRect.bottom + ", left=" + bgRect.left + ", right=" + bgRect.right + ")");
        }
        LayoutParams LP = view.getLayoutParams();
        int imageWidth;
        int imageHeight;
        if (view instanceof AlbumView) {
            int titleHeight = ResourceUtil.getDimen(C1291R.dimen.dimen_53dp);
            if (this.mAlbumViewType == AlbumViewType.DETAIL_VERTICAL) {
                imageWidth = ResourceUtil.getDimen(C1291R.dimen.dimen_160dp);
                imageHeight = ResourceUtil.getDimen(C1291R.dimen.dimen_221dp);
            } else if (this.mAlbumViewType == AlbumViewType.DETAIL_HORIZONAL) {
                imageWidth = ResourceUtil.getDimen(C1291R.dimen.dimen_248dp);
                imageHeight = ResourceUtil.getDimen(C1291R.dimen.dimen_139dp);
            } else if (this.mAlbumViewType == AlbumViewType.PLAYER_HORIZONAL) {
                imageWidth = ResourceUtil.getDimen(C1291R.dimen.dimen_218dp);
                imageHeight = ResourceUtil.getDimen(C1291R.dimen.dimen_123dp);
            } else if (this.mAlbumViewType == AlbumViewType.EXITDIALOG_VERTICAL) {
                imageWidth = ResourceUtil.getDimen(C1291R.dimen.dimen_160dp);
                imageHeight = ResourceUtil.getDimen(C1291R.dimen.dimen_221dp);
            } else {
                imageWidth = ResourceUtil.getDimen(C1291R.dimen.dimen_0dp);
                imageHeight = ResourceUtil.getDimen(C1291R.dimen.dimen_0dp);
            }
            ...
            if (this.mAlbumViewType == AlbumViewType.EXITDIALOG_VERTICAL) {
                imageWidth = ResourceUtil.getDimen(C1291R.dimen.dimen_160dp);
                imageHeight = ResourceUtil.getDimen(C1291R.dimen.dimen_261dp);
            } else {
                imageWidth = ResourceUtil.getDimen(C1291R.dimen.dimen_155dp);
                imageHeight = ResourceUtil.getDimen(C1291R.dimen.dimen_253dp);
            }
            itemWidth = (bgRect.right + imageWidth) + bgRect.left;
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d("Player/ui/detail/CommonScrollAdapter", "<< setItemParams, itemWidth=" + itemWidth + ", itemHeight=" + itemHeight + ", mAlbumViewType=" + this.mAlbumViewType);
        }
    }
}
