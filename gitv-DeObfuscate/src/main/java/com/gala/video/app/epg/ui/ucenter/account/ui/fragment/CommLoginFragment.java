...
public class CommLoginFragment extends BaseLoginFragment implements OnClickListener, OnFocusChangeListener, IBaseLoginView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.mMainView = inflater.inflate(C0508R.layout.epg_fragment_comm_login, null);
        findViewById();
        initCommUIData();
        initFocusForward();
        registerListener();
    ...
    private void initCommUIData() {
        ((TextView) this.mChangeTabView.findViewById(C0508R.id.epg_text_change_tab)).setText(getStr(C0508R.string.RegisterTip));
        ...
        this.mAccountCursor.setHint(getStr(C0508R.string.InputAccountHint1));
    ...
    private void findViewById() {
        this.mChangeTabView = this.mMainView.findViewById(C0508R.id.epg_view_change_tab);
        this.mAccountView = this.mMainView.findViewById(C0508R.id.epg_input_username);
        this.mPasswordView = this.mMainView.findViewById(C0508R.id.epg_input_password);
        this.mVerifyView = this.mMainView.findViewById(C0508R.id.epg_input_verification_code);
        this.mAccountErrorView = this.mMainView.findViewById(C0508R.id.epg_error_account);
        this.mPasswordErrorView = this.mMainView.findViewById(C0508R.id.epg_error_password);
        this.mVerifyErrorView = this.mMainView.findViewById(C0508R.id.epg_error_verifycode);
        this.mLoginButton = (Button) this.mMainView.findViewById(C0508R.id.epg_btn_login);
        this.mVerifyImage = (ImageView) this.mMainView.findViewById(C0508R.id.epg_image_verify);
        this.mGALAKeyboard = (GALAKeyboard) this.mMainView.findViewById(C0508R.id.epg_keyboard_comm_login);
        ...
        this.mProgressBar = (ProgressBarNewItem) this.mMainView.findViewById(C0508R.id.epg_verify_pro_login);
    }
    ...
    public void onClick(View v) {
        if (this.mLoginEvent != null && this.mLoginPresenter != null) {
            int vId = v.getId();
            if (vId == C0508R.id.epg_view_change_tab) {
                setBack(false);
                this.mLoginEvent.onSwitchFragment(new CommRegisterFragment(), getArguments());
            } else if (vId == C0508R.id.epg_input_username) {
                this.mLoginPresenter.switchInputAccount();
            } else if (vId == C0508R.id.epg_input_password) {
                this.mLoginPresenter.switchInputPassword();
            } else if (vId == C0508R.id.epg_input_verification_code) {
                this.mLoginPresenter.switchInputVerifyCode();
            } else if (vId == C0508R.id.epg_btn_login) {
                this.mLoginPresenter.callLoginRequest();
            } else if (vId == C0508R.id.epg_image_verify) {
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        int vid = v.getId();
        if (vid == C0508R.id.epg_input_username || vid == C0508R.id.epg_input_password || vid == C0508R.id.epg_input_verification_code || vid == C0508R.id.epg_image_verify || vid == C0508R.id.epg_btn_login || vid == C0508R.id.epg_view_change_tab) {
            if (vid == C0508R.id.epg_input_username || vid == C0508R.id.epg_input_password || vid == C0508R.id.epg_input_verification_code) {
    ...
    private void viewBringToFront(View v, int vid) {
        if (vid == C0508R.id.epg_input_verification_code || vid == C0508R.id.epg_image_verify) {
            v.bringToFront();
        }
    }
