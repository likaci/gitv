...
public class AlbumActivity extends QMultiScreenActivity implements IAlbumBaseEvent {
    ...
    onFocusChangedListener mAlbumTopChangedListener = new C08006();
    ...
    private IMessageNotification mMessageNotification = new C08017();
    private GlobalQRFeedbackPanel mNoResultPanel;
    private String mPageType;
    private ProgressBarItem mProgressBar;
    private Runnable mProgressBarRunable = new C07951();
    ...
    private String mTopMenuDescExpandString = ("<font color= '#" + ResourceUtil.getColorLength6(C0508R.color.albumview_menu_color) + "'>按</font><font color='#" + ResourceUtil.getColorLength6(C0508R.color.albumview_yellow_color) + "'>" + ResourceUtil.getStr(C0508R.string.alter_menukey_text) + "</font><font color= '#" + ResourceUtil.getColorLength6(C0508R.color.albumview_menu_color) + "'>");
    ...
    class C07962 implements OnFocusChangeListener {
        C07962() {
        }
    ...
    class C07984 implements OnClickListener {
        C07984() {
        }
    ...
    class C07995 implements MultiMenuPanelListenter {
        C07995() {
        }
    ...
    class C08006 implements onFocusChangedListener {
        C08006() {
        }
    ...
    class C08017 implements IMessageNotification {
        C08017() {
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0508R.layout.epg_q_album_activity);
        initIntentModel();
        initTopView();
        initData();
    }
    ...
    private void trimActivityMemory() {
        ...
        LogUtils.m1568d(LOG_TAG, "model：" + model);
        LogUtils.m1568d(LOG_TAG, "isLoaderWEBActivity：" + isLoaderWEBActivity);
    ...
    public void replaceFragment(AlbumBaseFragment fragment) {
        ...
        if (fragment != null && !isFinishing()) {
            ...
            if (locationType == AlbumFragmentLocation.LEFT) {
                ...
                transaction.replace(C0508R.id.epg_q_album_left_panel, this.mCurLeftFragment);
                ...
                transaction.replace(C0508R.id.epg_q_album_right_panel, this.mCurRightFragment);
            }
    ...
    public void addFragment(AlbumBaseFragment f) {
        ...
        if (f != null && !isFinishing()) {
            ...
            if (locationType == AlbumFragmentLocation.LEFT) {
                ...
                transaction.add(C0508R.id.epg_q_album_left_panel, this.mCurLeftFragment);
            } else if (locationType == AlbumFragmentLocation.RIGHT) {
                ...
                this.mRightFragmentCacheList.add(this.mCurRightFragment);
                transaction.add(C0508R.id.epg_q_album_right_panel, this.mCurRightFragment);
            }
            transaction.commitAllowingStateLoss();
        } else if (f != null) {
            if (!NOLOG) {
    ...
    private TextView getChannelNameTxt() {
        if (this.mChannelNameTxt == null) {
            this.mChannelNameTxt = (TextView) getTopLayout().findViewById(C0508R.id.epg_q_album_channel_name_txt);
        }
    ...
    private FrameLayout getRightLayout() {
        if (this.mRightLayout == null) {
            this.mRightLayout = (FrameLayout) findViewById(C0508R.id.epg_q_album_right_panel);
        }
    ...
    private FrameLayout getLeftLayout() {
        if (this.mLeftLayout == null && !this.mInfoModel.isNoLeftFragment()) {
            this.mLeftLayout = (FrameLayout) findViewById(C0508R.id.epg_q_album_left_panel);
        }
    ...
    private RelativeLayout getMainLayout() {
        if (this.mMainLayout == null) {
            this.mMainLayout = (RelativeLayout) findViewById(C0508R.id.epg_q_album_main_panel);
        }
    ...
    private RelativeLayout getStatusLayout() {
        if (this.mStatusLayout == null) {
            this.mStatusLayout = (RelativeLayout) ((ViewStub) findViewById(C0508R.id.epg_q_album_right_status_layout)).inflate();
            this.mStatusLayout.setOnFocusChangeListener(new C07962());
        }
    ...
    private ProgressBarItem getProgressBar() {
        if (this.mProgressBar == null) {
            this.mProgressBar = (ProgressBarItem) findViewById(C0508R.id.epg_q_album_right_data_progress);
            this.mProgressBar.setText(getString(C0508R.string.album_list_loading));
        }
    ...
    public GlobalQRFeedbackPanel getNoResultPanel() {
        if (this.mNoResultPanel == null) {
            getStatusLayout();
            this.mNoResultPanel = (GlobalQRFeedbackPanel) findViewById(C0508R.id.epg_q_album_right_data_no_result_panel);
    ...
    private RelativeLayout getTopLayout() {
        if (this.mTopLayout == null) {
            this.mTopLayout = (RelativeLayout) findViewById(C0508R.id.epg_q_album_top_panel);
        }
    ...
    private ImageView getTagDesLine() {
        if (this.mTagDesLine == null) {
            this.mTagDesLine = (ImageView) getTopLayout().findViewById(C0508R.id.epg_q_album_tag_cutting_line);
        }
    ...
    private TextView getMenuDesTxt() {
        if (this.mMenuDesTxt == null) {
            this.mMenuDesTxt = (TextView) findViewById(C0508R.id.epg_q_album_menu_des);
            this.mMenuDesTxt.setOnClickListener(new C07984());
        }
        ...
        if (this.mMenuView != null && getMainLayout() != null) {
            if (!this.mInfoModel.isNoLeftFragment() || !(this.mMenuView instanceof MultiMenuPanel)) {
                ...
                if (this.mMenuView instanceof MultiMenuPanel) {
                    ...
                    panel.setMeltiMenuPanelListener(new C07995());
