...
public class OpenHistoryCommand extends ServerCommand<Intent> {
    public OpenHistoryCommand(Context context) {
        super(context, 10001, 20001, 30000);
    }

    public Bundle onProcess(Bundle params) {
        AlbumUtils.startPlayhistoryActivityOpenApi(getContext(), ServerParamsHelper.parseIntentFlag(params));
