...
public class UpdateManager extends Wrapper {
    ...
    private OnClickListener mCancelDownLoadListener = new C05199();
    private Context mContext = null;
    private DialogType mCurrentDlgType = DialogType.NONE;
    private int mDlgShowingDownloadFailTimes = 0;
    ApkDownloadListener mDownloadListener = new C05177();
    ...
    private OnClickListener mExitBtnListener = new C05188();
    private Handler mHandler = new Handler(Looper.getMainLooper(), new C05101());
    ...
    class C05101 implements Callback {
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                case 100:
                    LogUtils.m1568d(InterfaceKey.EPG_UM, "handleMessage()---RESTART_DOWNLOAD");
                ...
                case 101:
                    ...
                    return true;
                case 102:
                    LogUtils.m1568d(InterfaceKey.EPG_UM, "handleMessage()---ON_ERROR");
                    UpdateManager.this.errorProc(msg.arg1);
                    return true;
                case 103:
                    LogUtils.m1568d(InterfaceKey.EPG_UM, "handleMessage()---ON_FINISHED");
                    UpdateManager.this.downloadCompleteProc();
                    return true;
                case 104:
                    LogUtils.m1568d(InterfaceKey.EPG_UM, "handleMessage()---ON_CANCELED");
                    UpdateManager.this.dismissAlertDialog();
                    return true;
                default:
                    LogUtils.m1568d(InterfaceKey.EPG_UM, "handleMessage()---default");
                    return false;
            }
        }
    }

    class C05133 implements BackPressedListener {
        C05133() {
        }
    ...
    class C05144 implements BackPressedListener {
        C05144() {
        }
    ...
    class C05155 implements BackPressedListener {
        C05155() {
        }
    ...
    class C05177 implements ApkDownloadListener {
        C05177() {
        }
        ...
        public void onError(int errCode) {
            LogUtils.m1571e(InterfaceKey.EPG_UM, "onError()--errCode=" + errCode);
        ...
        public void onExist() {
            LogUtils.m1568d(InterfaceKey.EPG_UM, "onExist()");
        ...
        public void onClick(View view) {
            try {
                ...
                if (UpdateManager.this.mDownloaded) {
                    LogUtils.m1568d(InterfaceKey.EPG_UM, "UpdateButtonListener.onClick()---start install");
                    UpdateManager.this.dismissAlertDialog();
                    if (!UpdateManager.this.startInstall(this.mContext, false)) {
                        LogUtils.m1568d(InterfaceKey.EPG_UM, "UpdateButtonListener.onClick()---install fail, restart download");
    ...
    public void setLimitNotifyCount(boolean limit) {
        LogUtils.m1568d(InterfaceKey.EPG_UM, "limit show dialog count = " + limit);
    ...
    public void showExitUpdateDialog(Context context, UpdateOperation operation) {
        LogUtils.m1568d(InterfaceKey.EPG_UM, "showExitUpdateDialog()");
        if (operation == null) {
            throw new IllegalArgumentException("showExitUpdateDialog  operation must be not null !");
        }
        this.mOperation = operation;
        if (context == null) {
            LogUtils.m1571e(InterfaceKey.EPG_UM, "showExitUpdateDialog()-----context is null");
            return;
        }
        this.mContext = context;
    ...
    public void showDialogAndStartDownload(Context context, boolean isManual, UpdateOperation operation) {
        LogUtils.m1568d(InterfaceKey.EPG_UM, "showDialogAndStartDownload()");
        if (operation == null) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1574i(InterfaceKey.EPG_UM, "showDialogAndStartDownload()---version = " + this.mVersion);
        }
        if (this.mVersion == null) {
            LogUtils.m1571e(InterfaceKey.EPG_UM, "showDialogAndStartDownload()---version is null");
        } else if (context == null) {
            LogUtils.m1571e(InterfaceKey.EPG_UM, "showDialogAndStartDownload()-----context is null");
        } else {
            this.mContext = context;
            if (!this.mDownloaded) {
    ...
    private void startDownload(Context context) {
        LogUtils.m1568d(InterfaceKey.EPG_UM, "startDownload()");
    ...
    private void showUpdateDialog(final Context context, boolean downloaded) {
        LogUtils.m1568d(InterfaceKey.EPG_UM, "showUpdateDialog()");
    ...
    private void showHomeNormalUpdateDialog(Context context) {
        ...
        LogUtils.m1568d(InterfaceKey.EPG_UM, "showHomeNormalUpdateDialog()--count=" + count + ",limit show count = " + this.mLimitShowCount);
    ...
    private void pingbackPageShow() {
        ...
        params.add(Keys.f2035T, "21").add("bstp", "1").add("qtcurl", "update_dlg").add("block", block);
    ...
    private void pingbackPageClick(ClickType clickType) {
        ...
        PingBackParams params = new PingBackParams();
        params.add(Keys.f2035T, "20").add("rseat", rseat).add("rpage", "update_dlg").add("block", block).add("rt", "i");
        PingBack.getInstance().postPingBackToLongYuan(params.build());
    }

    private void requestShowDialog(Context context, DialogType type) {
        LogUtils.m1568d(InterfaceKey.EPG_UM, "requestShowDialog() type=" + type);
    ...
    private String makeLineBreakManaul(String tip) {
        LogUtils.m1568d(InterfaceKey.EPG_UM, "UpdateManagertip=" + this.mVersion.getTip());
        String characters = "\\n";
    ...
    private String getDialogTitle(Context context, DialogType type) {
        String title = "";
        return context.getString(C0508R.string.update_normal_title) + context.getApplicationInfo().loadLabel(context.getPackageManager()).toString();
    }
    ...
    private void initForceDownloadDialog(Context context) {
        ...
        ((GlobalUpdateDialog) this.mUpgradeAlertDialog).setBackPressedListener(new C05133());
        this.mUpgradeAlertDialog.setParams(getDialogTitle(context, DialogType.FORCE_DOWNLOAD), context.getString(C0508R.string.update_imm), new UpdateButtonListener(context));
    ...
    private boolean checkDispNoRemind(Context context) {
        int count = SystemConfigPreference.getUpdateDialogCount(context);
        LogUtils.m1568d(InterfaceKey.EPG_UM, "checkDispNoRemind()--count=" + count);
    ...
    private void initNormalDownloadDialog(Context context) {
        LogUtils.m1568d(InterfaceKey.EPG_UM, "initNormalDownloadDialog()");
        ...
        this.mUpgradeAlertDialog = new GlobalUpdateDialog(context);
        ((GlobalUpdateDialog) this.mUpgradeAlertDialog).setBackPressedListener(new C05144());
        String okBtnText = context.getString(C0508R.string.update_imm);
        ...
        String cancelText = noRemind ? context.getString(C0508R.string.update_not_notify) : context.getString(C0508R.string.update_next_time);
    ...
    private void initExitRemindDialog(Context context) {
        LogUtils.m1568d(InterfaceKey.EPG_UM, "initExitRemindDialog()");
        this.mUpgradeAlertDialog = new GlobalUpdateDialog(context);
        ((GlobalUpdateDialog) this.mUpgradeAlertDialog).setBackPressedListener(new C05155());
        String okBtnText = context.getString(C0508R.string.update_exit_remind);
        this.mUpgradeAlertDialog.setParams(context.getString(C0508R.string.update_exit_title), context.getString(C0508R.string.update_exit_apk), new C05166(), okBtnText, new UpdateButtonListener(context));
        setUpdateTextInfo(context);
        this.mUpgradeAlertDialog.show();
    }
    ...
    private void updateDialogCount(Context context) {
        if (!this.mIsManual) {
            ...
            LogUtils.m1568d(InterfaceKey.EPG_UM, "updateDialogCount()--count=" + count);
        }
    }
    ...
    private void initDownloadProgressing(Context context) {
        if (isForceUpdate(this.mVersion)) {
            ...
            this.mProgressIndicator.setCancelButtonText(context.getString(C0508R.string.dialog_app_download_back));
            this.mProgressIndicator.setUpdateTextMessage(context.getString(C0508R.string.download_progress_message));
        }
    ...
    private void initUpdateFailDialog(Context context) {
        ...
        this.mUpgradeAlertDialog.setCancelable(false);
        this.mUpgradeAlertDialog.setParams(context.getString(C0508R.string.update_access_error), context.getString(C0508R.string.comfirm), new BaseCancelButtonListener(), null, null);
    }
    ...
    private void initRetryDialog(Context context) {
        ...
        this.mUpgradeAlertDialog.setParams(context.getString(C0508R.string.update_network_error), context.getString(C0508R.string.reupdate), retryListener, context.getString(C0508R.string.Cancel), cancelListener);
    }
    ...
    private void errorProc(int errCode) {
        LogUtils.m1568d(InterfaceKey.EPG_UM, "errorProc()---errCode=" + errCode);
        if (this.mCurrentDlgType == DialogType.NONE) {
            this.mSilentDownloadFailTimes++;
            LogUtils.m1568d(InterfaceKey.EPG_UM, "errorProc()---mSilentDownloadFailTimes=" + this.mSilentDownloadFailTimes);
            ...
            LogUtils.m1568d(InterfaceKey.EPG_UM, "errorProc()---mDlgShowingDownloadFailTimes=" + this.mDlgShowingDownloadFailTimes);
            if (errCode == 4) {
    ...
    public boolean hasUpdate() {
        ...
        LogUtils.m1568d(InterfaceKey.EPG_UM, "hasUpdate()--force update--");
        return true;
    }
