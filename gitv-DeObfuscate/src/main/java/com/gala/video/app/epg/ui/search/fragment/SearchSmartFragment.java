...
public class SearchSmartFragment extends SearchBaseFragment {
    ...
    private OnFocusChangeListener mGridFocusChangeListener = new C10075();
    int mIndex = 0;
    ...
    private OnTouchListener mOnTouchListener = new C10064();
    private PopupWindow mPopupWindow;
    private String mPreChar;
    private int mRelationKeyCount = 9;
    private RelationKeyItemListener mRelationKeyItemListener = new C10053();
    ...
    class C10042 implements OnDismissListener {
        C10042() {
        }

        public void onDismiss() {
            if (SearchSmartFragment.this.mClickItem != null) {
                SearchSmartFragment.this.mClickItem.setBackgroundResource(C0508R.drawable.epg_full_keyboard_bg);
    ...
    class C10053 implements RelationKeyItemListener {
        C10053() {
        }
        ...
        public void onConfirmClick() {
            if (SearchSmartFragment.this.mSearchEvent != null) {
                ...
                params.add(Keys.f2035T, "20").add("rseat", "done").add("rpage", "srch_keyboard").add("block", "smart_suggest").add("rt", "i");
    ...
    class C10064 implements OnTouchListener {
        C10064() {
        }
    ...
    class C10075 implements OnFocusChangeListener {
        C10075() {
        }
        ...
        public void onFocusChange(View v, boolean hasFocus) {
            if (SearchSmartFragment.this.mContext != null) {
                int id = v.getId();
                int colorFocus = SearchSmartFragment.this.mContext.getResources().getColor(C0508R.color.gala_write);
                int colorUnFocus = SearchSmartFragment.this.mContext.getResources().getColor(C0508R.color.keyboard_letter);
                int colorNum = SearchSmartFragment.this.mContext.getResources().getColor(C0508R.color.keyboard_num);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.mMainView = inflater.inflate(C0508R.layout.epg_fragment_expand_keyboard, null);
        this.mRelationKeyCount = 8;
        Log.e("jaunce", "mRelationKeyCount:" + this.mRelationKeyCount);
        initKeyboard();
        if (mIsRequireFocus) {
            ((ExpandRalationItem) this.mKeyBorderMap.get("O")).mKeyItemView.post(new C10031());
        }
        initPopupWindow();
    ...
    private void initPopupWindow() {
        if (this.mContext != null) {
            ...
            this.mKeyItemWidth = (int) this.mContext.getResources().getDimension(C0508R.dimen.dimen_85dp);
            int width = this.mKeyItemWidth * 3;
            this.mPopupWindow = new PopupWindow(this.mCustomGridView, width, width, true);
            this.mPopupWindow.setAnimationStyle(C0508R.style.popwin_anim_style);
            this.mPopupWindow.setTouchable(false);
            this.mPopupWindow.setOutsideTouchable(true);
            this.mPopupWindow.setBackgroundDrawable(getResources().getDrawable(C0508R.drawable.transparent_drawable));
            this.mPopupWindow.setOnDismissListener(new C10042());
        }
    }
    ...
    private void initKeyboard() {
        if (this.mContext != null) {
            ...
            LinearLayout rootLayout = (LinearLayout) this.mMainView.findViewById(C0508R.id.epg_keyboard_container);
            rootLayout.setClipChildren(false);
            rootLayout.setClipToPadding(false);
            int lineHeight = (int) this.mContext.getResources().getDimension(C0508R.dimen.dimen_85dp);
            int itemId = 65;
            for (int i = 0; i < 6; i++) {
                ...
                int dimenH = (int) this.mContext.getResources().getDimension(C0508R.dimen.dimen_13dp);
                llLayoutParams.setMargins(-dimenH, -dimenH, -dimenH, -dimenH);
                rootLayout.addView(rowsLayout, llLayoutParams);
                for (int j = 0; j < 6; j++) {
                    TextView keyItemTextView = (TextView) layoutInflater.inflate(C0508R.layout.epg_expand_keyitem, null);
                    ...
                    keyItemTextView.setBackgroundResource(C0508R.drawable.epg_full_keyboard_bg);
                    if (this.mIndex > 26) {
                        keyItemTextView.setTextColor(this.mContext.getResources().getColor(C0508R.color.keyboard_num));
                    }
                    ...
                    int dimenV = (int) this.mContext.getResources().getDimension(C0508R.dimen.dimen_10dp);
        ...
        if (!TextUtils.isEmpty(curChar) && SearchEnterUtils.checkNetWork(this.mContext) && this.mSearchEvent != null) {
            ...
            if (!TextUtils.isEmpty(this.mRelationkeys)) {
                ...
                if (this.mIsClickLayer && this.mPreChar != null && !curChar.equals(this.mPreChar)) {
                    showPopWindow(v, this.mRelationkeys, (-this.mKeyItemWidth) + ((int) this.mContext.getResources().getDimension(C0508R.dimen.dimen_15dp)), (this.mKeyItemWidth - ((int) this.mContext.getResources().getDimension(C0508R.dimen.dimen_9dp))) * -2);
                } else if (this.mContext != null) {
                    showPopWindow(v, this.mRelationkeys, (-this.mKeyItemWidth) + ((int) this.mContext.getResources().getDimension(C0508R.dimen.dimen_20dp)), (this.mKeyItemWidth - ((int) this.mContext.getResources().getDimension(C0508R.dimen.dimen_10dp))) * -2);
                } else {
                    return;
                }
    ...
    private void sendClickPingback(boolean mIsClickLayer, String curChar, String letterExist) {
        ...
        PingBackParams params = new PingBackParams();
        params.add(Keys.f2035T, "20").add("rseat", curChar).add("rpage", "srch_keyboard").add("block", block).add("rt", "i").add("letter_exist", letterExist);
        PingBack.getInstance().postPingBackToLongYuan(params.build());
    }
