...
public class LiveCornerFactory extends Wrapper {
    ...
    public LiveCornerFactory() {
        ...
        if (HomeDebug.DEBUG_LOG) {
            LogUtils.m1571e(this.TAG, "build factory, init handler");
        }
        this.mHandler = new Handler(Looper.getMainLooper()) {
            public void handleMessage(Message msg) {
                if (HomeDebug.DEBUG_LOG) {
                    LogUtils.m1571e(LiveCornerFactory.this.TAG, "handleMessage," + LiveCornerFactory.this.label.toString());
                }
                if (msg != null && LiveCornerFactory.this.mLiveCornerListener != null) {
                    ...
                    if (HomeDebug.DEBUG_LOG) {
                        LogUtils.m1571e(LiveCornerFactory.this.TAG, "handleMessage, lastType=" + lastType);
                    }
                    if (LivePlayingType.BEFORE.equals(lastType)) {
                        ...
                        if (HomeDebug.DEBUG_LOG) {
                            LogUtils.m1571e(LiveCornerFactory.this.TAG, "handleMessage,sendDelay:" + delayMillis + ",nextLiveModel:" + nextLiveModel);
                        }
    ...
    public void end() {
        if (HomeDebug.DEBUG_LOG) {
            LogUtils.m1571e(this.TAG, "clearStutus," + this.label.toString());
        }
    ...
    public void start(ChannelLabel label, LiveCornerListener liveCornerListener) {
        if (label == null) {
            LogUtils.m1571e(this.TAG, "start label == null");
            return;
        }
        this.label = label;
        if (HomeDebug.DEBUG_LOG) {
            LogUtils.m1571e(this.TAG, "refreshStatus," + label.toString());
        }
        this.mHandler.removeCallbacksAndMessages(null);
        ...
        if (before) {
            ...
            if (HomeDebug.DEBUG_LOG) {
                LogUtils.m1571e(this.TAG, "refreshStatus,before,delay=" + ms + ",liveModel=" + liveModel);
            }
            ...
            if (HomeDebug.DEBUG_LOG) {
                LogUtils.m1571e(this.TAG, "refreshStatus,playing,delay=" + ms + ",liveModel=" + liveModel);
            }
            this.mHandler.sendMessageDelayed(msg, ms);
        } else if (end) {
            if (liveCornerListener != null) {
            ...
            if (HomeDebug.DEBUG_LOG) {
                LogUtils.m1571e(this.TAG, "refreshStatus,end");
            }
        }
    }
}
