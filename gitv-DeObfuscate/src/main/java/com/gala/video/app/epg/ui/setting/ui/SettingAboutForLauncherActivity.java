...
public class SettingAboutForLauncherActivity extends QMultiScreenActivity {
    ...
    class C10521 implements IVrsCallback<ApiResultF4v> {
        C10521() {
        }
        ...
        public void onException(ApiException e) {
            LogUtils.m1571e(SettingAboutForLauncherActivity.TAG, "initCDNIPData()  e" + e);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0508R.layout.epg_fragment_setting_about_for_launcher);
        this.mLlyt = (LinearLayout) findViewById(C0508R.id.epg_about_main_layout);
        this.mTvDeviceName = (TextView) findViewById(C0508R.id.epg_about_device_name);
        initData();
        fillData();
        getDNS();
        initCDNIPData();
    ...
    protected View getBackgroundContainer() {
        return findViewById(C0508R.id.epg_setting_about_content);
    }
    ...
    private void initData() {
        ...
        this.mTvDeviceName.setText(getString(C0508R.string.setting_about_devicename, new Object[]{deviceName}));
    ...
    public List<Order> getShowOrder() {
        ...
        int[] nameId = new int[]{C0508R.string.setting_about_sysversion, C0508R.string.setting_about_softversion, C0508R.string.setting_about_ip_private, C0508R.string.setting_about_ip_public, C0508R.string.setting_about_dns_launcher, C0508R.string.setting_about_netcard_wired, C0508R.string.setting_about_netcard_wireless};
    ...
    private List<Order> formatData() {
        ...
        for (Order order : getShowOrder()) {
            if (!StringUtils.isEmpty((String) this.mData.get(order.mKey)) || order.mKey.equals(SettingAboutInteractorImpl.DNS)) {
                LogUtils.m1574i(TAG, order.mValue);
    ...
    private TextView createView(String string) {
        ...
        view.setTextSize(0, getResources().getDimension(C0508R.dimen.dimen_23sp));
        view.setTextColor(getResources().getColor(C0508R.color.setting_white));
    ...
    private void initCDNIPData() {
        CDNHelper.testStress.call(new C10521(), "");
    }

    private void onSuccessResult(ApiResultF4v result) {
        LogUtils.m1568d(TAG, "onSuccessResult() -> ip:" + result);
    ...
    private void getDNS() {
        ThreadUtils.execute(new C10532());
    }

    private void refreshPublicIP(final String ip) {
        runOnUiThread(new Runnable() {
            public void run() {
                SettingAboutForLauncherActivity.this.buildItem(SettingAboutInteractorImpl.PUBLIC_IP, SettingAboutForLauncherActivity.this.getString(C0508R.string.setting_about_ip_public, new Object[]{ip}));
            }
        });
    }
    ...
    private void refreshDNS(final String dns) {
        runOnUiThread(new Runnable() {
            public void run() {
                ...
                SettingAboutForLauncherActivity.this.buildItem(SettingAboutInteractorImpl.DNS, SettingAboutForLauncherActivity.this.getString(C0508R.string.setting_about_dns_launcher, new Object[]{dns}));
            }
        });
    }
