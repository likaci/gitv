...
public class GlobalVipCloudView extends CloudView implements OnFocusChangeListener, OnClickListener {
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        ...
        if (!hasFocus) {
            ...
            this.mCuteBottombgView.setDrawable(ResourceUtil.getDrawable(C0508R.drawable.epg_global_dialog_gradient_vip_bg));
        } else {
    ...
    public void onClick(View v) {
        if (this.mBitmapAlbum != null) {
            ...
            LogUtils.m1571e(this.TAG, "onClick mGlobalVipCloudViewCallBack: " + this.mGlobalVipCloudViewCallBack);
    ...
    private void sendClickPingBack(String rseat, String c1, String r) {
        ...
        params.add("rpage", "logout").add("block", "rec").add("rseat", rseat).add("c1", c1).add("r", r).add("rt", "i").add(Keys.f2035T, "20");
