...
public class MenuFloatLayerLayout extends RelativeLayout implements OnFocusChangeListener, OnClickListener {
    ...
    private void initView(Context context) {
        LayoutInflater.from(context).inflate(C0508R.layout.epg_home_menu_float_layer, this, true);
        this.mContext = context;
        this.mHorizontalScrollView = (LinearLayout) findViewById(C0508R.id.epg_home_menu_float_layer_horizontal_scrollview);
    }
    ...
    public void setAdapter(MenuFloatLayerStateListener listener) {
        ...
        for (int i = 0; i < listener.getCount(); i++) {
            ...
            if (layoutParams == null) {
                layoutParams = new LayoutParams(getResources().getDimensionPixelSize(C0508R.dimen.dimen_197dp), getResources().getDimensionPixelSize(C0508R.dimen.dimen_197dp));
            }
            layoutParams.height = getResources().getDimensionPixelSize(C0508R.dimen.dimen_197dp);
            layoutParams.width = getResources().getDimensionPixelSize(C0508R.dimen.dimen_197dp);
            layoutParams.rightMargin = getResources().getDimensionPixelSize(C0508R.dimen.dimen_3dp);
