...
public class SearchStarApi extends SearchResultApi {
    ...
    private String dealBirthday(String birth) {
        ...
        if (indexOf > 0) {
            birthday = (birthday + subStr.substring(0, indexOf)) + ResourceUtil.getStr(C0508R.string.year);
            subStr = subStr.substring(indexOf + 1);
        }
        indexOf = subStr.indexOf(45);
        if (indexOf > 0) {
            birthday = (birthday + subStr.substring(0, indexOf)) + ResourceUtil.getStr(C0508R.string.month);
            subStr = subStr.substring(indexOf + 1);
        }
        indexOf = subStr.indexOf(45);
        if (indexOf <= 0) {
        ...
        return (birthday + subStr.substring(0, indexOf)) + ResourceUtil.getStr(C0508R.string.day);
    }
}
