...
public class PlayerMultiProcessClient {
    ...
    private ServiceConnection mConnection = new C14171();
    ...
    class C14171 implements ServiceConnection {
        C14171() {
        }

        public void onServiceDisconnected(ComponentName name) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1568d(PlayerMultiProcessClient.TAG, "disconnect ");
            }
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            if (LogUtils.mIsDebug) {
                LogUtils.m1568d(PlayerMultiProcessClient.TAG, "connect success");
            }
    ...
    private class WorkHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (LogUtils.mIsDebug) {
                LogUtils.m1568d(PlayerMultiProcessClient.TAG, ">> handleMessage(), listener=" + listener);
            }
            if (PlayerMultiProcessClient.this.loadPlayerFeature()) {
                if (LogUtils.mIsDebug) {
                    LogUtils.m1568d(PlayerMultiProcessClient.TAG, ">> handleMessage() onSuccess!!");
                }
                if (listener != null) {
            ...
            if (LogUtils.mIsDebug) {
                LogUtils.m1568d(PlayerMultiProcessClient.TAG, ">> handleMessage() onFailed!!");
            }
            if (listener != null) {
                listener.onFailed();
            }
    ...
    public final synchronized void connect() {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "connect() start");
        }
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "connect() end");
        }
    }
    ...
    public synchronized void loadPlayerFeatureAsync(Context context, OnStateChangedListener listener, boolean showLoading) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "loadPlayerFeatureAsync() start");
        }
        if (this.mLoadProvderResult) {
            ...
            if (showLoading) {
                ...
                LogUtils.m1568d(TAG, "noLoading");
            }
            this.mWorkHandler.sendMessage(msg);
            if (LogUtils.mIsDebug) {
                LogUtils.m1568d(TAG, "loadPlayerFeatureAsync() end");
            }
        }
    }
    ...
    private synchronized boolean loadPlayerFeature() {
        Bundle result;
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "loadPlayerFeature() start");
        }
        result = null;
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "loadPlayerFeature result=" + result.getBoolean(PlayerCommand.PARCELABLE_RESULT));
        }
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "loadPlayerFeature() end");
        }
    ...
    public synchronized boolean isSupportDolby() {
        Bundle result;
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "isSupportDolby() start");
        }
        Bundle params = new Bundle();
        result = null;
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "isSupportDolby() end");
        }
        return result.getBoolean(PlayerCommand.PARCELABLE_RESULT);
    }
    ...
    public synchronized boolean isSupportH211() {
        Bundle result;
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "isSupportH211() start");
        }
        Bundle params = new Bundle();
        result = null;
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "isSupportH211() end");
        }
        return result.getBoolean(PlayerCommand.PARCELABLE_RESULT);
    }
    ...
    public synchronized String getLog(int logType) {
        Bundle result;
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "getLog() start type: " + logType);
        }
        Bundle params = new Bundle();
        result = null;
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "getPumaLog() end");
        }
    ...
    public synchronized void updateDeviceCheckInfo(String apiKey, String authId) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "updateDeviceCheckInfo()");
        }
        Bundle params = new Bundle();
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "updateDeviceCheckInfo() end");
        }
    }

    public synchronized void updateAuthorization(String authorization) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "updateAuthorization()");
        }
        Bundle params = new Bundle();
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "updateAuthorization() end");
        }
    }

    public synchronized void enableHCDNPreDeploy(boolean enable) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "enableHCDNPreDeploy(enable: " + enable + ")");
        }
        Bundle params = new Bundle();
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "enableHCDNPreDeploy(enable: " + enable + "), end");
        }
    }

    public synchronized void setHCDNCleanAvailable(boolean available) {
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "setHCDNCleanAvailable(available: " + available + ")");
        }
        Bundle params = new Bundle();
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "setHCDNCleanAvailable(available: " + available + "), end");
        }
    }
    ...
    public synchronized String getPlayerModulesVersion() {
        Bundle result;
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "getPlayerModulesVersion() start ");
        }
        Bundle params = new Bundle();
        result = null;
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.m1568d(TAG, "getPlayerModulesVersion() end");
        }
        return result.getString(PlayerCommand.PARCELABLE_RESULT);
    }
}
