...
public class GlobalQRFeedBackDialog extends GlobalDialog {
    ...
    protected void initLayout() {
        this.mContentTextView = (TextView) this.mContentLayout.findViewById(C0508R.id.epg_global_dialog_error_tv);
        this.mLeftBottomTextView = (TextView) findViewById(C0508R.id.epg_global_dialog_error_left_bottem_tv);
        this.mRightTopTextView = (TextView) findViewById(C0508R.id.epg_global_dialog_error_right_top_tv);
        this.mRightBottomTextView = (TextView) findViewById(C0508R.id.epg_global_dialog_error_right_bottom_tv);
        this.mQRCodeImage = (ImageView) this.mContentLayout.findViewById(C0508R.id.epg_global_dialog_error_qr_iv);
        this.mLoadingView = (ProgressBarNewItem) this.mContentLayout.findViewById(C0508R.id.epg_global_dialog_loading);
        this.mRightContentLayout = (RelativeLayout) this.mContentLayout.findViewById(C0508R.id.epg_global_dialog_error_right_tv_layout);
        this.mLayoutTxt = (LinearLayout) this.mContentLayout.findViewById(C0508R.id.epg_global_dialog_error_layout_txt);
        this.mLayoutQR = (RelativeLayout) this.mContentLayout.findViewById(C0508R.id.epg_global_dialog_error_layout_qr);
    }

    protected void initParams() {
        this.mDialogLayoutResId = C0508R.layout.share_global_dialog_layout;
        this.mContentResId = C0508R.layout.epg_global_dialog_error_view;
        this.mDialogWidth = getDimen(C0508R.dimen.dimen_570dp);
        this.mOnlyOneBtnHeight = getDimen(C0508R.dimen.dimen_73dp);
        this.mOnlyOneBtnWidth = getDimen(C0508R.dimen.dimen_446dp);
        this.mFirstBtnWidth = getDimen(C0508R.dimen.dimen_273dp);
    ...
    public GlobalQRFeedBackDialog setParams(StringModel stringModel, Bitmap codeImage, String okBtnText, OnClickListener okListener, String cancelBtnText, OnClickListener cancelListener) {
        LogUtils.m1576i(TAG, "setParams --- stringModel = ", stringModel);
        if (stringModel != null) {
            boolean z;
            if (codeImage == null) {
                this.mNeedUpdateDialogParam = true;
    ...
    private void setContentLayoutParams(StringModel stringModel, Bitmap codeImage) {
        if (stringModel != null && this.mIsFeedbackSuccess) {
            ...
            if (contentLayoutParams != null) {
                contentLayoutParams.topMargin = getDimen(C0508R.dimen.dimen_23dp);
                contentLayoutParams.bottomMargin = getDimen(C0508R.dimen.dimen_20dp);
            }
            ViewGroup.LayoutParams containerViewLayoutParams = this.mContainerView.getLayoutParams();
            this.mDialogWidth = getDimen(C0508R.dimen.dimen_500dp);
            containerViewLayoutParams.width = this.mDialogWidth;
            this.mOnlyOneBtnHeight = getDimen(C0508R.dimen.dimen_73dp);
            this.mOnlyOneBtnWidth = getDimen(C0508R.dimen.dimen_476dp);
    ...
    public GlobalQRFeedBackDialog setQRImage(Bitmap codeImage) {
        LogUtils.m1569d(TAG, "setQRImage", new Throwable().fillInStackTrace());
        ...
        if (codeImage == null) {
            txtParams.width = -2;
            txtParams.leftMargin = getDimen(C0508R.dimen.dimen_0dp);
            txtParams.rightMargin = getDimen(C0508R.dimen.dimen_0dp);
            txtParams.topMargin = getDimen(C0508R.dimen.dimen_10dp);
            txtParams.bottomMargin = getDimen(C0508R.dimen.dimen_10dp);
            this.mRightContentLayout.setGravity(1);
            this.mContentTextView.setMaxLines(7);
            this.mQRCodeImage.setVisibility(8);
        } else {
            txtParams.width = getDimen(C0508R.dimen.dimen_242dp);
            txtParams.leftMargin = getDimen(C0508R.dimen.dimen_20dp);
            txtParams.rightMargin = getDimen(C0508R.dimen.dimen_0dp);
            txtParams.topMargin = getDimen(C0508R.dimen.dimen_0dp);
            txtParams.bottomMargin = getDimen(C0508R.dimen.dimen_0dp);
    ...
    private void updateParams() {
        if (this.mNeedUpdateDialogParam) {
            this.mDialogLayoutResId = C0508R.layout.share_global_dialog_layout;
            this.mContentResId = C0508R.layout.epg_global_dialog_error_view;
            this.mDialogWidth = getDimen(C0508R.dimen.dimen_530dp);
            this.mOnlyOneBtnHeight = getDimen(C0508R.dimen.dimen_73dp);
            this.mOnlyOneBtnWidth = getDimen(C0508R.dimen.dimen_506dp);
            this.mFirstBtnWidth = getDimen(C0508R.dimen.dimen_253dp);
            this.mFirstBtnHeight = this.mOnlyOneBtnHeight;
            this.mSecondBtnWidth = this.mFirstBtnWidth;
            this.mSecondBtnHeight = this.mOnlyOneBtnHeight;
        }
    ...
    public void showQRFail() {
        this.mContentLayout.findViewById(C0508R.id.epg_view_failure).setVisibility(0);
    }
}
