...
public class TrackerRecord {
    ...
    public static class Builder {
        ...
        public Builder setKeyValueMaps(Map<String, String> val) {
    ...
    private TrackerRecord(Builder builder) {
        this.errorCode = "";
        this.errorPage = "";
        this.errorMessage = "";
        this.errorApiName = "";
    ...
    public String getApiName() {
        Log.v(TAG, "getApiName = " + this.errorApiName);
        return this.errorApiName;
    }

    public Map<String, String> getKeyValues() {
        Log.v(TAG, "getKeyValues");
        if (this.keyValueMaps == null) {
            Log.v(TAG, "getKeyValues is null");
        }
