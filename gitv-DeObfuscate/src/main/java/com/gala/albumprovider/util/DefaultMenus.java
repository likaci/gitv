...
public class DefaultMenus {
    ...
    public static class MenuTag {
        ...
        void m143a(String str, String str2) {
            this.id = str;
            this.name = str2;
        }
    }
    ...
    public static void initData() {
        TagAll.m143a(toString(0), AlbumProviderApi.getLanguages().getTagAllName());
        TagHot.m143a(toString(-101), AlbumProviderApi.getLanguages().getTagHotName());
        TagPraise.m143a(toString(-102), AlbumProviderApi.getLanguages().getTagPraiseName());
        TagPolymeric.m143a(toString(TAGPOLYMERIC), AlbumProviderApi.getLanguages().getTagAllName());
    }
