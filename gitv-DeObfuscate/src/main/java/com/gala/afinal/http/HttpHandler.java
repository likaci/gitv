...
import com.gala.imageprovider.p000private.C0040l;
import com.gala.imageprovider.p000private.C0136m;
...
public class HttpHandler<T> extends AsyncTask<Object, Object, Object> implements C0040l {
    ...
    private final C0136m mFileEntityHandler = new C0136m();
    private final C0137n mStrEntityHandler = new C0137n();
    ...
    public boolean isStop() {
        return this.mFileEntityHandler.m347a();
    }

    public void stop() {
        this.mFileEntityHandler.m347a();
    }
        ...
        try {
            ...
            if (entity != null) {
                ...
                if (this.targetUrl != null) {
                    obj = this.mFileEntityHandler.m346a(entity, this, this.targetUrl, this.isResume);
                } else {
                    C0137n c0137n = this.mStrEntityHandler;
                    obj = C0137n.m349a(entity, this, this.charset);
                }
            }
