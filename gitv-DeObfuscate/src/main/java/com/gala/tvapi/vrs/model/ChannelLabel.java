...
public class ChannelLabel extends Model {
    ...
    public Album getVideo() {
        ...
        if ((getTVType(this.sourceId, this.itemType) == TVType.ALBUM || getTVType(this.sourceId, this.itemType) == TVType.SOURCE) && this.video != null) {
            ...
            album3.vid = this.vid;
            if (C0214a.m592a(this.albumQipuId)) {
                str = this.tvQipuId;
                album2 = album3;
                album2.qpId = str;
    ...
    private TVType getTVType(String sourceId, String itemType) {
        if (!C0214a.m592a(sourceId) && Long.parseLong(sourceId) > 0) {
    ...
    public LivePlayingType getLivePlayingType() {
        ...
        long currentTime;
        if (this.itemKvs != null) {
            if (!C0214a.m592a(this.itemKvs.LiveEpisode_StartTime)) {
                if (!C0214a.m592a(this.itemKvs.LiveEpisode_EndTime)) {
    ...
    public long formatTime(String time) {
        try {
            ...
            C0262a.m634b("Channellabel", "please check itemKvs.LiveEpisode_StartTime&&itemKvs.LiveEpisode_EndTime, e = " + e);
            return 0;
        }
    }
