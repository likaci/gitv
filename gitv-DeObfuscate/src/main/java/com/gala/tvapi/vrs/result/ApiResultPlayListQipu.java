...
public class ApiResultPlayListQipu extends ApiResult {
    ...
    public List<Album> getAlbumList() {
        ...
        for (PlayAlbum playAlbum : this.data.plst) {
            ...
            String str = (C0214a.m592a(playAlbum.albumQipuId) || playAlbum.albumQipuId.equals("0")) ? playAlbum.tvQipuId : playAlbum.albumQipuId;
            album.qpId = str;
    ...
    private static Cast m837a(PlayAlbum playAlbum) {
        Cast cast = new Cast();
