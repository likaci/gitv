...
public class Utils {
    private static final StringBuilder f715a = new StringBuilder();
    private static final Formatter f716a = new Formatter(f715a, Locale.getDefault());
    ...
    public static String stringForTime(int timeMs, boolean alwaysHour) {
        ...
        f715a.setLength(0);
        if (alwaysHour) {
            return f716a.format("%02d:%02d:%02d", new Object[]{Integer.valueOf(i), Integer.valueOf(i3), Integer.valueOf(i2)}).toString();
        } else if (i > 0) {
            return f716a.format("%d:%02d:%02d", new Object[]{Integer.valueOf(i), Integer.valueOf(i3), Integer.valueOf(i2)}).toString();
        } else {
            return f716a.format("%02d:%02d", new Object[]{Integer.valueOf(i3), Integer.valueOf(i2)}).toString();
        }
    }
    ...
    public static boolean contain(int[] list, int value) {
        ...
        if (Log.DEBUG) {
            Log.m454d("PlayerUtils/Utils", "contain() return " + z);
        }
        return z;
    }
    ...
    public static boolean equals(String str1, String str2) {
        ...
        if (Log.DEBUG) {
            Log.m454d("PlayerUtils/Utils", "equal(" + str1 + ", " + str2 + ") return " + z);
        }
        return z;
    }
    ...
    public static LayoutParams createEmptyLayoutParamsWithSameType(LayoutParams srcParams) {
        ...
        try {
            ...
            if (Log.DEBUG) {
                Log.m457e("PlayerUtils/Utils", "createEmptyLayoutParamsWithSameType: exception happened with (int, int) constructor:", e);
            }
            try {
                layoutParams = (LayoutParams) cls.newInstance();
            } catch (Throwable e2) {
                if (Log.DEBUG) {
                    Log.m457e("PlayerUtils/Utils", "createEmptyLayoutParamsWithSameType: exception happened with default constructor:", e2);
                }
                layoutParams = null;
            }
        }
