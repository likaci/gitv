...
public class ObjectMethodHolder implements IMethodHolder {
    ...
    public Object invoke(Object... args) {
        if (sLoggable) {
            Log.m434v(TAG, ">> invoke() mMethodName=" + this.mMethodName + ", mCached=" + this.mCached + ", mCacheValue=" + this.mCacheValue + ", mMethod=" + this.mMethod);
        }
        ...
        if (!this.mTried) {
            ...
            try {
                ...
                Log.m437w(TAG, "invoke(" + argsString.toString() + ") error! " + this.mInstance.getClass(), e);
            }
        }
        if (!(this.mCached && this.mCacheValue)) {
            ...
            if (this.mMethod != null) {
                try {
                    ...
                    Log.m437w(TAG, "invoke(" + argsString.toString() + ") error!", e2);
                }
            }
        }
        if (sLoggable) {
            ...
            Log.m434v(TAG, "<< invoke() mMethodName=" + this.mMethodName + ", mCached=" + this.mCached + ", mCacheValue=" + this.mCacheValue + ", mMethod=" + this.mMethod + " return " + valueBuilder.toString());
        }
        return this.mValue;
    }
}
