...
public class CustomListener {
    private GalaDLNAListener mGalaDLNAListener = new C01571();

    class C01571 implements GalaDLNAListener {
        C01571() {
        }
        ...
        public void onReceiveSendMessage(int r21, java.lang.String r22, java.lang.StringBuffer r23) {
            ...
            r17 = com.gala.multiscreen.dmr.logic.listener.CustomListener.C01582.$SwitchMap$com$gala$multiscreen$dmr$model$type$MSType;	 Catch:{ Exception -> 0x00d3 }
        ...
        L_0x0037:
            r17 = com.gala.multiscreen.dmr.logic.listener.CustomListener.C01582.$SwitchMap$com$gala$multiscreen$dmr$model$type$MSControl;	 Catch:{ Exception -> 0x00d3 }
