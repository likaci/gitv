...
public class PushManager {
    ...
    private IPushServiceCallback mCallBack = new C19704();
    private ServiceConnection mConnection = new C19693();
    ...
    class C19693 implements ServiceConnection {

        class C19681 implements Runnable {
            C19681() {
            }
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            PushManager.this.mService = Stub.asInterface(service);
            if (PushManager.this.mService == null) {
                ...
                new Thread(new C19681()).start();
            }
        }
    }

    class C19704 extends IPushServiceCallback.Stub {
        C19704() {
        }
