...
public class PushService extends Service implements MqttCallback {
    ...
    class C19755 extends BroadcastReceiver {
        C19755() {
        }
    ...
    class C19766 extends BroadcastReceiver {
        C19766() {
        }
