...
public class NativeCrashStatistics {
    ...
    public String pchv;
    public String po;
    public final String f2128t = "50318_2";
    public final String tt = "0";

    public NativeCrashStatistics(String crshid, String po, String crpo, String crashtp, String crplg, String othdt, String crplgv, String pchv) {
        this.crshid = crshid;
        this.po = po;
        this.crpo = crpo;
