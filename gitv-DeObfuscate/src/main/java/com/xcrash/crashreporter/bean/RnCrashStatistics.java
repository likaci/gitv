...
public class RnCrashStatistics {
    ...
    public String pchv;
    public String po;
    public final String f2129t = "61109";
    public final String tt = "1";

    public RnCrashStatistics(String crshid, String po, String crpo, String crashtp, String crplg, String othdt, String crplgv, String pchv) {
        this.crshid = crshid;
        this.po = po;
        this.crpo = crpo;
