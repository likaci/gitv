...
public class Table {
    ...
    public static final ThreadLocal<Charset> UTF8_CHARSET = new C19072();
    private static final ThreadLocal<CharsetDecoder> UTF8_DECODER = new C19061();
    protected ByteBuffer bb;
    protected int bb_pos;

    class C19061 extends ThreadLocal<CharsetDecoder> {
        C19061() {
        }
    ...
    class C19072 extends ThreadLocal<Charset> {
        C19072() {
        }
