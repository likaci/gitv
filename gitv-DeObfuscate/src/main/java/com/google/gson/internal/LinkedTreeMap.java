...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C19331();
    ...
    static class C19331 implements Comparator<Comparable> {
        C19331() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C19341 extends LinkedTreeMapIterator<Entry<K, V>> {
            C19341() {
                super();
            }
    ...
    class KeySet extends AbstractSet<K> {
        ...
        class C19351 extends LinkedTreeMapIterator<K> {
            C19351() {
                super();
            }
    ...
    static final class Node<K, V> implements Entry<K, V> {
        ...
        public String toString() {
            return this.key + SearchCriteria.EQ + this.value;
        }
