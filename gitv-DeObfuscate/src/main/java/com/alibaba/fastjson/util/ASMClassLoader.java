...
public class ASMClassLoader extends ClassLoader {
    private static ProtectionDomain DOMAIN = ((ProtectionDomain) AccessController.doPrivileged(new C00251()));

    static class C00251 implements PrivilegedAction<Object> {
        C00251() {
        }
