...
public class ThrowableDeserializer extends JavaBeanDeserializer {
    ...
    L_0x0095:
        r7 = r9.stringVal();
        r13 = r16.getConfig();
        r13 = r13.getDefaultClassLoader();
        r6 = com.alibaba.fastjson.util.TypeUtils.loadClass(r7, r13);
        r13 = 16;
        r9.nextToken(r13);
    L_0x00aa:
        r13 = r9.token();
    ...
    L_0x0116:
        ...
        goto L_0x00aa;
    L_0x011e:
        r4 = r15.createException(r10, r1, r6);	 Catch:{ Exception -> 0x012c }
        if (r4 != 0) goto L_0x005b;
    L_0x0124:
        r5 = new java.lang.Exception;	 Catch:{ Exception -> 0x012c }
        r5.<init>(r10, r1);	 Catch:{ Exception -> 0x012c }
        r4 = r5;
        goto L_0x005b;
    L_0x012c:
        r3 = move-exception;
