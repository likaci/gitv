...
public class AppStoreManager implements InstallListener {
    ...
    BroadcastReceiver mReceiver = new C18951();
    ...
    class C18951 extends BroadcastReceiver {
        C18951() {
        }
    ...
    class C19006 extends ResponseCallback {
        C19006() {
        }

        public void failure(RetrofitError arg0) {
            LogUtils.m1738e(AppStoreManager.this.LOG_TAG, new StringBuilder(String.valueOf(AppStoreManager.this.LOG_TAG)).append(">>>>>>>>>>>> pingback onAdverClick 发送失败").append(arg0.getMessage()).toString());
        }

        public void success(Response arg0) {
            LogUtils.m1739i(AppStoreManager.this.LOG_TAG, new StringBuilder(String.valueOf(AppStoreManager.this.LOG_TAG)).append(">>>>>>>>>>>> pingback onAdverClick 发送成功").toString());
        }
    }

    class C19017 extends ResponseCallback {
        C19017() {
        }

        public void failure(RetrofitError arg0) {
            LogUtils.m1738e(AppStoreManager.this.LOG_TAG, new StringBuilder(String.valueOf(AppStoreManager.this.LOG_TAG)).append(">>>>>>>>>>>> pingback onMyAppClick 发送失败").append(arg0.getMessage()).toString());
        }

        public void success(Response arg0) {
            LogUtils.m1739i(AppStoreManager.this.LOG_TAG, new StringBuilder(String.valueOf(AppStoreManager.this.LOG_TAG)).append(">>>>>>>>>>>> pingback onMyAppClick 发送成功").toString());
        }
    }

    class C19028 extends ResponseCallback {
        C19028() {
        }

        public void failure(RetrofitError arg0) {
            LogUtils.m1738e(AppStoreManager.this.LOG_TAG, new StringBuilder(String.valueOf(AppStoreManager.this.LOG_TAG)).append(">>>>>>>>>>>> pingback launchApp 发送失败").append(arg0.getMessage()).toString());
        }

        public void success(Response arg0) {
            LogUtils.m1739i(AppStoreManager.this.LOG_TAG, new StringBuilder(String.valueOf(AppStoreManager.this.LOG_TAG)).append(">>>>>>>>>>>> pingback launcheApp 发送成功").toString());
        }
    }

    class C19039 extends ResponseCallback {
        C19039() {
        }

        public void failure(RetrofitError arg0) {
            LogUtils.m1738e(AppStoreManager.this.LOG_TAG, new StringBuilder(String.valueOf(AppStoreManager.this.LOG_TAG)).append(">>>>>>>>>>>> pingback onCategoriesClick 发送失败").append(arg0.getMessage()).toString());
        }

        public void success(Response arg0) {
            LogUtils.m1739i(AppStoreManager.this.LOG_TAG, new StringBuilder(String.valueOf(AppStoreManager.this.LOG_TAG)).append(">>>>>>>>>>>> pingback onCategoriesClick 发送成功").toString());
        }
    }
        ...
        this.mClient.getAdverIndex(new Callback<AdverIndexResponse>() {
            public void success(AdverIndexResponse resp, Response arg1) {
                if (CommonUtils.isListEmpty(resp.data)) {
                    LogUtils.m1738e(AppStoreManager.this.LOG_TAG, new StringBuilder(String.valueOf(AppStoreManager.this.LOG_TAG)).append(">>>>>>>>>>>>>>>>>>>>>>> adv resp.data is null  -  ").append(arg1.getUrl()).toString());
                    if (listener != null) {
    ...
    public void fetchRecomCategoryList(final OnGetRecomCategoryListListener listener) {
        this.mClient.getAppRecomCategiries(new Callback<AppCategoriesResponse>() {
            ...
            public void success(AppCategoriesResponse resp, Response arg1) {
                if (CommonUtils.isListEmpty(resp.data)) {
                    LogUtils.m1738e(AppStoreManager.this.LOG_TAG, new StringBuilder(String.valueOf(AppStoreManager.this.LOG_TAG)).append(">>>>>>>>>>>>>>>>>>>>>>> recom resp.data is null  -  ").append(arg1.getUrl()).toString());
                } else {
    ...
    private boolean shouldUpgrade(String lastVer, String mAppPackageName) {
        ...
        try {
            ...
            LogUtils.m1738e(this.LOG_TAG, this.LOG_TAG + "--shouldUpgrade () >>>> curVersionCode" + curVersionCode + "lastVersion" + lastVersion);
            if (lastVersion > curVersionCode) {
                return true;
            }
            return false;
        } catch (NameNotFoundException e) {
            LogUtils.m1738e(this.LOG_TAG, this.LOG_TAG + "--shouldUpgrade () >>>>" + " NameNotFoundException, vercode is null" + e.getMessage());
            return false;
        }
    }
    ...
    private void sendPingbackAdverClick(int position, AppDetailInfo info) {
        this.mClient.onClick(info.getAppId(), String.valueOf(AppCommUtils.getMyPackageInfo(mContext).versionCode), "home", "banner", "1-" + String.valueOf(position), "", new C19006());
    }

    private void sendPingbackMyAppClick(int position, AppDetailInfo info) {
        this.mClient.onClick(info.getAppId(), String.valueOf(AppCommUtils.getMyPackageInfo(mContext).versionCode), "home", "my_app", "1-" + String.valueOf(position), "", new C19017());
    }

    private void sendLaunchAppPingBack(AppDetailInfo detailInfo, String rpage, String block, String rseat) {
        this.mClient.onLaunchApp(detailInfo.getAppId(), detailInfo.getAppVersion(), rpage, block, rseat, new C19028());
    }

    private void sendPingbackCategoriesClick(String rpage, String block, String rseat) {
        this.mClient.onClick("", String.valueOf(AppCommUtils.getMyPackageInfo(mContext).versionCode), rpage, block, rseat, "", new C19039());
    }
    ...
    private void sendRecommendClick(String rpage, String block, int position) {
        this.mClient.onClick("", String.valueOf(AppCommUtils.getMyPackageInfo(mContext).versionCode), rpage, block, "1-" + String.valueOf(position), "", new ResponseCallback() {
            public void failure(RetrofitError arg0) {
                LogUtils.m1738e(AppStoreManager.this.LOG_TAG, new StringBuilder(String.valueOf(AppStoreManager.this.LOG_TAG)).append(">>>>>>>>>>>> pingback onRecommendClick 发送失败").append(arg0.getMessage()).toString());
            }

            public void success(Response arg0) {
                LogUtils.m1739i(AppStoreManager.this.LOG_TAG, new StringBuilder(String.valueOf(AppStoreManager.this.LOG_TAG)).append(">>>>>>>>>>>> pingback onRecommendClick 发送成功").toString());
            }
        });
    }
    ...
    private void appOperation(int type, AppInfo app, int index) {
        LogUtils.m1739i(this.LOG_TAG, this.LOG_TAG + ">>>>>>>>>>>>>>>>>> appList.size= " + this.mAppInfos.size() + " >>>>>> 前  ");
        switch (type) {
            case 0:
            ...
            case 1:
                if (index == -1) {
                    LogUtils.m1738e(this.LOG_TAG, this.LOG_TAG + ">>>>>>>>>>>>>>>> AppOperation.PACKAGE_REMOVED is failure sqlite 查询不到数据");
                    break;
                }
        ...
        LogUtils.m1739i(this.LOG_TAG, this.LOG_TAG + ">>>>>>>>>>>>>>>>>> appList.size= " + this.mAppInfos.size() + "  >>>>>> 后  ");
    }

    public void onAdd(String packageName) {
        LogUtils.m1737d(this.LOG_TAG, "package added ---  packageName is " + packageName);
        try {
    ...
    public void onRemove(String packageName) {
        LogUtils.m1737d(this.LOG_TAG, "package removed packageName is " + packageName);
        if (this.mAppInfos != null) {
        ...
        LogUtils.m1738e(this.LOG_TAG, "mAppInfos is null");
    }
