...
class LoaderManagerImpl extends LoaderManager {
    ...
    final class LoaderInfo implements OnLoadCompleteListener<Object> {
        ...
        public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
            ...
            if (this.mLoader != null) {
                this.mLoader.dump(new StringBuilder(String.valueOf(prefix)).append("  ").toString(), fd, writer, args);
            }
            ...
            if (this.mPendingLoader != null) {
                ...
                this.mPendingLoader.dump(new StringBuilder(String.valueOf(prefix)).append("  ").toString(), fd, writer, args);
            }
        }
    }
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        if (this.mLoaders.size() > 0) {
            ...
            innerPrefix = new StringBuilder(String.valueOf(prefix)).append("    ").toString();
