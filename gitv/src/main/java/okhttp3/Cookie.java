...
public final class Cookie {
    ...
    static Cookie parse(long currentTimeMillis, HttpUrl url, String setCookie) {
        ...
        while (pos < limit) {
            ...
            if (attributeName.equalsIgnoreCase("expires")) {
                ...
                if (attributeName.equalsIgnoreCase(HTTP.MAX_AGE)) {
                    try {
                    ...
                    if (attributeName.equalsIgnoreCase(WebSDKConstants.PARAM_KEY_DOMAIN)) {
                        try {
        ...
        if (deltaSeconds == Long.MIN_VALUE) {
            ...
            expiresAt = currentTimeMillis + (deltaSeconds <= 9223372036854775L ? deltaSeconds * 1000 : IOpenApiCommandHolder.OAA_NO_LIMIT);
    ...
    private static int dateCharacterOffset(String input, int pos, int limit, boolean invert) {
        for (int i = pos; i < limit; i++) {
            ...
            if ((c >= 32 || c == 9) && c < Service.LOCUS_CON && ((c < 48 || c > 57) && ((c < 97 || c > 122) && ((c < 65 || c > 90) && c != 58)))) {
                dateCharacter = false;
            } else {
                dateCharacter = true;
            }
    ...
    private static long parseMaxAge(String s) {
        ...
        try {
            ...
            if (s.matches("-?\\d+")) {
                if (!s.startsWith("-")) {
                    j = IOpenApiCommandHolder.OAA_NO_LIMIT;
                }
                return j;
            }
            throw e;
    ...
    public int hashCode() {
        int i;
        int i2 = 0;
        int hashCode = (((((((((this.name.hashCode() + WidgetType.ITEM_SETTING_NETWORK) * 31) + this.value.hashCode()) * 31) + this.domain.hashCode()) * 31) + this.path.hashCode()) * 31) + ((int) (this.expiresAt ^ (this.expiresAt >>> 32)))) * 31;
        if (this.secure) {
            i = 0;
        } else {
            i = 1;
