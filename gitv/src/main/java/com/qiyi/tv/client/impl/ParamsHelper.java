...
public class ParamsHelper {
    ...
    static class ClientInfoImpl implements ClientInfo {
        ...
        public ClientInfoImpl(Bundle bundle) {
            this.f825a = bundle.getString(Extras.EXTRA_CUSTOMER_VERSION_NAME);
            this.a = bundle.getInt(Extras.EXTRA_CUSTOMER_VERSION_CODE, -1);
            this.c = bundle.getString(Extras.EXTRA_CUSTOMER_PACKAGE_NAME);
            this.b = bundle.getString(Extras.EXTRA_CUSTOMER_SIGNATURE);
            this.d = bundle.getString(Extras.EXTRA_CUSTOMER_UUID);
        }
        ...
        public String toString() {
            return "ClientInfo(vn=" + this.f825a + ", vc=" + this.a + ", pk=" + this.c + ")";
        }
    }
    ...
    public static Intent getStartIntent(Context context, String signature, String servicePackageName) {
        Log.d("ParamsHelper", " packagename = " + servicePackageName);
    ...
    public static void setResultCode(Bundle params, int code) {
        ...
        Log.d("ParamsHelper", "setResultCode(" + code + ")");
    }
    ...
    public static <T extends Parcelable> void setResultData(Bundle params, T data) {
        Log.d("ParamsHelper", "setResultData(" + data + ")");
        if (params != null) {
    ...
    public static void setResultDataOfArrayString(Bundle params, ArrayList<String> data) {
        Log.d("ParamsHelper", "setResultDataOfArrayString(" + data + ")");
        if (params != null) {
    ...
    public static <T extends Parcelable> void setResultData(Bundle params, ArrayList<T> dataList) {
        Log.d("ParamsHelper", "setResultData(" + dataList + ")");
        if (params != null) {
    ...
    public static <T extends Parcelable> void setResultData(Bundle params, T[] dataArray) {
        Log.d("ParamsHelper", "setResultData(" + dataArray + ")");
        if (params != null) {
