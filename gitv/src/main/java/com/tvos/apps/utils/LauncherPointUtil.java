...
public class LauncherPointUtil {
    public static void updateLaunchPoint(Context context, boolean enableLaunchPoint, String launcherPointName) {
        int i = 1;
        LogUtil.d("updating launch point: " + enableLaunchPoint);
        ...
        try {
            ...
            if (e.toString().contains("does not exist")) {
                LogUtil.d(new StringBuilder(String.valueOf(launcherPointName)).append("updating launch point  component not exist...").toString());
            }
            e.printStackTrace();
        }
    }
