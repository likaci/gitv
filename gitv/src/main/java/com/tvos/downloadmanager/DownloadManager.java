...
public class DownloadManager implements IDownloadManager {
    ...
    private IDownloadThreadFinishListener mDownloadThreadFinishListener = new IDownloadThreadFinishListener() {
    ...
    private IDownloadTaskSizeListener mTaskSizeListener = new IDownloadTaskSizeListener() {
    ...
    class HandlerRunnable implements Runnable {
        ...
        public void run() {
            ...
            DownloadManager.this.mthread_handler = new Handler() {
