...
public class VoiceUtils {
    ...
    public static void dumpIntent(String str, Intent intent) {
        if (intent != null) {
            ...
            Log.d("Utils", "dumpIntent() " + str + ": flag=" + intent.getFlags() + "[" + Integer.toBinaryString(intent.getFlags()) + AlbumEnterFactory.SIGN_STR);
    ...
    public static boolean match(String str, String str2) {
        ...
        if (!(isEmpty(str) || isEmpty(str2))) {
            ...
            transferHanzi2Num = NumTransfer.transferHanzi2Num(StringUtils.a(str, "第", "个"));
            if (transferHanzi2Num == -1) {
