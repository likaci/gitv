...
public class VoiceService extends Service {
    ...
    private VoiceBinder f428a = new VoiceBinder(this);
    ...
    private static class VoiceBinder extends Stub {
        ...
        public Bundle invoke(Bundle bundle) throws RemoteException {
            ...
            switch (parseOperationType) {
                case 20001:
                    ...
                    try {
                        valueOf = Boolean.valueOf(((VoiceService) this.a.get()).a(voiceEvent));
        ...
        public void registerCallback(IVoiceEventCallback iVoiceEventCallback) throws RemoteException {
            ...
            ((VoiceService) this.a.get()).a.register(iVoiceEventCallback);
        }
        ...
        public void unregisterCallback(IVoiceEventCallback iVoiceEventCallback) throws RemoteException {
            ...
            ((VoiceService) this.a.get()).a.unregister(iVoiceEventCallback);
        }
    }
    ...
    public IBinder onBind(Intent intent) {
        Log.d("VoiceService", "onBind(" + intent + ") mBinder = " + this.f428a);
        return this.f428a;
    }
    ...
    private boolean a(com.gala.tv.voice.VoiceEvent r7) {
        /*
        r6 = this;
        r1 = 0;
        r0 = r6.a;	 Catch:{ Exception -> 0x003a }
        ...
        com.gala.tv.voice.core.Log.e(r0, r2);	 Catch:{ Exception -> 0x003a }
        r2 = r1;
    L_0x001e:
    ...
    L_0x003a:
        ...
        com.gala.tv.voice.core.Log.e(r2, r3);	 Catch:{ all -> 0x0061 }
    ...
    private List<VoiceEventGroup> a() {
        ...
        try {
            ...
            for (int i = 0; i < beginBroadcast; i++) {
                Bundle supportedVoices = ((IVoiceEventCallback) this.a.getBroadcastItem(i)).getSupportedVoices();
