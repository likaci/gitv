...
public class FastCacheLoader<T> implements IFastCache<T> {
    ...
    public void save(String data, String path) {
        if (StringUtils.isEmpty((CharSequence) data)) {
            LogUtils.d(TAG, "save failed, data is null!!!,path = " + path);
        } else {
    ...
    public synchronized byte[] readDataFromLocalCache(String path) {
        ...
        try {
            ...
            try {
                ...
                rFile = rFile2;
                try {
                    LogUtils.e(TAG, "read from local cache exception，path = " + path, e2);
                    if (fc != null) {
                        try {
                            fc.close();
                ...
                e1 = e4;
                rFile = rFile2;
                LogUtils.e(TAG, "read from local cache exception，path = " + path, e1);
                if (fc != null) {
                    try {
                        fc.close();
            ...
            e2222 = e5;
            LogUtils.e(TAG, "read from local cache exception，path = " + path, e2222);
            if (fc != null) {
                fc.close();
            }
            if (rFile != null) {
            ...
            try {
                ...
                if (mFc != null) {
                    try {
                        ...
                        LogUtils.d(TAG, "write data to disk failed", e2);
                        rFile = rFile2;
                        return;
                    }
                }
                ...
                try {
                    ...
                    if (mFc != null) {
                        try {
                            ...
                            LogUtils.d(TAG, "write data to disk failed", e22);
                            return;
                        }
                    }
                    if (rFile != null) {
                    ...
                    if (mFc != null) {
                        try {
                            ...
                            LogUtils.d(TAG, "write data to disk failed", e222);
                            throw th;
                        }
                    }
                    if (rFile != null) {
                ...
                e1 = e4;
                rFile = rFile2;
                LogUtils.d(TAG, "write data to disk failed", e1);
                if (mFc != null) {
                    try {
                        mFc.close();
                    } catch (IOException e2222) {
                        LogUtils.d(TAG, "write data to disk failed", e2222);
                        return;
                    }
                }
                if (rFile != null) {
