...
public class PlayListChannelCheck extends CheckTask {
    ...
    private IVrsCallback<ApiResultChannelLabels> iVrsCallback = new IVrsCallback<ApiResultChannelLabels>() {
        public void onSuccess(ApiResultChannelLabels channelLabels) {
            ...
            LogUtils.d(PlayListChannelCheck.TAG, "PlayListChannelCheck onSuccess()" + channelLabels.data);
        ...
        public void onException(ApiException e) {
            LogUtils.d(PlayListChannelCheck.TAG, "---PlayListChannelCheck onException---apicode=" + e.getCode() + "httpcode=" + e.getHttpCode());
