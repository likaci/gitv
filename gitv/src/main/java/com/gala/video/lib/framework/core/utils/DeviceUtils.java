...
public final class DeviceUtils {
                ...
                try {
                    ...
                    if (localBufferedReader != null) {
                        try {
                            ...
                            if (LogUtils.mIsDebug) {
                                LogUtils.e(TAG, "getCpuInfo: exception happened:", e32);
                            }
                        }
                    }
                    if (fr != null) {
                    ...
                    if (LogUtils.mIsDebug) {
                        LogUtils.d(TAG, "getCpuInfo: info=" + info);
                    }
                    ...
                    if (localBufferedReader != null) {
                        try {
                            ...
                            if (LogUtils.mIsDebug) {
                                LogUtils.e(TAG, "getCpuInfo: exception happened:", e322);
                            }
                            throw th;
                        }
                    }
    ...
    public static String getMacAddr(MacTypeEnum macTypeEnum) {
        ...
        switch (macTypeEnum) {
            ...
            case MAC_ETH:
                ...
                LogUtils.d(TAG, "MAC_ETH get mac address : " + macAddress);
                return macAddress;
            case MAC_WIFI:
                ...
                LogUtils.d(TAG, "MAC_WIFI get mac address : " + macAddress);
                return macAddress;
        }
        ...
        if ("mounted".equals(Environment.getExternalStorageState())) {
            ...
            if (sdcardDir != null && sdcardDir.exists()) {
                try {
                    ...
                    LogUtils.d(TAG, "getSDCardSpareQuantity exception ", e);
                    return -1;
                } catch (Throwable th) {
                    return -1;
                }
    ...
    private static String getSystemProperties(String key) {
        ...
        try {
            ...
            LogUtils.d(TAG, "get SystemProperties key: " + key + " value : " + value);
            return value;
    ...
    public static void updateServerTimeMillis(long serverTime) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, " update server time server time : " + serverTime + " elapsed time = " + sElapsedRealTimeMillis);
        }
    }
    ...
    public static long getServerTimeMillis() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "getServerTimeMillis: currentTimeMillis=" + curTimeMillis + ", serverTimeMillis=" + sServerTimeMillis + ", elapsed=" + sElapsedRealTimeMillis + "~" + elapsedRealTime + ", ret=" + ret);
        }
        return ret;
    }
        ...
        new Thread8K("DeviceUtils") {
            public void run() {
                try {
                    ...
                    if (LogUtils.mIsDebug) {
                        LogUtils.d(DeviceUtils.TAG, "sendKeyCode() keyCode( " + keyCode + " )");
                    }
                } catch (Exception e) {
                    if (LogUtils.mIsDebug) {
    ...
    public static int getCpuCoreNums() {
        if (cpuCores == 0) {
            try {
                cpuCores = new File("/sys/devices/system/cpu/").listFiles(new FileFilter() {
