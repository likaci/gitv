...
class JSConfigDataLoad {
    ...
    private void saveJsonToLocal(String json) {
        ...
        try {
            if (StringUtils.isEmpty((CharSequence) path)) {
                LogUtils.e(TAG, "saveJsonToLocal() -> path :" + path);
                return;
            }
            ...
            LogUtils.e(TAG, "saveJsonToLocal() -> flag :" + FileUtil.writeFile(path, json));
        } catch (Exception e) {
    ...
    private String getLocalConfigJson() {
        ...
        LogUtils.d(TAG, "getLocalConfigJson() -> configJson :" + configJson);
        return configJson;
    }
        ...
        try {
            ...
            try {
                ...
                if (LogUtils.mIsDebug) {
                    LogUtils.d(TAG, "read file:" + filePath + ", length = " + length);
                }
                ...
                try {
                    ...
                    if (fin != null) {
                        try {
                            ...
                            LogUtils.e(TAG, "readFile e2 :" + e22);
                        }
                    }
                    return res;
                } catch (Throwable th2) {
                    ...
                    if (fin != null) {
                        try {
                            ...
                            LogUtils.e(TAG, "readFile e2 :" + e222);
                        }
                    }
                    throw th;
                }
    ...
    private void checkAndSaveResult(String url) {
        if (!StringUtils.isEmpty((CharSequence) url)) {
            LogUtils.d(TAG, "checkResult() -> url :" + url);
            ApiFactory.getCommonApi().callSync(url, new ICommonApiCallback() {
                ...
                public void onException(Exception e, String s) {
                    ...
                    LogUtils.e(JSConfigDataLoad.TAG, "checkCongfigJson() -> callSync exception = " + e);
                }
            }, false, "");
        }
    }
    ...
    private JSONObject getDeviceJsonObject() {
        ...
        LogUtils.d(TAG, "getDeviceJsonObject jo :" + jo.toJSONString());
        return jo;
    }
}
