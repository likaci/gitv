...
public class AlignmentTextView extends TextView {
    ...
    public AlignmentTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.alignmenttextview);
        if (mTypedArray != null) {
            ...
            this.maxLine = mTypedArray.getInteger(R.styleable.alignmenttextview_max_line_is, 300);
            mTypedArray.recycle();
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        LogUtils.d(this.TAG, ">> onMeasure tempLineArray1 " + widthMeasureSpec + ", height " + heightMeasureSpec + ", heightMode:" + heightMode);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.mIsFirstSet) {
            ...
            if (!StringUtils.isEmpty(this.mText)) {
                ...
                LogUtils.d(this.TAG, ">> onDraw mPaddingLeft, " + this.mPaddingLeft + ", mPaddingTop " + this.mPaddingTop + ", mTextWidth " + this.mTextWidth);
    ...
    private ArrayList<LinePar> getLineParList(String mTextStr) {
        ...
        LogUtils.d(this.TAG, ">>  mListener notify count = " + tempLineCount);
