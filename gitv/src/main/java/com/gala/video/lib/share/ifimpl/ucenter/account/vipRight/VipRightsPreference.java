...
public class VipRightsPreference {
    ...
    int getAccountActivationState(Context context) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.i(TAG, "getAccountActivationState()=" + value);
        }
        return value;
    }
    ...
    void setAccountActivationState(Context context, int state) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.i(TAG, "setAccountActivationState() state = " + state + ", account = " + account);
        }
    }
    ...
    int getActivationFeedbackState(Context context) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.i(TAG, "getActivationFeedbackState()=" + value);
        }
        return value;
    }
    ...
    void setActivationFeedbackState(Context context, int state) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.i(TAG, "setActivationFeedbackState() = " + state);
        }
    }
    ...
    String getActivationAccount(Context context) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.i(TAG, "getActivationAccount() = " + account);
        }
        return account;
    }
}
