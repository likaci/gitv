...
public class IntentUtils {
    ...
    public static String getActionName(String oldActionName) {
        LogUtils.d(TAG, "oldActionName=" + oldActionName);
        ...
        LogUtils.d(TAG, "oldPackageName=" + oldPackageName + ",newPackageName=" + newPackageName);
        ...
        LogUtils.d(TAG, "newAction=" + newActionName);
