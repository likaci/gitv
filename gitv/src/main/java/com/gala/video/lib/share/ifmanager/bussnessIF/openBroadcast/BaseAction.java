    ...
    public boolean checkParamsValidity(JSONObject playDict) {
        if (playDict != null) {
            try {
                ...
                LogUtils.d("openplay/broadcast/BaseAction", "customer = " + customer);
        ...
        LogUtils.e("openplay/broadcast/BaseAction", "[INVALID-PARAMTER] [reason:missing field--customer][playInfo:" + playDict.toString() + AlbumEnterFactory.SIGN_STR);
        return false;
    }
}
