...
public class SettingConfig {
    ...
    private static final String[] NAMES_HOME = new String[]{ResourceUtil.getStr(R.string.setting_my), ResourceUtil.getStr(R.string.setting_network), ResourceUtil.getStr(R.string.setting_play_show), ResourceUtil.getStr(R.string.setting_common), ResourceUtil.getStr(R.string.setting_tab_manage), ResourceUtil.getStr(R.string.setting_upgrade), ResourceUtil.getStr(R.string.setting_help), ResourceUtil.getStr(R.string.setting_feedback), ResourceUtil.getStr(R.string.setting_wechat), ResourceUtil.getStr(R.string.setting_multiscreen), ResourceUtil.getStr(R.string.setting_about)};
    private static final String[] NAMES_MINE = new String[]{ResourceUtil.getStr(R.string.setting_network), ResourceUtil.getStr(R.string.setting_play_show), ResourceUtil.getStr(R.string.setting_common), ResourceUtil.getStr(R.string.setting_tab_manage), ResourceUtil.getStr(R.string.setting_upgrade), ResourceUtil.getStr(R.string.setting_help), ResourceUtil.getStr(R.string.setting_feedback), ResourceUtil.getStr(R.string.setting_wechat), ResourceUtil.getStr(R.string.setting_multiscreen), ResourceUtil.getStr(R.string.setting_account_manager), ResourceUtil.getStr(R.string.setting_about), ResourceUtil.getStr(R.string.setting_logout)};
