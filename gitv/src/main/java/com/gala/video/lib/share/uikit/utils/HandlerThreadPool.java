...
public class HandlerThreadPool {
    ...
    public void registerHandler(ThreadHandler handler) {
        if (handler != null) {
            ...
            LOG.d("before size = " + this.mUserCount.size() + " count = " + this.mUserCount.get(thread) + " name = " + thread.getName());
            ((AtomicInteger) this.mUserCount.get(thread)).increment();
            LOG.d("after size = " + this.mUserCount.size() + " count = " + this.mUserCount.get(thread) + " name = " + thread.getName());
