...
class ReceiveMsgPingbackSender {
    ...
    void setContent(IMsgContent con) {
        ...
        this.r = String.valueOf(con.msg_id);
    }

    void sendPingback() {
        PingBackParams params = new PingBackParams();
        params.add(Keys.T, "11").add("ct", "160810_rcvmsg").add(Keys.ISSHOW, this.isShow).add("rlink", this.rLink).add(Keys.JUMP_TYPE, this.jumpType).add("r", this.r).add("content", this.content);
