...
public class VipCard extends GridCard {
    ...
    public void setModel(CardInfoModel model) {
        ...
        if (!StringUtils.isEmpty(tips)) {
            ...
            tc.setTextSize(ResourceUtil.getDimen(R.dimen.dimen_16sp));
            tc.setHeight(ResourceUtil.getDimen(R.dimen.dimen_26dp));
            tc.setBackground(R.drawable.share_top_action_bar_tip_bg);
            tc.setMargin(ResourceUtil.getDimen(R.dimen.dimen_8dp), 0, 0, 0);
            tc.setPadding(ResourceUtil.getDimen(R.dimen.dimen_8dp), 0, ResourceUtil.getDimen(R.dimen.dimen_9dp), 0);
            tc.setTextColor(ResourceUtil.getColor(R.color.action_bar_tip_text));
            tc.setText(tips);
