    ...
    public boolean runCheck() {
        ...
        TVApi.albumInfo.callSync(new IApiCallback<ApiResultAlbum>() {
            public void onSuccess(ApiResultAlbum apiResult) {
                ...
                LogUtils.d(AlbumInfoCheck.TAG, "AlbumInfoCheck onSuccess: fetched info= " + apiResult.data);
            ...
            public void onException(ApiException e) {
                LogUtils.d(AlbumInfoCheck.TAG, "AlbumInfoCheck onException: code=" + e.getCode() + ", msg=" + e.getMessage());
