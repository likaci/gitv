        ...
        TVApi.playCheck.callSync(new IApiCallback<ApiResultCode>() {
            public void onSuccess(ApiResultCode apiResult) {
                if (LogUtils.mIsDebug) {
                    LogUtils.d(PlayerAuthCheck.TAG, "PlayerAuthCheck onSuccess(" + apiResult.code + ")");
                }
            ...
            public void onException(ApiException e) {
                LogUtils.d(PlayerAuthCheck.TAG, "PlayerAuthCheck onException: code=" + e.getCode() + ", msg=" + e.getMessage());
