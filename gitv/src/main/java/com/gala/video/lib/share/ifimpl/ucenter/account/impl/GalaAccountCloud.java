...
class GalaAccountCloud {
    ...
    UserResponseBean loginByKeyInput(String account, String pwd, String verifyCode, final ILoginCallback callback) {
        ...
        PassportTVHelper.loginWithCode.call(new IVrsCallback<ApiResultUserInfo>() {
            ...
            public void onException(ApiException exception) {
                LogUtils.e(GalaAccountCloud.LOG_TAG, ">>>>>PassportTVHelper.loginWithCode.callSync---onException---code:", exception.getCode());
    ...
    void saveVipInfo(User user) {
        ...
        if (vipInfo != null) {
            ...
            if (deadLine != null) {
                ...
                this.mPPreference.setVipTimeStamp(context, deadLine.t);
    ...
    void updateUserTypeForPlayer(String json) {
        try {
            LogUtils.d(LOG_TAG, ">>>>>updateUserTypeForPlayer json: ", json);
            Context context = AppRuntimeEnv.get().getApplicationContext();
            ...
            LogUtils.e(LOG_TAG, ">>>>>updateUserTypeForPlayer json parse error: ", json);
        }
    }
    ...
    private void checkVipAccount(final String cookie) {
        UserHelper.checkVipAccount.callSync(new IVrsCallback<ApiResultKeepaliveInterval>() {
            public void onSuccess(ApiResultKeepaliveInterval result) {
                LogUtils.d(GalaAccountCloud.LOG_TAG, ">>>>>UserHelper.checkVipAccount.callSync---onSuccess, cookie:", cookie);
                AccountAdsHelper.handelCheckVipAccount(result);
            }

            public void onException(ApiException exception) {
                LogUtils.e(GalaAccountCloud.LOG_TAG, ">>>>>UserHelper.checkVipAccount.callSync---onException, code:", exception.getCode());
        ...
        try {
            ...
            FingerPrintManager.getInstance().getFingerPrint(context, new FingerPrintCallBack() {
                public void onSuccess(String fingerPrint) {
                    LogUtils.d(GalaAccountCloud.LOG_TAG, "FingerPrintManager:success, length = " + fingerPrint.length() + " " + fingerPrint);
                    PassportTVHelper.renew_authcookie.call(new IVrsCallback<ApiResultData>() {
                        public void onSuccess(ApiResultData arg0) {
                            LogUtils.d(GalaAccountCloud.LOG_TAG, "renewcookie=" + arg0.data);
                    ...
                    }, GalaAccountCloud.this.mLocal.getAuthCookie(), fingerPrint, evninfo);
                }

                public void onFailed(String message) {
                    LogUtils.d(GalaAccountCloud.LOG_TAG, "FingerPrintManager:failure, " + message);
                }
            });
        } catch (Throwable e) {
            String abi;
