...
public class c {
    ...
    private a f685a;
    final b f686a;
    private final ArrayList<View> f687a;
    final Rect b;
    final Rect c;
    ...
    private static final class b implements Comparator<View> {
        ...
        private void a(View view, Rect rect) {
            ...
            this.f688a.offsetDescendantRectToMyCoords(view, rect);
        }
    }
    ...
    private View a(ViewGroup viewGroup, View view, Rect rect, int i, a aVar) {
        View view2 = null;
        if (view != null) {
            view2 = a(viewGroup, view, i);
        }
        if (view2 == null) {
            this.f685a = aVar;
            ArrayList arrayList = this.f687a;
            try {
                arrayList.clear();
    ...
    private View b(ArrayList<View> arrayList, ViewGroup viewGroup, View view, Rect rect, int i) {
        try {
            this.f686a.a(viewGroup);
            this.f686a.a(false);
            Collections.sort(arrayList, this.f686a);
    ...
    boolean m160a(int i, Rect rect, Rect rect2) {
        switch (i) {
            case 17:
            case 66:
    ...
    boolean m161b(int i, Rect rect, Rect rect2) {
        switch (i) {
            case 17:
