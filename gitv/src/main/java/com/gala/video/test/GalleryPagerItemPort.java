...
public class GalleryPagerItemPort extends AbsGalleryPagerItem implements OnFocusChangeListener {
    ...
    protected OnLayoutChangeListener mLayoutListener = new OnLayoutChangeListener() {
        public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
            int width = right - left;
            LogUtils.d(GalleryPagerItemPort.TAG, "onLayoutChange: width=" + width);
            if (width > 0) {
                ...
                LogUtils.d(GalleryPagerItemPort.TAG, "setTitle: ellipsized=" + ellipsized);
            }
        }
    };
    ...
    protected void initViews(Context context) {
        ...
        LogUtils.d(TAG, "initViews: item w/h=" + this.mItemWidthPadded + "/" + outerH);
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        LogUtils.d(TAG, "[" + hashCode() + "] onFocusChange: " + hasFocus + ", view={" + v + "}");
