...
public class PortraitVideoAdapter extends ViewAdapter<GalleryData> {
    ...
    private View initConvertView(int position, ViewGroup parent) {
        LogUtils.d(TAG, "initConvertView: pos=" + position);
    ...
    private void updateData(BaseViewHolder holder, int position) {
        ...
        LogUtils.d(TAG, "updateData: id=" + data.getId() + ", name=" + data.getName());
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LogUtils.d(TAG, "[" + hashCode() + AlbumEnterFactory.SIGN_STR + "getView(" + position + "): old/new holder Id=" + oldId + "/" + newId);
    ...
    public void notifyDataSetChanged(List<GalleryData> datas) {
        LogUtils.d(TAG, "[" + hashCode() + "] notifyDataSetChanged: datas=" + datas);
        this.mDatas.clear();
