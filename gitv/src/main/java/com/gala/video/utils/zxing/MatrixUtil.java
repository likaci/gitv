...
final class MatrixUtil {
    ...
    private static final int[][] POSITION_ADJUSTMENT_PATTERN_COORDINATE_TABLE = new int[][]{new int[]{-1, -1, -1, -1, -1, -1, -1}, new int[]{6, 18, -1, -1, -1, -1, -1}, new int[]{6, 22, -1, -1, -1, -1, -1}, new int[]{6, 26, -1, -1, -1, -1, -1}, new int[]{6, 30, -1, -1, -1, -1, -1}, new int[]{6, 34, -1, -1, -1, -1, -1}, new int[]{6, 22, 38, -1, -1, -1, -1}, new int[]{6, 24, 42, -1, -1, -1, -1}, new int[]{6, 26, 46, -1, -1, -1, -1}, new int[]{6, 28, 50, -1, -1, -1, -1}, new int[]{6, 30, 54, -1, -1, -1, -1}, new int[]{6, 32, 58, -1, -1, -1, -1}, new int[]{6, 34, 62, -1, -1, -1, -1}, new int[]{6, 26, 46, 66, -1, -1, -1}, new int[]{6, 26, 48, 70, -1, -1, -1}, new int[]{6, 26, 50, 74, -1, -1, -1}, new int[]{6, 30, 54, 78, -1, -1, -1}, new int[]{6, 30, 56, 82, -1, -1, -1}, new int[]{6, 30, 58, 86, -1, -1, -1}, new int[]{6, 34, 62, 90, -1, -1, -1}, new int[]{6, 28, 50, 72, 94, -1, -1}, new int[]{6, 26, 50, 74, 98, -1, -1}, new int[]{6, 30, 54, 78, 102, -1, -1}, new int[]{6, 28, 54, 80, 106, -1, -1}, new int[]{6, 32, 58, 84, 110, -1, -1}, new int[]{6, 30, 58, 86, HistoryInfoHelper.MSG_CACHE_CLEAR_ALL, -1, -1}, new int[]{6, 34, 62, 90, ItemSize.ITEM_118, -1, -1}, new int[]{6, 26, 50, 74, 98, 122, -1}, new int[]{6, 30, 54, 78, 102, Opcodes.IAND, -1}, new int[]{6, 26, 52, 78, 104, Service.CISCO_FNA, -1}, new int[]{6, 30, 56, 82, 108, Service.INGRES_NET, -1}, new int[]{6, 34, 60, 86, HistoryInfoHelper.MSG_MERGE, Service.NETBIOS_DGM, -1}, new int[]{6, 30, 58, 86, HistoryInfoHelper.MSG_CACHE_CLEAR_ALL, Service.BL_IDM, -1}, new int[]{6, 34, 62, 90, ItemSize.ITEM_118, 146, -1}, new int[]{6, 30, 54, 78, 102, Opcodes.IAND, 150}, new int[]{6, 24, 50, 76, 102, 128, Opcodes.IFNE}, new int[]{6, 28, 54, 80, 106, Service.CISCO_SYS, Opcodes.IFLE}, new int[]{6, 32, 58, 84, 110, Service.PROFILE, Opcodes.IF_ICMPGE}, new int[]{6, 26, 54, 82, 110, Service.NETBIOS_DGM, Opcodes.IF_ACMPNE}, new int[]{6, 30, 58, 86, HistoryInfoHelper.MSG_CACHE_CLEAR_ALL, Service.BL_IDM, 170}};
