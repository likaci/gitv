...
public class PlayerActivity extends BasePlayActivity implements IPingbackContext {
    ...
    private void initPingBack() {
        ...
        setItem("e", E.E_ID(getIntent().getStringExtra("eventId")));
        setItem("hcdn", hcdn);
    ...
    public void onBackPressed() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, ">> onBackPressed, from=" + from);
        }
    ...
    public void updatePageState(String pageState) {
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "updatePageState() pageState= " + pageState + ", mIsFirstPlay=" + this.mIsFirstPlay);
        }
    ...
    public Notify onPhoneSync() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "onResult(), ret = " + notify);
        }
        return notify;
    }
