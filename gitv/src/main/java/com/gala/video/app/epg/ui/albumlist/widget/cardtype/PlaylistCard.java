                    ...
                    if (ListUtils.isLegal(cardInfo, 0)) {
                        ...
                        if (!TextUtils.isEmpty(title)) {
                            ...
                            if (count > 0) {
                                ...
                                title = titleView.subText(title, getDimenSize(R.dimen.dimen_397dp) + ((4 - countLength) * getDimenSize(R.dimen.dimen_10dp)));
                                int popupNeedWidth = getDimenSize(R.dimen.dimen_87dp) + ((countLength - 1) * getDimenSize(R.dimen.dimen_10dp));
                                int titleRealLineCount = titleView.getRealLineCount(title);
                                int titleLastLineWidth = titleView.getLastLineWidth(title);
                                int popupMarLeft = getDimenSize(R.dimen.dimen_8dp);
                                if (titleRealLineCount == 1) {
                                    if (titleLastLineWidth + popupNeedWidth < getDimenSize(R.dimen.dimen_263dp)) {
