...
public class KeyboardManager {
        ...
        try {
            if (inputFile.isFile() && inputFile.exists()) {
                ...
                try {
                    ...
                    try {
                            ...
                            try {
                                ...
                                if (bufferedReader != null) {
                                    try {
                                        ...
                                        LogUtils.e(TAG, "bufferedReader:" + e3);
                                    }
                                }
                                if (read != null) {
                                    try {
                                ...
                                if (bufferedReader != null) {
                                    try {
                                        ...
                                        LogUtils.e(TAG, "bufferedReader:" + e32);
                                    }
                                }
                                if (read != null) {
                                    try {
                        ...
                        fread = fread2;
                        if (LogUtils.mIsDebug) {
                            LogUtils.e(TAG, "readLocalFile() -> Error reading the file e:" + e4222);
                        }
                        this.mIsLocalHave = false;
                        if (bufferedReader != null) {
                            bufferedReader.close();
            ...
            if (bufferedReader != null) {
                try {
                    ...
                    LogUtils.e(TAG, "bufferedReader:" + e322);
                }
            }
            if (read != null) {
                try {
            ...
            if (fread != null) {
                try {
                    ...
                    LogUtils.e(TAG, "fread:" + e422222);
                }
            }
        } catch (Exception e7) {
            e422222 = e7;
            if (LogUtils.mIsDebug) {
                LogUtils.e(TAG, "readLocalFile() -> Error reading the file e:" + e422222);
            }
            this.mIsLocalHave = false;
            if (bufferedReader != null) {
                bufferedReader.close();
    ...
    private void readAssetsFile() {
        ...
        try {
            ...
            try {
                ...
                if (bufferedReader2 != null) {
                    try {
                        ...
                        LogUtils.e(TAG, "readAssetsFile bufferedReader:" + e3);
                    }
                }
                if (read2 != null) {
                    try {
                        ...
                        LogUtils.e(TAG, "readAssetsFile read:" + e4);
                    }
                }
                if (fread != null) {
                    try {
                        ...
                        LogUtils.e(TAG, "readAssetsFile fread:" + e42);
                        bufferedReader = bufferedReader2;
                        read = read2;
                        return;
                    }
                ...
                try {
                    if (LogUtils.mIsDebug) {
                        LogUtils.e(TAG, "readAssets() -> Error reading the file e:" + e42);
                    }
                    if (bufferedReader != null) {
                        try {
                            bufferedReader.close();
                        } catch (IOException e32) {
                            LogUtils.e(TAG, "readAssetsFile bufferedReader:" + e32);
                        }
                    }
                    if (read != null) {
                        try {
                            ...
                            LogUtils.e(TAG, "readAssetsFile read:" + e422);
                        }
                    }
                    if (fread != null) {
                        try {
                            ...
                            LogUtils.e(TAG, "readAssetsFile fread:" + e4222);
                        }
                    }
                } catch (Throwable th3) {
                    th = th3;
                    if (bufferedReader != null) {
                        try {
                            ...
                            LogUtils.e(TAG, "readAssetsFile bufferedReader:" + e322);
                        }
                    }
                    if (read != null) {
                        try {
                            ...
                            LogUtils.e(TAG, "readAssetsFile read:" + e42222);
                        }
                    }
                    if (fread != null) {
                        try {
                            ...
                            LogUtils.e(TAG, "readAssetsFile fread:" + e422222);
                        }
                    }
                    throw th;
                }
            ...
            e422222 = e6;
            if (LogUtils.mIsDebug) {
                LogUtils.e(TAG, "readAssets() -> Error reading the file e:" + e422222);
            }
            if (bufferedReader != null) {
                bufferedReader.close();
            }
    ...
    private char[] getKeys(char[][] mDoubleWord, String str, int now, int reckonNumber) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "getKeys() -> posLastLetter :", Integer.valueOf(posLastLetter), "str:", str);
        }
        i = 0;
