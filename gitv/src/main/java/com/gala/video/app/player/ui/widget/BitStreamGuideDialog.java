...
public class BitStreamGuideDialog extends AlertDialog {
    ...
    private OnKeyListener mKeyEventListener = new OnKeyListener() {
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            if (LogUtils.mIsDebug) {
                LogUtils.d(BitStreamGuideDialog.TAG, ">> mKeyEventListener.onKey, v=" + v + ", event=" + event);
            }
    ...
    private void initViews() {
        ...
        ImageProviderApi.getImageProvider().loadImage(new ImageRequest(this.mImgUrl), new IImageCallback() {
        ...
        LinearLayout.LayoutParams bottomLP = new LinearLayout.LayoutParams((ResourceUtil.getDimen(R.dimen.dimen_249dp) + bgPadding.left) + bgPadding.right, (ResourceUtil.getDimen(R.dimen.dimen_60dp) + bgPadding.top) + bgPadding.bottom);
    ...
    private String getLeftButtonTxt() {
        if (this.mParams != null) {
            ...
            if (bitstream != null) {
                ...
                if (type == 2) {
                    return this.mContext.getResources().getString(R.string.employing_six_minutes);
                }
                if (type == 0) {
                    return this.mContext.getResources().getString(R.string.employing_instantly);
                }
            }
        }
        return this.mContext.getResources().getString(R.string.employing_instantly);
    ...
    private String get4kGuideBgImgUrls() {
        ...
        LogUtils.d(TAG, "get4kGuideBgImgUrls=" + hdr4kGuideBgImgUrl);
    ...
    private String get1080GuideBgImgUrls() {
        ...
        LogUtils.d(TAG, "hdr1080GuideBgImgUrl=" + hdr1080GuideBgImgUrl);
    ...
    private String getHDRGuideBgImgUrls() {
        ...
        LogUtils.d(TAG, "hdrGuideBgImgUrl=" + hdrGuideBgImgUrl);
