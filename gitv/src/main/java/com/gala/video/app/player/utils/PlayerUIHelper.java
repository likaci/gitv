...
public class PlayerUIHelper {
    ...
    private static String getJSTVPath() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "getJSTVPath path = " + path);
        }
        return path;
    }
    ...
    private static String getPPSPath() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "getPPSPath path = " + path);
        }
        return path;
    }
    ...
    private static String getGalaPath() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "getPath path = " + path);
        }
        return path;
    }
    ...
    public static String getJumpAdTip() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "getJumpAdTip path = " + path);
        }
        return path;
    }
    ...
    public static String getcannotJumpAdTip() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "getcanntJumpAdTip path=" + path);
        }
        return path;
    }
    ...
    public static String getPushVipPreviewTip() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "getPushVipPreviewTip tip=" + tip);
        }
        return tip;
    }
    ...
    public static String getPreviewNeedBuyTip() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "getPreviewNeedBuyTip path=" + path);
        }
        return path;
    }
    ...
    public static String getPreviewCannotBuyTip() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "getPreviewCannotBuyTip path=" + path);
        }
        return path;
    }
    ...
    public static String getNewPreviewPurchaseTip() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "getNewPreviewPurchaseTip path=" + path);
        }
        return path;
    }
    ...
    public static String getLivePreviewPurchaseTip() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "getLivePreviewPurchaseTip path=" + path);
        }
        return path;
    }
    ...
    private static String getPreviewPurchasePicturePath() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "getPreviewPurchasePicturePath path = " + path);
        }
        return path;
    }
    ...
    private static String getLivePreviewPurchasePicturePath() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "getLivePreviewPurchasePicturePath path = " + path);
        }
        return path;
    }
    ...
    private static Object[] decodeTargetBitmap(Context context, IBitmapDecoder decoder, boolean is3D) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "checkPictureSize heightRatioScreen=" + heightRatioScreen);
        }
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "decodeTargetBitmap: original w/h=" + nativeWidth + "/" + nativeHeight);
        }
    ...
    private static Bitmap createTargetBitmap(Context context, IBitmapDecoder decoder, float nativeWidth, float nativeHeight, float targetWidth, float targetHeight, ScaleType type, Config config) {
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, ">> createTargetBitmap: target w/h=" + targetWidth + "/" + targetHeight + ", scale type=" + type);
        }
        try {
            ...
            if (LogUtils.mIsDebug) {
                LogUtils.d(TAG, "createTargetBitmap: scaled w/h=" + scaledWidth + "/" + scaledHeight);
            }
    ...
    public static Object[] getDefaultBitmap(Context context, boolean is3D) {
        ...
        return decodeTargetBitmap(context, new ResDecoder(context.getResources(), R.drawable.player_tip_indication), is3D);
    }
    ...
    public static Object[] getHDRDefaultBitmap(Context context, boolean is3D) {
        ...
        return decodeTargetBitmap(context, new ResDecoder(context.getResources(), R.drawable.player_hdr_tip_indication), is3D);
    }
    ...
    public static Object[] getLoginBitmap(Context context, boolean is3D) {
        ...
        return decodeTargetBitmap(context, new ResDecoder(context.getResources(), R.drawable.player_login), is3D);
    }
}
