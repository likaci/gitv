...
public class AppOperateRequestTask extends BaseRequestTask {
    ...
    public AppOperateRequestTask() {
        ...
        this.mUrl = "";
        this.mICommonApiCallback = new ICommonApiCallback() {
            public void onSuccess(String resJson) {
                ...
                LogUtils.d(AppOperateRequestTask.TAG, "mICommonApiCallback() ->  onSuccess = " + resJson);
                try {
            ...
            public void onException(Exception e, String code) {
                String str;
                LogUtils.e(AppOperateRequestTask.TAG, "mICommonApiCallback() -> onException() -> e:", e, "code:", code);
    ...
    public AppOperateRequestTask(boolean fromOpenApi) {
        this.mFromOpenApi = false;
        this.mUrl = "";
        this.mICommonApiCallback = /* anonymous class already generated */;
    ...
    private List<AppDataModel> getOperateDataModelList(List<?> info, int flag) {
        if (ListUtils.isEmpty((List) info)) {
            LogUtils.e(TAG, "getOperateDataModelList() -> list == null ,size:" + info.size());
            return null;
        }
    ...
    public void invoke() {
        ...
        this.mUrl = url;
        LogUtils.d(TAG, "requestDataInThread() ->  url = " + url);
