...
public class StartUpCostInfoProvider {
    ...
    public void onPreviewCompleted(long time) {
        LogUtils.d(TAG, "onPreviewCompleted, preview complete time : " + time);
    ...
    public void onHomeBuildCompleted(long time) {
        LogUtils.d(TAG, "onHomeBuildCompleted, home build complete time : " + time);
    ...
    private void sendStartupPingback() {
        ...
        LogUtils.d(TAG, "old version :" + oldApkVersionStr + ", current apk version : " + currentAPKVersionStr);
