...
public class EquityView extends RelativeLayout {
    ...
    private void initialize(Context context) {
        ...
        this.mIvEquity = (ImageView) findViewById(R.id.share_detail_iv_album_equity);
        this.mTvCouponCount = (TextView) findViewById(R.id.share_detail_tv_album_coupon_count);
        this.mTvPrice = (TextView) findViewById(R.id.share_detail_tv_album_price);
        this.mTvOriginPrice = (TextView) findViewById(R.id.share_detail_tv_album_origin_price);
    }
    ...
    private int parseInt(String s) {
        if (!StringUtils.isEmpty((CharSequence) s)) {
            try {
                ...
                LogUtils.d(TAG, "parseInt(): error" + s);
            }
        }
        return 0;
    }
