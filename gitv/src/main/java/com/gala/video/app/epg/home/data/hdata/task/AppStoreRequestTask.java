...
public class AppStoreRequestTask extends BaseRequestTask {
    ...
    private OnGetUrlListener mDownloadApkUrlListener = new OnGetUrlListener() {
        ...
        public void onFailure(RetrofitError e) {
            boolean z;
            String str;
            LogUtils.e(AppStoreRequestTask.TAG, "mDownloadApkUrlListener() -> onFailure() RetrofitError e:", e);
    ...
    L_0x0025:
        ...
        com.gala.video.lib.framework.core.utils.LogUtils.e(r1, r2, r0);	 Catch:{ all -> 0x0039 }
        r1 = "home/AppStoreRequestTask";
        r2 = "requestDataFromServer() -> mCountDownLatch end";
        com.gala.video.lib.framework.core.utils.LogUtils.e(r1, r2);
        goto L_0x0024;
    L_0x0039:
        ...
        com.gala.video.lib.framework.core.utils.LogUtils.e(r2, r3);
        throw r1;
        */
