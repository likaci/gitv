...
public class ItemUiFactory {
    public static int getRectBgResId(boolean isVipTab) {
        if (isVipTab) {
            return R.drawable.share_item_vip_selector;
        }
        return R.drawable.share_item_rect_selector;
    }

    public static int getRectBtnResId(boolean isVipTab) {
        if (isVipTab) {
            return R.drawable.share_item_rect_vip_btn_selector;
        }
        return R.drawable.share_item_rect_btn_selector;
    }
    ...
    public static Drawable getSkewBgDrawable(boolean isVipTab) {
        if (isVipTab) {
            return ResourceUtil.getDrawable(R.drawable.epg_item_skew_bg_vip);
        }
        return ResourceUtil.getDrawable(R.drawable.epg_item_skew_bg);
    }
    ...
    public static int getCircleTextSpecialFocusColor(boolean isVipTab) {
        if (isVipTab) {
            return ResourceUtil.getColor(R.color.item_vip_focus_color);
        }
        return ResourceUtil.getColor(R.color.item_normal_focus_color);
    }
