...
public class FetchSourceDetailInfoJob extends AlbumJob {
    ...
    IFetchSourceCacheTaskListener fetchSourceCacheTaskListener = new IFetchSourceCacheTaskListener() {
        ...
        public void onFailed(ApiException e) {
            LogUtils.d(FetchSourceDetailInfoJob.TAG, "onException: code=" + e.getCode() + ", msg=" + e.getMessage());
