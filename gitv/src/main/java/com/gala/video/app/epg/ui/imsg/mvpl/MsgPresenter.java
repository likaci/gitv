...
public class MsgPresenter implements Presenter {
    ...
    private Runnable mUpdateUnreadMsgCountRunnable = new Runnable() {
        public void run() {
    ...
    private void fetchLabelContent(final int labelIndex) {
        LogUtils.e(TAG, "fetchLabelContent --- index = ", Integer.valueOf(labelIndex));
        ...
        this.mTasksRepository.getMsgList(type, new IMsgCallback() {
            public void onSuccess(List<IMsgContent> list) {
                ...
                LogUtils.i(MsgPresenter.TAG, "fetchLabelContent --- consumeTime = ", Long.valueOf(System.currentTimeMillis() - startTime));
