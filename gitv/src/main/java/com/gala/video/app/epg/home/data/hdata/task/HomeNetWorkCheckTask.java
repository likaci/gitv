...
public class HomeNetWorkCheckTask extends BaseRequestTask {
        ...
        public void onStateChanged(int oldState, int newState) {
            switch (newState) {
                ...
                case 2:
                    ...
                    LogUtils.e(HomeNetWorkCheckTask.TAG, "network state changed net state = " + newState);
                    return;
                default:
                    return;
            }
    ...
    public HomeNetWorkCheckTask() {
        LogUtils.d(TAG, "home network check task");
    }
    ...
    public void invoke() {
        ...
        LogUtils.e(TAG, "api code : " + apiCode);
        if (StringUtils.isEmpty(apiCode) || NetWorkStateHelper.isNoNetWorkOnBootUp()) {
            ...
            LogUtils.e(TAG, "home network check is finished");
            return;
        }
        ApiExceptionModelFactory.createDevApiExceptionModel();
    }
