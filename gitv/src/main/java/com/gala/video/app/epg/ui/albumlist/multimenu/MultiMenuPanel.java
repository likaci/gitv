...
public class MultiMenuPanel extends RelativeLayout {
    ...
    private ScrollerDrawListener mScrollerDrawListener = new ScrollerDrawListener() {
    ...
    private ScrollerEventListener mScrollerEventListener = new ScrollerEventListener() {
    ...
    public void fillData(List<TwoLevelTag> subTags, int channelId) {
        ...
        for (int i = 0; i < this.mMenuDataLineCount; i++) {
            ...
            LayoutParams params1 = new LayoutParams(-1, ResourceUtil.getDimen(R.dimen.dimen_42dp));
            if (i < this.mMenuDataLineCount - 1) {
                params1.topMargin = ResourceUtil.getDimen(R.dimen.dimen_7dp);
                params1.bottomMargin = ResourceUtil.getDimen(R.dimen.dimen_7dp);
            } else {
                params1.topMargin = ResourceUtil.getDimen(R.dimen.dimen_7dp);
                params1.bottomMargin = ResourceUtil.getDimen(R.dimen.dimen_12dp);
            }
            this.mLeftTitleLayout.addView(titleTv, params1);
            ScrollerLayout scrollerLayout = getPerScrollerLayout(i, isSortLine);
            this.mRightMenuLayout.addView(scrollerLayout, new LayoutParams(ResourceUtil.getDimen(R.dimen.dimen_900dp), -2));
    ...
    private ScrollerLayout getPerScrollerLayout(int linePos, boolean isSortLine) {
        ...
        for (int childPos = 0; childPos < size; childPos++) {
            ...
            try {
                textWidth = textView.getPaint().measureText(threeLevelTag.n);
            } catch (Exception e) {
            }
            ...
            params = new LayoutParams(ResourceUtil.getDimen(R.dimen.dimen_82dp), ResourceUtil.getDimen(R.dimen.dimen_43dp));
            if (textWidth > ((float) ResourceUtil.getDimen(R.dimen.dimen_102dp))) {
                params.width = ResourceUtil.getDimen(R.dimen.dimen_151dp);
            } else if (textWidth > ((float) ResourceUtil.getDimen(R.dimen.dimen_60dp))) {
                params.width = ResourceUtil.getDimen(R.dimen.dimen_122dp);
            }
            params.leftMargin = (int) getResources().getDimension(R.dimen.dimen_10dp);
            if (linePos < this.mMenuDataLineCount - 1) {
                params.topMargin = ResourceUtil.getDimen(R.dimen.dimen_7dp);
                params.bottomMargin = ResourceUtil.getDimen(R.dimen.dimen_7dp);
            } else {
                params.topMargin = ResourceUtil.getDimen(R.dimen.dimen_7dp);
                params.bottomMargin = ResourceUtil.getDimen(R.dimen.dimen_12dp);
            }
            scrollerLayout.addView(textView, params);
        }
        params = new LayoutParams(ResourceUtil.getDimen(R.dimen.dimen_30dp), ResourceUtil.getDimen(R.dimen.dimen_43dp));
    ...
    private void addRightLayout() {
        RelativeLayout.LayoutParams rightParams = new RelativeLayout.LayoutParams(ResourceUtil.getDimen(R.dimen.dimen_1050dp), -2);
        rightParams.leftMargin = (int) getResources().getDimension(R.dimen.dimen_150dp);
        rightParams.topMargin = (int) getResources().getDimension(R.dimen.dimen_20dp);
    ...
    private void addLeftLayout() {
        RelativeLayout.LayoutParams leftParams = new RelativeLayout.LayoutParams(ResourceUtil.getDimen(R.dimen.dimen_143dp), -2);
        leftParams.topMargin = ResourceUtil.getDimen(R.dimen.dimen_20dp);
        addView(this.mLeftTitleLayout, leftParams);
    }

    private void setMultiMenuTextViewStyle(int i, TextView textView) {
        textView.setTextColor(ResourceUtil.getColorStateList(R.color.epg_menu_panel_textcolor_selected));
        textView.setBackgroundResource(R.drawable.epg_menu_panel_button);
        textView.setTextSize(0, (float) ResourceUtil.getDimen(R.dimen.dimen_20dp));
    }
    ...
    private StringBuffer appendTagStringId(View view, StringBuffer stringId, int i) {
        ...
        if (!StringUtils.isEmpty(threeLevelTag.v)) {
            stringId.append(threeLevelTag.v);
    ...
    private StringBuffer appendTagStringName(View view, StringBuffer stringName) {
        ...
        if (!STR_ALL.equals(threeLevelTag.n)) {
            stringName.append(threeLevelTag.n);
            stringName.append("/");
        }
        return stringName;
    }
    ...
    private TextView getMultiMenuTwoLevelLeftTitleTv(String text) {
        ...
        titleTxt.setTextColor(ResourceUtil.getColor(R.color.card_grey_color));
        titleTxt.setSingleLine();
        titleTxt.setTextSize(0, (float) ResourceUtil.getDimen(R.dimen.dimen_20dp));
