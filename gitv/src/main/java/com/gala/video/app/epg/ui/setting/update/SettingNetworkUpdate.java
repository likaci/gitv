...
public class SettingNetworkUpdate extends BaseSettingUpdate {
    ...
    private String getNetSpeed(Context context) {
        ...
        return context.getResources().getString(R.string.setting_netspeed, new Object[]{netSpeed}) + " ";
    }
    ...
    private String getNetState(Context context) {
        ...
        switch (netState) {
            ...
            case 3:
                ...
                return context.getResources().getString(R.string.setting_netstate_wifi, new Object[]{wifiInfo.getSSID()}) + " ";
            case 2:
            case 4:
    ...
    public String getLastStateByPos(SettingItem item) {
        ...
        LogUtils.d(LOG_TAG, ">>>>>getLastStateByPos: ", lastState);
        return lastState;
    }
}
