    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getActivity() != null) {
            ...
            if (intent != null) {
                ...
                LogUtils.d(LOG_TAG, ">>>>> s1 --- intent.getStringExtra(ILoginConstant.INCOMSRC_TAB) --- ", this.mIncomSrc);
            }
        }
    }
            ...
            activity.runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if (intentFlag == 1) {
                        ...
                        LogUtils.d(BaseLoginFragment.LOG_TAG, "LoginConstant.LOGIN_SUCC_TO_COUPON");
                        intent = activity.getIntent();
                        String coupon_key = "";
                        String coupon_sign = "";
                        String from = "";
                        ...
                        LogUtils.d(BaseLoginFragment.LOG_TAG, ">>>>> from, coupon_key, coupon_sign, enterType, incomsrc = ", from, ", ", coupon_key, ", ", coupon_sign, ", ", Integer.valueOf(enter_type), ", ", BaseLoginFragment.this.mIncomSrc);
