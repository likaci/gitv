...
public class DetailDebugHelper {
    ...
    public static ApiException checkForSimulatedDataError() {
        ...
        LogUtils.d(TAG, "checkForSimulatedDataError: fakeException=" + fakeException);
        return fakeException;
    }
    ...
    private static int[] getTestLostEpisodes() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, ">>checkForEpisodeLostError: lost=" + lost);
        }
        ...
        LogUtils.d(TAG, "checkForEpisodeLostError: return=" + result.length);
        return result;
    }
                ...
                for (int fakeLostOrder : fakeLostEpisodeOrders) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (episode.order == fakeLostOrder) {
                            if (LogUtils.mIsDebug) {
                                LogUtils.d(TAG, "remove=" + fakeLostOrder);
                            }
