...
public class VipRightsScanLoginFragment extends BaseLoginFragment implements OnClickListener, OnFocusChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.mMainView = inflater.inflate(R.layout.epg_fragment_vip_rights_login, null);
        ...
        if (StringUtils.isEmpty((CharSequence) qrTip)) {
            qrTip = getStr(R.string.login_qr_tip);
        }
    ...
    protected void callQRBitmap() {
        PassportTVHelper.getTVLoginToken.call(new IVrsCallback<ApiResultQuickLogin>() {
            public void onSuccess(final ApiResultQuickLogin resultQuickLogin) {
                LogUtils.i(VipRightsScanLoginFragment.LOG_TAG, "onSuccess --- PassportTVHelper.getTVLoginToken.call");
                IDynamicResult dynamicQDataModel = GetInterfaceTools.getIDynamicQDataProvider().getDynamicQDataModel();
                String payeeType = "";
                String ab_test = "";
                ...
                TVApi.tinyurl.call(new IApiCallback<ApiResultTinyurl>() {
                    public void onSuccess(ApiResultTinyurl arg0) {
                        LogUtils.i(VipRightsScanLoginFragment.LOG_TAG, "onSuccess --- TVApi.tinyurl.call：" + arg0.data.url);
                        AnonymousClass3.this.doHasQRContent(resultQuickLogin, arg0.data.url);
                    }

                    public void onException(ApiException exception) {
                        LogUtils.e(VipRightsScanLoginFragment.LOG_TAG, "onException --- TVApi.tinyurl.call");
                        LoginPingbackUtils.getInstance().errorPingback("315009", "login", "TVApi.tinyurl", exception);
                        AnonymousClass3.this.doHasNoQRContent();
                    }
                }, qrContent);
            }

            public void onException(ApiException exception) {
                LogUtils.e(VipRightsScanLoginFragment.LOG_TAG, "onException --- PassportTVHelper.getTVLoginToken.call");
                    ...
                    VipRightsScanLoginFragment.this.getActivity().runOnUiThread(new Runnable() {
                        public void run() {
                            if (VipRightsScanLoginFragment.this.mTimeRunnable != null) {
                                LogUtils.e(VipRightsScanLoginFragment.LOG_TAG, "mQRImage.removeCallbacks(r) ----- PassportTVHelper.getTVLoginToken.call --- exception");
                            ...
                            VipRightsScanLoginFragment.this.mQRBgView.setBackgroundColor(VipRightsScanLoginFragment.this.getColor(R.color.transparent));
                            ...
                            if (VipRightsScanLoginFragment.this.mLoginBtn != null && VipRightsScanLoginFragment.this.mLoginBtn.getVisibility() == 0) {
                                VipRightsScanLoginFragment.this.mLoginBtn.setNextFocusUpId(R.id.epg_view_failure);
                            }
                        }
                    });
                }
            ...
            private void doHasQRContent(ApiResultQuickLogin resultQuickLogin, String qrContent) {
                ...
                final Bitmap bitmap = QRUtils.createQRImage(qrContent, VipRightsScanLoginFragment.this.getDimen(R.dimen.dimen_310dp), VipRightsScanLoginFragment.this.getDimen(R.dimen.dimen_310dp));
                if (bitmap != null && VipRightsScanLoginFragment.this.getActivity() != null) {
                    LogUtils.d(VipRightsScanLoginFragment.LOG_TAG, ">>>>>二维码扫码成功展示pingback");
                    ...
                    VipRightsScanLoginFragment.this.getActivity().runOnUiThread(new Runnable() {
                        public void run() {
                            VipRightsScanLoginFragment.this.mLoadingView.setVisibility(4);
                            VipRightsScanLoginFragment.this.mQRBgView.setBackgroundColor(VipRightsScanLoginFragment.this.getColor(R.color.gala_write));
                            VipRightsScanLoginFragment.this.mQRImage.setVisibility(0);
                            VipRightsScanLoginFragment.this.mQRImage.setImageBitmap(bitmap);
                            VipRightsScanLoginFragment.this.mQRImage.postDelayed(VipRightsScanLoginFragment.this.mTimeRunnable, 1000);
                            if (VipRightsScanLoginFragment.this.mLoginBtn != null && VipRightsScanLoginFragment.this.mLoginBtn.getVisibility() == 0) {
                                VipRightsScanLoginFragment.this.mLoginBtn.setNextFocusUpId(R.id.epg_login_qr_bg);
                            }
                        }
                    });
                }
    ...
    protected void checkQRLoad() {
        if (this.mIsCheckable) {
            ...
            GetInterfaceTools.getIGalaAccountManager().loginByScan(this.mToken, new ILoginCallback() {
                public void onLoginSuccess(UserInfoBean bean) {
                    ...
                    if (VipRightsScanLoginFragment.this.mTimeRunnable != null) {
                        LogUtils.e(VipRightsScanLoginFragment.LOG_TAG, "mQRImage.removeCallbacks(r) ----- PassportTVHelper.checkTVLogin.call --- onSuccess");
                        VipRightsScanLoginFragment.this.mQRImage.removeCallbacks(VipRightsScanLoginFragment.this.mTimeRunnable);
                    }
                ...
                public void onLoginFail(ApiException exception) {
                    LogUtils.e(VipRightsScanLoginFragment.LOG_TAG, ">>>>> GetInterfaceTools.getIGalaAccountManager().loginByScan --- return onException");
                }
            });
        }
    }
    ...
    public void onClick(View v) {
        int vId = v.getId();
        if (vId == R.id.epg_view_failure) {
            if (this.mQRFailView.getVisibility() == 0) {
                loadQRBitmap();
            }
        } else if (vId == R.id.epg_btn_comm_login && this.mLoginBtn.getVisibility() == 0 && this.mLoginEvent != null) {
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        if (v.getId() == R.id.epg_btn_comm_login) {
