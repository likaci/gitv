...
public class ItemCorner {
    ...
    void setCornerBg() {
        if (!this.mIsToBeOnlineShowing && !this.mIsRankShowing) {
            ...
            if (this.mItemData.isPlaying) {
                ...
                if (this.mIsDolbyShowing && this.mIs3DShowing) {
                    this.mCornerLBBg.setWidth(ResourceUtil.getDimen(R.dimen.dimen_105dp));
                } else if (this.mIsDolbyShowing && !this.mIs3DShowing) {
                    this.mCornerLBBg.setWidth(ResourceUtil.getDimen(R.dimen.dimen_70dp));
                } else if (!this.mIsDolbyShowing && this.mIs3DShowing) {
                    this.mCornerLBBg.setWidth(ResourceUtil.getDimen(R.dimen.dimen_50dp));
                }
    ...
    private void setPlaying(boolean isPlaying) {
        ...
        if (isPlaying) {
            if (this.mDisableGifAnim) {
                this.mPlayingGifView.setResourceId(R.drawable.share_detail_gif_playing_6);
            } else {
                this.mPlayingGifView.setResourceId(R.drawable.share_detail_gif_playing);
            ...
            this.mCornerLBBg.setDrawable(ImageCacheUtil.CORNER_BG_LEFT);
            this.mCornerLBBg.setWidth(ResourceUtil.getDimen(R.dimen.dimen_48dp));
            adjustGifPlace();
            return;
        }
    ...
    void setCornerRankVisible() {
        ...
        if (this.mCornerRankImage != null && this.mItemData != null) {
            ...
            switch (rank) {
                case 1:
                    this.mCornerRankImage.setDrawable(ResourceUtil.getDrawable(R.drawable.share_corner_rank_1));
                    break;
                case 2:
                    this.mCornerRankImage.setDrawable(ResourceUtil.getDrawable(R.drawable.share_corner_rank_2));
                    break;
                case 3:
                    this.mCornerRankImage.setDrawable(ResourceUtil.getDrawable(R.drawable.share_corner_rank_3));
                    break;
                case 4:
                    this.mCornerRankImage.setDrawable(ResourceUtil.getDrawable(R.drawable.share_corner_rank_4));
                    break;
                case 5:
                    this.mCornerRankImage.setDrawable(ResourceUtil.getDrawable(R.drawable.share_corner_rank_5));
                    break;
                case 6:
                    this.mCornerRankImage.setDrawable(ResourceUtil.getDrawable(R.drawable.share_corner_rank_6));
                    break;
                case 7:
                    this.mCornerRankImage.setDrawable(ResourceUtil.getDrawable(R.drawable.share_corner_rank_7));
                    break;
                case 8:
                    this.mCornerRankImage.setDrawable(ResourceUtil.getDrawable(R.drawable.share_corner_rank_8));
                    break;
                case 9:
                    this.mCornerRankImage.setDrawable(ResourceUtil.getDrawable(R.drawable.share_corner_rank_9));
                    break;
                case 10:
                    this.mCornerRankImage.setDrawable(ResourceUtil.getDrawable(R.drawable.share_corner_rank_10));
                    break;
            }
    ...
    void setCornerSubjectVisible() {
        getCornerRLView();
        if (this.mCornerRTImage != null) {
            this.mCornerRTImage.setDrawable(ResourceUtil.getDrawable(R.drawable.share_corner_zhuanti));
            adjustCornerRTViewPlace();
        }
    }
    ...
    void setCornerDujiaVisible() {
        getCornerRLView();
        if (this.mCornerRTImage != null) {
            this.mCornerRTImage.setDrawable(ResourceUtil.getDrawable(R.drawable.share_corner_dujia));
            adjustCornerRTViewPlace();
        }
    }
