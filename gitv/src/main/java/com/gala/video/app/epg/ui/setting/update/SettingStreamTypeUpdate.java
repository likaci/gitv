...
public class SettingStreamTypeUpdate extends BaseSettingUpdate {
    ...
    public void saveNewCache(String selectedState) {
        ...
        LogUtils.i(LOG_TAG, ">>>>> save Stream Type ", Integer.valueOf(definition));
        LogUtils.i(LOG_TAG, ">>>>> save Audio Type ", Integer.valueOf(audiotype));
    ...
    private String getStreamType(Context context) {
        ...
        LogUtils.i(LOG_TAG, ">>>>>getStreamType() ---end--- definition = ", Integer.valueOf(definition), " --- result = ", result);
        return result;
    }
}
