...
public class DigitKeyboard extends RelativeLayout {
    ...
    private OnClickListener mListener = new OnClickListener() {
        public void onClick(View v) {
            LogUtils.d("DigitKeyboard", "onClick, mTargetView = " + (DigitKeyboard.this.mTargetView == null ? "mTargetView is null" : DigitKeyboard.this.mTargetView.getText()));
            ...
            LogUtils.d("DigitKeyboard", "text length=" + sb.length() + "keyCode = " + ((TextView) v).getText());
            if (sb.length() < DigitKeyboard.this.PHONE_NUMBER_LIMIT || v.getId() == R.id.epg_key_del || v.getId() == R.id.epg_key_clear) {
                int i = v.getId();
                if (i == R.id.epg_key_0) {
                    sb.append("0");
                } else if (i == R.id.epg_key_1) {
                    sb.append("1");
                } else if (i == R.id.epg_key_2) {
                    sb.append("2");
                } else if (i == R.id.epg_key_3) {
                    sb.append("3");
                } else if (i == R.id.epg_key_4) {
                    sb.append("4");
                } else if (i == R.id.epg_key_5) {
                    sb.append("5");
                } else if (i == R.id.epg_key_6) {
                    sb.append("6");
                } else if (i == R.id.epg_key_7) {
                    sb.append("7");
                } else if (i == R.id.epg_key_8) {
                    sb.append("8");
                } else if (i == R.id.epg_key_9) {
                    sb.append("9");
                } else if (i == R.id.epg_key_del) {
                    if (sb.length() > 0) {
                        sb.deleteCharAt(sb.length() - 1);
                    }
                } else if (i == R.id.epg_key_clear && sb.length() > 0) {
    ...
    private void init(Context context) {
        ...
        addView(child);
        this.mKey0 = (Button) child.findViewById(R.id.epg_key_0);
        this.mKey0.setOnClickListener(this.mListener);
        this.mKey1 = (Button) child.findViewById(R.id.epg_key_1);
        this.mKey1.setOnClickListener(this.mListener);
        this.mKey2 = (Button) child.findViewById(R.id.epg_key_2);
        this.mKey2.setOnClickListener(this.mListener);
        this.mKey3 = (Button) child.findViewById(R.id.epg_key_3);
        this.mKey3.setOnClickListener(this.mListener);
        this.mKey4 = (Button) child.findViewById(R.id.epg_key_4);
        this.mKey4.setOnClickListener(this.mListener);
        this.mKey5 = (Button) child.findViewById(R.id.epg_key_5);
        this.mKey5.setOnClickListener(this.mListener);
        this.mKey6 = (Button) child.findViewById(R.id.epg_key_6);
        this.mKey6.setOnClickListener(this.mListener);
        this.mKey7 = (Button) child.findViewById(R.id.epg_key_7);
        this.mKey7.setOnClickListener(this.mListener);
        this.mKey8 = (Button) child.findViewById(R.id.epg_key_8);
        this.mKey8.setOnClickListener(this.mListener);
        this.mKey9 = (Button) child.findViewById(R.id.epg_key_9);
        this.mKey9.setOnClickListener(this.mListener);
        this.mKeyDel = (Button) child.findViewById(R.id.epg_key_del);
        this.mKeyDel.setOnClickListener(this.mListener);
        this.mKeyClear = (Button) child.findViewById(R.id.epg_key_clear);
