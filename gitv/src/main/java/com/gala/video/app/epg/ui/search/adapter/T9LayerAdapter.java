...
public class T9LayerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        int background = R.drawable.epg_t9_layer_bg;
        int textColor = R.color.gala_green;
        TextView view = new TextView(this.mContext);
        view.setBackgroundResource(background);
        view.setTextColor(getColor(textColor));
        QSizeUtils.setTextSize(view, R.dimen.dimen_29dp);
        view.setGravity(17);
        return view;
    }

    public void changeTextColor(View view, boolean hasFocus) {
        ((TextView) view).setTextColor(getColor(hasFocus ? R.color.gala_write : R.color.gala_green));
    }
