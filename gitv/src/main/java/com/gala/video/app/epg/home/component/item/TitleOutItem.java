...
public class TitleOutItem extends AndroidItem {
    private static final int CHANGE_FOCUS_EXTRA_SPACE = ResourceUtil.getDimen(R.dimen.dimen_19dp);
    ...
    protected void setData() {
        ...
        this.mTitleView.setNormalColor(this.mContext.getResources().getColor(R.color.albumview_normal_color));
    ...
    private void setChannelId() {
        if (this.mItemData.isCarouselChannel) {
            ...
            if (!TextUtils.isEmpty(this.mChannelIdStr)) {
                this.mTitleView.setMarginLeft(ResourceUtil.getDimen(R.dimen.dimen_42dp));
                this.mTitleView.setPaddingRight(ResourceUtil.getDimen(R.dimen.dimen_42dp));
                this.mTitleBgView.setMarginLeft(ResourceUtil.getDimen(R.dimen.dimen_42dp));
                this.mChannelIdImageView.setMarginLeft(0);
                this.mChannelIdImageView.setMarginBottom(CHANGE_FOCUS_EXTRA_SPACE);
                this.mChannelIdImageView.setWidth(ResourceUtil.getDimen(R.dimen.dimen_42dp));
                this.mChannelIdImageView.setHeight(ResourceUtil.getDimen(R.dimen.dimen_42dp));
            }
    ...
    protected void initViewComponent() {
        ...
        this.mCoreImageView.setPaddingBottom(ResourceUtil.getDimen(R.dimen.dimen_55dp));
    }
        ...
        if (hasFocus) {
            if (TextUtils.isEmpty(this.mTitleStr)) {
                ...
                if (this.mTitleView.getRealLineCount() == 1) {
                    ...
                    this.mView.setBgPaddingBottom(CHANGE_FOCUS_EXTRA_SPACE);
                    this.mBottomBgGreenColorView.setHeight(ResourceUtil.getDimen(R.dimen.dimen_36dp));
                    ...
                    this.mTitleView.setMarginBottom(ResourceUtil.getDimen(R.dimen.dimen_6dp));
                    this.mView.setBgPaddingBottom(0);
                    this.mBottomBgGreenColorView.setHeight(ResourceUtil.getDimen(R.dimen.dimen_55dp));
                    this.mBottomBgGreenColorView.setGravity(Gravity4CuteImage.CENTER_OF_BOTTOM);
                ...
                if (!TextUtils.isEmpty(this.mChannelIdStr) && this.mItemData.isCarouselChannel) {
                    if (this.mTitleView.getRealLineCount() == 2) {
                        this.mChannelIdTextView.setMarginBottom(ResourceUtil.getDimen(R.dimen.dimen_15dp));
                    } else {
                        this.mChannelIdTextView.setMarginBottom(ResourceUtil.getDimen(R.dimen.dimen_13dp));
                    }
                }
            }
