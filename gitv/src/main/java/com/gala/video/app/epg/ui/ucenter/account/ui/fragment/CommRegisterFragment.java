...
public class CommRegisterFragment extends BaseLoginFragment implements OnClickListener, OnFocusChangeListener, IRegisterView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.mMainView = inflater.inflate(R.layout.epg_fragment_comm_register, null);
        findViewById();
        initCommUIData();
        initFocusForward();
        registerListener();
    ...
    public void onClick(View v) {
        if (this.mLoginEvent != null && this.mRegisterPresenter != null) {
            int vId = v.getId();
            if (vId == R.id.epg_view_change_tab_regist) {
                setBack(false);
                getFragmentManager().popBackStack();
            } else if (vId == R.id.epg_input_username_regist) {
                this.mRegisterPresenter.switchInputAccount();
            } else if (vId == R.id.epg_input_password_regist) {
                this.mRegisterPresenter.switchInputPassword();
            } else if (vId == R.id.epg_input_verification_code_regist) {
                this.mRegisterPresenter.switchInputVerifyCode();
            } else if (vId == R.id.epg_input_message_code) {
                this.mRegisterPresenter.switchInputMessageCode();
            } else if (vId == R.id.epg_btn_regist) {
                this.mRegisterPresenter.callRegisterRequest();
            } else if (vId == R.id.epg_image_verify_regist) {
                this.mRegisterPresenter.loadVerifyCode();
            } else if (vId == R.id.epg_btn_message) {
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        int vid = v.getId();
        if (vid == R.id.epg_input_username_regist || vid == R.id.epg_input_password_regist || vid == R.id.epg_input_verification_code_regist || vid == R.id.epg_input_message_code || vid == R.id.epg_image_verify_regist || vid == R.id.epg_btn_regist || vid == R.id.epg_btn_message || vid == R.id.epg_view_change_tab_regist) {
            if (vid == R.id.epg_input_username_regist || vid == R.id.epg_input_password_regist || vid == R.id.epg_input_verification_code_regist || vid == R.id.epg_input_message_code) {
                setHintColor(vid, hasFocus ? R.color.gala_write : R.color.hot_search);
            }
            if (v.getId() == R.id.epg_view_change_tab_regist) {
    ...
    private void viewBringToFront(View v, int vid) {
        if (vid == R.id.epg_input_verification_code_regist || vid == R.id.epg_input_message_code || vid == R.id.epg_image_verify_regist) {
            v.bringToFront();
        }
    }
    ...
    public void showMessagecodeErrorTipUI(boolean showIcon, int resId) {
        ...
        if (this.mMessageErrorView != null && this.mMessageErrorView.getVisibility() == 4) {
            ImageView tipIcon = (ImageView) this.mMessageErrorView.findViewById(R.id.epg_error_tip_icon);
            TextView tipText = (TextView) this.mMessageErrorView.findViewById(R.id.epg_error_tip_text);
            if (showIcon) {
                i = 0;
            }
            tipIcon.setVisibility(i);
