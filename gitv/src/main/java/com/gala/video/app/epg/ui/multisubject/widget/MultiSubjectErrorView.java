...
public class MultiSubjectErrorView {
    ...
    private LinearLayout getProgressBar() {
        if (this.mProgressBar == null) {
            this.mProgressBar = (LinearLayout) ((ViewStub) this.mRootView.findViewById(R.id.epg_multi_subject_status_loadding_id)).inflate();
    ...
    public GlobalQRFeedbackPanel getNoResultPanel() {
        if (this.mNoResultPanel == null) {
            this.mNoResultPanel = (GlobalQRFeedbackPanel) ((ViewStub) this.mRootView.findViewById(R.id.epg_multi_subject_status_layout_id)).inflate();
        }
    ...
    public void showNoResultPanel() {
        LogUtils.e(this.LOG_TAG, "showNoResultPanel");
