...
public class BaseStartUpPresenter {
    ...
    private AdStatusCallBack mAdStatusCallback = new AdStatusCallBack() {
    ...
    private OperateImageStatusCallBack mOperateStatusCallback = new OperateImageStatusCallBack() {
        public void onFinished(boolean nextActivity) {
            ...
            LogUtils.d(BaseStartUpPresenter.TAG, "start operate image is onFinished, nextActivity = " + nextActivity);
        }
    };
    ...
    private boolean dispatchKeyEventWhenAdShowing(KeyEvent event) {
        LogUtils.d(TAG, "dispatchKeyEventWhenAdShowing, keyEvent Action = " + event.getAction() + "keyEvent keyCode = " + event.getKeyCode());
    ...
    private boolean dispatchKeyEventWhenStartOperateShowing(KeyEvent event) {
        LogUtils.d(TAG, "dispatchKeyEventWhenStartOperateShowing, keyEvent Action = " + event.getAction() + "keyEvent keyCode = " + event.getKeyCode());
    ...
    protected void init(Context context, Handler handler) {
        this.mRootView = LayoutInflater.from(context).inflate(R.layout.epg_activity_welcome, null);
    ...
    protected void onPreviewFinished() {
        LogUtils.d(TAG, "show preview completed");
        dismiss();
    ...
    private void showGuide() {
        ...
        this.mGuidePresenter.setOnGuideCompleteListener(new onGuideDismissListener() {
    ...
    protected void initGuideBoot() {
        ...
        LogUtils.i(TAG, "initGuideBoot: mShouldPresentSceneGuide -> " + this.mShouldPresentSceneGuide);
    }
    ...
    private void initGuideDialog() {
        if (this.mShouldPresentSceneGuide) {
            ...
            checkInDialog.show();
            checkInDialog.setOnDismissListener(new OnDismissListener() {
                public void onDismiss(DialogInterface dialog) {
                    LogUtils.d(BaseStartUpPresenter.TAG, "initGuideCheckIn dialog dismiss");
