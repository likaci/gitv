...
public class MsgDialog extends Dialog {
    ...
    public MsgDialog(Context context, boolean isSystem) {
        this(context, R.style.Theme_Dialog_Loading_Notitle, 0, isSystem);
    }
    ...
    public MsgDialog(Context context, int position, boolean isSystem) {
        this(context, R.style.Theme_Dialog_Loading_Notitle, position, isSystem);
    }
    ...
    public void setHImg(String imgUrl) {
        try {
            ...
            ImageRequest request = new ImageRequest(imgUrl, findViewById(R.id.epg_msg_dialog_text));
            request.setLasting(true);
            ImageProviderApi.getImageProvider().loadImage(request, new IImageCallback() {
