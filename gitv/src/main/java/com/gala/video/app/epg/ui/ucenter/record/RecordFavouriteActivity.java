...
public class RecordFavouriteActivity extends QMultiScreenActivity implements onClickCallback, OnStatusListener, OnFocusChangeListener, OnItemClickListener {
    ...
    private LabelChangedListener mLabelChangedListener = new LabelChangedListener() {
    ...
    private void initViews() {
        ...
        this.mTextTipNoLogin = (TextView) findViewById(R.id.epg_record_menu_text_nologin);
        this.mTextTipLogin = (TextView) findViewById(R.id.epg_record_menu_text_login);
        ...
        RecordFavouriteContentFragment contentView = (RecordFavouriteContentFragment) getSupportFragmentManager().findFragmentById(R.id.epg_content);
        ...
        TextView channelTv = (TextView) findViewById(R.id.epg_q_album_channel_name_txt);
    ...
    private void trimActivityMemory() {
        ...
        LogUtils.d("RecordFavouriteActivity", "model：" + model);
    ...
    public void setBackground() {
        ...
        if (MemoryLevelInfo.isLowMemoryDevice()) {
            drawable = ResourceUtil.getDrawable(R.drawable.epg_app_background);
        } else {
    ...
    public void OnClickCallback(int index) {
        ...
        QToast.makeTextAndShow(AppRuntimeEnv.get().getApplicationContext(), page == FootLeftRefreshPage.FAVOURITE ? ResourceUtil.getStr(R.string.favourite_login_toast) : ResourceUtil.getStr(R.string.record_login_toast), 5000);
    ...
    public void setTopTagTxt(FootLeftRefreshPage page, int count) {
        ...
        if (count != 0) {
            getTagDesTxt().setText(String.format(getResources().getString(R.string.top_tag_format), new Object[]{tagNameTxt, tagDesTxt, Integer.valueOf(count)}));
            return;
        }
