...
public class CarouselWindowOverlay {
    ...
    private void initView(View root) {
        this.mBottom = (RelativeLayout) root.findViewById(R.id.win_bottom);
        this.mId = (TextView) root.findViewById(R.id.window_id);
        this.mName = (TextView) root.findViewById(R.id.window_name);
        this.mTipImg = (ImageView) root.findViewById(R.id.carousel_window_tip);
    }
    ...
    private void updateInfo(TVChannelCarousel channelCarousel) {
        ...
        if (channelCarousel != null) {
            ...
            if (LogUtils.mIsDebug) {
                LogUtils.d(TAG, "updateInfo() name=" + name + ", id=" + id);
            }
        }
    }
