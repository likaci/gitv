...
public class DetailOverlay implements IDetailOverlay, IKeyEventListener {
    ...
    private OnFullDescClickedListener mFullDescClickedListener = new OnFullDescClickedListener() {
    ...
    public Runnable mUikitAllEngineViewHideRunnable = new Runnable() {
        public void run() {
    ...
    public Runnable mUikitEngineViewHideRunnable = new Runnable() {
        public void run() {
    ...
    private void initAllView() {
        ...
        this.mAllBlocksView.setBackClickedListener(new OnBackClickedListener() {
    ...
    public void showLoading() {
        ...
        this.mLoadingView = (TextView) LayoutInflater.from(rootView.getContext()).inflate(R.layout.share_cardlist_loading, null);
    ...
    private void correctLineOneMargin() {
        ...
        if (height >= ResourceUtil.getDimen(R.dimen.dimen_620dp)) {
            this.mBlocksView.setItemDecoration(new ItemDecoration() {
    ...
    private DetailStarsErrorView getErrorView() {
        ...
        if (this.mErrorView == null) {
            View rootView = LayoutInflater.from(this.mRootView.getContext()).inflate(R.layout.player_detail_error_view, null);
    ...
    public boolean isViewVisible() {
        ...
        LogUtils.e(this.TAG, "isViewVisible --- topY = " + topY + "v.getTop() = " + v.getTop() + " getScrollY() = " + this.mBlocksView.getScrollY());
        LogUtils.e(this.TAG, "isViewVisible --- bottomY = " + topY + "v.getBottom() = " + v.getBottom() + " getScrollY() = " + this.mBlocksView.getScrollY());
