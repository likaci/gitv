    ...
    public void startPerf() {
        ...
        this.mHandler = new Handler(this.mUIThread.getLooper()) {
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case 1:
                        LeftPerformanceMonitor.this.mLeftFloatingWindow = new LeftFloatingWindow((Context) LeftPerformanceMonitor.this.mContextRef.get(), LayoutInflater.from((Context) LeftPerformanceMonitor.this.mContextRef.get()).inflate(R.layout.player_floating_view_left, null));
                        LeftPerformanceMonitor.this.mTVCurrentTime = (TextView) LeftPerformanceMonitor.this.mLeftFloatingWindow.getContentView().findViewById(R.id.txt_currentTime);
                    ...
                    case 3:
                        ...
                        if (LeftPerformanceMonitor.this.mUIThread.quit()) {
                            LogUtils.d(LeftPerformanceMonitor.TAG, "uiThread quit.");
                            return;
                        }
                        return;
                    default:
