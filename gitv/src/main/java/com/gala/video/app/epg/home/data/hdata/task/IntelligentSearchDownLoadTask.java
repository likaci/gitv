...
public class IntelligentSearchDownLoadTask extends BaseRequestTask {
    ...
    private IFileCallback mIFileCallback = new IFileCallback() {
        ...
        public void onFailure(FileRequest imageRequest, Exception e) {
            LogUtils.e(IntelligentSearchDownLoadTask.TAG, "mIFileCallback() -> onFailure", e);
        }
    };
    ...
    public void invoke() {
        ...
        TVApi.let2kb.callSync(new IApiCallback<ApiResultLet2kb>() {
            ...
            public void onException(ApiException e) {
                String str;
                LogUtils.e(IntelligentSearchDownLoadTask.TAG, "startDwonload() -> onException", e);
