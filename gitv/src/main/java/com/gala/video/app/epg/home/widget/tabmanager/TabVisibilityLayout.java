...
public class TabVisibilityLayout extends LinearLayout implements OnFocusChangeListener, OnClickListener {
    ...
    public void setAdapter(TabVisibilityAdapter adapter) {
        ...
        for (int i = 0; i < lineNum; i++) {
            ...
            if (i == 0) {
                layoutParams.topMargin = this.mContext.getResources().getDimensionPixelSize(R.dimen.dimen_3dp);
            }
            layoutParams.leftMargin = this.mContext.getResources().getDimensionPixelSize(R.dimen.dimen_30dp);
            ...
            while (j < (i + 1) * 8 && j < length) {
                ...
                childLayoutParams.width = this.mContext.getResources().getDimensionPixelSize(R.dimen.dimen_136dp);
                childLayoutParams.height = this.mContext.getResources().getDimensionPixelSize(R.dimen.dimen_53dp);
                childLayoutParams.rightMargin = this.mContext.getResources().getDimensionPixelSize(R.dimen.dimen_17dp);
                childLayoutParams.bottomMargin = this.mContext.getResources().getDimensionPixelSize(R.dimen.dimen_16dp);
    ...
    public void onClick(View v) {
        if (v instanceof TabVisibilityItemView) {
            ...
            if (state == TabVisibilityState.FOCUS_ADDIBLE) {
                ...
                LogUtils.w(TAG, "onClick, itemView status illegal: " + state);
