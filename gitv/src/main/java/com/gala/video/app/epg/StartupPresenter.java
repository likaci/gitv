...
public class StartupPresenter extends BaseStartUpPresenter {
    ...
    private class StartUpHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            LogUtils.d(StartupPresenter.TAG, "start up handler,receive msg : " + msg.what + ",arg1 = " + msg.arg1);
            switch (msg.what) {
                case 256:
                    break;
                case 512:
                ...
                case 768:
                    ...
                    LogUtils.d(StartupPresenter.TAG, "is ad ready " + isAdReady);
                    removeMessages(768);
    ...
    private void load() {
        ...
        LogUtils.d(TAG, "load interval = " + interval + " ms");
        if (interval < 0) {
