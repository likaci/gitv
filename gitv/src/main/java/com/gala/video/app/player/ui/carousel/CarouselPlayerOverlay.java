...
public class CarouselPlayerOverlay extends AbsPlayerOverlay {
    ...
    private OnCarouselPanelHideListener mOnCarouselHideListener = new OnCarouselPanelHideListener() {
        public void hide() {
    ...
    public CarouselPlayerOverlay(GalaPlayerView playerView, boolean initByWindowMode, float zoomRatio) {
        LogUtils.d(this.TAG, " CarouselPlayerOverlay.<init>: initByWindowMode=" + initByWindowMode);
    ...
    private void switchScreenMode(boolean isFullScreen, float zoomRatio) {
        LogUtils.d(this.TAG, "switchScreenMode isFullScreen=" + isFullScreen);
    ...
    public void showError(ErrorType errorType, String msg) {
        if (LogUtils.mIsDebug) {
            LogUtils.d(this.TAG, "showError(" + msg + ")");
        }
        this.mMenuPanel.hide();
        this.mLoadingView.hide();
    ...
    public void updateBufferProgress(int percent) {
        if (LogUtils.mIsDebug) {
            LogUtils.d(this.TAG, "updateBufferProgress(" + percent + ")");
        }
    ...
    public void updateNetSpeed(long bytePerSecond) {
        if (LogUtils.mIsDebug) {
            LogUtils.d(this.TAG, "updateNetSpeed(" + bytePerSecond + ")");
        }
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        LogUtils.d(this.TAG, "dispatchKeyEvent: " + keyEventToString(event));
    ...
    public void setCurrentChannel(TVChannelCarousel channelCarousel) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(this.TAG, "setCurrentChannel double??=" + channelCarousel);
        }
    ...
    public void notifyChannelChangeByIndex(int index) {
        if (LogUtils.mIsDebug) {
            LogUtils.d(this.TAG, "notifyChannelChangeByIndex() index=" + index);
        }
