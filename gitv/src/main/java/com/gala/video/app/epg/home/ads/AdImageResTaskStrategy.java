    ...
    private void sendInstalledAppInfoPingback() {
        new Thread(new Runnable() {
            public void run() {
                ...
                HomePingbackFactory.instance().createPingback(CommonPingback.LOCAL_INSTALLED_APP_INFO_PINGBACK).addItem(Keys.T, "11").addItem("ct", "170626_competitor").addItem(Keys.COMPETEAPK, competeApkValue).post();
            }
        }).start();
    }
