        ...
        if (adData != null) {
            switch (adData.getItemDataType()) {
                case FOCUS_IMAGE_AD:
                    ...
                    if (sDebugable) {
                        LogUtils.d(TAG, "onItemClickAD, send focus image ad click pingback, adId = " + adData.getAdId());
                        return;
                    }
                    return;
                case BANNER_IMAGE_AD:
                    ...
                    if (sDebugable) {
                        LogUtils.d(TAG, "onItemClickAD, send banner image ad click pingback, adId = " + adData.getAdId());
                        return;
                    }
                    return;
                default:
                    ...
                    switch (itemDataType) {
                        ...
                        case VIP_VIDEO:
                            ...
                            if (!hasVipTab || vipTabModel == null) {
                                LogUtils.w(TAG, "onItemClick, VIP_VIDEO, vip tabModel:" + vipTabModel + ", hasVipTab : " + hasVipTab);
