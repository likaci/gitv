...
public class IFootConstant {
    ...
    public static final String STR_FAV_TOP_MENU = ResourceUtil.getStr(R.string.menu_alter_favorite);
    public static final String STR_FILM_FOOT = ResourceUtil.getStr(R.string.foot_str);
    public static final String STR_FILM_FOOT_PLAY = ResourceUtil.getStr(R.string.foot_play_str);
    public static final String STR_LOGHISTORY_TOP_MENU = ResourceUtil.getStr(R.string.menu_alter_text_clean_history3);
    public static final String STR_MYHISTORY_TOP_MENU = ResourceUtil.getStr(R.string.menu_alter_text_clean_history1);
    public static final String STR_PLAYHISTORY = ResourceUtil.getStr(R.string.foot_playhistory);
    public static final String STR_PLAYHISTORY_ALL = ResourceUtil.getStr(R.string.foot_label_all);
    public static final String STR_PLAYHISTORY_LONG = ResourceUtil.getStr(R.string.str_long_video);
    public static final String STR_SUBSCRIBLE = ResourceUtil.getStr(R.string.foot_subscreible);
    public static final String STR_SUBSCRIBLE_TOP_MENU = ResourceUtil.getStr(R.string.menu_alter_subscreible);
}
