...
public class MenuFloatLayerAdapter implements MenuFloatLayerStateListener {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        LogUtils.d(TAG, "getView, menu float layer item,  title = " + title + " item type = " + itemDataType);
        itemView.setText(title);
        itemView.setItemType(itemDataType);
        itemView.setBackgroundResource(R.drawable.epg_home_menu_float_layer_item_selector);
