...
public class CarouselRequestTask extends BaseRequestTask {
    ...
    private void fetchData() {
        ...
        TVApi.channelCarousel.callSync(new IApiCallback<ApiResultTVChannelListCarousel>() {
            public void onSuccess(ApiResultTVChannelListCarousel apiResultTVChannelListCarousel) {
                if (apiResultTVChannelListCarousel != null && !Precondition.isEmpty(apiResultTVChannelListCarousel.data)) {
                    ...
                    CarouselRequestTask.mTime = String.valueOf(apiResultTVChannelListCarousel.t);
            ...
            public void onException(ApiException e) {
                ...
                HomePingbackFactory.instance().createPingback(CommonPingback.DATA_ERROR_PINGBACK).addItem("ec", "315008").addItem("pfec", e.getCode()).addItem(Keys.ERRURL, e.getUrl()).addItem(Keys.APINAME, "channelCarousel").addItem(Keys.ERRDETAIL, e.getMessage()).addItem("activity", "HomeActivity").addItem(Keys.T, "0").setOthersNull().post();
            }
        }, "2", "0", mTime, TVApiBase.getTVApiProperty().getVersion(), "1.0");
    }
