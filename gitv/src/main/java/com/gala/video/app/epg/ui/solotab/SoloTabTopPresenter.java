...
public class SoloTabTopPresenter {
    ...
    private MyObserver mVipOperateTxtObserver = new MyObserver() {
    ...
    public SoloTabTopPresenter(Context context, View root, SoloTabInfoModel infoModel, SoloTabManage soloTabManage) {
        ...
        this.mActionBar = (ActionBarLayout) root.findViewById(R.id.epg_solotab_action_bar);
        this.mActionTip = (TextView) root.findViewById(R.id.epg_solotab_actionbar_tip);
        this.mActionTip.setSelected(true);
        this.mVipAnimationView = (VipAnimationView) root.findViewById(R.id.epg_vip_animation);
        ((TextView) root.findViewById(R.id.epg_q_solotab_channel_name_txt)).setText(infoModel.getTabName());
        root.findViewById(R.id.epg_solotab_bar_line).setBackgroundDrawable(ResourceUtil.getDrawable(this.mInfoModel.isVip() ? R.drawable.epg_tab_bar_decorated_vip_line : R.drawable.epg_tab_bar_decorated_line));
