...
public class CarouselPlayerDataProvider {
    ...
    L_0x002f:
        ...
        com.gala.video.lib.framework.core.utils.LogUtils.d(r4, r6);	 Catch:{ all -> 0x000f }
    L_0x0051:
        monitor-exit(r5);	 Catch:{ all -> 0x000f }
        goto L_0x0006;
    L_0x0053:
    ...
    public List<TVChannelCarousel> getCarouselChannelList(TVChannelCarouselTag tvtag) {
        ...
        synchronized (this.mLock1) {
            if (tvtag == null) {
                ...
                if (LogUtils.mIsDebug) {
                    LogUtils.d("Player/Ui/CarouselPlayerDataProvider", "map does not contain the label of " + tvtag.name + sProvider);
                }
            }
        }
        return list;
