...
public class DetailViewPresenter {
    ...
    private final OnNetStateChangedListener mAlbumNetStateChangedListener = new OnNetStateChangedListener() {
            ...
            switch (newState) {
                ...
                case 2:
                    ...
                    if (LogUtils.mIsDebug) {
                        LogUtils.d(DetailViewPresenter.this.TAG, "onNetworkState- change -state" + oldState + " >>> newState " + newState);
                        return;
                    }
                    return;
                default:
    ...
    private IUIEventListener mUIEventListener = new IUIEventListener() {
