...
public class FetchExitAlbumsTask {
    ...
    public void excute() {
        ...
        VrsHelper.channelLabels.call(new IVrsCallback<ApiResultChannelLabels>() {
            public void onException(ApiException e) {
                LogUtils.d(FetchExitAlbumsTask.TAG, "onException: code=" + e.getCode() + ", msg=" + e.getMessage());
            ...
            public void onSuccess(ApiResultChannelLabels result) {
                ...
                for (ChannelLabel label : channelList) {
                    if (label.getType() == ResourceType.ALBUM || label.getType() == ResourceType.VIDEO) {
                        ...
                        LogUtils.d(FetchExitAlbumsTask.TAG, "ResourceType.else =" + label.getType());
                    }
                }
                if (LogUtils.mIsDebug) {
                    LogUtils.d(FetchExitAlbumsTask.TAG, ">>onSuccess=" + ListUtils.getCount(list));
                }
