...
public class StarsActivity extends QMultiScreenActivity implements View {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        stopImageProvider();
        setContentView(R.layout.epg_activity_stars);
        this.mStarVerticalGridView = (StarVerticalGridView) findViewById(R.id.epg_stars_gridview_id);
    ...
    private synchronized StarsFullView getFullView() {
        if (this.mStarsFullView == null) {
            ...
            this.mStarsFullView.setOnFullDescClickedListener(new OnFullDescClickedListener() {
