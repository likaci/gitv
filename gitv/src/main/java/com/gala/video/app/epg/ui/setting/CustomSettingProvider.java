...
public class CustomSettingProvider {
    ...
    private void parseSettingJson() {
        ...
        try {
            ...
            LogUtils.d("setting/CustomSettingProvider", "bos.toString() =" + bos.toString());
            ...
            try {
                ...
                if (fileInputStream != null) {
                    try {
                        ...
                        LogUtils.d("setting/CustomSettingProvider", "getSettingJson IOException = ", e32);
                        return;
                    }
                }
                bos.close();
                ...
                if (fileInputStream != null) {
                    try {
                        ...
                        LogUtils.d("setting/CustomSettingProvider", "getSettingJson IOException = ", e322);
                        throw th;
                    }
                }
                bos.close();
