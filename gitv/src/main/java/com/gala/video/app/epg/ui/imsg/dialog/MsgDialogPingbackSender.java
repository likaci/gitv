...
public class MsgDialogPingbackSender {
    ...
    private void send() {
        ...
        params.add(Keys.T, "11").add("a", this.a).add("qtcurl", this.qtcurl).add("rpage", this.rpage).add("block", this.block).add("rseat", this.rseat).add("msgtype", this.msgtype).add(Keys.MSG_LEVEL, this.msgLevel).add(Keys.MSG_ID, this.msgid).add(Keys.PUSH_POSITION, this.pushposition).add(Keys.SCR_POSITION, this.scrposition).add("ct", ct);
