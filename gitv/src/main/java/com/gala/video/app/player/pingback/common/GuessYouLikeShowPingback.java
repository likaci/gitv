...
public class GuessYouLikeShowPingback extends Pingback {
    ...
    public void doSend(Map<String, String> map) {
        ...
        params.add("type", Constants.RECOMMEND_PINGBACK_TYPE_CLICK).add("usract", DBColumns.IS_NEED_SHOW).add(Keys.PLATFORM, "5201").add("rank", "").add("url", "").add("tag", "").add(Keys.T, "").add("taid", "").add("tcid", "");
