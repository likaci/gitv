...
public class MsgDetailFragment extends QBaseFragment implements View {
    ...
    public android.view.View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        android.view.View root = inflater.inflate(R.layout.epg_fragment_msg_center_detail, container, false);
        initViews(root);
        ...
        LogUtils.d(TAG, "title = " + title + " ; deString  = " + deString + " ; pic_url = " + pic_url + " ; button_name = " + button_name + " ; imsgContent = " + this.mImsgContent);
    ...
    private void initViews(android.view.View root) {
        this.mTitleView = (TextView) root.findViewById(R.id.epg_msgdetail_title);
        this.mDescriptionAlignmentTextView = (TextView) root.findViewById(R.id.epg_msgdetail_desc_AlignmentTextView);
        this.mDescriptionTextView = (TextView) root.findViewById(R.id.epg_msgdetail_desc_TextView);
        this.mButton = (Button) root.findViewById(R.id.epg_msgdetail_button);
        this.mImageView = (ImageView) root.findViewById(R.id.epg_msgdetail_image);
        this.mButton.setOnClickListener(new OnClickListener() {
            public void onClick(android.view.View v) {
                LogUtils.d(MsgDetailFragment.TAG, "onClick==R.id.msgdetail_button");
    ...
    public void sendShowPingBack() {
        PingBackParams params = new PingBackParams();
        params.add("qtcurl", ISearchConstant.TVSRCHSOURCE_MSG).add("qpid", this.mImsgContent.msg_id + "").add("block", ISearchConstant.TVSRCHSOURCE_MSG).add(Keys.T, "21").add(Keys.JUMP_TYPE, handlejumpType(this.mImsgContent.page_jumping)).add(Keys.ISREAD, this.mImsgContent.isRead ? "1" : "0");
        PingBack.getInstance().postPingBackToLongYuan(params.build());
    }
