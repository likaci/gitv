...
public class DynamicRequestTask extends BaseRequestTask {
    ...
    public void invoke() {
        ...
        TVApi.dynamicQ.callSync(new IApiCallback<ApiResultDeviceCheck>() {
            public void onSuccess(ApiResultDeviceCheck apiResult) {
                ...
                if (data != null) {
                    GetInterfaceTools.getIDynamicQDataProvider().loadDynamicQData(data, new ILoadDynamicDataCallback() {
            ...
            public void onException(ApiException e) {
                ...
                addItem.addItem(str2, str).addItem(Keys.ERRURL, "").addItem(Keys.APINAME, "dynamicQ").addItem("activity", "HomeActivity").addItem(Keys.T, "0").setOthersNull().post();
                if (e != null) {
                    LogUtils.e(DynamicRequestTask.TAG, "request dynamic data exception ApiCode=" + e.getCode() + "  HttpCode=" + e.getHttpCode());
                }
            }
