...
public class MenupanelDataHelper {
    ...
    public boolean needScreenRatio(IVideo video) {
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, ">> needScreenRatio, video=" + video);
        }
        boolean ret = true;
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "<< needScreenRatio, ret=" + ret);
        }
        return ret;
    }
    ...
    public boolean need2DTo3D(IVideo video) {
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, ">> need2DTo3D, video=" + video);
        }
        boolean ret = false;
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "<< need2DTo3D, ret=" + ret);
        }
        return ret;
    }
    ...
    private boolean shouldShow2Dto3D(IVideo video) {
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, ">> shouldShow2Dto3D, video=" + video);
        }
        boolean ret = true;
        if (video != null) {
            if (video.is3d()) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "<< shouldShow2Dto3D, ret=" + ret);
        }
        return ret;
    }
    ...
    public boolean needEpisode(IVideo video) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "needEpisode, isTvSeries=" + isTvSeries + ", showAsGallery=" + showAsGallery + ", isFlowerShowRecommend" + isFlowerShowRecommend + ",isTrailer" + isTrailer + " isRelated" + isRelated);
        }
        if (!(!isNeedAssociative || !isTvSeries || showAsGallery || isFlowerShowRecommend || isTrailer || isRelated)) {
            ret = true;
        }
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "<< needEpisode, ret=" + ret);
        }
        return ret;
    }
    ...
    public boolean needBodan(IVideo video) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, ">> needBodan, ret=" + ret);
        }
        return ret;
    }
    ...
    public boolean needTrailers(IVideo video) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, ">> needTrailers, ret=" + ret);
        }
        return ret;
    }
    ...
    public boolean needPrograms(IVideo video) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "needPrograms, sourceType=" + sourceType + ", isSourceType=" + isSourceType + ", isTvSeries=" + isTvSeries + ", showAsGallery=" + showAsGallery + ", isRecommend=" + isRecommend + ",isTrailer" + isTrailer + " isRelated" + isRelated);
        }
        if (isNeedAssociative && !((!isSourceType && (!isTvSeries || !showAsGallery)) || isRecommend || isTrailer || isRelated)) {
            ret = true;
        }
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, ">> needPrograms, ret=" + ret);
        }
        return ret;
    }
    ...
    public boolean needRecommend(IVideo video) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, ">> needRecommend, video=" + video);
        }
        boolean ret = false;
        SourceType sourceType = video.getSourceType();
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "needRecommend, sourceType=" + sourceType + ", channelId=" + channelId + ", showAsGallery=" + showAsGallery + "isRecommend" + isRecommend);
        }
        if (isNeedAssociative && isRecommend) {
            ret = true;
        }
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "<< needRecommend, ret=" + ret);
        }
        return ret;
    }
    ...
    public boolean needRelated(IVideo video) {
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, ">> needRelated, video=" + video);
        }
        boolean ret = false;
        boolean isRelated = video.getProvider().getPlaylistSource() == 5;
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "needRelated," + isRelated);
        }
        if (isRelated) {
            ret = true;
        }
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "<< needRelated, ret=" + ret);
        }
        return ret;
    }
    ...
    public boolean needSkipHeaderTailer(IVideo video) {
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, ">> needSkipHeaderTailer, video=" + video);
        }
        boolean ret = false;
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "<< needSkipHeaderTailer, ret=" + ret);
        }
        return ret;
    }
}
