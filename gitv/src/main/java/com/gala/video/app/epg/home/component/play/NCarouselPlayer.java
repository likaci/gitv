...
public class NCarouselPlayer {
    ...
    private OnPlayerStateChangedListener mPlayerStateListener = new OnPlayerStateChangedListener() {
        public void onVideoSwitched(IVideo video, int type) {
            LogUtils.d(NCarouselPlayer.TAG, "onVideoSwitched video = " + video);
        }
        ...
        public void onScreenModeSwitched(ScreenMode newMode) {
            int i = 1;
            LogUtils.d(NCarouselPlayer.TAG, "Home/CarouselPlayer---onScreenModeSwitched() newMode=" + newMode);
            if (LogUtils.mIsDebug) {
                LogUtils.d(NCarouselPlayer.TAG, "onScreenModeSwitched newMode=" + newMode);
            }
        ...
        public boolean onError(IVideo video, ISdkError error) {
            if (LogUtils.mIsDebug) {
                LogUtils.d(NCarouselPlayer.TAG, "onError: error=" + error + ", video = " + video);
            }
