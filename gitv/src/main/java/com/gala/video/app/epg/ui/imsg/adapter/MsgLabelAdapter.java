...
public class MsgLabelAdapter extends Adapter<MyViewHolder> {
    ...
    public MsgLabelAdapter(Context context) {
        ...
        this.mGreenColor = ResourceUtil.getColor(R.color.gala_green);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        if (holder == null || holder.itemView == null) {
            ...
            LogUtils.e(TAG, "onBindViewHolder mLabelList is null !");
        } else {
            ...
            if (textView != null) {
                ...
                if (this.mRemainedPosition == position) {
                    ...
                    textView.setTextColor(ResourceUtil.getColorStateList(R.drawable.epg_label_left_color_selector));
                }
            }
        }
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        int layoutId = R.layout.epg_label_item_view_msg;
        if (viewType == 1) {
            layoutId = R.layout.epg_label_item_view_level1_msg;
        }
