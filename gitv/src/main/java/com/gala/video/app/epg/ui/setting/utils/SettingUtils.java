...
public class SettingUtils {
    ...
    private static final int[] SETTING_RESIDS = new int[]{R.drawable.share_tab_setting_icon_account, R.drawable.share_tab_setting_icon_net, R.drawable.share_tab_setting_icon_play, R.drawable.share_tab_setting_icon_common, R.drawable.share_tab_setting_icon_tab_manage, R.drawable.share_tab_setting_icon_update, R.drawable.share_tab_setting_icon_help, R.drawable.share_tab_setting_icon_feedback, R.drawable.share_tab_setting_icon_weixin, R.drawable.share_tab_setting_icon_multiscreen, R.drawable.share_tab_setting_icon_about};
    ...
    private static void showNotInstallTip(Context context) {
        QToast.makeTextAndShow(context, R.string.setting_not_install, 3000);
    }
    ...
    protected static void showNotSupportedDialog(Context contxt) {
        ...
        dialog.setParams(contxt.getString(R.string.tip_excp_4)).show();
