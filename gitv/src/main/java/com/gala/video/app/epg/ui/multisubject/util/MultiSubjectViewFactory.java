...
public class MultiSubjectViewFactory extends Wrapper {
    ...
    public int getItemExtraHeight(int cardWidgetType, int itemWidgetType) {
        ...
        switch (cardWidgetType) {
            ...
            case 30:
            case 254:
                LogUtils.e(TAG, "getItemExtraHeight，widgettype error is not support, cardType:" + cardWidgetType);
                break;
            case 2:
                h = 60;
                break;
    ...
    public int getItemViewPaddingTop(int cardWidgetType) {
        switch (cardWidgetType) {
            ...
            case 24:
            case 254:
                LogUtils.e(TAG, "getItemViewPaddingTop，widgettype error is not support, type:" + cardWidgetType);
                return 0;
            case 2:
            case 3:
                return 30;
    ...
    public MultiSubjectImp createItem(int widgettype) {
        ...
        if (widget == null) {
            LogUtils.e(TAG, "createItem error is type:" + widgettype);
        }
        if (widget instanceof MultiSubjectImp) {
            return (MultiSubjectImp) widget;
        }
        LogUtils.e(TAG, "createItem error, and widget is not MultiSubjectImp. type:" + widgettype);
        return null;
    }
