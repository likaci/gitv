...
public class PlayerConfigJsFunc2Java {
    ...
    public static final String getPlayerConfig(String cpu, String product, String model, int ram, String androidVersion, String apkVersion, String uuid) {
        ...
        List<String> notSupportCpuList = new ArrayList<String>() {
            {
                add("rtd");
            }
        };
        List<String> exceptCpuList = new ArrayList<String>() {
            {
                add("mt8685");
            }
        };
        ...
        List<String> disableGifViewModelList = new ArrayList<String>() {
            {
                add("magicbox1s_plus");
            }
        };
        ...
        List<String> disableGifViewForDetailModelList = new ArrayList<String>() {
            {
                add("letv new c1s");
            }
        };
        ...
        List<String> supportH211ModelList = new ArrayList<String>() {
            {
                add("magicbox_m13");
                add("mitv2-49");
                add("mibox3_pro");
        ...
        List<String> support4kModelList = new ArrayList<String>() {
            {
                add("magicbox2");
                add("inphic_i9h");
                add("mibox3");
        ...
        List<String> support4kH211ModelList = new ArrayList<String>() {
            {
                add("magicbox_m13");
                add("mitv2-49");
                add("mibox3_pro");
        ...
        List<String> disable4kH264ModelList = new ArrayList<String>() {
        };
        ...
        List<String> supportHDR10ModelList = new ArrayList<String>() {
            {
                add("9s51_q7");
                add("mibox3s");
                add("q65x1s");
