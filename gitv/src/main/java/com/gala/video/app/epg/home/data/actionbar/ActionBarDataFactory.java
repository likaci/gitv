...
public class ActionBarDataFactory {
    ...
    public static List<ActionBarItemInfo> buildActionBarData() {
        ...
        actionBarInfoList.add(new Builder(TOP_BAR_TIME_NAME_SEARCH, R.drawable.epg_action_bar_search_default, ActionBarType.SEARCH).id(ViewUtils.generateViewId()).iconWith(R.dimen.dimen_23dp).build());
        actionBarInfoList.add(new Builder(TOP_BAR_TIME_NAME_MY, R.drawable.epg_action_bar_my_default, ActionBarType.MY).messageBgDrawable(R.drawable.epg_action_bar_item_message).setIsMy().id(ViewUtils.generateViewId()).iconWith(R.dimen.dimen_25dp).build());
        if (CheckInHelper.getIsShowActionBar()) {
            actionBarInfoList.add(buildCheckInItem());
        }
        actionBarInfoList.add(new Builder(TOP_BAR_TIME_NAME_OPEN_VIP, R.drawable.epg_action_bar_vip_default, ActionBarType.VIP).setIsVip().id(ViewUtils.generateViewId()).iconWith(R.dimen.dimen_25dp).build());
        return actionBarInfoList;
    }

    public static List<ActionBarItemInfo> buildActionBarSearchData() {
        List<ActionBarItemInfo> actionBarInfoList = new ArrayList();
        actionBarInfoList.add(new Builder(TOP_BAR_TIME_NAME_MY, R.drawable.epg_action_bar_my_default, ActionBarType.MY).setIsMy().id(ViewUtils.generateViewId()).iconWith(R.dimen.dimen_25dp).build());
        if (CheckInHelper.getIsShowActionBar()) {
            actionBarInfoList.add(buildCheckInItem());
        }
        actionBarInfoList.add(new Builder(TOP_BAR_TIME_NAME_OPEN_VIP, R.drawable.epg_action_bar_vip_default, ActionBarType.VIP).setIsVip().id(ViewUtils.generateViewId()).iconWith(R.dimen.dimen_25dp).build());
    ...
    private static ActionBarItemInfo buildCheckInItem() {
        return new Builder(TOP_BAR_TIME_TXT_SIGN, R.drawable.epg_action_bar_checkin_default, ActionBarType.CHECKIN).messageBgDrawable(R.drawable.epg_action_bar_item_message).id(ViewUtils.generateViewId()).iconWith(R.dimen.dimen_23dp).build();
    }
}
