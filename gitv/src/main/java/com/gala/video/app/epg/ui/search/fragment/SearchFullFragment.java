...
public class SearchFullFragment extends SearchBaseFragment {
    ...
    private WidgetStatusListener mFullKeyboardListener = new WidgetStatusListener() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.mMainView = inflater.inflate(R.layout.epg_fragment_full_keyboard, null);
        init();
    ...
    private void initKeyboard() {
        if (this.mContext != null) {
            String[] keyNum = this.mContext.getResources().getStringArray(R.array.full_keyboard);
            ...
            if (this.mContext != null) {
                ...
                this.mFullKeyboard.post(new Runnable() {
                    public void run() {
    ...
    private PhotoGridParams getFullKeyboardParams() {
        ...
        p.horizontalSpace = getDimen(R.dimen.dimen_13dp);
        p.contentHeight = getDimen(R.dimen.dimen_53dp);
        p.contentWidth = getDimen(R.dimen.dimen_53dp);
        p.scaleRate = 1.1f;
        return p;
    }
    ...
    private void sendClickPingback() {
        ...
        params.add(Keys.T, "20").add("rseat", "fullkeyboard").add("rpage", "srch_keyboard").add("block", "fullkeyboard").add("rt", "i");
    ...
    public void requestDefaultFocus() {
        if (this.mFullKeyboard != null && this.mFullKeyboard.getViewByPos(14) != null) {
            this.mFullKeyboard.getViewByPos(14).post(new Runnable() {
                public void run() {
