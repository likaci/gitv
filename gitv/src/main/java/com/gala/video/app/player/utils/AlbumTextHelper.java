...
public class AlbumTextHelper {
    ...
    public static String getHost(Album album, Context context) {
        ...
        sb.append(context.getString(R.string.detail_album_info_host).trim()).append(getTypeStr(host.trim(), 3));
        return sb.toString();
    }
    ...
    public static String getGuest(Album album, Context context) {
        ...
        sb.append(context.getString(R.string.detail_album_info_guest).trim()).append(getTypeStr(guest.trim(), 3));
        return sb.toString();
    }
    ...
    public static String getPerformer(AlbumInfo albumInfo, Context context) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "<< getPerformer, performer=" + performer);
        }
        sb.append(context.getString(R.string.detail_album_info_main_actor).trim()).append(getTypeStr(performer.trim(), 5));
        if (LogUtils.mIsDebug) {
    ...
    public static String getEpisodeSet(AlbumInfo albumInfo, Context context) {
        ...
        if (albumInfo.isSeries() && !albumInfo.isSourceType() && set > 0) {
            sb.append(context.getString(R.string.tv_sum)).append(set).append(context.getString(R.string.set));
        }
        return sb.toString();
    }
    ...
    public static String getEpisodeCount(AlbumInfo albumInfo, Context context) {
        ...
        if (albumInfo.isSeries() && !albumInfo.isSourceType() && count > 0) {
            sb.append(context.getString(R.string.tv_update)).append(count).append(context.getString(R.string.set));
        }
        return sb.toString();
    }
    ...
    public static String getTimeLength(Album album, Context context) {
        ...
        if (!StringUtils.isEmpty(album.len)) {
            ...
            if (length >= 0) {
                if (length < 60) {
                    sb.append(length + context.getString(R.string.play_second));
                } else {
    ...
    public static String getDirectorStr(IVideo video, Context context) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "getChannelId: " + categoryId);
        }
        StringBuilder sb = new StringBuilder();
        switch (categoryId) {
            case 1:
            case 2:
                ...
                if (!ListUtils.isEmpty(directors)) {
                    ...
                    for (int i = 0; i < length; i++) {
                        ...
                        if (LogUtils.mIsDebug) {
                            LogUtils.i(TAG, "director is: " + ((Director) directors.get(i)).name);
                        }
                    }
                    break;
                }
                ...
                if (StringUtils.isEmpty(host)) {
                    if (StringUtils.isEmpty(guest)) {
                        if (!StringUtils.isEmpty(video.getAlbum().tag)) {
                            sb.append(context.getString(R.string.type)).append(getTypeStr(video.getAlbum().tag, 3));
                            break;
                        }
                    }
                    sb.append(context.getString(R.string.detail_album_info_guest).trim()).append(getTypeStr(host.trim(), 5));
                    break;
                }
                sb.append(context.getString(R.string.detail_album_info_host).trim()).append(getTypeStr(host.trim(), 5));
                break;
                break;
            default:
                if (!StringUtils.isEmpty(video.getAlbum().tag)) {
    ...
    public static SpannableStringBuilder getActorSpannableString(List<Director> actors, Context context, int titleColor, int contentColor) {
        ...
        SpannableStringBuilder ssb = new SpannableStringBuilder();
        SpannableString title = getSpannableStringWithColor(context.getString(R.string.detail_album_info_main_actor).trim(), titleColor);
    ...
    public static SpannableStringBuilder getDirectorSpannableString(int categoryId, List<Director> directors, Context context, int titleColor, int contentColor) {
        ...
        SpannableStringBuilder ssb = new SpannableStringBuilder();
        SpannableString title = getSpannableStringWithColor(context.getString(R.string.detail_album_info_director).trim(), titleColor);
    ...
    public static SpannableStringBuilder getVVCountStr(String countStr, int numberPx, Context context) {
        ...
        spannableStringNum.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.detail_count_point_text_color)), 0, sb.length(), 34);
    ...
    public static List<String> getStarIDList(AlbumInfo albumInfo) {
        ...
        if (albumInfo == null) {
            ...
            LogUtils.d(TAG, "<< getStarIDs, listFirst=" + listFirst);
            return listFirst;
        }
    }
    ...
    public static SpannableStringBuilder getTimeInfoSpannableString(Album mAlbumInfo, Context context, int titleColor, int contentColor) {
        ...
        if (!TextUtils.isEmpty(issueTime) && issueTime.trim().length() >= 4) {
            ssb.append(getSpannableStringWithColor(context.getString(R.string.release_time), titleColor)).append(getSpannableStringWithColor((issueTime.length() > 4 ? issueTime.substring(0, 4) : issueTime) + context.getString(R.string.year), contentColor)).append(BIG_BLANK);
        }
        int setCount;
        if (DataHelper.showEpisodeAsGallery(mAlbumInfo)) {
            if (mAlbumInfo.isSourceType()) {
                ssb.append(getSpannableStringWithColor(context.getString(R.string.tv_update), titleColor)).append(getSpannableStringWithColor("" + formatDate(mAlbumInfo.time) + context.getString(R.string.menu_alter_total_episode), contentColor)).append(BIG_BLANK);
            } else {
                ...
                ssb.append(getSpannableStringWithColor(context.getString(R.string.tv_sets), titleColor)).append(getSpannableStringWithColor("" + setCount + context.getString(R.string.set), contentColor)).append(BIG_BLANK);
            }
            ...
            if (length >= 0) {
                if (length < 60) {
                    ssb.append(getSpannableStringWithColor(context.getString(R.string.play_length), titleColor)).append(getSpannableStringWithColor("" + length + context.getString(R.string.play_second), contentColor)).append(BIG_BLANK);
                } else {
                    int minutes = length / 60;
                    ssb.append(getSpannableStringWithColor(context.getString(R.string.play_length), titleColor)).append(getSpannableStringWithColor("" + minutes + context.getString(R.string.play_minite), contentColor)).append(BIG_BLANK);
                }
            }
        }
        ...
        ssb.append(getSpannableStringWithColor(context.getString(R.string.type), titleColor)).append(getSpannableStringWithColor(getTypeStr(mAlbumInfo.tag, 3), contentColor));
        return ssb;
    }
    ...
    public static String getUpdateInfo(AlbumInfo albumInfo, Context context) {
        ...
        if (!TextUtils.isEmpty(strategy)) {
            sb.append(context.getResources().getString(R.string.left_brackets)).append(strategy).append(context.getResources().getString(R.string.right_brackets));
        }
        if (LogUtils.mIsDebug) {
            LogUtils.w(TAG, ">> getUpdateInfo():" + strategy);
        }
        return sb.toString();
    }
    ...
    public static String getEpisodeUpdate(IVideo mAlbumInfo, Context context) {
        ...
        if (mAlbumInfo.isSeries() && !mAlbumInfo.isSourceType()) {
            ...
            if (set == 0 && count != 0) {
                sb.append(context.getString(R.string.tv_update)).append(count).append(context.getString(R.string.set)).append(SMALL_BLANK).append(getUpdateStrategy(mAlbumInfo, context));
            } else if (count != set && count != 0) {
                sb.append(context.getString(R.string.tv_update)).append(count).append(context.getString(R.string.set)).append("/").append(context.getString(R.string.tv_sum)).append(set).append(context.getString(R.string.set)).append(SMALL_BLANK).append(getUpdateStrategy(mAlbumInfo, context));
            } else if (count == set && set != 0) {
                sb.append(context.getString(R.string.tv_sum)).append(set).append(context.getString(R.string.set)).append(SMALL_BLANK);
            } else if (LogUtils.mIsDebug) {
                LogUtils.d(TAG, "TvSets error : count is" + count + "set is" + set);
            }
        }
        return sb.toString();
    }
    ...
    public static String getVarietyUpdate(AlbumInfo albumInfo, Context context) {
        ...
        if (!StringUtils.isEmpty(sourceUpdateTime)) {
            ...
            sb.append(context.getString(R.string.tv_update)).append(formatDate(time)).append(context.getString(R.string.menu_alter_total_episode));
        }
        return sb.toString();
    }
    ...
    public static String getCartoonUpdate(IVideo mAlbumInfo, Context context) {
        ...
        if (mAlbumInfo.isSeries()) {
            ...
            if (set == 0 && count != 0) {
                ...
                sb.append(context.getString(R.string.tv_update)).append(count).append(context.getString(R.string.set)).append("/").append(context.getString(R.string.tv_sum)).append(set).append(context.getString(R.string.set));
            } else if (count == set && set != 0) {
                sb.append(context.getString(R.string.tv_sum)).append(set).append(context.getString(R.string.set));
            } else if (LogUtils.mIsDebug) {
                LogUtils.d(TAG, "TvSets error : count is" + count + "set is" + set);
    ...
    public static String getTimeInfoStr(Album mAlbumInfo, Context context) {
        ...
        String issueTime = mAlbumInfo.time;
        if (!TextUtils.isEmpty(issueTime) && issueTime.trim().length() >= 4) {
            sb.append(context.getString(R.string.release_time)).append(issueTime.length() > 4 ? issueTime.substring(0, 4) : issueTime).append(context.getString(R.string.year)).append(BIG_BLANK);
        }
        int setCount;
        if (DataHelper.showEpisodeAsGallery(mAlbumInfo)) {
            if (mAlbumInfo.isSourceType()) {
                sb.append(context.getString(R.string.tv_update)).append(formatDate(mAlbumInfo.time)).append(context.getString(R.string.menu_alter_total_episode)).append(BIG_BLANK);
            } else {
                if (mAlbumInfo.tvsets == 0) {
                    setCount = mAlbumInfo.tvCount;
                } else {
                ...
                sb.append(context.getString(R.string.tv_sets)).append(setCount).append(context.getString(R.string.set)).append(BIG_BLANK);
            }
        } else if (mAlbumInfo.isSeries() && !mAlbumInfo.isSourceType()) {
            if (mAlbumInfo.tvsets == 0) {
                setCount = mAlbumInfo.tvCount;
            ...
            if (length >= 0) {
                if (length < 60) {
                    sb.append(context.getString(R.string.play_length)).append(length + context.getString(R.string.play_second)).append(BIG_BLANK);
                } else {
                    sb.append(context.getString(R.string.play_length)).append((StringUtils.parse(mAlbumInfo.len, 0) / 60) + context.getString(R.string.play_minite)).append(BIG_BLANK);
                }
            }
        }
        return sb.toString();
    ...
    public static SpannableStringBuilder getPointStr(String score, int integerPx, int decimalPx, int unitPx, Context context) {
        ...
        if (!TextUtils.isEmpty(score.trim())) {
            ...
            spannableStringPoint.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.detail_count_point_text_color)), 0, spannableStringPoint.length(), 34);
        }
        SpannableString spannableString = new SpannableString("分");
        spannableString.setSpan(new ForegroundColorSpan(context.getResources().getColor(R.color.detail_count_point_text_color)), 0, 1, 34);
    ...
    public static SpannableStringBuilder appendInfo(Context context, SpannableStringBuilder ssb, String msg) {
        if (!StringUtils.isEmpty((CharSequence) msg)) {
            ForegroundColorSpan gray = new ForegroundColorSpan(ResourceUtil.getColor(R.color.detail_album_info_divider_color_new));
            if (!StringUtils.isEmpty((CharSequence) ssb)) {
                int start = ssb.length();
                ssb.append(context.getString(R.string.detail_album_info_division));
    ...
    public static SpannableStringBuilder firstInfoYellow(SpannableStringBuilder ssb, String msg) {
        if (!StringUtils.isEmpty((CharSequence) msg)) {
            ForegroundColorSpan gray = new ForegroundColorSpan(ResourceUtil.getColor(R.color.detail_album_info_first_color));
            if (ssb != null) {
                int start = ssb.length();
                ssb.append(msg);
                ssb.setSpan(gray, start, ssb.length(), 33);
    ...
    public static SpannableStringBuilder updateInfoText(SpannableStringBuilder ssb, String msg) {
        if (!StringUtils.isEmpty((CharSequence) msg)) {
            ForegroundColorSpan gray = new ForegroundColorSpan(ResourceUtil.getColor(R.color.detail_text_color_default));
            if (ssb != null) {
                int start = ssb.length();
                ssb.append(msg);
                ssb.setSpan(gray, start, ssb.length(), 33);
                ssb.setSpan(new AbsoluteSizeSpan(ResourceUtil.getDimensionPixelSize(R.dimen.dimen_20dp)), start, ssb.length(), 33);
            }
        }
        return ssb;
    }
