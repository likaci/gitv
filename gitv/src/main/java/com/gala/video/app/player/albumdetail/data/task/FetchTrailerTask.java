    ...
    private class FirstCallback implements IApiCallback<ApiResultTrailersList> {
        ...
        public void onSuccess(ApiResultTrailersList result) {
            if (result == null) {
                ...
                if (LogUtils.mIsDebug) {
                    LogUtils.d(FetchTrailerTask.TAG, "episode data is ready firstCount" + firstCount + " total" + FetchTrailerTask.this.mTotal);
                }
            }
        }
    }
    ...
    private class SecondCallback implements IApiCallback<ApiResultTrailersList> {
        ...
        public void onSuccess(ApiResultTrailersList result) {
            if (result == null) {
                ...
                if (LogUtils.mIsDebug) {
                    LogUtils.d(FetchTrailerTask.TAG, "second data is ready mPage is " + FetchTrailerTask.this.mPage + " msecondCount = " + secondCount + " sumCount" + sumCount);
                }
