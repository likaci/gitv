...
public class FetchSearchBannerAdTask {
    ...
    private String fetchSearchBannerAdJson() {
        ...
        LogUtils.d(TAG, "getSearchBannerUrl --- pi = " + pi + " pc = " + pc + " isVip = " + isVip);
        ...
        LogUtils.d(TAG, "getSearchBannerUrl ---url is " + url);
        String response = "";
        try {
            HttpUtil hu = new HttpUtil(url);
            LogUtils.d(TAG, "HttpUtil hu = " + hu);
            response = hu.get();
        } catch (Exception e) {
            LogUtils.e(TAG, "Exception= " + e);
        }
        LogUtils.d(TAG, " the ad json response = " + response);
        return response;
    }
