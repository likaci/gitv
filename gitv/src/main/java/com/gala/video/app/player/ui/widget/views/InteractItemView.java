...
public class InteractItemView extends ImageView {
    ...
    public boolean onClick() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(this.TAG, "onClick>>() return " + handled);
        }
        return handled;
    }
    ...
    private void translate() {
        ...
        translate.addUpdateListener(new MyAnimatorUpdateListener<Integer>(Integer.valueOf(0)) {
            public void onAnimationUpdate(ValueAnimator animator, Integer lastValue, Integer newValue) {
                ...
                if (LogUtils.mIsDebug) {
                    LogUtils.d(InteractItemView.this.TAG, "translate...() offset=" + value);
                }
        ...
        translate.addListener(new MyAnimatorListener() {
            public void onAnimationEnd(Animator animation) {
    ...
    private void notifyStateChanged(int targetState) {
        if (LogUtils.mIsDebug) {
            LogUtils.d(this.TAG, "notifyStateChanged<<(targetState=" + targetState + "), currentState=" + this.mCurrentState + ", stateChangedListener=" + this.mStateChangedListener);
        }
    ...
    public boolean handledClick() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(this.TAG, "handledClick>>() return " + handled + ", currentState=" + this.mCurrentState);
        }
        return handled;
    }
