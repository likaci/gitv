...
public class ViewCachePool {
    ...
    public void setTotalSize(int size, ViewType type) {
        this.MAX_SIZE = size;
        LogUtils.e(TAG, "setTotalSize ----  size = " + size + ", type = " + type + ",mViewType=" + this.mViewType);
    ...
    public void preCreateViews(PreCreateViewListener preCreateViewListener) {
        ...
        if (size < this.MAX_SIZE) {
            ...
            LogUtils.e(TAG, "preCreateViews -------- 创建个数： " + (loadMaxIndex - size));
                ...
                public void run() {
                    ...
                    while (i < loadMaxIndex) {
                        ...
                        if (ViewCachePool.mViewStack.size() < loadMaxIndex) {
                            ...
                            LogUtils.e(ViewCachePool.TAG, "preCreateViews --------onComplete time =  " + (System.currentTimeMillis() - time));
