...
public class SkyworthSetting {
                ...
                if (outputs != null) {
                    ...
                    for (int i = 0; i < length; i++) {
                        if (LogUtils.mIsDebug) {
                            LogUtils.d("SkyworthSetting", "output[" + i + "]:" + outputs[i]);
                        }
                        if (outputs[i] != null) {
        ...
        if (this.mSettingService != null) {
            try {
                ...
                if (drcs != null) {
                    ...
                    for (int i = 0; i < length; i++) {
                        if (LogUtils.mIsDebug) {
                            LogUtils.d("SkyworthSetting", "output[" + i + "]:" + drcs[i]);
                        }
                        if (drcs[i] != null) {
        ...
        if (this.mSettingService != null) {
            try {
                ...
                if (audios != null) {
                    ...
                    for (int i = 0; i < length; i++) {
                        if (LogUtils.mIsDebug) {
                            LogUtils.d("SkyworthSetting", "output[" + i + "]:" + audios[i]);
                        }
                        if (audios[i] != null) {
        ...
        if (this.mSettingService != null) {
            try {
                ...
                if (times != null) {
                    ...
                    for (int i = 0; i < length; i++) {
                        if (LogUtils.mIsDebug) {
                            LogUtils.d("SkyworthSetting", "output[" + i + "]:" + times[i]);
                        }
                        if (times[i] != null) {
                ...
                LogUtils.e("SkyworthSetting", "occurs error when call getAllScreenSaveTime", e);
            }
        } else {
            LogUtils.e("SkyworthSetting", "skyworth setting service is null!");
        }
        ...
        if (this.mSettingService != null) {
            try {
                ...
                if (names != null) {
                    ...
                    for (int i = 0; i < length; i++) {
                        if (LogUtils.mIsDebug) {
                            LogUtils.d("SkyworthSetting", "output[" + i + "]:" + names[i]);
                        }
                        if (names[i] != null) {
        ...
        if (this.mSettingService != null) {
            try {
                ...
                if (infos != null) {
                    ...
                    if (LogUtils.mIsDebug) {
                        LogUtils.d("SkyworthSetting", "about:" + msg);
                    }
                }
            } catch (RemoteException e) {
    ...
    public String getCurrScreenSaveTime() {
        ...
        if (this.mSettingService != null) {
            try {
                ...
                LogUtils.e("SkyworthSetting", "occurs error when call getCurrScreenSaveTime", e);
            }
        } else {
            LogUtils.e("SkyworthSetting", "skyworth setting service is null!");
        }
    ...
    public void goToPositionSetting() {
        if (this.mSettingService != null) {
            try {
                ...
                LogUtils.e("SkyworthSetting", "occurs error when call goToPositionSetting", e);
                return;
            }
        }
        LogUtils.e("SkyworthSetting", "skyworth setting service is null!");
    ...
    public void goToNetworkSettings() {
        ...
        try {
            ...
            LogUtils.e("SkyworthSetting", "activity not fuound!", e);
        }
    }
