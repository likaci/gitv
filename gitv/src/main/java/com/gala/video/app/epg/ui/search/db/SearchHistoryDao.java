...
*/
        ...
        r2[r3] = r4;	 Catch:{ SQLException -> 0x0090, all -> 0x009a }
        com.gala.video.lib.framework.core.utils.LogUtils.i(r2);	 Catch:{ SQLException -> 0x0090, all -> 0x009a }
    ...
    public void insertHistory(SearchHistoryBean history, int maxCount, boolean isUnique) {
        if (history != null) {
            LogUtils.i("SQL_TEST", "SearchHistoryDao ---- ", history.toString(), " --- 【 KeyWords : ", history.getKeyword(), " 】");
            ...
            try {
                ...
                LogUtils.d(TAG, "---databse insertHistory--success--", history.getKeyword());
            } catch (Exception e) {
                e.printStackTrace();
                LogUtils.d(TAG, "---databse insertHistory--fail--", history.getKeyword());
            }
        }
    }
    ...
    public boolean deleteHistoryByKeyword(String keyword) {
        ...
        try {
            ...
            LogUtils.i("SQL_TEST", "SearchHistoryDao --- deleteHistoryByKeyword --- keywords : ", keyword);
            if (db != null) {
                db.close();
            }
        } catch (Exception e) {
