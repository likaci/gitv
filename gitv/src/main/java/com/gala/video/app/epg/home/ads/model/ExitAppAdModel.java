...
public class ExitAppAdModel extends CupidAdModel {
    ...
    public Bitmap getQrBitmap() {
        LogUtils.d(TAG, "getQrBitmap, shouldShowQr: " + shouldShowQr() + " is need qr : " + this.mNeedQr);
        ...
        LogUtils.d(TAG, "getQrBitmap, the predefined bitmap dimension = " + dimension);
        try {
            ...
            LogUtils.d(TAG, "getQrBitmap, the width of bitmap generated : " + (qrBitmap != null ? qrBitmap.getWidth() : -1));
            return qrBitmap;
        } catch (Exception e) {
