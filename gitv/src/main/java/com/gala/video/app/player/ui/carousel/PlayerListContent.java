...
public class PlayerListContent extends FrameLayout implements OnItemRecycledListener, OnItemClickListener, OnItemFocusChangedListener {
    ...
    public void initView() {
        ...
        this.mTxt.setTextSize(0, (float) this.mContext.getResources().getDimensionPixelSize(R.dimen.dimen_27dp));
        ...
        LayoutParams barparams = new LayoutParams(this.mContext.getResources().getDimensionPixelSize(R.dimen.dimen_40dp), this.mContext.getResources().getDimensionPixelSize(R.dimen.dimen_40dp));
