...
class ScreenSaverWindow extends Dialog {
    ...
    private void init(Context context) {
        this.mContainerView = LayoutInflater.from(context).inflate(R.layout.share_screen_saver_ad, null);
    ...
    void setCurrentWindowStyle(int currentWindowStyle) {
        LogUtils.d(TAG, "setCurrentWindowStyle:" + currentWindowStyle);
        switch (currentWindowStyle) {
            ...
            case 1:
                ...
                return;
            default:
                LogUtils.d(TAG, "setCurrentWindowStyle: windowStyle is error, currentWindowStyle = " + currentWindowStyle);
                return;
        }
    }
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        LogUtils.d(TAG, "dispatchKeyEvent,keycode=" + event.getKeyCode() + ",action=" + event.getAction());
        onKeyEvent(event);
        return true;
    }
