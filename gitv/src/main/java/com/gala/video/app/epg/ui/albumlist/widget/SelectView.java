...
public class SelectView extends RelativeLayout {
    ...
    private final int NORMAL_COLOR = ResourceUtil.getColor(R.color.albumview_normal_color);
    ...
    public void setViewParams(int type) {
        LogUtils.i(LOG_TAG, "setViewParams ---type = ", Integer.valueOf(type));
        this.mWidth = getDimen(R.dimen.dimen_218dp);
    ...
    private void initLayout() {
        ...
        switch (this.mLayoutType) {
            case 0:
                layoutParams = new LayoutParams(getDimen(R.dimen.dimen_218dp), getDimen(R.dimen.dimen_44dp));
                break;
            case 1:
            case 2:
            case 3:
                layoutParams = new LayoutParams(getDimen(R.dimen.dimen_218dp), getDimen(R.dimen.dimen_75dp));
            ...
            case 6:
            case 7:
                layoutParams = new LayoutParams(-2, getDimen(R.dimen.dimen_160dp));
                this.mFirstItemLayout = initItemLayout(0);
            ...
            case 8:
            case 9:
                layoutParams = new LayoutParams(-2, getDimen(R.dimen.dimen_230dp));
                this.mFirstItemLayout = initItemLayout(0);
                this.mSecondItemLayout = initItemLayout(1);
    ...
    private RelativeLayout initItemLayout(int position) {
        RelativeLayout relativeLayout = (RelativeLayout) this.mInflater.inflate(R.layout.epg_select_view_item_layout, null);
    ...
    private void setFocus(RelativeLayout upLayout, RelativeLayout downLayout) {
        if (upLayout != null && downLayout != null) {
            ...
            LogUtils.e(LOG_TAG, "setFocus error, illgel arguments, upLayout = ", upLayout, " downLayout = ", downLayout);
        } else {
    ...
    private void setRelativePlace(RelativeLayout upLayout, RelativeLayout downLayout) {
        if (upLayout == null || downLayout == null) {
            LogUtils.e(LOG_TAG, "setRelativePlace error --- illgel arguments, upLayout = ", upLayout, " downLayout = ", downLayout);
            return;
        }
    ...
    private void initDivideLine() {
        this.mLineImage = (ImageView) this.mInflater.inflate(R.layout.epg_select_view_divide_line_layout, null);
        LayoutParams imageParams = new LayoutParams(getDimen(R.dimen.dimen_169dp), getDimen(R.dimen.dimen_2dp));
    ...
    private ImageView findImageView(RelativeLayout relativeLayout) {
        return relativeLayout != null ? (ImageView) relativeLayout.findViewById(R.id.epg_select_view_item_imageview) : null;
    }

    private TextView findTextView(RelativeLayout relativeLayout) {
        return relativeLayout != null ? (TextView) relativeLayout.findViewById(R.id.epg_select_view_item_textview) : null;
    }
    ...
    public void setSelectViewColorStatus(int status) {
        if (getSelectItem() != null) {
            ...
            if (!isNull(imageView, textView)) {
                switch (status) {
                    case 0:
                        setImageResource(imageView, R.drawable.epg_ic_top_select_focus_icon);
                        setTextColor(textView, -1);
                        return;
                    case 1:
                        setImageResource(imageView, R.drawable.epg_ic_top_selected_icon);
                        setTextColor(textView, GREEN_COLOR);
                        return;
                    case 2:
                        setImageResource(imageView, R.drawable.epg_ic_top_select_normal_icon);
                        setTextColor(textView, this.NORMAL_COLOR);
                        return;
                    default:
                        LogUtils.e(LOG_TAG, "setSelectViewColorStatus --- illgel arguments,status = ", Integer.valueOf(status));
                        return;
                }
            }
        }
    ...
    public void setCarrouselViewColorStatus(int status) {
        if (getCarrouselItem() != null) {
            ...
            if (!isNull(imageView, textView)) {
                switch (status) {
                    case 0:
                        setImageResource(imageView, R.drawable.epg_ic_top_carrousel_focus_icon);
                        setTextColor(textView, -1);
                        return;
                    case 2:
                        setImageResource(imageView, R.drawable.epg_ic_top_carrousel_normal_icon);
                        setTextColor(textView, this.NORMAL_COLOR);
                        return;
                    default:
                        LogUtils.e(LOG_TAG, "setCarrouselViewColorStatus --- illgel arguments,status = ", Integer.valueOf(status));
                        return;
                }
            }
        }
    ...
    public String getTagName(int tagType) {
        switch (tagType) {
            ...
            default:
                LogUtils.e(LOG_TAG, "getTagName --- illgel argument, tagType = ", Integer.valueOf(tagType));
                return "";
        }
    }
