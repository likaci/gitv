...
public class NetworkPrompt {
    ...
    public void showPrompt() {
        if (this.mPromptDialog == null || !this.mPromptDialog.isShowing()) {
            String okBtnText = this.mContext.getString(R.string.albumlist_networksetting);
            ...
            this.mPromptDialog.setParams(this.mContext.getString(R.string.albumlist_no_network), okBtnText, onClickListener, null, null);
