...
public class Support2Dto3DContent extends AbsTabContent<List<Boolean>, Boolean> {
    ...
    private void initViews() {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(R.layout.player_tabpanel_2dto3d, null);
        if (LogUtils.mIsDebug) {
    ...
    private void initDefinitionWidget(View contentView) {
        this.mRG2Dto3D = (MyRadioGroup) contentView.findViewById(R.id.rg_2dto3d);
        this.m2dTo3dPanel = (LinearLayout) contentView.findViewById(R.id.ll_2d_to_3d);
    ...
    public void show() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(this.TAG, "init2Dto3DWidget: is2Dto3DEnabled=" + is2Dto3DEnabled);
        }
        ...
        this.mRG2Dto3D.setOnCheckedChangedListener(new OnCheckedChangeListener() {
            public void onCheckedChanged(int index) {
                if (LogUtils.mIsDebug) {
                    LogUtils.d(Support2Dto3DContent.this.TAG, "onCheckedChanged(2dto3d): index=" + index);
                }
            }

            public void onItemChecked(int index) {
                if (LogUtils.mIsDebug) {
                    LogUtils.d(Support2Dto3DContent.this.TAG, "onItemChecked(2dto3d): " + index);
                }
