...
public class ScreenRatioContent extends AbsTabContent<List<Pair<Integer, Integer>>, Integer> {
    ...
    private void initViews() {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(R.layout.player_tabpanel_screenratio, null);
        if (LogUtils.mIsDebug) {
    ...
    private void initDefinitionWidget(View contentView) {
        this.mHScrollViewScreenRatio = (HorizontalScrollView) contentView.findViewById(R.id.rg);
        this.mRGScreenRatio = (MyRadioGroup) contentView.findViewById(R.id.rg_screenratio);
        this.mScreenRatioPanel = (LinearLayout) contentView.findViewById(R.id.ll_screenratio);
    ...
    public void show() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(this.TAG, "onShow: list=" + list + ", checkedIndex=" + this.mCheckedIndex);
        }
        this.mRGScreenRatio.setDataSource(list, this.mCheckedIndex);
        this.mRGScreenRatio.setOnCheckedChangedListener(new OnCheckedChangeListener() {
            public void onCheckedChanged(int index) {
                if (LogUtils.mIsDebug) {
                    LogUtils.d(ScreenRatioContent.this.TAG, "onCheckedChanged(screen): index=" + index);
                }
            ...
            public void onItemChecked(int index) {
                if (LogUtils.mIsDebug) {
                    LogUtils.d(ScreenRatioContent.this.TAG, "onItemChecked(screen): " + index);
                }
