...
public class ChannelLeftFragment extends AlbumBaseLeftFragment implements OnItemRecycledListener, OnItemClickListener, OnItemFocusChangedListener, OnFocusLostListener {
    ...
    private SelectView.OnItemClickListener mSelectViewClickListener = new SelectView.OnItemClickListener() {
    ...
    private OnItemSelectListener mSelectViewSelectListener = new OnItemSelectListener() {
    ...
    public class GridItemDecoration extends ItemDecoration {
        public int getItemOffsets(int position, RecyclerView parent) {
            return ChannelLeftFragment.this.isLevel(position) ? ChannelLeftFragment.this.getDimen(R.dimen.dimen_1dp) : ChannelLeftFragment.this.getDimen(R.dimen.dimen_8dp);
        }
    }
    ...
    private void initLabelView() {
        ...
        this.mLeftLabel.setDividerWidth(getDimen(R.dimen.dimen_169dp));
        this.mLeftLabel.setBackgroundWidth(getDimen(R.dimen.dimen_218dp));
        ...
        if (this.mSelectType == 0) {
            ...
            lp.topMargin = getDimen(R.dimen.dimen_50dp);
