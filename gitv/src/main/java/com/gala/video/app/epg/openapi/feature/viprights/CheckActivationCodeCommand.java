    ...
    private class MyListener extends NetworkHolder implements IVrsCallback<ApiResultCode> {
        ...
        public void onException(ApiException exception) {
            ...
            if (LogUtils.mIsDebug) {
                LogUtils.w(CheckActivationCodeCommand.TAG, "MyListener.onException(" + exception + ")");
            }
        ...
        public void onSuccess(ApiResultCode apiResult) {
            if (LogUtils.mIsDebug) {
                LogUtils.w(CheckActivationCodeCommand.TAG, "MyListener.onSuccess(" + apiResult.code + ")");
            }
