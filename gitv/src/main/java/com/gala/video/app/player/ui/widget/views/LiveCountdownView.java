...
public class LiveCountdownView extends RelativeLayout implements ICountDownView {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                ...
                if (LogUtils.mIsDebug) {
                    LogUtils.d(LiveCountdownView.TAG, "handlerMessage() countDownTime=" + countDownTime + ", isShown()=" + LiveCountdownView.this.isShown());
                }
            }
        }
    };
    ...
    private static class TimeHolder {
        ...
        public static TimeHolder getTimeInfos(Context context, int timeSeconds) {
            ...
            if (day > 0) {
                ...
                infos[0] = new TimeInfo(String.format(TIME_FORMAT, new Object[]{Integer.valueOf(day)}), context.getString(R.string.day_unit));
                infos[1] = new TimeInfo(String.format(TIME_FORMAT, new Object[]{Integer.valueOf(hour)}), context.getString(R.string.hour_unit));
                infos[2] = new TimeInfo(String.format(TIME_FORMAT, new Object[]{Integer.valueOf(minute)}), context.getString(R.string.minute_unit));
            } else {
                mode = 0;
                infos[0] = new TimeInfo(String.format(TIME_FORMAT, new Object[]{Integer.valueOf(hour)}), context.getString(R.string.hour_unit));
                infos[1] = new TimeInfo(String.format(TIME_FORMAT, new Object[]{Integer.valueOf(minute)}), context.getString(R.string.minute_unit));
                infos[2] = new TimeInfo(String.format(TIME_FORMAT, new Object[]{Integer.valueOf(second)}), context.getString(R.string.second_unit));
            }
    ...
    private void init(Context context) {
        View v = ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(R.layout.player_live_countdown_view, null);
        this.mTitle = (TextView) v.findViewById(R.id.txt_title);
        this.mTime0Dec = (TextView) v.findViewById(R.id.txt_time0_dec);
        this.mTime0Unit = (TextView) v.findViewById(R.id.txt_time0_unit);
        this.mTime1Dec = (TextView) v.findViewById(R.id.txt_time1_dec);
        this.mTime1Unit = (TextView) v.findViewById(R.id.txt_time1_unit);
        this.mTime2Dec = (TextView) v.findViewById(R.id.txt_time2_dec);
        this.mTime2Unit = (TextView) v.findViewById(R.id.txt_time2_unit);
        addView(v);
    }
    ...
    public void setLiveStartTime(long time) {
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "setLiveStartTime() time=" + time);
        }
    ...
    private int getCountdownTime() {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "getCountdownTime() return " + count);
        }
        return count;
    }
    ...
    public void setVisibility(int visibility) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "setVisibility() visibility=" + visibility);
        }
    ...
    public void switchScreen(boolean isFullScreen, float zoomRatio) {
        ...
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "switchScreen(isFullScreen=" + isFullScreen + ", ratio=" + ratio + ")");
        }
        float titleSize = ((float) getResources().getDimensionPixelSize(R.dimen.live_title_text_size)) * ratio;
        updateViewSizeTitle(this.mTitle, -1, -1, -1, -1, -1, (int) (((float) getResources().getDimensionPixelSize(R.dimen.live_title_margin_bottom)) * ratio));
        this.mTitle.setTextSize(0, titleSize);
        int timeDecW = (int) (((float) getResources().getDimensionPixelSize(R.dimen.live_countdown_view_item_width)) * ratio);
        int timeDecH = (int) (((float) getResources().getDimensionPixelSize(R.dimen.live_countdown_view_item_height)) * ratio);
        float timeDecTextSize = ((float) getResources().getDimensionPixelSize(R.dimen.live_time_dec_text_size)) * ratio;
        ...
        int timeUnitW = (int) (((float) getResources().getDimensionPixelSize(R.dimen.live_countdown_view_item_width)) * ratio);
        int timeUnitMarginT = (int) (((float) getResources().getDimensionPixelSize(R.dimen.live_time_unit_margin_top)) * ratio);
        float timeUnitTextSize = ((float) getResources().getDimensionPixelSize(R.dimen.live_time_unit_text_size)) * ratio;
