...
public class TabSortedLayout extends TableRow implements OnFocusChangeListener, OnClickListener {
    ...
    public void setAdapter(TabSortedAdapter adapter) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            layoutParams.leftMargin = this.mContext.getResources().getDimensionPixelSize(R.dimen.dimen_022dp);
            layoutParams.rightMargin = this.mContext.getResources().getDimensionPixelSize(R.dimen.dimen_022dp);
            layoutParams.width = this.mContext.getResources().getDimensionPixelSize(R.dimen.dimen_196dp);
            layoutParams.height = this.mContext.getResources().getDimensionPixelSize(R.dimen.dimen_121dp);
    ...
    private boolean swapTabsOnRightKeyDown() {
        ...
        LogUtils.d(TAG, "nextChildView.getX() - curFocusVieX.getX() : " + offset);
    ...
    private void smoothScrollToEnd() {
        ...
        int margin = this.mContext.getResources().getDimensionPixelSize(R.dimen.dimen_17dp);
        if (this.mIsRemoveItemTabFromAlternativeList) {
    ...
    public void addItemView(TabModel tabModel) {
        ...
        layoutParams.height = this.mContext.getResources().getDimensionPixelSize(R.dimen.dimen_121dp);
        childView.setId(ViewUtils.generateViewId());
        childView.setLayoutAnimation(AnimationUtils.loadLayoutAnimation(this.mContext, R.anim.epg_tab_manager_add_tab_layout_animation));
        addView(childView, layoutParams);
