...
public class MenuFloatLayerSettingActivity extends QMultiScreenActivity implements OnItemClickListener, OnItemFocusChangedListener {
    ...
    private void initSettingGridView() {
        ...
        this.mSettingGridView.setVerticalMargin(ResourceUtil.getDimen(R.dimen.dimen_16dp) - (ninePatchBorder * 2));
        this.mSettingGridView.setHorizontalMargin(ResourceUtil.getDimen(R.dimen.dimen_16dp) - (ninePatchBorder * 2));
        LogUtils.i(TAG, "ninePatchBorder = ", Integer.valueOf(ninePatchBorder));
        this.mSettingGridView.setContentWidth(ResourceUtil.getDimen(R.dimen.dimen_188dp) + (ninePatchBorder * 2));
        this.mSettingGridView.setContentHeight(ResourceUtil.getDimen(R.dimen.dimen_188dp) + (ninePatchBorder * 2));
        ...
        this.mSettingGridView.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
