...
public class SystemKeyListener extends VoiceListener {
    ...
    protected List<AbsVoiceAction> doOpenAction() {
        ...
        try {
            ...
            if (!(activity == null || activity.isFinishing())) {
                actions.add(createVoiceActionbyKeyEvent(getString(R.string.voice_key_click_default), 23));
                actions.add(createVoiceActionbyKeyEvent(getString(R.string.voice_key_left_default), 21));
                actions.add(createVoiceActionbyKeyEvent(getString(R.string.voice_key_right_default), 22));
                actions.add(createVoiceActionbyKeyEvent(getString(R.string.voice_key_up_default), 19));
                actions.add(createVoiceActionbyKeyEvent(getString(R.string.voice_key_down_default), 20));
                actions.add(createVoiceActionbyKeyEvent(getString(R.string.voice_key_back_default), 4));
                actions.add(createVoiceActionbyKeyEvent(getString(R.string.voice_key_menu_default), 82));
            }
        } catch (Exception e) {
    ...
    AbsVoiceAction createVoiceActionbyKeyEvent(String keyWord, final int keyCode) {
        if (LogUtils.mIsDebug) {
            LogUtils.d(TAG, "create voice action keyword = " + keyWord);
        }
