...
public class AppMenuItem extends FrameLayout {
    ...
    private void init(Context context) {
        View view = ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(R.layout.epg_app_menu_item, null);
        RelativeLayout mLayout = (RelativeLayout) view.findViewById(R.id.epg_app_menu_layout);
        this.mIcon = (ImageView) mLayout.findViewById(R.id.epg_app_menu_icon);
        this.mText = (TextView) mLayout.findViewById(R.id.epg_app_menu_text);
