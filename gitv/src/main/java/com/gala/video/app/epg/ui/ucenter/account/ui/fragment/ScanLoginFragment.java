...
public class ScanLoginFragment extends BaseLoginFragment implements OnClickListener, OnFocusChangeListener {
    ...
    private Runnable mGifAnimalRunnable = new Runnable() {
        public void run() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        this.mMainView = inflater.inflate(R.layout.epg_fragment_login, null);
    ...
    private void loadDynamicQData() {
        ...
        this.mHandler.post(new Runnable() {
            public void run() {
                ScanLoginFragment.this.mQRTipText.setText(StringUtils.isEmpty(finalQrTip) ? ScanLoginFragment.this.getStr(R.string.login_qr_tip) : finalQrTip);
            }
        });
        if (this.mIntentFlag == 6) {
            this.mHandler.post(new Runnable() {
                public void run() {
                    ...
                    options.inPurgeable = true;
                    options.inPreferredConfig = Config.RGB_565;
                    ScanLoginFragment.this.mLoginGuideBitmap = BitmapFactory.decodeResource(ScanLoginFragment.this.getResources(), R.drawable.epg_login_coupon_bg, options);
                    ScanLoginFragment.this.mHandler.post(new Runnable() {
                        public void run() {
    ...
    private void doHasQRContent(ApiResultQuickLogin resultQuickLogin, String qrContent) {
        ...
        final Bitmap bitmap = QRUtils.createQRImage(qrContent, getDimen(R.dimen.dimen_310dp), getDimen(R.dimen.dimen_310dp));
                ...
                public void run() {
                    ...
                    ScanLoginFragment.this.mCountDownTimer = new CountDownTimer((long) (expireTime * 1000), 1000) {
                        ...
                        public void onFinish() {
                            LogUtils.d(ScanLoginFragment.LOG_TAG, "onFinish -- 倒计时结束 , expireTime = " + expireTime);
