...
public class T9Layer extends RelativeLayout {
    ...
    private WidgetStatusListener mWidgetStatusListener = new WidgetStatusListener() {
    ...
    private PhotoGridParams getPhotoGridParam(int columnNum, int layerItemWidth, int layerItemHeight) {
        ...
        p.verticalSpace = ResourceUtil.getDimen(R.dimen.dimen_2dp);
        p.horizontalSpace = ResourceUtil.getDimen(R.dimen.dimen_2dp);
