...
public class SubscribleItemView extends FavoriteHistoryItemView {
    ...
    public void setCorner(IData info) {
        ...
        LogUtils.d(TAG, "content:" + getContentDescription() + "isVip:" + isVip + ",isSingleBuy:" + isSingleBuy + ",isCoupons:" + isCoupons + ",isDubo:" + isDubo + ",isZhuanTi:" + isZhuanTi + ",isDujia:" + isDujia + ",isSubscrible:" + isSubscrible);
        if (!isSubscrible) {
            clearLiveCorner();
