...
public class VideoJobSwitcher extends VideoJob {
    private VideoJob a;
    private final List<JobHolder> f355a = new ArrayList();
...
*/
    ...
    L_0x002a:
        ...
        com.gala.video.lib.framework.core.utils.LogUtils.d(r2, r3);	 Catch:{ all -> 0x0065 }
    L_0x0040:
    ...
    L_0x0046:
        ...
        com.gala.video.lib.framework.core.utils.LogUtils.d(r2, r1);	 Catch:{ all -> 0x0065 }
    L_0x005c:
    ...
    public synchronized void link(ISwitchCondition condition, VideoJob job) {
        if (LogUtils.mIsDebug) {
            LogUtils.d("Player/Lib/Data/VideoJobSwitcher", "link(" + condition + ", " + job + ")");
        }
        if (condition != null) {
            this.f355a.add(new JobHolder(this, condition, job));
        } else {
            this.a = job;
        }
    }
    ...
    public List<Job<IVideo>> getNextJobs() {
        ...
        synchronized (this.f355a) {
            for (JobHolder jobHolder : this.f355a) {
                arrayList.add(jobHolder.a);
            }
        }
        return arrayList;
    }
