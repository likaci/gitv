...
public final class a {
    ...
    private List<String> f519a = new ArrayList(1);
    private HostnameVerifier f520a = new HostnameVerifier() {
    ...
    public final com.gala.tvapi.tv3.b.b a(boolean r16) {
        /*
        r15 = this;
    ...
    L_0x0007:
        ...
        r0 = r15.f520a;	 Catch:{ Exception -> 0x026f, Error -> 0x026c }
        ...
        r5 = r15.f518a;	 Catch:{ Exception -> 0x026f, Error -> 0x026c }
        ...
        r5 = "application/json";
        r0.setRequestProperty(r1, r5);	 Catch:{ Exception -> 0x00a8, Error -> 0x0119, all -> 0x0238 }
        r1 = r15.f519a;	 Catch:{ Exception -> 0x00a8, Error -> 0x0119, all -> 0x0238 }
    ...
    L_0x00ad:
        r5 = -50;
        r3.a = r5;	 Catch:{ all -> 0x0267 }
        r3.f516a = r0;	 Catch:{ all -> 0x0267 }
    ...
    L_0x00d0:
        ...
        r1 = r15.b;	 Catch:{ Exception -> 0x00a8, Error -> 0x0119, all -> 0x0238 }
    ...
    L_0x00e2:
        ...
        r5 = r15.b;	 Catch:{ Exception -> 0x00a8, Error -> 0x0119, all -> 0x0238 }
    ...
    L_0x00fa:
        ...
        r3.a = r5;	 Catch:{ Exception -> 0x00a8, Error -> 0x0119, all -> 0x0238 }
    ...
    L_0x0104:
        ...
        r6 = r6 - r8;
        r3.f515a = r6;	 Catch:{ Exception -> 0x00a8, Error -> 0x0119, all -> 0x0238 }
    ...
    L_0x0144:
        ...
        r1 = a;	 Catch:{ Exception -> 0x0208, Error -> 0x0119, all -> 0x0238 }
    ...
    L_0x017e:
        ...
        r3.f516a = r10;	 Catch:{ Exception -> 0x0208, Error -> 0x0119, all -> 0x0238 }
        r10 = android.os.SystemClock.elapsedRealtime();	 Catch:{ Exception -> 0x0208, Error -> 0x0119, all -> 0x0238 }
        r10 = r10 - r8;
        r3.f515a = r10;	 Catch:{ Exception -> 0x0208, Error -> 0x0119, all -> 0x0238 }
    L_0x018f:
    ...
    L_0x0196:
        ...
        r3.f516a = r1;	 Catch:{ Exception -> 0x0208, Error -> 0x0119, all -> 0x0238 }
        r6 = android.os.SystemClock.elapsedRealtime();	 Catch:{ Exception -> 0x0208, Error -> 0x0119, all -> 0x0238 }
        r6 = r6 - r8;
        r3.f515a = r6;	 Catch:{ Exception -> 0x0208, Error -> 0x0119, all -> 0x0238 }
    ...
    L_0x01b9:
        ...
        r3.f517a = r1;	 Catch:{ Exception -> 0x0208, Error -> 0x0119, all -> 0x0238 }
        r6 = android.os.SystemClock.elapsedRealtime();	 Catch:{ Exception -> 0x0208, Error -> 0x0119, all -> 0x0238 }
        r6 = r6 - r8;
        r3.f515a = r6;	 Catch:{ Exception -> 0x0208, Error -> 0x0119, all -> 0x0238 }
    ...
    L_0x020f:
        ...
        r10 = android.os.SystemClock.elapsedRealtime();	 Catch:{ Exception -> 0x0208, Error -> 0x0119, all -> 0x0238 }
        r8 = r10 - r8;
        r3.f515a = r8;	 Catch:{ Exception -> 0x0208, Error -> 0x0119, all -> 0x0238 }
