...
public class Album extends Model implements Cloneable {
    ...
    public CornerMark getHighestCornerMark(CornerMark mark) {
        com.gala.tvapi.log.a.a("CornerMark()", "level mark:" + mark);
    ...
    public boolean isSourceType() {
        return (a.a(this.sourceCode) || this.sourceCode.equals("0")) ? false : true;
    }
    ...
    public String getScore() {
        if (a.a(this.score) || this.score.contains(".")) {
            return this.score;
        }
        return this.score + ".0";
    }
