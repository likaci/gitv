...
public final class f {
    ...
    public static String e(String str, String str2) {
        ...
        String a = a.a(str.substring(4, 36) + "|" + str2 + "|Fw0JD89dhtS7BdPLU21");
        a = a;
        return a;
    }

    public static boolean m98a(String str, String str2, String str3) {
        try {
            String str4;
            ...
            String str5 = new String(instance.doFinal(com.gala.tvapi.c.a.a(str.getBytes("UTF8"))), "UTF8");
            com.gala.tvapi.log.a.a("checkvip", "data_string=" + str3);
            com.gala.tvapi.log.a.a("checkvip", "request_sign=" + a);
            str4 = a.a(str3 + a);
            str5 = str5.trim();
            com.gala.tvapi.log.a.a("Sign=", str4);
            com.gala.tvapi.log.a.a("orginal=", str5);
    ...
    private static String a(Map<String, String> map, String str) {
        ...
        return a.a(stringBuilder.append(str).toString());
    }
    ...
    public static String b(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8) {
        ...
        return a.a(stringBuilder.append("w0JD89dhtS7BdPLU2").toString());
    }
    ...
    public static String f(String str, String str2) {
        return a.a(str2 + "_890dbe91fbadca03_" + str + "_2385461878_");
    }
    ...
    public static String g(String str, String str2) {
        ...
        try {
            ...
            return new String(com.gala.tvapi.c.a.a(instance.doFinal(str.getBytes("UTF8")), 0)).replaceAll("\n", "").replaceAll(HTTP.TAB, "");
        } catch (Exception e) {
            e.printStackTrace();
            return "";
        }
    ...
    public static String b(String str, String str2, String str3) {
        ...
        return a.a(stringBuilder.append(str42).toString());
    }
    ...
    public static String h(String str, String str2) {
        ...
        Map hashMap = new HashMap();
        com.gala.tvapi.log.a.a("macid", "id=" + str);
        hashMap.put("macid", str);
