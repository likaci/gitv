...
public class ApiResultRecommendListQipu extends ApiResult {
    ...
    public Map<String, Album> getALbumMap() {
        ...
        for (String str : this.videos.keySet()) {
            hashMap.put(str, a((MixinVideo) this.videos.get(str)));
        }
        return hashMap;
    }
    ...
    private Album a(MixinVideo mixinVideo) {
        ...
        String str = (a.a(mixinVideo.sourceId) || mixinVideo.sourceId.equals("0")) ? mixinVideo.albumName : mixinVideo.sourceName;
        album.name = str;
        ...
        str = (a.a(mixinVideo.albumQipuId) || mixinVideo.albumQipuId.equals("0")) ? mixinVideo.qipuId : mixinVideo.albumQipuId;
        album.qpId = str;
        ...
        album.pic = a.a(mixinVideo.albumImageUrl) ? mixinVideo.videoImageUrl : mixinVideo.albumImageUrl;
