...
abstract class BitmapHunter implements Runnable {
    ...
    class AnonymousClass3 implements Runnable {
        ...
        AnonymousClass3(Transformation transformation) {
    ...
    class AnonymousClass4 implements Runnable {
        ...
        AnonymousClass4(Transformation transformation) {
            this.val$transformation = transformation;
        }
    ...
    static Bitmap applyCustomTransformations(List<Transformation> transformations, Bitmap result) {
        ...
        while (i < count) {
            ...
            if (newResult == null) {
                ...
                Picasso.HANDLER.post(new AnonymousClass2(builder));
                return null;
            } else if (newResult == result && result.isRecycled()) {
                Picasso.HANDLER.post(new AnonymousClass3(transformation));
                return null;
            } else if (newResult == result || result.isRecycled()) {
                result = newResult;
                i++;
            } else {
                Picasso.HANDLER.post(new AnonymousClass4(transformation));
                return null;
            }
        }
        return result;
