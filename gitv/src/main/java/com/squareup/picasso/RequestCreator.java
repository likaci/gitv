...
public class RequestCreator {
    ...
    class AnonymousClass1 implements Runnable {
        ...
        AnonymousClass1(AtomicInteger atomicInteger, CountDownLatch countDownLatch) {
    ...
    private static int getRequestId() {
        ...
        Picasso.HANDLER.post(new AnonymousClass1(id, latch));
        try {
            latch.await();
        } catch (InterruptedException e) {
            Picasso.HANDLER.post(new AnonymousClass2(e));
        }
        return id.get();
    }
