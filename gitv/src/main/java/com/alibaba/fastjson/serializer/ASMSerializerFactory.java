...
public class ASMSerializerFactory implements Opcodes {
    ...
    static class Context {
        ...
        public Context(List<FieldInfo> getters, JSONType jsonType, String className, int beanSerializeFeatures, boolean writeDirect, boolean nonContext) {
            ...
            this.beanFeatures = jsonType != null ? SerializerFeature.of(jsonType.serialzeFeatures()) : 0;
        }
        ...
        public int getFieldOrinal(String name) {
            int size = this.getters.size();
            for (int i = 0; i < size; i++) {
                if (((FieldInfo) this.getters.get(i)).name.equals(name)) {
                    return i;
                }
            }
            return -1;
    ...
    public ObjectSerializer createJavaBeanSerializer(Class<?> clazz, Map<String, String> aliasMap) throws Exception {
        ...
        if (orders == null || orders.length == 0) {
            List<FieldInfo> arrayList = new ArrayList(unsortedGetters);
        ...
        for (i = 0; i < size; i++) {
            if (!((FieldInfo) unsortedGetters.get(i)).equals(getters.get(i))) {
                nativeSorted = false;
                break;
            }
        }
        ...
        for (FieldInfo fieldInfo22 : getters) {
            if (!(fieldInfo22.fieldClass.isPrimitive() || fieldInfo22.fieldClass.isEnum() || fieldInfo22.fieldClass == String.class)) {
        ...
        MethodVisitor mw = new MethodWriter(cw, 1, "<init>", "()V", null, null);
        mw.visitVarInsn(25, 0);
        mw.visitLdcInsn(Type.getType(ASMUtils.desc((Class) clazz)));
        mw.visitMethodInsn(Opcodes.INVOKESPECIAL, JavaBeanSerializer, "<init>", "(Ljava/lang/Class;)V");
        for (i = 0; i < getters.size(); i++) {
            fieldInfo22 = (FieldInfo) getters.get(i);
            if (!(fieldInfo22.fieldClass.isPrimitive() || fieldInfo22.fieldClass.isEnum() || fieldInfo22.fieldClass == String.class)) {
                mw.visitVarInsn(25, 0);
        ...
        for (i = 0; i < 3; i++) {
            ...
            MethodVisitor methodWriter = new MethodWriter(cw, 1, methodName, "(L" + JSONSerializer + ";Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V", null, new String[]{"java/io/IOException"});
            ...
            if (context.writeDirect && !nonContext) {
                ...
                methodWriter.visitVarInsn(25, 1);
                methodWriter.visitVarInsn(25, 0);
                methodWriter.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONSerializer, "writeDirect", "(" + JavaBeanSerializer_desc + ")Z");
        ...
        if (!nativeSorted) {
            Context context2 = new Context(getters, jsonType, classNameType, beanSerializeFeatures, false, DisableCircularReferenceDetect);
        ...
        for (i = 0; i < 3; i++) {
            ...
            context = new Context(getters, jsonType, classNameType, beanSerializeFeatures, writeDirect, nonContext);
        ...
        return (ObjectSerializer) this.classLoader.defineClassPublic(classNameFull, code, 0, code.length).newInstance();
    }
    ...
    private void generateWriteAsArray(Class<?> cls, MethodVisitor mw, List<FieldInfo> getters, Context context) throws Exception {
        ...
        while (i < size) {
            ...
            if (fieldClass == Byte.TYPE || fieldClass == Short.TYPE || fieldClass == Integer.TYPE) {
                ...
                mw.visitVarInsn(58, context.var(IAlbumConfig.BUY_SOURCE_VIP_BTN));
                if (elementClass == String.class && context.writeDirect) {
                    mw.visitVarInsn(25, context.var("out"));
                    mw.visitVarInsn(25, context.var(IAlbumConfig.BUY_SOURCE_VIP_BTN));
    ...
    private void generateWriteMethod(Class<?> clazz, MethodVisitor mw, List<FieldInfo> getters, Context context) throws Exception {
        ...
        if (context.writeDirect) {
            mw.visitVarInsn(16, Service.NTP);
        } else {
        ...
        mw.visitIntInsn(16, Service.NTP);
        ...
        mw.visitLabel(_else);
        mw.visitVarInsn(25, context.var("out"));
        mw.visitVarInsn(16, Service.LOCUS_MAP);
        mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, SerializeWriter, "write", "(I)V");
    ...
    private void _enum(Class<?> cls, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        if (writeEnumUsingToString) {
            ...
            mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "java/lang/Enum", WebSDKConstants.PARAM_KEY_PL_NAME, "()Ljava/lang/String;");
            ...
            mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, SerializeWriter, "writeFieldValue", "(CLjava/lang/String;Ljava/lang/Enum;)V");
        }
    ...
    private void _get(MethodVisitor mw, Context context, FieldInfo property) {
        ...
        if (method != null) {
            ...
            mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, ASMUtils.type(method.getDeclaringClass()), method.getName(), ASMUtils.desc(method));
            return;
        }
        mw.visitVarInsn(25, context.var("entity"));
    ...
    private void _nameApply(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
        if (!context.writeDirect) {
            ...
            mw.visitVarInsn(25, 2);
            mw.visitVarInsn(25, Context.fieldName);
            mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONSerializer, "applyName", "(" + SerializeFilterable_desc + "Ljava/lang/Object;Ljava/lang/String;)Z");
            mw.visitJumpInsn(Opcodes.IFEQ, _end);
    ...
    private void _labelApply(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
        ...
        mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONSerializer, "applyLabel", "(" + SerializeFilterable_desc + "Ljava/lang/String;)Z");
        mw.visitJumpInsn(Opcodes.IFEQ, _end);
    }
    ...
    private void _before(MethodVisitor mw, Context context) {
        ...
        mw.visitVarInsn(25, 2);
        mw.visitVarInsn(21, context.var("seperator"));
        mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONSerializer, "writeBefore", "(" + SerializeFilterable_desc + "Ljava/lang/Object;C)C");
        mw.visitVarInsn(54, context.var("seperator"));
    }
    ...
    private void _after(MethodVisitor mw, Context context) {
        ...
        mw.visitVarInsn(25, 2);
        mw.visitVarInsn(21, context.var("seperator"));
        mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONSerializer, "writeAfter", "(" + SerializeFilterable_desc + "Ljava/lang/Object;C)C");
        mw.visitVarInsn(54, context.var("seperator"));
    }
    ...
    private void _apply(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONSerializer, "apply", "(" + SerializeFilterable_desc + "Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Z");
    }
    ...
    private void _processValue(MethodVisitor mw, FieldInfo fieldInfo, Context context, Label _end) {
        ...
        mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONSerializer, "processValue", "(" + SerializeFilterable_desc + ASMUtils.desc(BeanContext.class) + "Ljava/lang/Object;Ljava/lang/String;" + valueDesc + ")Ljava/lang/Object;");
        mw.visitVarInsn(58, Context.processValue);
        mw.visitVarInsn(25, Context.original);
        mw.visitVarInsn(25, Context.processValue);
    ...
    private void _processKey(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONSerializer, "processKey", "(" + SerializeFilterable_desc + "Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;");
        mw.visitVarInsn(58, Context.fieldName);
    ...
    private void _if_write_null(MethodVisitor mw, FieldInfo fieldInfo, Context context) {
        ...
        if ((SerializerFeature.WriteMapNullValue.mask & features) == 0) {
            mw.visitVarInsn(25, context.var("out"));
            mw.visitLdcInsn(Integer.valueOf(SerializerFeature.WriteMapNullValue.mask));
            mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, SerializeWriter, "isEnabled", "(I)Z");
