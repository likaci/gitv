...
public class ASMDeserializerFactory implements Opcodes {
    ...
    public ObjectDeserializer createJavaBeanDeserializer(ParserConfig config, Class<?> clazz, Type type) throws Exception {
        ...
        return (ObjectDeserializer) defineClassPublic(classNameFull, code, 0, code.length).getConstructor(new Class[]{ParserConfig.class, Class.class}).newInstance(new Object[]{config, clazz});
    }
        ...
        if (context.fieldInfoList.length != 0) {
            ...
            for (i = 0; i < fieldListSize; i++) {
                ...
                if (fieldClass2 == Boolean.TYPE) {
                    ...
                    mw.visitVarInsn(25, 1);
                    mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, DefaultJSONParser, "getSymbolTable", "()" + ASMUtils.desc(SymbolTable.class));
                    mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONLexerBase, "scanFieldSymbol", "([C" + ASMUtils.desc(SymbolTable.class) + ")Ljava/lang/String;");
                    mw.visitInsn(89);
                    mw.visitVarInsn(58, context.var(fieldInfo.name + "_asm_enumName"));
                    mw.visitJumpInsn(Opcodes.IFNULL, enumNull_);
                    mw.visitVarInsn(25, context.var(fieldInfo.name + "_asm_enumName"));
                    mw.visitMethodInsn(184, ASMUtils.type(fieldClass2), "valueOf", "(Ljava/lang/String;)" + ASMUtils.desc(fieldClass2));
                    mw.visitVarInsn(58, context.var(fieldInfo.name + "_asm"));
            ...
            mw.visitVarInsn(25, 3);
            mw.visitVarInsn(25, context.var("instance"));
            mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, ASMUtils.type(JavaBeanDeserializer.class), "parseRest", "(L" + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;");
            ...
            mw.visitVarInsn(25, 2);
            mw.visitVarInsn(25, 3);
            mw.visitMethodInsn(Opcodes.INVOKESPECIAL, ASMUtils.type(JavaBeanDeserializer.class), "deserialze", "(L" + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;)Ljava/lang/Object;");
            mw.visitInsn(Opcodes.ARETURN);
            mw.visitMaxs(5, context.variantIndex);
            mw.visitEnd();
        }
    ...
    private void _set(Context context, MethodVisitor mw, FieldInfo fieldInfo) {
        if (fieldInfo.method != null) {
            mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, ASMUtils.type(fieldInfo.declaringClass), fieldInfo.method.getName(), ASMUtils.desc(fieldInfo.method));
            if (!fieldInfo.method.getReturnType().equals(Void.TYPE)) {
                mw.visitInsn(87);
                return;
            }
    ...
    private void _init(ClassWriter cw, Context context) {
        ...
        MethodVisitor mw = new MethodWriter(cw, 1, "<init>", "(" + ASMUtils.desc(ParserConfig.class) + "Ljava/lang/Class;)V", null, null);
        mw.visitVarInsn(25, 0);
        mw.visitVarInsn(25, 1);
        mw.visitVarInsn(25, 2);
        mw.visitMethodInsn(Opcodes.INVOKESPECIAL, ASMUtils.type(JavaBeanDeserializer.class), "<init>", "(" + ASMUtils.desc(ParserConfig.class) + "Ljava/lang/Class;)V");
