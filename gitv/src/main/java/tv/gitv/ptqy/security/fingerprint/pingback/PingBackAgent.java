...
public class PingBackAgent {
    ...
    class AnonymousClass1 implements OnRequestBackListener {
    ...
    class AnonymousClass2 extends Thread {
        ...
        public void run() {
            try {
                ...
                LogMgr.i("sendErrorPingbackAsync :" + e.toString());
            }
        }
    }
    ...
    private static void saveErrorCache(Context context, int errorLevel, String errorType, String errorMsg) {
        ...
        try {
            ...
            LogMgr.i("saveErrorCache exception: " + e22.toString());
        }
        jarr.put(jobj);
    ...
    private static void sendErrorStatistics(Context context) {
        ...
        if (!TextUtils.isEmpty(cache)) {
            ...
            if (jarr != null && jarr.length() != 0) {
                ...
                HttpUtils.doPostRequest(Consts.PINGBACK_ADDRESS, HttpUtils.params2payload(params), new AnonymousClass1(context));
            }
        }
    }
